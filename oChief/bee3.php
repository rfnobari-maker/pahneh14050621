...
<p class="style1">آمار زنبورستان های استان در سال 1395</p>
           ...
           <table width="98%" height="232" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td height="100" colspan="9" bgcolor="#999999">میزان تحصیلات زنبورداران استان </td>
               <td width="7%" rowspan="2" bgcolor="#999999">شهرستان </td>
    <td width="3%" rowspan="2" bgcolor="#999999">ردیف</td>
    </tr>
             <tr align="center" class="text1">
               <td width="2%" height="100" bgcolor="#999999">حوزوی</td>
...
?>
    ...
    <td height="59"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_bah_mtah_count($id_ostan,$id_city,$sal,'9')?></td>
