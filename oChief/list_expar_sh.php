...
<body>
 ...
 ?>
<p align="center" ><span class="style1">کارشناسان موضوعی شهرستان </span></p>
...
?>
 ...
 <table width="750" height="100" border="0" align="center" cellpadding="2" cellspacing="2" >
   <tr align="center" class="text1">
     ...
     <td width="22%" bgcolor="#999999">واحد تخصصی </td>
...
$r = 1 ;
 foreach($stmt as $row){
   if ($row['expert_unit']=='1') $v_exp_unit = 'طرح و برنامه/ترویج' ; 
