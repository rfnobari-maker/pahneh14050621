...
$query = "SELECT * FROM  mar WHERE  id_ostan = '$id_ostan' and id_city = '$id_city_sh' "  ;
...
$r = 1 ;
 foreach($stmt as $row)
  {
$id_mar = $row['id_mar'];
$query2 = "SELECT * FROM  users WHERE  id_ostan = '$id_ostan' and  id_city = '$id_city_sh' and  S_access = '2' 
and id_mar = '$id_mar'"   ;
