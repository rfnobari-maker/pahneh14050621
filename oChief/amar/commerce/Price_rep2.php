...
inner join price_pro_list ON price_pro_list.p_cod = price_record.p_cod
 where year = $year and mont = $mont and $v_id_ostan  and  $v_s_date  and $v_p_cod  group by price_record.p_cod  ORDER BY id_ostan,p_cod  ASC LIMIT $start, $limit "; 
...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
              <tr class="text1">
                ...
                <td width="13%" rowspan="2" bgcolor="#006699">میانگین قیمت <br />
                ریال</td>
                <td width="6%" rowspan="2" bgcolor="#006699">تعداد  رکورد</td>
                <td width="8%" rowspan="2" bgcolor="#006699">واحد</td>
                <td width="18%" rowspan="2" bgcolor="#006699">نام محصول</td>
                <td width="13%" rowspan="2" bgcolor="#006699"> استان</td>
                <td width="4%" rowspan="2" bgcolor="#006699">ردیف</td>
              </tr>
              <tr class="text1">
                <td width="9%" height="31" bgcolor="#006699">قیمت ریال </td>
...
$min_city	=  price_city($id_ostan,$p_cod_1,$year,$mont,$v_s_date,$p_price_min) ;
  ?>
          <td height="49" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo 
		 $p_price_max ; 
		  ?></td>
          <td height="49" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($max_city,$id_ostan) ?></td>
          <td width="9%" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo 
		  $p_price_min ; 
		  ?></td>
          <td width="10%" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($min_city,$id_ostan) ?></td>
          <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['avg'] ; ?></td>
