       ...
       <div dir="ltr"> <?php include('menu.php'); ?> </div>
        ...
        <div class="content-section">
            <div class="welcome-banner">
                <img src="../files/reza.gif" alt="Welcome" width="240" height="57">
            </div>
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="benef.php" title="اطلاعات بهره برداران کشاورزی">
                        <img src="../files/farmer.png" alt="بهره برداران" class="card-icon">
                    </a>
                    <a href="benef.php" class="btn">بهره برداران کشاورزی</a>
                </div>
                <?php } if(strstr($perm,'d1') or strstr($perm,'d2')) { ?>
                <div class="card">
                    <a href="Agri" title="مدیریت امور زراعت">
                ...
                <div class="card">
                    <a href="Poultry/" title="زنبورعسل">
                        <img src="../files/bee.png" alt="زنبورعسل" class="card-icon">
                    </a>
                    <a href="Poultry/" class="btn">زنبورعسل</a>
                </div>
                <?php } if(strstr($perm,'d6')) { ?>
                <div class="card">
                    <a href="Aquatic" title="آبزی پروری">
                        <img src="../files/fish1.png" alt="آبزی پروری" class="card-icon">
                    </a>
                    <a href="Aquatic" class="btn">آبزی پروری</a>
                </div>
                <?php } if(strstr($perm,'d10')) { ?>
                <div class="card">
                    <a href="Industry/" title="صنایع تبدیلی و غذایی">
                        <img src="../files/sana.png" alt="صنایع تبدیلی" class="card-icon">
                    </a>
                    <a href="Industry/" class="btn">صنایع تبدیلی و تکمیلی</a>
                </div>
                ...
                <div class="card">
                    <a href="Animal/index.php" title="مدیریت امور دام">
                        <img src="../files/ani.jpg" alt="امور دام" class="card-icon">
                    </a>
                    <a href="./Animal" class="btn">مدیریت امور دام</a>
                </div>
                <?php } ?>
            </div>
