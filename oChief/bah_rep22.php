...
$stmt->execute();
?>
<p class="style8">گزارش  بهره برداران کشاورزی استان <?php echo ostan_name($id_ostan_t);?> به تفکیک زمینه فعالیت </p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <table width="132" height="56" border="0" align="center">
             <tr>
               <td width="61"><form  action="bah_rep22_xls.php" method="post">
               ...
               <td width="129"><form  action="bah_rep22_doc.php" method="post">
                 <input type="hidden" name="id_ostan_t" value="<?php echo $id_ostan_t ;?>" />
           ...
           <table  align="center" class="my-table"  >
             <tr align="center" class="text1">
               <td height="9" colspan="11" bgcolor="#006699">زمینه فعالیت</td>
               <td colspan="2" bgcolor="#006699">نوع بهره بردار</td>
    <td height="56" colspan="2" bgcolor="#006699">جنسیت </td>
    <td width="6%" rowspan="2" bgcolor="#006699">کل بهره برداران</td>
    <td width="13%" rowspan="2" bgcolor="#006699">شهرستان </td>
    <td width="6%" rowspan="2" bgcolor="#006699">ردیف</td>
    </tr>
  <tr align="center" class="text1">
    <td bgcolor="#006699">صنایع کشاورزی</td>
    <td bgcolor="#006699">پرورش ماهی</td>
    <td bgcolor="#006699">کرم ابریشم</td>
    <td height="47" bgcolor="#006699">زنبور عسل</td>
    <td height="47" bgcolor="#006699">طیور صنعتی</td>
    <td height="47" bgcolor="#006699">طیور سنتی</td>
    <td height="47" bgcolor="#006699">دام سبک</td>
    <td bgcolor="#006699">دام سنگین</td>
    <td bgcolor="#006699" style="text-align: center">گلخانه </td>
    <td bgcolor="#006699" style="text-align: center">باغ و قلمستان</td>
    <td bgcolor="#006699" style="text-align: center">زراعی</td>
    <td width="5%" bgcolor="#006699">حقوقی</td>
    <td width="5%" bgcolor="#006699">حقیقی<br /></td>
    <td width="4%" height="47" bgcolor="#006699">زن</td>
    <td width="5%" bgcolor="#006699">مرد</td>
    </tr>
  <?php
$r = 1 ;
 foreach($stmt as $row){
?>
  ...
  <td width="5%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['fa3'];?></td>
    ...
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo city_name1($row['id_city'],$row['id_ostan']);?><br /></td>
...
?>
  <tr>
    <td align="center" bgcolor="#006699" class="morph">صنایع کشاورزی</td>
    <td align="center" bgcolor="#006699" class="morph">پرورش ماهی</td>
    <td align="center" bgcolor="#006699" class="morph">کرم ابریشم</td>
    <td height="47" align="center" bgcolor="#006699" class="morph">زنیورعسل</td>
    <td height="47" align="center" bgcolor="#006699" class="morph">طیور صنعتی</td>
    <td height="47" align="center" bgcolor="#006699" class="morph">طیور سنتی</td>
    <td height="47" align="center" bgcolor="#006699" class="morph">دام سبک</td>
    <td align="center" bgcolor="#006699" class="morph">دام سنگین</td>
    <td align="center" bgcolor="#006699" class="morph">گلخانه</td>
    <td align="center" bgcolor="#006699" class="morph">باغی</td>
    <td align="center" bgcolor="#006699" class="morph">زراعی</td>
    <td align="center" bgcolor="#006699" class="morph">حقوقی</td>
    <td align="center" bgcolor="#006699" class="morph">حقیقی<br />
    </td>
    <td height="47" align="center" bgcolor="#006699" class="morph">زن</td>
    <td align="center" bgcolor="#006699" class="morph">مرد</td>
    <td bgcolor="#006699"  class="morph"  >کل بهره برداران</td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['jam'];?></td>
           ...
           <p>&nbsp;</p><p><a href="benef.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>
