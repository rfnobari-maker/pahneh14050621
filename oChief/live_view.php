...
echo $date_edit ; 
$query = "SELECT * FROM  log  where date = '$date_edit' and id_ostan= '$id_ostan' ORDER BY date DESC , time DESC LIMIT $start, $limit" ;
$query1 = "SELECT count(*) FROM  log  where date = '$date_edit' and id_ostan= '$id_ostan'  " ;
...
$query2 = "SELECT Last_name,name,city,markaz,pic FROM  users  where username = '$username' " ;
