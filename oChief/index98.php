...
<tr>
          ...
          <tr>
           ...
           <?php include('top.php'); ?>
              ...
              <div class="box" align="center">
                <p><a href="prof.php" title="اطلاعات اختصاصی  آبادی ها"><img src="../files/p_abadi.png" alt="اطلاعات اختصاصی" width="86" height="83" border="0" class="tricky_image" /></a></p>
                <p><a href="prof.php" class="btn"> اطلاعات اختصاصی + </a></p>
              </div>
              <div class="box" align="center">
                <p><a href="users.php" title=" کاربران سامانه"><img src="../files/login_rep.png" alt=" کاربران سامانه" width="83" height="83" border="0" class="tricky_image" /></a></p>
                <p><a href="users.php" class="btn">کاربران سامانه +</a><br />
                </p>
              </div>
              <div class="box" align="center">
