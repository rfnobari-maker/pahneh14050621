...
<body>
    <div class="container">
        ...
        <div align="center" class="content-section">
            <h2 class="page-title">بهره برداران کشاورزی</h2>
            <img src="../files/horizontal-line-700x223.png" alt="divider" class="divider">

            <div class="cards-container">
                <div class="card">
                    <a href="list_bah.php">
                        <img src="../files/farmer.png" alt="ویرایش" class="card-icon">
                    </a>
                    <a href="list_bah.php" class="btn">لیست بهره برداران کشاورزی</a>
                </div>

                <div class="card">
                    <a href="bah_rep11.php" title="پنل مدیریتی استان ها">
                        <img src="../files/centers.png" alt="استان ها" class="card-icon">
                    </a>
                    <a href="bah_rep11.php" class="btn">گزارش به تفکیک مدرک تحصیلی</a>
                </div>

                <div class="card">
                    <a href="bah_rep22.php" title="لیست شهر های تحت پوشش">
                        <img src="../files/p_abadi.png" alt="شهرها" class="card-icon">
                    </a>
                    <a href="bah_rep22.php" class="btn">گزارش به تفکیک زمینه فعالیت</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="GetPerson.php#1" class="btn">استعلام از ثبت احوال</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="search_benef.php" class="btn">سوابق بهره بردار</a>
                </div>
            </div>
