...
$query = "SELECT * FROM  bah where  id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar  ORDER BY BINARY last_name ASC LIMIT $start, $limit "; 
$query1 = "SELECT * FROM  bah where  id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar  ORDER BY BINARY last_name ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
...
?>
            ...
            <p>&nbsp;</p>
           <p> <p><a href="prof.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="128" height="57"  alt=""/> </a></p>    
           </p>
           <p>&nbsp;</p>
    </td>
  </tr>
