...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h2 class="page-title">ترویج</h2>
            <p align="center"><img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>

            <div class="cards-container">
                <?php if(strstr($perm,'p3')) { ?>
                <div class="card">
                    <a href="../list_center.php" title="اطلاعات مرکز جهاد کشاورزی">
                        <img src="../../files/pub_abadi.png" alt="اطلاعات مرکز جهاد کشاورزی" class="card-icon">
                    </a>
                    <a href="../list_center.php" class="btn">اطلاعات مرکز جهاد کشاورزی</a>
                </div>
                <?php } ?>
                <div class="card">
                    <a href="Eworker/Eworker_rep.php" title="اطلاعات مددکاران ترویجی">
                        <img src="../../files/morvege1.png" alt="اطلاعات مددکاران ترویجی" class="card-icon">
                    </a>
                    <a href="Eworker/Eworker_rep.php" class="btn">اطلاعات مددکاران ترویجی</a>
                </div>
            </div>
