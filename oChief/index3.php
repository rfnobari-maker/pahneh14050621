...
<p><a href="profile.php" class="btn">ویرایش اطلاعات کاربری</a></p>
              ...
              <div class="box" align="center">
                <p><a href="promo_action.php" title="مروجین شهرستان"><img src="../files/reports.png" alt="عملکرد  مروجین " width="80" height="72" border="0" class="tricky_image" /></a></p>
                <p><a href="promo_action.php" class="btn">گزارش عملکرد کارشناسان پهنه</a></p>
              </div>
              <div class="box" align="center">
                <p><a href="search_promo.php" title="جستجوی مروج"><img src="../files/morvege2.png" alt="جستجوی کاربر " width="83" height="72" border="0" class="tricky_image" /></a></p>
                <p><a href="search_promo.php" class="btn">جستجوی کاربر</a></p>
              </div>
              <div class="box" align="center">
                <p><a href="requests.php" title="درخواست رسیده "><img src="../files/Sback.PNG" alt="درخواست های رسیده" width="83" height="72" border="0" class="tricky_image" /></a></p>
