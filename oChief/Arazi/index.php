...
<tr>
  ...
  <?php include('top.php'); ?>
           ...
           <div class="box" align="center">
             <p><img src="../../files/tkarazi.png" alt="bee" width="110" height="105" border="0" class="tricky_image" /></p>
             <p><a href="list_tkarazi.php" class="btn">گزارش تغییر کاربری اراضی کشاورزی</a></p>
             <p>&nbsp;</p>
             <p>&nbsp;</p>
              </div>
            <p class="style9">&nbsp;</p></td>
