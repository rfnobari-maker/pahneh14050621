...
<p align="right"><form  action="list_tkarazi_xls.php" method="post">
 ...
 if ($row['no_ara']=='1') $v_no_ara = 'آبی'; else $v_no_ara = 'دیم' ;
  ?>
      ...
      <td width="7%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>> <form  action="view_tk_arazi.php" method="post">
      ...
      <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tk_cod_m'] ?></td>
