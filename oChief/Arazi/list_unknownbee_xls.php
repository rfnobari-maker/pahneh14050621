...
?>
      ...
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          ...
          <td width="7%" bgcolor="#FFCC99">نام مروج </td>
          <td width="32%" bgcolor="#FFCC99">توضیحات</td>
          <td width="5%" bgcolor="#FFCC99">جمع کندو</td>
          <td width="6%" height="58" bgcolor="#FFCC99">تعداد کندوی مدرن</td>
          <td width="5%" bgcolor="#FFCC99">تعدادکندوی بومی</td>
          <td width="4%" bgcolor="#FFCC99"><p>نوع زنبورستان</p></td>
          <td width="6%" bgcolor="#FFCC99">آبادی</td>
          <td width="5%" bgcolor="#FFCC99">شهر</td>
          <td width="5%" bgcolor="#FFCC99">شهرستان</td>
          <td width="8%" bgcolor="#FFCC99">ردیف</td>
        </tr>
          <?php  
		   $r = 1 ;
		  foreach($stmt as $row){ 
  ...
  ?>
        <tr>
          <td width="5%" height="41" bgcolor="#FFFFCC"><span class="normalTextSmall"><?php echo $row['date_s'] ?></span></td>
          <td width="6%"><?php echo user_tel($row['mor_cod_m'])?></td>
          <td width="6%"><?php echo $row['mor_cod_m']?></td>
