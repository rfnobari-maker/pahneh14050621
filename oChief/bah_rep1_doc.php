...
<p align="center" class="style8">گزارش  بهره برداران کشاورزی به تفکیک مدرک تحصیلی </p>
           <table width="98%" height="174" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
...
?>
  ...
  <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="5%" height="35" class="normalTextSmaller"><?php echo $row['m_tah8'];?></td>
...
?>
  ...
  <tr>
    ...
    <td height="43" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah8'];?></td>
