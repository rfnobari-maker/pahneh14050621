...
?>
  <table  align="center" class="my-table" >
    <tr>
     <td height="38" colspan="9" align="right" bgcolor="#CCCCCC"><?php if (isset($_POST['add_abadi'])) 
...
?>
    ...
    <tr>
      <td height="32" colspan="7" bgcolor="#FFFFCC" class="style8"><?php
    ...
    <tr>
      <td height="32" colspan="7" bgcolor="#FFFFCC" class="style8">تعداد واحد ثبت شده در سال</td>
      <td colspan="2" rowspan="2" bgcolor="#FFFFCC">نوع بهره برداری </td>
      </tr>
    <tr>
      <td width="116" bgcolor="#FFFFCC"><span class="style8">1404</span><br />
1403-1404</td>
   ...
   <tr>
	 ...
	 $valeu = Abadi_agri_count($add_abadi,'Agri1403_1404') ;
      if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
       <form  action="Agri/bah_liste_Agri.php" method="post" onsubmit="target_popup3(this)">
   ...
   <tr>
     <td><?php
     $valeu = Abadi_vege_count($add_abadi,'1403-1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
   ...
   <tr>
     <td bgcolor="#CCCCCC"><?php
     $valeu = Abadi_garden_count($add_abadi,'1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
   ...
   <tr>
     <td><?php
     $valeu = Abadi_Mushroom_count($add_abadi,'1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
   ...
   <tr>
     <td bgcolor="#CCCCCC"><?php
     $valeu = Abadi_Greenhous_count($add_abadi,'1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
   ...
   <tr>
     <td><?php
     $valeu = Abadi_Aquatic_count($add_abadi,'1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
   ...
   <tr>
     <td bgcolor="#CCCCCC"><?php
     $valeu = Abadi_bee_count($add_abadi,'1404') ;
	 if($valeu>= 0) { 	 echo $valeu ;  } else {  ?>
...
?>
 ...
 <p><a href="cities&villages.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p> 
  </td>
  </tr>
  <tr>
