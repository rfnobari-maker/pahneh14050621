     ...
     <tr bgcolor='#f1f1f1' >
       <td height="45" align="right" bgcolor="#F1F1F1" class="input_text" >
         <select  name="id_ostan" disabled="disabled" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
           <?php
$query = "SELECT id_ostan,ostan FROM ostanname where id_ostan  = '$id_ostan' "  ;
...
<table width="95%" height="108" border="1" align="center" cellpadding="0" cellspacing="0" >
  <tr align="center" class="style8">
      ...
      <td width="9%" bgcolor="#CCCCCC">آخرین بازدید</td>
      <td width="12%" bgcolor="#CCCCCC">بخش تخصصی</td>
      <td width="12%" bgcolor="#CCCCCC">سطح دسترسی</td>
      <td width="11%" bgcolor="#CCCCCC">تلفن همراه</td>
      <td width="11%" bgcolor="#CCCCCC">کد ملی</td>
      <td width="12%" bgcolor="#CCCCCC">نام خانوادگی</td>
      <td width="8%" bgcolor="#CCCCCC">نام</td>
      <td width="5%" bgcolor="#CCCCCC">تصویر</td>
      <td width="11%" bgcolor="#CCCCCC">شهرستان</td>
      <td width="11%" bgcolor="#CCCCCC">استان</td>
