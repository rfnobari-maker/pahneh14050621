...
if ($add_deh == 0) { $v_add_deh = 'add_deh=add_deh' ;} else { $v_add_deh = "add_deh='$add_deh'" ;}
 // برای نمایش 
 $query = "SELECT add_abadi,abadi,deh,mar,bakh,city,ostan,mor_cod_m,post_cod FROM  list_abadi where  $v_id_ostan and  $v_id_city and $v_id_mar and $v_add_deh  ORDER BY  mor_cod_m ASC  "; 
