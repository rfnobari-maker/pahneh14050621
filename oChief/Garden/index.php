...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h2 class="page-title">باغبانی</h2>
            ...
            <div class="cards-container">
               ...
               <div class="card">
                ...
                <div class="card">
                    <a href="Garden.php" title="باغ">
                        <img src="../../files/tree.png" alt="باغ" class="card-icon">
                    </a>
                    <a href="Garden.php" class="btn">باغ</a>
                </div>
                ...
                <div class="card">
                    <a href="Mushroom.php" title="پرورش قارچ های خوراکی">
                        <img src="../../files/mushroom.png" alt="پرورش قارچ های خوراکی" class="card-icon">
                    </a>
                    <a href="Mushroom.php" class="btn">پرورش قارچ های خوراکی</a>
                </div>
                <div class="card">
                    <a href="amar.php" title="گزارشات آمار نامه">
                        <img src="../../files/sent0.png" alt="گزارشات آمار نامه" class="card-icon">
                    </a>
                    <a href="amar.php" class="btn">گزارشات آمار نامه</a>
                </div>
                <?php } ?>
            </div>
