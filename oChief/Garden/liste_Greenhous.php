...
echo  $query = "SELECT id,id_ostan,id_city,id_mar,no_mtol,no_saz,no_gol,sys_kesh,mor_cod_m,bah_cod_m,sal,no_mal,m_zamin,m_zamin_baz,add_abadi,add_city,num_bah from Greenhous_old  where $v_id_ostan  and $v_id_city and  $v_id_mar  and $f_no_mtol and $f_no_saz and $f_no_gol and $f_sys_kesh and $f_sys_hot and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $v_sal  ORDER BY mor_cod_m ASC LIMIT $start, $limit "; 
 $query1 = "SELECT id_ostan,id_city,id_mar,no_mtol,no_saz,no_gol,sys_kesh,mor_cod_m,bah_cod_m,sal,no_mal,m_zamin,add_abadi,add_city from  Greenhous_old where $v_id_ostan  and $v_id_city and  $v_id_mar  and $f_no_mtol and $f_no_saz and $f_no_gol and $f_sys_kesh and $f_sys_hot and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and  $v_sal  ORDER BY mor_cod_m ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
