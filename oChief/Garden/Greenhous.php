...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h2 class="page-title">واحدهای گلخانه</h2>
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="Greenh_rep1.php" title="گزارش ویژه عملکرد سالانه">
                        <img src="../../files/add_new.png" alt="گزارش ویژه عملکرد سالانه" class="card-icon">
                    </a>
                ...
                <div class="card">
                    <a href="Greenh_rep4.php" title="گزارش جمعبندی محصولات">
                        <img src="../../files/map.png" alt="گزارش جمعبندی محصولات" class="card-icon">
                    </a>
                    <a href="Greenh_rep4.php" class="btn">گزارش جمعبندی محصولات</a>
                </div>
            </div>
