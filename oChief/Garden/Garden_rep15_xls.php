...
header("Content-Disposition: attachment;Filename=بهره برداران باغی.xls");
...
?>
<br />
<table width="98%" height="107" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td width="11%" bgcolor="#999999">کد ملی مروج </td>
               <td width="11%" height="31" bgcolor="#999999">میزان تولید قطعی / تن </td>
               <td width="10%" bgcolor="#999999">میزان تولید پیش بینی / تن </td>
               ...
               <td width="11%" bgcolor="#999999"> همراه بهره بردار</td>
               <td width="12%" bgcolor="#999999">کد ملی بهره بردار </td>
               <td width="10%" bgcolor="#999999">نام و نام خانوادگی بهره بردار </td>
...
?>
        ...
        <td align="center" height="31"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $mahtol ;?></td>
               <td align="center"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $mahtolp ;?></td>
               <td align="center" width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $treegb ;?></td>
               <td align="center"  width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $treeb ;?></td>
               <td align="center" width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $s_keshtgb ;?></td>
               <td align="center"    <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $s_keshtb ;?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><span class="normalTextSmall"><?php echo bah_tel_m($row['bah_cod_m']) ?></span><br /></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><span class="normalTextSmall"><?php echo $row['bah_cod_m'] ?></span></td>
