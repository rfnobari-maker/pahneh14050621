...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h2 class="page-title">برنامه الگوی کشت محصولات باغی</h2>
            <p align="center"><img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>

            <div class="cards-container">
                <div class="card">
                    <a href="Sab_L1_Ostan" title="برنامه الگوی کشت استان">
                        <img src="../../files/Sback.PNG" alt="برنامه الگوی کشت استان" class="card-icon">
                    </a>
                    <a href="Sab_L1_Ostan" class="btn">مشاهده برنامه الگوی کشت استان</a>
                </div>
            ...
            <?php  if(strstr($perm,'Bgh')) { ?>
                <div class="card">
                    <a href="Garden_s_ab.php" title="ثبت برش شهرستانی الگوی کشت">
                        <img src="../../files/add_new.png" alt="ثبت برش شهرستانی الگوی کشت" class="card-icon">
                    </a>
                    <a href="Garden_s_ab.php" class="btn">ثبت برش شهرستانی الگوی کشت</a>
                </div>

                <div class="card">
                    <a href="Garden_s_ab2.php" title="ثبت برش شهرستانی الگوی کشت-محصول ">
                        <img src="../../files/agri_prod.png" alt="ثبت برش شهرستانی الگوی کشت" class="card-icon">
                    </a>
                    <a href="Garden_s_ab2.php" class="btn">ثبت برش شهرستان به تفکیک محصول</a>
                </div>
                <div class="card">
                    <a href="Agri_ab_request_list" title="ثبت و پیگیری درخواست تغییر الگوی کشت">
                        <img src="../../files/setting.png" alt="Vege" class="card-icon">
                    </a>
                    <a href="Garden_ab_request_list" class="btn">ثبت و پیگیری درخواست تغییر الگوی کشت</a>
                </div>
