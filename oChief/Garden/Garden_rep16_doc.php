...
if ($id_mar != '0') $mar = ' مرکز ' . mar_name($id_mar);  
?>
<p dir="rtl" align="center" class="style8">گزارش محصولات باغی<?php echo mah_name($mah_name) ?> استان <?php echo ostan_name($id_ostan1) , $shahr , $mar ?> در سال <?php echo $z_sal ?>
...
?>
               ...
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="7%" ><?php echo round($row['m_tol_p'],4)*1 ; ?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="7%" ><?php echo round($row['m_tol_dim'],4)*1 ; ?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="8%" ><?php echo round($row['m_tol_abi'],4)*1 ; ?></td>
