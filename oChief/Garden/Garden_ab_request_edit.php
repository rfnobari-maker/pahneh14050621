...
if ($id == 0) {
    header('Location: Garden_ab_request_list.php');
    exit;
}
...
if ($request['status'] != 'pending' && $request['status'] != 'reviewing') {
    echo '<script>alert("این درخواست قبلاً تأیید یا رد شده است و قابل ویرایش نیست."); window.location.href="Garden_ab_request_list.php";</script>';
    exit;
}
...
$group_name = '';
if (!empty($request['group_cod'])) {
    $query_group = "SELECT group_name FROM product_b_new WHERE group_cod = ? LIMIT 1";
    $stmt_group = $dbh->prepare($query_group);
    $stmt_group->execute(array($request['group_cod']));
...
// محاسبه تولید فعلی از سطح بارور و عملکرد
$current_calculated_t_abi = ($request['current_s_bar_abi'] * $request['current_a_abi']) / 1000;
$current_calculated_t_dem = ($request['current_s_bar_dem'] * $request['current_a_dem']) / 1000;

// محاسبه تولید درخواستی از سطح بارور و عملکرد
...
<body>
            ...
            <td>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        ...
                        <td width="840">
                            <?php include('top.php'); ?>
                            <span class="style8">ویرایش درخواست تغییر الگوی کشت باغی</span><br />
                            ...
                            <div class="edit-box">
                                ...
                                <div class="edit-header">
                                    <div class="title">
                                        🌳 ویرایش درخواست #<?php echo $request['id']; ?>
                                ...
                                <div class="info-box">
                                    <table width="100%" border="0" cellpadding="3" cellspacing="0">
                                        ...
                                        <tr>
                                            <td><span class="label">سال:</span></td>
                                        ...
                                        <tr>
                                            <td><span class="label">گروه محصول:</span></td>
                                            <td><span class="value"><?php echo htmlspecialchars($group_name); ?></span></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </table>
                                ...
                                <!-- فرم ویرایش -->
                                <form method="post" enctype="multipart/form-data" id="edit-form" action="Garden_ab_request_update.php">
                                    <input type="hidden" name="id" value="<?php echo $request['id']; ?>" />
                                    <input type="hidden" name="action" value="edit" />
                                    <input type="hidden" name="group_cod" value="<?php echo htmlspecialchars($request['group_cod']); ?>" />
                                    
                                    <!-- مقادیر فعلی (ابلاغی) - برای کنترل تغییرات -->
                                    <input type="hidden" name="current_s_nobar_abi" value="<?php echo $request['current_s_nobar_abi']; ?>" />
                                    <input type="hidden" name="current_s_nobar_dem" value="<?php echo $request['current_s_nobar_dem']; ?>" />
                                    <input type="hidden" name="current_s_bar_abi" value="<?php echo $request['current_s_bar_abi']; ?>" />
                                    <input type="hidden" name="current_s_bar_dem" value="<?php echo $request['current_s_bar_dem']; ?>" />
                                    ...
                                    <table class="request-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-val"><?php echo number_format($request['current_s_nobar_abi'], 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_nobar_abi" class="request-input" id="request_s_nobar_abi" 
                                                           value="<?php echo number_format($request['request_s_nobar_abi'], 1); ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-val"><?php echo number_format($request['current_s_nobar_dem'], 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_nobar_dem" class="request-input" id="request_s_nobar_dem" 
                                                           value="<?php echo number_format($request['request_s_nobar_dem'], 1); ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-val"><?php echo number_format($request['current_s_bar_abi'], 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_bar_abi" class="request-input" id="request_s_bar_abi" 
                                                           value="<?php echo number_format($request['request_s_bar_abi'], 1); ?>" 
                                                ...
                                                <td id="calculated_t_abi_display" class="calculated-value">
                                                    <?php echo number_format($calculated_t_abi, 1); ?>
                                                </td>
                                            </tr>
                                            <!-- سطح بارور دیم -->
                                            <tr>
                                                <td><strong>سطح بارور دیم</strong></td>
                                                <td class="current-val"><?php echo number_format($request['current_s_bar_dem'], 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_bar_dem" class="request-input" id="request_s_bar_dem" 
                                                           value="<?php echo number_format($request['request_s_bar_dem'], 1); ?>" 
                                                ...
                                                <td id="calculated_t_dem_display" class="calculated-value">
                                                    <?php echo number_format($calculated_t_dem, 1); ?>
                                                </td>
                                            </tr>
                                            <!-- عملکرد آبی -->
                                            <tr>
                                                <td><strong>عملکرد آبی</strong></td>
                                                <td class="current-val"><?php echo number_format($request['current_a_abi'], 2); ?></td>
                                                <td>
                                                    <input type="text" name="request_a_abi" class="request-input" id="request_a_abi" 
                                                           value="<?php echo number_format($request['request_a_abi'], 2); ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-val"><?php echo number_format($request['current_a_dem'], 2); ?></td>
                                                <td>
                                                    <input type="text" name="request_a_dem" class="request-input" id="request_a_dem" 
                                                           value="<?php echo number_format($request['request_a_dem'], 2); ?>" 
                                    ...
                                    <div class="btn-actions">
                                        ...
                                        <form method="post" action="Garden_ab_request_detail.php" style="display:inline;">
                                            <input type="hidden" name="id" value="<?php echo $request['id']; ?>">
    ...
    // ============================================================
    // محاسبه تولید از سطح بارور و عملکرد
    // ============================================================
    ...
    $(document).ready(function() {
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            $.ajax({
                url: 'Garden_ab_request_update.php',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                    ...
                    if (response.valid) {
                        ...
                        if (response.changes && response.changes.length > 0) {
                            ...
                            for (var i = 0; i < response.changes.length; i++) {
                                var item = response.changes[i];
                                var formatted = item.replace(/(\d+\.?\d*)/g, function(match) {
                                ...
                                formattedChanges.push(formatted);
                            }
                        ...
                        setTimeout(function() {
                            ...
                            form.method = 'post';
                            form.action = 'Garden_ab_request_detail.php';
