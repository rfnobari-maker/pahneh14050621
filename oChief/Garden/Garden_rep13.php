...
<img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/>
           ...
           <table width="98%" height="111" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td height="39" colspan="3" bgcolor="#999999">میزان تولید<br />
               ...
               <td width="20%" rowspan="2" bgcolor="#999999">نام محصول<br />
                 <span class="style2">کد محصول</span></td>
               <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
             </tr>
             <tr align="center" class="text1">
               <td width="12%" bgcolor="#999999">عملکرد</td>
               <td width="12%" height="31" bgcolor="#999999">قطعی</td>
               <td width="11%" bgcolor="#999999">پیش بینی</td>
               <td bgcolor="#999999">غیربارور</td>
               <td bgcolor="#999999">بارور</td>
               <td bgcolor="#999999">غیربارور</td>
               <td width="11%" bgcolor="#999999">بارور</td>
             </tr>
             <tr>
               <?php
...
?>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($mahtol/$s_keshtb,3) ;?></td>
               ...
               <td width="10%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $treeb ;?></td>
