...
<form  id="reg-form" method="post" action="#1">
  ...
  <div style="width: 450px; padding: 5px; border: 3px solid navy; margin: auto; text-align: left; border-radius:15px" >
    <table width="100%" height="223" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="56" align="right" bgcolor="#FFFFFF" class="input_text" >
  ...
  <tr>
           ...
           <table  align="center" class="my-table" >
             <tr align="center" class="text1">
               <td colspan="3" bgcolor="#006699">سطح آیش<br />
                 <span class="style2">هکتار</span></td>
               <td height="55" colspan="3" bgcolor="#006699">تعداد قطعات زراعی<br />
                 <span class="style2">قطعه</span></td>
               <td width="7%" rowspan="2" bgcolor="#006699">شهرستان </td>
               <td width="4%" rowspan="2" bgcolor="#006699">ردیف</td>
             </tr>
             <tr align="center" class="text1">
               <td width="5%" height="57" bgcolor="#006699">کل</td>
               <td width="6%" bgcolor="#006699">دیم</td>
               <td width="5%" bgcolor="#006699">آبی</td>
               <td width="6%" height="57" bgcolor="#006699">کل</td>
               <td width="5%" bgcolor="#006699">دیم</td>
               <td width="5%" bgcolor="#006699">آبی</td>
             </tr>
             <tr>
               <?php
...
?>
           ...
           <table  align="center" class="my-table" >
             <tr align="center" class="text1">
               <td height="55" colspan="3" bgcolor="#006699">میزان تولید<br />
                 <span class="style2">تن</span></td>
               <td colspan="3" bgcolor="#006699">سطح برداشت<br />
                 <span class="style2">هکتار</span></td>
               <td colspan="3" bgcolor="#006699">سطح زیر کشت<br />
                 <span class="style2">هکتار</span></td>
               <td width="7%" rowspan="2" bgcolor="#006699">شهرستان </td>
               <td width="4%" rowspan="2" bgcolor="#006699">ردیف</td>
             </tr>
             <tr align="center" class="text1">
               <td height="57" bgcolor="#006699">کل</td>
               <td bgcolor="#006699">دیم</td>
               <td bgcolor="#006699">آبی</td>
               <td height="57" bgcolor="#006699">کل</td>
               <td bgcolor="#006699">دیم</td>
               <td bgcolor="#006699">آبی</td>
               <td height="57" bgcolor="#006699">کل</td>
