...
$add_city    = post('add_city');
$no_kesh     = post('no_kesh');
$mor_cod_m   = post('mor_cod_m');
$bah_cod_m   = post('bah_cod_m');
$z_sal       = post('z_sal');
$mah_qroup   = post('mah_qroup');
$mah_name    = post('mah_name');
        ...
        <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td height="46" align="right" bgcolor="#DDDDDD" class="input_text" >
                  <?php $id_ostan1 = $id_ostan?>                 <select  name="id_ostan" disabled="disabled" class="input_text" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
