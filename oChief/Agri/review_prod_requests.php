...
$f_status  = isset($_POST['f_status']) ? $_POST['f_status'] : '2'; // پیش‌فرض: بررسی نشده
              ...
              <div style="padding: 20px; min-height: 450px;">
                <div class="filter-container">
                        <div class="filter-box">
                            <form method="post" action="review_prod_requests.php" id="search_form">
                ...
                <input type="hidden" name="f_status" value="<?php echo isset($f_status) ? $f_status : ''; ?>" />
                 <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
                  ...
                  <table width="92%" class="list-table" dir="rtl">
                      ...
                      <tbody>
                          <?php  $i = $start + 1;  foreach($requests as $row) { ?>
                          <tr>
                              <td><?php echo $i++; ?></td>
