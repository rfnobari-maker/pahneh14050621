...
$f_status  = isset($_POST['f_status']) ? $_POST['f_status'] : '2'; // پیش فرض تایید شهرستان 
...
<body>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          <td>&nbsp;</td></tr>
        <tr>
          <td><img src="../../files/images/header.jpg" width="100%" height="149" alt="Header" style="display: block;" />
              ...
              <div style="padding: 20px; min-height: 450px;">
                <div class="filter-container">
                        <div class="filter-box">
                            <form method="post" action="review_farmer_requests.php" id="search_form">
...
function openCommentModal(id, action) {
    ...
    `;
    modal.innerHTML = `
        <div style="text-align: center; margin-bottom: 15px; font-weight: bold; font-size: 18px; color: ${action === 1 ? '#2ecc71' : '#e74c3c'};">
		...
		<div style="text-align: center; margin-bottom: 15px; font-weight: bold; font-size: 16px; color:#e74c3c"> دقت فرمایید: بعد از کلیک روی دکمه ثبت نهائی ، امکان برگشت وجود ندارد</div>
