...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td height="52" align="right" bgcolor="#FFFFFF" class="style1" >&nbsp;</td>
                 ...
                 <td width="166"  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="normalTextSmall">: منبع آب</font></td>
               </tr>
               <tr >
...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
               ...
               <tr >
                 <td height="44" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
...
?>
                 ...
                 <td height="44"  align='center' bgcolor="#DDDDDD" class="normalTextSmall">: نام محصول</td>
                 <td height="44" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
...
?>
   ...
   <?php if ($row['group_cod']==$mah_qroup) echo 'selected=selected'?>> <?php echo $row['group_name'] ;?></option>
               ...
               <tr >
                 ...
                 <td  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="normalTextSmall">سطح زیر کشت اول<br />
               ...
               <tr >
                 ...
                 <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">سطح زیر کشت مجدد<br />
                   : بزرگتر یا مساوی</font></td>
               </tr>
               <tr >
                 <td height="50" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right"> <span class="style2">هکتار </span>
                 ...
                 <td  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="normalTextSmall">سطح  برداشت اول<br />
                   : بزرگتر یا مساوی</font></td>
               </tr>
               <tr >
                 <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right"> <span class="style2">هکتار </span>
                 ...
                 <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">سطح  برداشت مجدد<br />
                   : بزرگتر یا مساوی</font></td>
               </tr>
               <tr >
 ...
 {  
 if ($id_ostan1 == '-1')    { $v_id_ostan = 1 ;} else { $v_id_ostan = "Agri_prod.id_ostan='$id_ostan1'" ;}
 if ($id_city == 0)    { $v_id_city = 1 ;} else { $v_id_city = "Agri_prod.id_city='$id_city'" ;}
 if ($id_mar  == 0)    { $v_id_mar = 1 ;} else { $v_id_mar = "Agri_prod.id_mar='$id_mar'" ;}
 if ($add_abadi  == '0')  { $f_add_abadi  = 1  ; }else{ $f_add_abadi = "Agri_prod.add_abadi = '$add_abadi'" ;}
 if ($add_city  == '0')  { $f_add_city  = 1  ; }else{ $f_add_city = "Agri_prod.add_city = '$add_city'" ;}
 if ($no_kesh == '0')  { $f_no_kesh  = 1  ; }else{ $f_no_kesh = "Agri_prod.no_kesh = '$no_kesh'" ;}
 if ($m_ab == '0')  { $f_m_ab  = 1  ; }else{ $f_m_ab = "Agri.m_ab = '$m_ab'" ;}
 if ($mor_cod_m == '')  { $v_mor_cod_m  = 1  ; }else{ $v_mor_cod_m = "Agri_prod.mor_cod_m = '$mor_cod_m'" ;}
 if ($bah_cod_m == '')  { $v_bah_cod_m  = 1  ; }else{ $v_bah_cod_m = "Agri_prod.bah_cod_m = '$bah_cod_m'" ;}
 if ($z_sal == '')  { $v_z_sal  = 1  ; }else{ $v_z_sal = "Agri_prod.z_sal = '$z_sal'" ;}
 if ($mah_name == '')  { $v_cod_mah  = 1  ; }else{ $v_cod_mah = "Agri_prod.cod_mah = '$mah_name'" ;}
 if ($zka1 == '')  { $v_zka1  = 1  ; }else{ $v_zka1 = "Agri_prod.zer_kesht_a >= '$zka1'" ;}
 if ($zka2 == '')  { $v_zka2  = 1  ; }else{ $v_zka2 = "Agri_prod.zer_kesht_a <= '$zka2'" ;}
 if ($zkb1 == '')  { $v_zkb1  = 1  ; }else{ $v_zkb1 = "Agri_prod.zer_kesht_b >= '$zkb1'" ;}
 if ($zkb2 == '')  { $v_zkb2  = 1  ; }else{ $v_zkb2 = "Agri_prod.zer_kesht_b <=  $zkb2'" ;}
 if ($sba1 == '')  { $v_sba1  = 1  ; }else{ $v_sba1 = "Agri_prod.s_bar_a >= '$sba1'" ;}
 if ($sba2 == '')  { $v_sba2  = 1  ; }else{ $v_sba2 = "Agri_prod.s_bar_a <= '$sba2'" ;}
 if ($sbb1 == '')  { $v_sbb1  = 1  ; }else{ $v_sbb1 = "Agri_prod.s_bar_b >= '$sbb1'" ;}
 if ($sbb2 == '')  { $v_sbb2  = 1  ; }else{ $v_sbb2 = "Agri_prod.s_bar_b <= '$sbb2'" ;}
 if ($mtol1 == '')  { $v_mtol1  = 1  ; }else{ $v_mtol1 = "Agri_prod.mah_tol >= '$mtol1'" ;}
 if ($mtol2 == '')  { $v_mtol2  = 1  ; }else{ $v_mtol2 = "Agri_prod.mah_tol <= '$mtol2'" ;}
 if ($mtolp1 == '')  { $v_mtolp1  = 1  ; }else{ $v_mtolp1 = "Agri_prod.mah_tolp >= '$mtolp1'" ;}
 if ($mtolp2 == '')  { $v_mtolp2  = 1  ; }else{ $v_mtolp2 = "Agri_prod.mah_tolp <= '$mtolp2'" ;}
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56"><form  action="Agri_rep17_xls.php" method="post">
                 ...
                 <td width="56"><form  action="Agri_rep17_doc.php" method="post">
                   <input type="hidden" name="id_ostan"  value="<?php echo  $id_ostan1 ;?>" />
                   <input type="hidden" name="id_city"   value="<?php echo  $id_city ;?>" />
                   <input type="hidden" name="id_mar"    value="<?php echo  $id_mar ;?>" />
                   <input type="hidden" name="add_abadi" value="<?php echo  $add_abadi ;?>" />
        ...
        <tr class="text1">
          ...
          <td width="5%" bgcolor="#006699">مجدد</td>
          <td width="6%" bgcolor="#006699">اول </td>
          <td width="6%"  bgcolor="#006699">کل</td>
          <td width="6%" bgcolor="#006699">مجدد</td>
          <td width="6%" bgcolor="#006699">اول </td>
        </tr>
        <tr>
          <?php 
...
{
	?>
    <form  action="Agri_rep17.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="Agri_rep17.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
         <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
        <input type="hidden" name="id_mar" value="<?php echo $id_mar ?>" />
