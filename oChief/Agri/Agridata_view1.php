...
<body>
      ...
      <table width="99%" height="1147" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td><div align="right"><span class="style2">هکتار</span>
            <input name="m_zamin" type="text" class="input_text required" id="m_zamin" style="width:100px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $m_zamin*1 ; ?>" maxlength="70" readonly="readonly"  align="baseline" xml:lang="fa" />
            </div></td>
  ...
  <?php }?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><div class="style8" align="right">
            <?php echo $z_sal ;?>
          </div></td>
...
?>
            <tr>
              <td height="36" bgcolor="#FFFFFF"><div align="center">
                <select name="mah_bem<?php echo $num2_t_mah ;?>" disabled="disabled" class="required input_text  required" id="mah_bem<?php echo $num2_t_mah ;?>"  style="height:40px ; width:50px ; direction:rtl" tabindex="31">
              ...
              <td height="36" bgcolor="#FFFFFF"><select name="mah_kh<?php echo $num2_t_mah ;?>" disabled="disabled" class="required input_text  required" id="mah_kh<?php echo $num2_t_mah ;?>"  style="height:40px ; width:50px ; direction:rtl" tabindex="30">
                <option value="">انتخاب</option>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  echo $mah_tol*1 ; ?>" maxlength="4" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>2" style="width:75px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  echo $mah_tolp*1 ; ?>" maxlength="4" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_b<?php echo $num2_t_mah ;?>" type="text" class="s_bar_b required digits input_text" id="s_bar_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $s_bar_b*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_a<?php echo $num2_t_mah ;?>" type="text" class="s_bar_a required digits input_text" id="s_bar_a<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $s_bar_a*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="zer_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_b required digits input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_b*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="zer_kesht_a<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_a required digits input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_a*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
...
?>
   ...
   <?php if ($row['group_cod']==$group_cod) echo 'selected=selected'?>>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_mas<?php echo $num2_t_mah ;?>" type="text" class="mashat required digits input_text" id="mashat<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $mah_mas*1 ;?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
...
?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right"><span class="style2">هکتار</span>
            <input name="s_ayesh" type="text" class="mashat input_text required digits" id="s_ayesh" style="width:100px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php echo $s_ayesh*1 ; ?>" maxlength="70" readonly="readonly"  align="baseline" xml:lang="fa" />
            </div></td>
