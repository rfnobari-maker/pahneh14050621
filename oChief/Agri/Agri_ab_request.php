...
$id_ostan1 = $id_ostan;
$z_sal = isset($_POST['z_sal']) ? $_POST['z_sal'] : '1405-1406';
...
if (!empty($product_cod) && !empty($z_sal)) {
    $query = "SELECT product_name, s_abi, s_dem, t_abi, t_dem, a_abi, a_dem 
              FROM Agri_ab_ostan 
    ...
    if ($row) {
        ...
        $current_s_abi = floatval($row['s_abi']);
        $current_s_dem = floatval($row['s_dem']);
...
// گرفتن لیست گروه‌ها
$query_groups = "SELECT DISTINCT group_cod, group_name FROM product_z ORDER BY group_cod ASC";
...
<body>
            ...
            <td>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        ...
                        <td width="840">
                            <?php include('top.php'); ?>
                            <span class="style8">درخواست تغییر الگوی کشت ابلاغی</span><br />
                            ...
                            <div class="info-box" style="background:#ffebee; border-color:#c62828;">
                                ...
                                <a href="Agri_ab_request_list.php" style="color:#006699;">مشاهده درخواست‌های من</a>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="request-box">
                                ...
                                <form id="request-form" method="post" action="">
                                    ...
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        <tr>
                                            <td width="15%"><span class="style8">سال زراعی:</span></td>
                                            <td width="35%">
                                ...
                                <div class="info-box">
                                    ...
                                    <table width="100%" border="0" cellpadding="3" cellspacing="0">
                                        <tr>
                                            <td width="25%"><span class="label">سطح آبی (ابلاغی):</span></td>
                                            <td width="25%"><span class="value"><?php echo number_format($current_s_abi, 1); ?></span></td>
                                            <td width="25%"><span class="label">سطح دیم (ابلاغی):</span></td>
                                            <td width="25%"><span class="value"><?php echo number_format($current_s_dem, 1); ?></span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label">عملکرد آبی (ابلاغی):</span></td>
                                            <td><span class="value"><?php echo number_format($current_a_abi, 2); ?></span></td>
                                            <td><span class="label">عملکرد دیم (ابلاغی):</span></td>
                                            <td><span class="value"><?php echo number_format($current_a_dem, 2); ?></span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label">تولید آبی (ابلاغی):</span></td>
                                            <td><span class="value"><?php echo number_format($current_t_abi, 1); ?></span></td>
                                            <td><span class="label">تولید دیم (ابلاغی):</span></td>
                                    ...
                                    <div style="font-size:12px; color:#666; margin-top:5px; border-top:1px solid #ccc; padding-top:5px;">
                                        💡 شما می‌توانید <strong>سطح</strong> و <strong>عملکرد</strong> را تغییر دهید. <strong>تولید</strong> به‌صورت خودکار محاسبه می‌شود.
                                    </div>
                                </div>
                                ...
                                <form method="post" enctype="multipart/form-data" id="main-form">
                                    ...
                                    <input type="hidden" name="cod_qroup" value="<?php echo htmlspecialchars($group_cod); ?>" />
                                    
                                    <!-- مقادیر فعلی (ابلاغی) -->
                                    <input type="hidden" name="current_s_abi" value="<?php echo $current_s_abi; ?>" />
                                    <input type="hidden" name="current_s_dem" value="<?php echo $current_s_dem; ?>" />
                                    ...
                                    <table class="request-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-value"><?php echo number_format($current_s_abi, 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_abi" class="request-input" id="request_s_abi" 
                                                           value="<?php echo number_format($current_s_abi, 1); ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td class="current-value"><?php echo number_format($current_s_dem, 1); ?></td>
                                                <td>
                                                    <input type="text" name="request_s_dem" class="request-input" id="request_s_dem" 
                                                           value="<?php echo number_format($current_s_dem, 1); ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td id="calculated_t_abi_display" class="calculated-value">
                                                    <?php echo number_format(($current_a_abi * $current_s_abi) / 1000, 1); ?>
                                                </td>
                                            </tr>
                                            <!-- عملکرد دیم -->
                                            <tr>
                                                ...
                                                <td id="calculated_t_dem_display" class="calculated-value">
                                                    <?php echo number_format(($current_a_dem * $current_s_dem) / 1000, 1); ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <table width="100%" border="0" cellpadding="5">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align:center; padding-top:20px;">
                                                    ...
                                                    <a href="Agri_ab_request_list.php" class="cancel-btn">🔙 بازگشت به لیست درخواست‌ها</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div style="text-align:center; padding:30px;">
                                    <a href="Agri_ab_request_list.php" class="submit-btn" style="text-decoration:none; display:inline-block;">🔙 مشاهده درخواست‌های من</a>
                                </div>
                                <?php endif; ?>
    ...
    $(document).ready(function() {
        ...
        $('#main-form').on('submit', function(e) {
            ...
            var calculated_t_abi = (a_abi * s_abi) / 1000;
            var calculated_t_dem = (a_dem * s_dem) / 1000;
            
            formData.append('calculated_t_abi', calculated_t_abi);
            formData.append('calculated_t_dem', calculated_t_dem);
            
            $.ajax({
                url: 'Agri_ab_request_save.php',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    if (response.valid) {
                        ...
                        setTimeout(function() {
                            window.location.href = 'Agri_ab_request_list.php';
                        }, 3000);
                    } else {
                        $('#form-message')
