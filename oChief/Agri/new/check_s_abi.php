...
try {
    ...
    $stage1_query_for_log = "SELECT {$fields[$field]['column']} FROM Agri_ab_ostan WHERE z_sal = '{$z_sal}' AND id_ostan = '{$id_ostan}'  AND product_cod = '{$product_cod}'";
    ...
    // مرحله 2: مجموع مقدار در جدول برش مرکز
    $query2 = "
        SELECT 
