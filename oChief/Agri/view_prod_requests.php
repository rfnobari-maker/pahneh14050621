...
$sql_count = "SELECT COUNT(*) FROM Agri_prod_req r $where_clauses";
...
$sql = "SELECT r.* FROM Agri_prod_req r $where_clauses ORDER BY r.id DESC LIMIT $start, $limit";
              ...
              <div style="padding: 20px; min-height: 450px;">
                <div class="filter-container">
                        <div class="filter-box">
                            <!-- فرم جستجو که کلیدهای صفحه‌بندی را نیز مدیریت می‌کند -->
                            <form method="post" action="view_prod_requests.php" id="search_form">
                              ...
                              <div class="filter-row">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="view_prod_requests.php" class="btn-clear">❌ حذف فیلترها</a>
                                </div>
                            </form>
                        </div>
                  </div>
<table width="122" height="56" border="0" align="center">
             <tr>
               <td width="56"><form  action="prod_requests_xls.php" method="post">
                  ...
                  <table width="92%" class="list-table" dir="rtl">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><strong><?php echo bah_name2($row['bah_cod_m'],$row['num_bah']); ?></strong><br><code><?php echo $row['bah_cod_m']; ?></code></td>
                              ...
                              <td width="8%"><form action="Agridata_view1.php" method="post" onSubmit="target_Agri18(this)">
                              ...
                              </form><form action="review_prod_comment.php" method="post" onsubmit="target_Agri19(this)">
