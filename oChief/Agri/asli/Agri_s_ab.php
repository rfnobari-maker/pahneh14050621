...
?></td>
            ...
            <tr bgcolor='#f1f1f1' >
              <td height="71" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  >
                <?php
...
SELECT p.group_cod, p.group_name, p.product_cod, p.product_name, :id_ostan1, :id_city, :z_sal
FROM product_z p
...
<?php
 ...
 {
echo '<span style="color: red;">شما مجوز دسترسی به این صفحه را ندارید با ادمین استان تماس بگیرید </span>' ;
 }
