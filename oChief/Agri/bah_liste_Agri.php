...
if(isset($_GET['id']))
{
 ...
 $query = "SELECT id,id_ostan,id_city,add_abadi,add_city,bah_cod_m,mor_cod_m,sh_gat,no_mal,no_kesh,m_zamin,t_mah,z_sal from $table where  $v_bah_cod_m  and num_bah = '$num_bah' ORDER BY mor_cod_m ASC LIMIT $start, $limit "; 
 $query1 = "SELECT id,id_ostan,id_city,add_abadi,add_city,bah_cod_m,mor_cod_m,sh_gat,no_mal,no_kesh,m_zamin,t_mah,z_sal from $table where $v_id_ostan   and num_bah = '$num_bah' ORDER BY mor_cod_m ASC  "; 
...
?>
             <br />
             <span dir="rtl" class="style8">سوابق زراعی   بهره بردار در سال زراعی <?php echo $z_sal ;?></span><br />
          ...
          <td width="9%" rowspan="2" bgcolor="#006699">مساحت زمین<br />
            هکتار</td>
          <td width="6%" rowspan="2" bgcolor="#006699">نوع کشت</td>
          <td width="9%" rowspan="2" bgcolor="#006699">نوع مالکیت</td>
        ...
        <tr class="text1">
          <td width="6%" height="31" bgcolor="#006699">کد ملی </td>
...
if ($row['no_kesh']=='2') $v_no_kesh='دیم' ;	 
  ?>
          <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="Agridata_view1.php" method="post">
