            ...
            <div class="cards-container">
              ...
              <div class="card">
                    <a href="Sab_L3" title="مشاهده برش مراکز جهاد کشاورزی ">
                        <img src="../../files/abadi.png" alt="مشاهده برش مراکز جهاد کشاورزی " class="card-icon">
                    </a>
            ...
            <?php  if(strstr($perm,'Bsh')) { ?>
               ...
               <div class="card">
                ...
                <div class="card">
                    ...
                    <a href="Agri_ab_request_list" class="btn">ثبت و پیگیری درخواست تغییر الگوی کشت</a>
                </div>

              <?php } else { ?>
               <div class="card">
                    <a href="view_prod_requests" title="مشاهده تغییرات محصول و مساحت">
                        <img src="../../files/send_data.png" alt="Vege" class="card-icon">
                    </a>
                    <a href="view_prod_requests" class="btn">مشاهده تغییرات محصول و مساحت</a>
                </div>
                <div class="card">
                    <a href="view_farmer_requests" title="مشاهده تغییر بهره بردار">
                        <img src="../../files/changeuser.png" alt="Vege" class="card-icon">
                    </a>
                    <a href="view_farmer_requests" class="btn">مشاهده تغییر بهره بردار</a>
                </div>
