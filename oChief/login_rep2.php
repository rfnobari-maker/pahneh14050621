...
?>
  ...
  <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1 ; border-radius:10px" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="45" align="right" bgcolor="#F1F1F1" class="input_text" ><?php $id_ostan1 = $id_ostan ?>
          <select  name="id_ostan2" disabled="disabled"  class="style2" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
   ...
   <?php if ($row['id_ostan']==$id_ostan) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="45" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
  ...
  <p><form  action="login_rep_xls.php" method="post">
