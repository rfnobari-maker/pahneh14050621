...
float: left;
 ...
 <?php include ('top.php') ;?>
      <div id="content">
  <p  align="center" class="style8">عملکرد مروج در سامانه
    <?php
...
$cod_m = $row2['cod_m'] ;
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#66CCFF">
    <tr>
      <td width="14%" height="33" bgcolor="#FFFFCC">زنبورستان</td>
      <td width="19%" bgcolor="#FFFFCC"> مرغداری صنعتی</td>
      <td width="16%" bgcolor="#FFFFCC"> قطعات باغی</td>
      <td width="16%" bgcolor="#FFFFCC"> قطعات زراعی</td>
      <td width="14%" bgcolor="#FFFFCC"> بهره بردار</td>
      <td width="11%" bgcolor="#FFFFCC"> شهر</td>
      <td width="10%" bgcolor="#FFFFCC">آبادی</td>
    </tr>
    <tr>
      <td height="46"><?php echo mor_bee_count($cod_m)?></td>
      <td><?php echo mor_spoul_count($cod_m)?></td>
      <td><?php echo mor_Garden_count($cod_m)?></td>
      <td><?php echo mor_Agri_count($cod_m)?></td>
      <td><?php echo mor_bah_count($cod_m)?></td>
      <td><?php echo mor_shahr_count($cod_m)?></td>
      <td><?php echo mor_abadi_count($cod_m)?></td>
    </tr>
  </table>
  <p><span class="style8"><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></span></p>
</div>
