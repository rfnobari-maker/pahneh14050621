...
$query = "SELECT * from bah where id_ostan=:id_ostan and id_city=:id_city "; 
$stmt = $dbh->prepare($query);
$stmt->execute(array(':id_ostan'=>$id_ostan,':id_city'=>$id_city));
?>
      </p>
      <p>&nbsp; </p>
...
$r++ ; 
           ...
           <p>&nbsp;</p>
           <p><a href="centers.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a>
            </p>
           <p>&nbsp;</p>
