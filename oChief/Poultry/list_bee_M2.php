...
if(isset($_GET['id']))
{
 ...
 $query = "SELECT * FROM  bee where  $v_id_ostan  and $v_m_ostan  and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  and date_s > '1397/10/30'  ORDER BY date_s ASC LIMIT $start, $limit ";
 $query1 = "SELECT id FROM  bee where  $v_id_ostan and $v_m_ostan and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  and date_s > '1397/10/30'  ORDER BY date_s ASC"  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
