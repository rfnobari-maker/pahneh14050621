...
?></td>
      ...
      <tr >
        <td height="23" rowspan="3" align="right" bgcolor="#FFFFFF" class="input_text" >
...
?>
   ...
   <?php if ($row['id_mar']==$id_mar) echo 'selected=selected'?>> <?php echo $row['mar'] ;?></option>
            ...
            <p>
              <select dir="rtl"  name="sal" id="sal" style="width:170px ; height:40px">
...
?>
        ...
        <td height="29"  align='center' bgcolor="#FFFFFF" class="style8"><font size="2" class="style8">: مرکز خدمات</font></td>
      </tr>
      <tr >
        <td height="29"  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="style8">:سرشماری سال</font></td>
      </tr>
      <tr >
...
$query = "SELECT * FROM  bee where  id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar and $v_sal "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
...
$query = "SELECT SUM(tk_bo) AS kol_k_bo ,SUM(tk_mo) AS kol_k_mo,SUM(to_bo) AS kol_t_bo,SUM(to_mo) AS kol_t_mo from bee where id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar and $v_sal";
$stmt = $dbh->prepare($query);
$stmt->execute();
