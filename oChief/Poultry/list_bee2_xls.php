...
include ('../../login/config.php');
 if ($id_ostan1 == '-1')    { $v_id_ostan   = "bee.id_ostan !='$id_ostan'" ;}else{ $v_id_ostan  = "bee.id_ostan='$id_ostan1'" ;}
 if ($m_ostan == '-1')    { $v_m_ostan    = 1 ;}else{ $v_m_ostan   = "bee.m_ostan='$m_ostan'" ;}
 if ($m_city == 0)         { $v_m_city    = 1 ;}else{ $v_m_city   = "bee.m_city='$m_city'" ;}
...
?>
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          ...
          <td width="2%" align="center" bgcolor="#FFCC99">تولید زهرg </td>
          ...
          <td width="2%" align="center" bgcolor="#FFCC99">تعداد ملکه خریداری شده از بخش دولتی</td>
          <td width="4%" align="center" bgcolor="#FFCC99">تعداد ملکه خریداری شده از بخش خصوص</td>
          <td width="3%" align="center" bgcolor="#FFCC99">تعداد ملکه از محل خود مصرفی</td>
          <td align="center" width="4%" bgcolor="#FFCC99">شماره مجوز </td>
          <td align="center" width="5%" bgcolor="#FFCC99">شهرستان مبداء</td>
          <td align="center" width="5%" bgcolor="#FFCC99">استان مبداء</td>
