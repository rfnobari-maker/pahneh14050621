...
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ; ?>
    <div align="center">گزارش میانگین قیمت استانی اقلام خوراکی / تاریخ تهیه گزارش :<?php echo $date_edit?> </div>
...
$min_city	=  price_city($id_ostan,$p_cod_1,$year,$mont,$v_s_date,$p_price_min) ;
  ?>
        <td height="27" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo 
		 $p_price_max ; 
		  ?></td>
        <td height="27" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($max_city,$id_ostan) ?></td>
