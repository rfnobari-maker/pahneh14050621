...
$query="SELECT substr(s_date,9,2),round(avg(p_price),0) from price_record where p_cod='$p_cod' and year = '$year' and mont = '$mont' and id_ostan = '$id_ostan1' and p_price > 0 group by s_date ";
