...
header("Content-Disposition: attachment;Filename=قیمت_اقلام_خوراکی.doc");
...
?>
    ...
    <table width="100%" border="1" align="center" cellpadding="1" cellspacing="1"  bordercolor="#0099CC">
              <tr class="text1">
                <td align="center" width="12%" bgcolor="#999999">درصد تغییرات نسبت به روز قبل<br /></td>
                <td align="center" width="12%" bgcolor="#999999">میزان تغییرات نسبت به روز قبل 
                ریال</td>
                <td align="center" width="8%" bgcolor="#999999">قیمت روز قبل</td>
                <td align="center" width="8%" bgcolor="#999999">قیمت                ریال</td>
                <td align="center" width="12%" bgcolor="#999999">تاریخ قیمت گیری</td>
                <td align="center" width="12%" bgcolor="#999999">واحد</td>
                <td align="center" width="12%" bgcolor="#999999">نام محصول</td>
                <td align="center" width="9%" bgcolor="#999999">شهرستان</td>
                <td align="center" width="11%" bgcolor="#999999"> استان</td>
