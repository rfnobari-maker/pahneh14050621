...
if ($b=='اینترنت اکسپلورر') 
{
echo "<p align='center' style='background-color:#900;color:#FFF;font-family:Tahoma;font-size:16px'>مرورگر شما '.$b.' نسخه '.$browser[1].' می باشد  <br />";
echo 'برای استفاده بهینه از امکانات سامانه لطفاً از مرورگرهای کرم یا فایرفاکس استفاده نمایید <br/>' ;
echo '<br/>' ;
}
?>
