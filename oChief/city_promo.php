...
$city = $_POST['city'] ; 
$query = "SELECT * FROM  mar WHERE  id_ostan = '$id_ostan' and  id_city = '$id_city' "  ;
...
<p class="style1">مشخصات مراکز جهاد کشاورزی شهرستان  <?php echo ' '.$city ?></p>
    ...
    <td colspan="5" bgcolor="#999999"> تعداد مروجین مرکز به تفکیک مدرک تحصیلی</td>
...
<td  class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mar_mor_mtah_count($row['id_mar'],3)?></td>
    ...
    <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mar_mor_mtah_count($row['id_mar'],5)?></td>
    <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mar_mor_mtah_count($row['id_mar'],4)?></td>
...
<td height="58" bgcolor="#FFCCCC" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
  <form  action="city_promotes.php" method="post">
    ...
    <td bgcolor="#FFCCCC" class="RightMenuCell" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_mor_mtah_count($id_ostan,$row['id_city'],2)?></td>
    <td bgcolor="#FFCCCC" class="RightMenuCell" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_mor_mtah_count($id_ostan,$row['id_city'],1)?></td>
    <td bgcolor="#FFCCCC" class="RightMenuCell" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_mor_mtah_count($id_ostan,$row['id_city'],5)?></td>
    <td bgcolor="#FFCCCC" class="RightMenuCell" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_mor_mtah_count($id_ostan,$row['id_city'],4)?></td>
    <td bgcolor="#FFCCCC" class="RightMenuCell" ><?php echo city_mor_count($id_ostan,$row['id_city'])?></td>
    <td bgcolor="#FFCCCC"  class="RightMenuCell" ><?php echo city_mor_jens_count($id_ostan,$row['id_city'],1)?></td>
    <td bgcolor="#FFCCCC" class="RightMenuCell"  ><?php echo city_mor_jens_count($id_ostan,$row['id_city'],2)?></td>
