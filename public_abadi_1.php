...
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'ویرایش اطلاعات عمومی\پایه') ; 
...
$q = $dbh->prepare($query);
$q->execute(array($beh_1,$beh_2,$beh_3,$beh_4,$beh_5,$beh_6,$beh_7,$beh_8,$beh_9,$beh_10,$beh_11,$beh_12,$beh_13,$beh_14,$beh_15,$beh_16,$beh_17,
$add_abadi));
