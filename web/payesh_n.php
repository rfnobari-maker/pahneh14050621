...
// --- تغییر اعمال شده: 'Category' اضافه شد ---
$csv_headers = array('id', 'Ostan', 'shahrestan', 'Code', 'Year', 'Count', 'category');
$rows = array();
...
foreach ($rows as $row) {
    ...
    foreach ($csv_headers as $header_key) {
        // این منطق اکنون به دنبال کلید 'Category' در خروجی وب‌سرویس می‌گردد
