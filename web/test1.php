...
where Agri_prod.`z_sal` ='1395-1396' and Agri_prod.`cod_mah` = '108' and Agri_prod.`cod_qroup` = '1' and Agri_prod.`zer_kesht_a`+Agri_prod.`zer_kesht_b` > 0 and Agri_prod.`mah_tolp`>0 and Agri_prod.date_s > '$date_s'  order by Agri_prod.date_s limit $start,$number_records
;"; 
