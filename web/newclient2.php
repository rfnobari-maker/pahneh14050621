...
$username = "poshtibani";
$password = "2@ej5D6*7";
//$client = new nusoap_client("http://10.7.234.126/web/PahnehWebService.php?wsdl,true");
$client = new SoapClient("http://10.7.234.126/web/PahnehWebService.php?wsdl,true");
