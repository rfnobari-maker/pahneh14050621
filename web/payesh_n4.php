...
// --------------------------------------------------
// تابع فراخوانی وب‌سرویس (پذیرش category)
// --------------------------------------------------
...
// --------------------------------------------------
// منطق اصلی تبدیل به CSV و دانلود (ترکیب و حذف تکرار با استخراج سختگیرانه)
// --------------------------------------------------

// 1. فراخوانی تابع برای Category '0' و '4'
...
if ($soap_result_0 !== false && $soap_result_0 !== null) {
    $results_to_process['0'] = object_to_array_php53($soap_result_0);
}

if ($soap_result_4 !== false && $soap_result_4 !== null) {
    $results_to_process['4'] = object_to_array_php53($soap_result_4);
}
...
// 2. نرمال‌سازی و ترکیب سطرها با **استخراج سختگیرانه** و **حذف تکرار**
foreach ($results_to_process as $category => $report_data) {
    
    $current_rows_raw = array();
    
    // **منطق استخراج سختگیرانه (مشابه payesh_n.php با break)**
