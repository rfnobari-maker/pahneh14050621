...
<form action="" method="post">
	<p>
	  ...
	  : کد استان<br>
	  <br>
	  <input type="text" name="id_city" id="id_city"> 
	  : کد شهرستان<br>
	  <br>
...
//echo getProd($username,$password,$_POST['id_ostan'],$_POST['no_bah'],$_POST['meli']) ; 
 $client = new nusoap_client("http://poud.maj.ir/web/Wheat10_WS.php");
$record = $client->call("getProd", array("username" => $username , "password" =>$password, "id_ostan" =>$_POST['id_ostan'], "id_city" =>$_POST['id_city'], "no_bah" =>$_POST['no_bah'], "meli" =>$_POST['meli']));
        ...
        echo '<table border="0">
            ...
            <tr>
                ...
                <td align="center">'.$record['fname'].'</td>
