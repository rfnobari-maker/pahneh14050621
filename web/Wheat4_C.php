...
$username = "poshtibani";
$password = "2@ej5D6*7";
$client = new nusoap_client("http://10.7.234.126/web/Wheat4_WS.php");
...
$n = (($_POST['start']-1)*2000)+1 ;
        foreach ($result as $record) {
            ...
            <tr>
                ...
                <td align="center">'.($record['zer_kesht']*1).'</td>
                <td align="center">'.($record['mah_tolp']*1).'</td>
           </tr>';
    $n++ ; 
        }
        echo '
