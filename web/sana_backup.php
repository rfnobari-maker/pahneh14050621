 ...
 //  print_r($res->GetLicenseInfoByIdentCodeResult->LicenseInfo);
            ...
            <table width="65%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="right" width="3%"><?php echo  $res->GetLicenseInfoByIdentCodeResult->LicenseInfo->LicenseDocNum?></td>
                <td align="center" width="11%">:</td>
                <td align="right" width="29%">شماره مجوز صادر شده</td>
              </tr>
              <tr>
                <td align="right">&nbsp;</td>
...
<?php }?>
              <tr>
                <td  height="39" colspan="4" align="center" bgcolor="#FFFFFF"><p>&nbsp;</p>                  <?php  //  print_r($res->GetLicenseInfoByIdentCodeResult->LicenseInfo->Products) ; ?></td>
              </tr>
            </table>
