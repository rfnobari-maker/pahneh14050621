...
$name = base64_decode($response->result->data->getEstelam3Response->return->name);
$family = base64_decode($response->result->data->getEstelam3Response->return->family);
$fatherName = base64_decode($response->result->data->getEstelam3Response->return->fatherName);
...
$Message = $response->result->data->getEstelam3Response->return->Message;
