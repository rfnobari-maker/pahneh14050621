...
$username = "poshtibani";
$password = "2@ej5D6*7";
$client = new nusoap_client("http://10.7.234.126/web/cornproService.php?wsdl,true");
$result = $client->call("getProd", array("username" => $username , "password" =>$password, "date_s" =>$_POST['date_s']));
