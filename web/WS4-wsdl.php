 ...
 *****************************************************************************/
    ...
    $serviceName = "Get List of Farmers ";

    $functions[] = array("funcName" => "getList",
                         "doc" => "Geting list of Farmer Info",
                         "inputParams" => array(array("name" => "username", "type" => "string"),
                                                array("name" => "password", "type" => "string"),
                                                array("name" => "date_s", "type" => "string"),
                                                array("name" => "start", "type" => "int")),
                         "outputParams" => array(array("name" => "id_ostan", "type" => "string"),
                                                array("name" => "id_city", "type" => "string"),
						array("name" => "bah_cod_m", "type" => "string"),
						array("name" => "zer_kesht", "type" => "float"),
						array("name" => "mah_tolp", "type" => "float"),
						array("name" => "no_bah", "type" => "string"),
						array("name" => "last_name", "type" => "string"),
						array("name" => "name", "type" => "string"),
						array("name" => "fname", "type" => "string"),
						array("name" => "co_name", "type" => "string"),
						array("name" => "sh_meli", "type" => "string")),
                         "soapAddress" => "http://poud.maj.ir/web/Wheat4_WS.php"
                         );
//  "soapAddress" => "http://localhost:8080/wsdl/WS4.php"
// ----------------------------------------------------------------------------
