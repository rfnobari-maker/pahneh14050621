...
?>
       ...
       <form  action="Industry/index.php" method="post" >
      <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
      <button><img src="../files/new.png" title="ثبت واحد صنعتی "  width="33" height="26"  alt=""/></button>
    </form></td>
    ...
    <input type="hidden" name="add_abadi" value="<?php echo $orw['add_abadi'] ;?>" />
    <input type="hidden" name="add_city" value="<?php echo $row['add_city'] ;?>" />
    <button onclick="return confirm('از حذف اطلاعات بهره بردار مطمئن هستید ؟')"><img src="../files/del1.png" title="حذف اطلاعات بهره بردار" width="33" height="26" alt=""/>
    </button>
      </form></td>
      <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="edit_ind_benef.php" method="post">
    ...
    <input type="hidden" name="no_bah" value="<?php echo $row['no_bah'] ;  ;?>" />
      ...
      <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="view_ind_benef1.php#1" method="post" onsubmit="target_popup2(this)">
        <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
        <input type="hidden" name="num_bah" value="<?php echo $row['num_bah'] ;?>" />
...
?>
          ...
          <p><a href="ind.php"><img src="../files/add_new.png"  alt="" width="50" height="52" class="btn" title="ثبت بهره بردار جدید"/></a></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>          <p><a href="Industry.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
  </tr>
  <tr>
