...
<p class="style1">مشخصات مراکز جهاد کشاورزی شهرستان <?php echo $city ?> </p>
    ...
    <td colspan="2" rowspan="2" bgcolor="#999999">  آبادی <br />
      های تحت پوشش</td>
    <td width="10%" rowspan="2" bgcolor="#999999">تعداد مروجین</td>
    <td width="10%" rowspan="2" bgcolor="#999999">تلفن همراه</td>
    <td height="43" colspan="3" bgcolor="#999999">مشخصات رئیس مرکز</td>
    <td width="13%" rowspan="2" bgcolor="#999999">نام مرکز </td>
    <td width="6%" rowspan="2" bgcolor="#999999">ردیف</td>
    </tr>
  <tr align="center" class="text1">
    <td width="12%" height="43" bgcolor="#999999">نام خانوادگی</td>
...
$r = 1 ;
 foreach($stmt as $row)
  {
$id_mar = $row['id_mar'];
$query2 = "SELECT * FROM  users WHERE  id_ostan = '$id_ostan' and  id_city = '$id_city' and  S_access = '2' 
and id_mar = '$id_mar'"   ;
...
<td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="4%" class="normalTextSmaller">
...
<td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="7%" class="normalTextSmaller">
    ...
    <td width="6%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
      ...
      <button><img src="../files/abadi.png" border="0"  title="مشاهده لیست آبادی ها" width="31" height="30" /></button>
      </form>
   </td>
    <td width="4%" class="normalTextSmaller"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
	<?php echo mar_abadi_count($row['id_mar'])?></td>
    <td class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mar_mor_count($row['id_mar'],$id_ostan)?></td>
