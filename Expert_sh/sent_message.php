...
$date_edit ; 
include('../login/config.php');
$query = "SELECT r_date,del_date,r_user,id,s_time,title,s_date,ru_read,s_user,file FROM  pm WHERE   s_user = '$login_session' ORDER BY s_date DESC , s_time DESC LIMIT $start, $limit" ;
