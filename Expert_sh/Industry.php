...
<p><a href="ind.php" class="btn"> ثبت بهره برداران بخش صنایع</a></p>
<p>&nbsp;</p>
<p><a href="list_ind_benef.php" class="btn"> لیست بهره برداران بخش صنایع</a></p>
<p>&nbsp;</p>
<p><a href="manager_ind_benef.php" class="btn"> مدیریت بهره برداران بخش صنایع</a></p>
              </div>
              <div class="box" align="center">
                <p><img src="../files/city.png" alt="" width="83" height="83" border="0" class="tricky_image" /></p>
               <p><a href="Industry" class="btn"> ثبت اطلاعات واحد های صنعتی</a></p>
               <p>&nbsp;</p>
               <p><a href="Industry/list_ind_unit.php" class="btn"> لیست واحد های صنعتی</a></p>
              </div>
              <div class="box" align="center">
                     <p><img src="../files/Ind.png" alt="" width="83" height="83" border="0" class="tricky_image" /></p>
                     <p><a href="Industry/ind_prod.php" class="btn">ثبت عملکرد سالانه واحد های صنعتی</a></p>
                <p>&nbsp;</p>
                     <p><a href="Industry/list_ind_prod.php" class="btn">لیست عملکرد سالانه واحد های صنعتی</a></p>
              </div>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
