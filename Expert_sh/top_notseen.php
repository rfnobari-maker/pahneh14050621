...
<div style="float:right ; margin-right:30px ; margin-left:20px ; margin-top:15px ; padding:10px "  >
 <a  title="ویرایش اطلاعات کاربری" href="#"><img src="../files/users/<?php echo $pic ?>" width="79" height="103" id="img" alt="تصویر کاربر "/></a></div>
              ...
              <p align="right" class="RedTitleSmaller" style="margin-right:30px">ویژه کارشناسان موضوعی شهرستان </p>
              <p align="right" class="normalTextSmaller" style="margin-right:30px">واحد تخصصی : <?php echo $v_expert_unit ;?></p>

<div class="box_pm">
  <p><a href="#" title="ارسال و دریافت پیام"><img src="../files/messanger.png" alt="users" width="83" height="83" border="0" class="tricky_image" /></a>
<?php if ($count_pm > 0)
