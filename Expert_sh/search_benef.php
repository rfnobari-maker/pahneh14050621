...
?>
  ...
  <table style="border:3px solid #069;" width="90%" border="1" align="center" cellpadding="1" cellspacing="0">
    <tr>
     <td height="38" colspan="9" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>سوابق بهره بردار در سامانه </strong></div></td>
   </tr>
    <tr>
    ...
    <tr>
      <td width="101" bgcolor="#FFFFCC">&nbsp;</td>
