    ...
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      ...
      <tr bgcolor='#f1f1f1' >
        ...
        <form method="post" name="form1" id="form1" >
          <select  name="id_city" disabled="disabled" id="bakh" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
$query = "SELECT * FROM  spoultry where  id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
