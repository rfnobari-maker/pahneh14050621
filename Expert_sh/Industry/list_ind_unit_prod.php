    ...
    <td width="840" >
      ...
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 650px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px ; background-color:#CCC" >
               ...
               <tr bgcolor='#f1f1f1' >
                 <td align="right" bgcolor="#CCCCCC" class="input_text" ><select  name="id_city5" disabled="disabled" class="style8" id="id_city2" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
      ...
      <td  width="7%" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['identCode'];?></td>
