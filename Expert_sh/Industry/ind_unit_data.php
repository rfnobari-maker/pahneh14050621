...
if($m_zmos='')  $m_zmos = 0 ;
if($m_zamin='') $m_zamin = 0 ;
if($t_shagel='') $t_shagel = 0 ;
...
// بانک اطلاعات کشت
if ($no_bah=='1') {$co_name = '' ; $no_co=''; $co_sabt='';$date_sabt='';$c_f_name='';$c_l_name='';$c_cod_m='';}
...
$stmt->execute();
 ...
 id_ostan,addres,email,c_f_name,c_l_name,c_cod_m,ShenaseKasboKar) 
 ...
 ,:addres,:email,:c_f_name,:c_l_name,:c_cod_m,:ShenaseKasboKar)";
$q = $dbh->prepare($query);
...
':addres'=>$addres,':email'=>$email,':c_f_name'=>$c_f_name,':c_l_name'=>$c_l_name,':c_cod_m'=>$c_cod_m,':ShenaseKasboKar'=>$ShenaseKasboKar));
...
$isic_code    = trim($response['plan']['productInfo'][0]['isikCode']); 
...
{
$identCode = $_POST["identCode"];
$c_cod_m2 = $_POST["c_cod_m"];
$c_f_name2 = $_POST["c_f_name"];
$c_l_name2 = $_POST["c_l_name"];
  ...
  $("#v_ab").change(function() {
    ...
    if (value == "1") {
     ...
     document.getElementById("g_en").disabled = true;
       ...
       var e = document.getElementById("v_ch");
       var strUser = e.value;
           if(strUser =='2') {
	 ...
	 document.getElementById("no_mch").disabled = true;
          ...
          if(strUser =='1') {
     document.getElementById("y_mch").disabled  = false;
	 document.getElementById("m_mch").disabled  = false;
	 document.getElementById("d_mch").disabled  = false;
     document.getElementById("no_mch").disabled = false;
		   }
...
<td width="4"><p>&nbsp;</p>
 ...
 <input name="y_mch" type="text" class="input_text number required" id="y_mch" style="width:40px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $y_mch ; ?>"min="0" max="1400" maxlength="4" minlength="4" align="baseline" xml:lang="fa" />
                                        /
  <input name="m_mch" type="text" class="input_text number required" id="m_mch" style="width:20px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php echo $m_mch; ?>" min="0" max="12" maxlength="2" minlength="2"  align="baseline" xml:lang="fa" />
                                        /
  <input name="d_mch" type="text" class="input_text number required" id="d_mch" style="width:20px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $d_mch ; ?>" min="0" max="31" maxlength="2" minlength="2"  align="baseline" xml:lang="fa" />
                                      </div></td>
  ...
  <input name="no_mch"  type="text" class="input_text number required" id="no_mch" style="width:75px; height:30px ; " tabindex="23" dir="rtl" lang="fa" value="<?php echo $no_mch ; ?>" maxlength="15"  align="baseline" xml:lang="fa" />
                                      ...
                                      <td><div align="right" > : چاه آب </div></td>
                                    </tr>
                                    <tr>
