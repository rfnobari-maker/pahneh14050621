...
<td width="4"><p>&nbsp;</p>
                    ...
                    <td width="840" >
                          ...
                          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id=" " style="border:3px solid #069;">
                                ...
                                <div   style=" text-align:right; margin:auto;width:90%;overflow:auto;background-color:#ffffff;color:#06C;scrollbar-base-color:gold;font-family:tahoma;font-size:11px;padding:10px;; border-radius: 15px">
                                  <table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" >
                                    <tr align="center" class="text1">
                                      <td height="28"  colspan="3" bgcolor="#999999">عملیات</td>
...
if ($row['y_prod']=='1401' and $row['d_prod']=='12') $available = '1' ; else $available = 0 ;
$mor_cod_m1=$row['mor_cod_m'];
//echo $row2['User_Name'] ; 
?>
        <td width="4%" height="55"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
		<?php if ($available == '1')  {?>
        <form  action="del_ind_prod_data.php" method="post" onsubmit="view_ind_benef(this)">
          ...
          <button onclick="return confirm('از حذف عملکرد این واحد مطمئن هستید ؟')"><img src="../../files/del.png" title="حذف عملکرد واحد صنعتی"  width="27" height="20"  alt=""/></button>
        </form>
        <?php }?>
        </td>
        <td width="5%"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
        <?php if ($available == '1')  {?>    
          <form   action="ind_prod_edit.php" method="post" onsubmit="view_ind_prod(this)">
          <input type="hidden" name="ShenaseKasboKar" value="<?php echo $row['ShenaseKasboKar'] ;?>" />
          ...
          <button><img src="../../files/edit.png" title="نمایش اطلاعات بهره بردار صنعتی"  width="28" height="20"  alt=""/></button>
        </form>
         <?php }?>
        </td>
          ...
          <button><img src="../../files/view.png" title="نمایش اطلاعات بهره بردار صنعتی"  width="20" height="20"  alt=""/></button>
                                      ...
                                      <td  width="26%" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $v_v_unit;?></td>
