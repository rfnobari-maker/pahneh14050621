...
if  (isset($_POST['bah_cod_m']))
{
 ...
 $sal = $_POST['sal'];
 $m_poul = $_POST['m_poul'];
 $query = "SELECT * from Aquatic2 where bah_cod_m = '$bah_cod_m' and sal = '$sal' and num_bah = '$num_bah' "; 
...
<body>
  ...
  <tr>
    ...
    <input type="hidden" name="action" value="1" />
      <button  id="send" style="width:150px ; height:45px ; font-family:tahoma ; font-size:16px " onclick="close_window()">بستن پنجره</button>
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
