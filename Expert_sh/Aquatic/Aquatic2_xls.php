...
include ('../../login/config.php');
  $query = "SELECT * from Aquatic2 where $v_id_ostan  and $v_id_city and  $v_id_mar  and $f_no_fa and $f_g_tol and $f_m_ab and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $v_sal ORDER BY mor_cod_m ASC  ";
...
?>
           ...
           <table width="98%" height="153" border="0" align="center" cellpadding="1" cellspacing="1" >
             <tr align="center" class="text_r">
               ...
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">سیست و بیومس آرتمیا /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">جلبک (وزن تر) /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">صدف /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">کروکودیل /سر</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">گیاهان آبزی /هزار شاخه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">زالوی طبی /هزار عدد</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان زینتی /هزارقطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش در منابع آبی طبیعی و نیمه طبیعی /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش شاه میگو /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش میگو آب شور /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش میگو آب شیرین /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش ماهیان گرمابی /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش ماهیان سردآبی /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش  ماهیان دریایی در استخرهای خاکی /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش ماهیان خاویاری /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش ماهی در دریا (قفس) /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">پرورش ماهی تیلاپیا /تن</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">صدف /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان زینتی /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">شاه میگو /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">میگو آب شور /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">میگو آب شیرین /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">منابع آبی طبیعی و نیمه طبیعی /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان سردآبی (قزل آلا) /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان خاویاری /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان دریایی در استخرهای خاکی /هزار قطعه</td>
               <td width="3%" height="43" bordercolor="#0099CC" bgcolor="#999999">ماهیان گرمابی /هزار قطعه</td>
...
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par17'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par16'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par15'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par14'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par13'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par12'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par11'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par10'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par9'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par8'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par7'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par6'] ?></td>
<td align="center" class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['par5'] ?></td>
...
<td align="center"class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tak10'] ?></td>
<td align="center"class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tak9'] ?></td>
<td align="center"class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tak8'] ?></td>
<td align="center"class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tak7'] ?></td>
<td align="center"class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tak6'] ?></td>
