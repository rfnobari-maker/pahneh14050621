...
$query = "SELECT * FROM  change_mor WHERE  id_mar = '$id_mar' and status = '2'" ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
           <p><span class="style1"> لیست درخواست های تایید شده مرکز <?php echo $mar ; ?></span></p>
  ...
  <tr align="center" class="style8">
    <td width="10%" bgcolor="#CCCCCC">تاریخ تایید</td>
...
?>
<td height="60" <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $row['date_a'];?></span></td>
<td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="11%"><span class="normalTextSmaller"><?php echo $row['date_s'];?></span></td>
 ...
 <?php if($no_request=='1' or $no_request=='2') echo '<img src=../files/users/'.$pic_mo1.' width=42 height=47 />' ?> 
     ...
     <td  class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo $row['abadi'];?></td>
