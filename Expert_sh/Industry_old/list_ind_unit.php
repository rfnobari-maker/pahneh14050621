...
//echo $row2['User_Name'] ; 
?>
        <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="ind_prod.php#1" method="post" >
      <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
      <input type="hidden" name="unit_id"   value="<?php echo $row['id'] ;?>" />
      <button><img src="../../files/new.png" title="ثبت عملکرد سالانه واحد"  width="33" height="26"  alt=""/></button>
    </form></td>
      <td width="6%" height="72" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
    <form  action="del_ind_unit.php" method="post">
    ...
    <button onclick="return confirm('از حذف اطلاعات واحد صنعتی مطمئن هستید ؟')"><img src="../../files/del1.png" title="حذف واحد صنعتی" width="33" height="26" alt=""/>
    </button>
      </form></td>
      <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="edit_ind_unit.php" method="post">
    ...
    <input type="hidden" name="id" value="<?php echo $row['id'] ;  ;?>" />
        <button><img src="../../files/edit.png" title="ویرایش اطلاعات واحد صنعتی" width="33" height="26"  alt=""/></button>
      </form></td>
      <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="ind_unit_view.php#1" method="post" onsubmit="winpap1(this)">
        <input type="hidden" name="id" value="<?php echo $row['id'] ;?>" />
...
?>
          ...
          <p><a href="index.php"><img src="../../files/add_new.png"  alt="" width="50" height="52" class="btn" title="ثبت واحد جدید"/></a></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="../Industry.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
  </tr>
  <tr>
