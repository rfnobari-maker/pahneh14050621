                                  ...
                                  <td height="256" colspan="5">
                                    ...
                                    <tr>
                                      ...
                                      <td width="14%" ><div align="center" class="vab_comment" >
                                        <input name="g_en" type="text" class="input_text digits required" id="g_en" style="width:50px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $g_en ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                                      </div></td>
