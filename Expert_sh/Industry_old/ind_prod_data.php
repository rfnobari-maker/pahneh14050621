...
$num3_t_mah--;
 ...
 // ثبت در بانک پیگیری
    sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'ثبت عملکرد واحد صنعتی - '.$bah_cod_m,$id_ostan) ;
...
$query = "SELECT id_ostan,id_city,id_mar,unit_name,add_abadi,add_city,num_bah,v_gaz,v_bar from ind_unit where  id = :id"; 
...
<body>
  ...
  <tr>
    <td>
      <?php include('top.php'); ?>
           <p class="style8">ثبت عملکرد سال <?php echo  $y_prod ?> واحد صنعتی <br />
             <br />
...
?>
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="right" style="margin-right:10px">
                <select  name="mah_name<?php echo $num2_t_mah ;?>" class="target required input_text myselect mar<?php echo $mah_name.$num2_t_mah ;?>" id="cod_mah<?php echo $num2_t_mah ;?>"
                 style="width:550px ; height:40px" tabindex="23" dir="rtl" l>
                </select>
              </div></td>
