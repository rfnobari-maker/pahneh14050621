...
<tr>
  ...
  <?php include('top.php'); ?>
           ...
           <div class="box" align="center">
             <p><a href="Agri_rep16.php"><img src="../../files/agri_prod.png" alt="bee" width="83" height="83" border="0" class="tricky_image" /></a></p>
           ...
           <div class="box" align="center">
             <p><a href="list_Agri_no_editing.php"><img src="../../files/download-(2).jpg" alt="سوابق" width="86" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="list_Agri_no_editing.php" class="btn">لیست قطعات فاقد ویرایش </a><br />
             </p>
           </div>

           <div class="box" align="center">
             <p><img src="../../files/zera.png" alt="گندم تحویلی به دولت" width="86" height="86" border="0" class="tricky_image" /></p>
             <p><a href="delivery.php" class="btn"> گندم تحویلی به دولت</a><br />
             </p>

           <div class="box" align="center">
             <p><img src="../../files/Vege.png" alt="بهره برداری زراعی" width="86" height="86" border="0" class="tricky_image" /></p>
          ...
          <tr>
            <td  height="109"colspan="3" valign="middle" ><p><a href="../prof.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
          </tr>
          <tr>
