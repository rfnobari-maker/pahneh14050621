...
?>
<p dir="rtl" align="center" class="style8">گزارش محصولات زراعی <?php echo mah_name($mah_name) ?> استان <?php echo ostan_name($id_ostan1) , $shahr , $mar ?> در سال <?php echo $z_sal ?></p>           <table width="98%" height="101" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
