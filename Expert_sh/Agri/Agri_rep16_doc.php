...
header("Content-Disposition: attachment;Filename=محصولات زراعی.doc");
...
?>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="11%" height="38" ><?php echo $mahtol ;?></td>
