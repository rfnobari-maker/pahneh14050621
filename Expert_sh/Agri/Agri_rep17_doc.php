...
header("Content-Disposition: attachment;Filename=گزارش_ویژه_زراعی.dox");
...
<body>
      <p align="center"  dir="rtl" class="style8">گزارش اختصاصی اطلاعات زراعی - سال زراعی <?php echo $z_sal?>
        <?php
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['mah_tol'],3)*1 ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['mah_tolp'],3)*1 ; ?></td>
