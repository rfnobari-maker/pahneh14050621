...
<div style="float:right ; margin-right:30px ; margin-left:20px ; margin-top:15px ; padding:10px "  >
 <a  title="ویرایش اطلاعات کاربری" href="profile.php"><img src="../files/users/<?php echo $pic ?>" width="79" height="103" id="img" alt="تصویر کاربر "/></a></div>
              ...
              پانل مدیریتی سامانه پهنه بندی و مدیریت داده های کشاورزی </p>
              <p align="right" class="RedTitleSmaller" style="margin-right:30px">ویژه کارشناسان موضوعی شهرستان <?php echo $ostan.'&nbsp; /&nbsp;'.$city ;  ?></p>
  <p align="right" class="normalTextSmaller" style="margin-right:30px">واحد تخصصی : <?php echo $v_expert_unit ;?><br>
                <br>کد استان : <?php echo $id_ostan?> /کد شهرستان : <?php echo $id_city?>
    </p>
<div class="box_pm">
