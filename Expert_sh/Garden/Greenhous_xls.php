...
header("Content-Disposition: attachment;Filename=Greenhous.xls");
?>
<?php 
...
$query = "SELECT * from Greenhous where $v_id_ostan  and $v_id_city and  $v_id_mar  and $f_no_kesht and $f_no_saz and $f_no_gol and $f_sys_kesh and $f_sys_hot and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $f_no_moj   ORDER BY mor_cod_m ASC "; 
