...
$id_ostan_post = isset($_POST['id_ostan']) ? trim($_POST['id_ostan']) : '' ;
if ($id_ostan_post !== '' && $id_ostan_post !== '-1' && $id_ostan_post !== '0') {
    $id_ostan = $id_ostan_post;
}
$id_city = isset($_POST['id_city']) ? $_POST['id_city'] : (isset($id_city) ? $id_city : 0) ;
...
if ($id_ostan === '' || $id_ostan === '-1' || $id_ostan === '0') {
    echo '<p align="center">کد استان کاربر خالی است؛ گزارش اجرا نشد.</p>';
} else {
