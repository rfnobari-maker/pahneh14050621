  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             ...
             <table width="100%" height="430" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
               ...
               <tr bgcolor='#f1f1f1' >
                 <td width="35%" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city" disabled="disabled" class="style8" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
