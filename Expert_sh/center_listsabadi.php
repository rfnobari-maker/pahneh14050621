...
$r = 1 ;
 foreach($stmt as $row){
?>
    <td height="48" class="normalTextSmaller"<? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['add_abadi'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['abadi'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['deh'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['bakh'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['city'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $row['ostan'];?></td>
    <td <? if($r%2 == 0) echo 'bgcolor=#f1f1f1' ?>><?php echo $r;?></td>
  </tr>
<?php
$r++ ; 
}
