...
?>
      <td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="5%" height="58" class="normalTextSmaller"><form  action="send_sms.php" method="post" onsubmit="target_popup(this)">
      ...
      <td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="4%" class="normalTextSmaller"><form  action="send_pm.php" method="post">
        <input type="hidden" name="username" value="<?php echo $row2['username'] ;?>" />
      ...
      <td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> width="19%" class="normalTextSmaller"><?php echo $row2['Last_name'].' '.$row2['name'];?></td>
