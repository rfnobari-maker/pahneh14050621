...
$date_edit ; 
include('../login/config.php');
$query = "SELECT * FROM  `pm` WHERE   s_user = '$login_session' ORDER BY s_date DESC LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  `pm` WHERE   s_user = '$login_session' ORDER BY s_date DESC  "  ;
