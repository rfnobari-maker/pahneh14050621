...
<div id="div_list" >
  <p>
    <span class="style19">لیست در انتظار کشتار به تفکیک مرغداری </span>
...
<table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC'>
  <tr class="text1">
    <td width="9%" bgcolor="#006699">ثبت کشتار</td>
    <td width="9%" bgcolor="#006699">تعداد ارسال به کشتار</td>
    <td width="9%" bgcolor="#006699">تاریخ ارسال کشتار</td>
    <td width="10%" bgcolor="#006699">شناسه یکتا واحد</td>
    <td width="11%" bgcolor="#006699">نام مالک</td>
...
$t_r = $r
  ?>
    <tr>
      <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>&nbsp;</td>
      ...
      <td height="23" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['name_m'] ; ?></td>
