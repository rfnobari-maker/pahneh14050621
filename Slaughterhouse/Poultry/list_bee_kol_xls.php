...
include ('../../login/config.php');
 if ($id_ostan1 == '-1')    { $v_id_ostan   = 1 ;}else{ $v_id_ostan = "(((bee.id_ostan='$id_ostan1') and 
 (bee.m_ostan='$id_ostan1' or bee.m_ostan='-'))
...
where   $v_id_ostan  and $v_sal  and $v_bah_cod_m ORDER BY id_ostan ASC"  ;
...
?>
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          ...
          <td align="center" width="2%" bgcolor="#FFCC99">تولید بره مومKg</td>
