...
<tr>
          ...
          <tr>
            <td>
  <?php include('top.php'); ?>
           <p align="center" class="style8"  > طیور و زنبورعسل</p>
           ...
           <div class="box" align="center">
             ...
             <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <p><a href="list_bee2.php" class="btn">زنبورستان های مهاجر در سایر استان ها</a></p>
                <p>&nbsp;</p>
                <p><a href="list_bee_kol.php" class="btn">لیست نهایی زنبورستان های استان </a><br />
                </p>
              </div>
           <div class="box" align="center">
             ...
             <p>&nbsp;</p>
             <p><a href="bee_Ncity.php" class="btn">گزارش نهایی تولید به تفکیک شهرستان</a></p>
           </div>
<?php if($id_ostan=='03') {?>
           <div class="box" align="center">
             <p><a href="bee2.php"><img src="../../files/pol.jpg" alt="bee" width="108" height="103" border="0" class="tricky_image" /></a></p>
             <p><a href="Broiler_chicken.php" class="btn">مرغ گوشتی</a></p>
           </div>
<?php }?>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
