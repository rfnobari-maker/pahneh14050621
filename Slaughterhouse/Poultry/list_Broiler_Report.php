...
?>
  ...
  بررسی و تصحیح موجودی واحد های گوشتی در جریان </p>
  ...
  <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
    <table width="100%" height="335" border='0' align="center" cellpadding='0' cellspacing='0'>
      ...
      <tr bgcolor='#f1f1f1' >
        <td align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city5"  class="style8" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
