...
<body>
  ...
  <tr>
    <td>
           <p class="style8"> تصحیح موجودی واحد </p>
      ...
      <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          <td height="104"><div align="right">
            <textarea name="comment" id="comment" cols="45" rows="5" dir="rtl"  style="font-family:Tahoma ; font-size:14 ; color:#069" >تصحیح موجودی مدیریت طیور استان</textarea>
          </div></td>
