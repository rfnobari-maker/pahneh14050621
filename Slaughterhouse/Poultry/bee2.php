  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
        ...
        <p class="style1">آمار تولید زنبورستان به تفکیک شهرستان </p>
...
sum(bee.`t_zah`) t_zah 
FROM `bee` 
inner join cityname on cityname.id_ostan = bee.id_ostan and cityname.id_city  = bee.id_city 
...
Kg</td>
    ...
    <td width="4%" rowspan="2" bgcolor="#999999">ردیف</td>
             ...
             <tr align="center" class="text1">
               ...
               <td width="4%" bgcolor="#999999">خرید از بخش دولتی</td>
               <td width="6%" bgcolor="#999999">خرید از بخش خصوصی</td>
               <td width="5%" bgcolor="#999999">خود مصرفی</td>
...
$r = 1 ;
 ...
 $m_kmo = $row['t_mo'] / $row['k_mo'] ; 
  ...
  if(city_status($id_ostan1,$row['id_city'])=='2') $conf_status='../../files/notok.png'; ?>
               ...
               <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tm_kdo']*1 ; ?></td>
               <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tm_kkh']*1 ; ?></td>
               <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tm_kh']*1 ; ?></td>
               ...
               <td width="5%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['t_sh']*1 ; ?></td>
