...
$query = "SELECT * FROM  `pm` WHERE  r_user = '$login_session' and del <> 'T' ORDER BY s_date DESC LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  `pm` WHERE  r_user = '$login_session' and del <> 'T' ORDER BY s_date DESC  "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
<ul id="menu">
<li></li>
<li><a href="send_group_pm.php">پیام گروهی</a></li>
