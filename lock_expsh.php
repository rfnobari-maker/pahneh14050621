...
{
$query = "SELECT username,Last_name,ostan,id_ostan,city,id_city,markaz,name,id_mar,pic,jens,expert_unit from users  WHERE username='".$user_check."' and S_access='6'";
