 ...
 *
 *   /dash/dash_snap_build_locked.php?confirm=1
 *   /dash/dash_snap_build_locked.php?confirm=1&year=1403
 *
...
if (!function_exists('dash_snap_build_locked_levels')) {
    dash_locked_out('lib.php is outdated — upload latest dash/lib.php', $isCli);
    exit(1);
}
