...
include ('event.php');
$query = "SELECT id_mar,id_city,bah_cod_m from Garden WHERE add_abadi <1 and add_city <1  and z_sal = '1404'  "; 
...
//alert($add_abadi);
$query = "UPDATE Garden SET add_abadi=? , add_city=?  where id_city = ? and 
