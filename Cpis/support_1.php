...
function close_window() {
    ...
    <style>
    #box
	{ box-shadow:10px 10px 5px #999 ; width:90% ; background-color:#CCC; 
...
<body>
 ...
 <p>
   <br />
   <span class="style8">ارتباط با پشتیبان سامانه </span></p>
 <p align="center" dir="rtl"><img src="files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
 <p align="center" style="color:#900 ; font-family:Tahoma; font-size:12px" ><?php echo $mess ?><span class="style21"><a name="1" id="1"></a></span></p>
       ...
       <div id="box">
         <p class="style19">لطفا با شماره </p>
         <p class="style19">02143542288 </p>
         <p class="style19">سرکار خانم حسین پور تماس بگیرید </p>
       </div>
       <p>
