...
<tr>
    <td class="header_test">
        <img src="<?php echo $root ?>../../files/images/headerc1.jpg" width="100%" height="130" />
    </td>
</tr>
...
<tr>
    <td class="menu_test" dir="ltr">
        <?php include($_SERVER['DOCUMENT_ROOT'].'/Cpis/menu.php'); ?>
    </td>
</tr>
...
<tr>
    <td>
        <?php include($_SERVER['DOCUMENT_ROOT'].'/Cpis/top.php'); ?>
    </td>
</tr>
