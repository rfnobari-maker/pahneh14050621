...
require_once('side_menu1.php');
    alert('برای نمایش گزارش باید مدتی صبر کنید') ; 
?>
...
<p class="style8">گزارش  بهره برداران کشاورزی به تفکیک مدرک تحصیلی </p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
      <table width="132" height="56" border="0" align="center">
             <tr>
               <td width="61"><form  action="bah_rep1_xls.php" method="post">
                 <button><img src="../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="39" height="43"  alt=""/></button>
               </form></td>
               <td width="129"><form  action="bah_rep1_doc.php" method="post">
                 <button><img src="../files/word.png" title="دانلود نتایج با فرمت فایل ورد"  width="39" height="43"  alt=""/></button>
               </form></td>
             </tr>
           </table>
           <table width="85%" height="330" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
...
?>
  ...
  <td width="5%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah3'];?></td>
    ...
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> >
      <form  action="bah_rep11.php" method="POST" onsubmit="return ray.ajax()">
