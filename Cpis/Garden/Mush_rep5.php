...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style19">اطلاعات سالن های  واحد های پرورش قارچ</span><br />
...
$f_no_mush and $v_bah_cod_m and $v_mor_cod_m  
group by Mushroom.id
ORDER BY id_ostan,id_city,bah_cod_m ASC LIMIT $start, $limit "; 
...
where  $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and Mushroom_prod.y_prod = '$y_prod' and 
$f_no_mush and $v_bah_cod_m and $v_mor_cod_m 
group by Mushroom.id ORDER BY bah_cod_m "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
