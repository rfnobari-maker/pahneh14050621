...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $_SESSION['garden_admin_filter_id_ostan'] = isset($_POST['id_ostan']) ? $_POST['id_ostan'] : '';
    $_SESSION['garden_admin_filter_z_sal'] = isset($_POST['z_sal']) ? $_POST['z_sal'] : '';
    $_SESSION['garden_admin_filter_group_cod'] = isset($_POST['group_cod']) ? $_POST['group_cod'] : '';
    $_SESSION['garden_admin_filter_product_cod'] = isset($_POST['product_cod']) ? $_POST['product_cod'] : '';
    $_SESSION['garden_admin_filter_status'] = isset($_POST['status']) ? $_POST['status'] : '';
}

// خواندن فیلترها از Session (اگر POST وجود نداشت)
$filter_id_ostan = isset($_SESSION['garden_admin_filter_id_ostan']) ? $_SESSION['garden_admin_filter_id_ostan'] : '';
$filter_z_sal = isset($_SESSION['garden_admin_filter_z_sal']) ? $_SESSION['garden_admin_filter_z_sal'] : '';
$filter_group_cod = isset($_SESSION['garden_admin_filter_group_cod']) ? $_SESSION['garden_admin_filter_group_cod'] : '';
$filter_product_cod = isset($_SESSION['garden_admin_filter_product_cod']) ? $_SESSION['garden_admin_filter_product_cod'] : '';
$filter_status = isset($_SESSION['garden_admin_filter_status']) ? $_SESSION['garden_admin_filter_status'] : '';
                ...
                <td width="840">
                    ...
                    <div class="admin-box">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div class="btn-group">
                                                ...
                                                <a href="Garden_ab_request_admin.php?reset=1" class="reset-btn">🔄 حذف فیلتر</a>
                        ...
                        <table class="request-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="Garden_ab_request_admin_detail.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>" class="manage-link">
                                            ⚙️ مدیریت
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <div class="pagination">
                            <?php if ($page > 1): ?>
                                <a href="?page=<?php echo $page - 1; ?>&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>">‹ قبلی</a>
                            <?php endif; ?>
                            ...
                            if ($start_page > 1): ?>
                                <a href="?page=1&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>">1</a>
                                <?php if ($start_page > 2): ?>
                                    <span>...</span>
                                <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="?page=<?php echo $i; ?>&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>"><?php echo $i; ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                            ...
                            <?php if ($end_page < $total_pages): ?>
                                <?php if ($end_page < $total_pages - 1): ?>
                                    <span>...</span>
                                <?php endif; ?>
                                <a href="?page=<?php echo $total_pages; ?>&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>"><?php echo $total_pages; ?></a>
                            <?php endif; ?>
                            
                            <?php if ($page < $total_pages): ?>
                                <a href="?page=<?php echo $page + 1; ?>&id_ostan=<?php echo urlencode($filter_id_ostan); ?>&z_sal=<?php echo urlencode($filter_z_sal); ?>&group_cod=<?php echo urlencode($filter_group_cod); ?>&product_cod=<?php echo urlencode($filter_product_cod); ?>&status=<?php echo urlencode($filter_status); ?>">بعدی ›</a>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
