<?php
/**
 * export_garden_requests_xls.php - خروجی Excel از درخواست‌های محصولات باغی
...
header('Content-Disposition: attachment; filename="garden_requests_' . date('Y-m-d') . '.xls"');
...
// ============================================================
// دریافت لیست درخواست‌ها با JOIN
// ============================================================
...
if ($rowCount > 0) {
    ...
    echo '<th>ostan</th>';
    echo '<th>z_sal</th>';
    echo '<th>group_cod</th>';
    echo '<th>product_cod</th>';
    echo '<th>product_name</th>';
    echo '<th>current_s_nobar_abi</th>';
    echo '<th>current_s_nobar_dem</th>';
    echo '<th>current_s_bar_abi</th>';
    echo '<th>current_s_bar_dem</th>';
    echo '<th>current_t_abi</th>';
    echo '<th>current_t_dem</th>';
    echo '<th>current_a_abi</th>';
    echo '<th>current_a_dem</th>';
    echo '<th>request_s_nobar_abi</th>';
    echo '<th>request_s_nobar_dem</th>';
    echo '<th>request_s_bar_abi</th>';
    echo '<th>request_s_bar_dem</th>';
    echo '<th>request_a_abi</th>';
    echo '<th>request_a_dem</th>';
    echo '<th>calculated_t_abi</th>';
    echo '<th>calculated_t_dem</th>';
    echo '<th>admin_s_nobar_abi</th>';
    echo '<th>admin_s_nobar_dem</th>';
    echo '<th>admin_s_bar_abi</th>';
    echo '<th>admin_s_bar_dem</th>';
    ...
    foreach ($requests as $row) {
        ...
        echo '<td class="text-left">' . htmlspecialchars($row['ostan']) . '</td>';
        echo '<td class="number">' . htmlspecialchars($row['z_sal']) . '</td>';
        echo '<td class="number">' . htmlspecialchars($row['group_cod']) . '</td>';
        echo '<td class="number">' . htmlspecialchars($row['product_cod']) . '</td>';
        echo '<td class="text-left">' . htmlspecialchars($row['product_name']) . '</td>';
        echo '<td class="number">' . number_format($row['current_s_nobar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['current_s_nobar_dem'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['current_s_bar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['current_s_bar_dem'], 2) . '</td>';
        ...
        echo '<td class="number">' . number_format($row['request_s_nobar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['request_s_nobar_dem'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['request_s_bar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['request_s_bar_dem'], 2) . '</td>';
        ...
        echo '<td class="number">' . number_format($row['admin_s_nobar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['admin_s_nobar_dem'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['admin_s_bar_abi'], 2) . '</td>';
        echo '<td class="number">' . number_format($row['admin_s_bar_dem'], 2) . '</td>';
