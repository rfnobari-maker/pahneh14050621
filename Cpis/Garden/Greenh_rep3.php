...
<body>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_1) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
...
?>
      ...
      <table width="85%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#0099FF">
        <tr class="style8">
          ...
          <td width="8%" align="center" bgcolor="#CCCCCC">شماره همراه کارشناس</td>
          <td width="8%" align="center" bgcolor="#CCCCCC">نام نام خانوادگی کارشناس </td>
          <td width="8%" align="center" bgcolor="#CCCCCC">کد ملی کارشناس</td>
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo user_name($row['mor_cod_m']) ?></td>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_2) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 > 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_3) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_4) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_5) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol1_6) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol3_1) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol3_2) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol3_4) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,  (Greenhous_prod.no_mtol2_2) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  
 ,  (Greenhous_prod.no_mtol2_3) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  
Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
Greenhous_prod.no_mtol1_3 = 0  and 
Greenhous_prod.no_mtol1_4 = 0  and 
Greenhous_prod.no_mtol1_5 = 0  and 
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>درخت و درختچه های زینتی</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($row['id_city'],$row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
        </tr>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  , 
  (Greenhous_prod.no_mtol2_4) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  , 
  (Greenhous_prod.no_mtol4_1) as tol , (Greenhousn.m_zamin) as zamin
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>شاخه</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>گل شاخه بریده در فضای باز</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($row['id_city'],$row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
        </tr>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,
   (Greenhous_prod.no_mtol4_2) as tol , (Greenhousn.m_zamin) as zamin
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  , 
  (Greenhous_prod.no_mtol4_3) as tol , (Greenhousn.m_zamin) as zamin
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['zamin']/10000 ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>اصله</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>درخت و درختچه های زینتی در فضای باز</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($row['id_city'],$row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
        </tr>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,
   (Greenhous_prod.no_mtol4_4)  as tol , (Greenhousn.m_zamin) as zamin
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['zamin']/10000 ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>بوته</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>گل های فصلی در فضای باز</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($row['id_city'],$row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
        </tr>
 ...
 $query = " SELECT  Greenhous_prod.id_ostan ,  Greenhous_prod.id_city   ,  Greenhous_prod.mor_cod_m  ,
   (Greenhous_prod.no_mtol3_3) as tol , (Greenhousn.m_zamin_gol) as zamin_gol
FROM Greenhous_prod 
inner join Greenhousn ON Greenhousn.id = Greenhous_prod.unit_id
WHERE Greenhous_prod.y_prod='1400' and  Greenhous_prod.no_mtol1_1 = 0  and 
Greenhous_prod.no_mtol1_2 = 0  and 
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['zamin_gol']/10000 ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>اصله</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>نهال و قلمه</td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo city_name1($row['id_city'],$row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan']) ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
        </tr>
...
{
include_once('../../login/config.php');
 $query = "SELECT  ($mah) as tol_k FROM Greenhous_prod where id_ostan = '$id_ostan1' and id_city = '$id_city' ";
$stmt = $dbh->prepare($query);
$stmt->execute();
