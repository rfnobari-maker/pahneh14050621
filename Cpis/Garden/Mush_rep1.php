...
if (isset($_POST['m_fani'])) $m_fani = $_POST['m_fani'];
if (isset($_POST['v_unit'])) $v_unit = $_POST['v_unit'];
if (isset($_POST['nt_comp'])) $nt_comp = $_POST['nt_comp'];
if (isset($_POST['comp1'])) $comp1 = $_POST['comp1'];
if (isset($_POST['comp2'])) $comp2 = $_POST['comp2'];
if (isset($_POST['t_dpar1'])) $t_dpar1 = $_POST['t_dpar1'];
if (isset($_POST['t_dpar2'])) $t_dpar2 = $_POST['t_dpar2'];
if (isset($_POST['zer_kesh1'])) $zer_kesh1 = $_POST['zer_kesh1'];
if (isset($_POST['zer_kesh2'])) $zer_kesh2 = $_POST['zer_kesh2'];
if (isset($_POST['mah_tol1'])) $mah_tol1 = $_POST['mah_tol1'];
if (isset($_POST['mah_tol2'])) $mah_tol2 = $_POST['mah_tol2'];
if (isset($_POST['tol_avg1'])) $tol_avg1 = $_POST['tol_avg1'];
if (isset($_POST['tol_avg2'])) $tol_avg2 = $_POST['tol_avg2'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style19">گزارش اختصاصی عملکرد واحد های پرورش قارچ</span><br />
      </p>
...
$v_zer_kesh1 and $v_zer_kesh2 and $v_mah_tol1 and $v_mah_tol2 and $v_tol_avg1 and $v_tol_avg2 and $v_bah_cod_m 
and $v_mor_cod_m  ORDER BY bah_cod_m ASC LIMIT $start, $limit "; 
...
?>
             ...
             <br />
            <table width="99%"  align="center" class="my-table" >
              <tr class="text1">
                <td colspan="2" rowspan="2" bgcolor="#006699">عملیات</td>
                <td width="6%" rowspan="2" bgcolor="#006699">عملکرد تولید<span class="style2"><br />
                  کیلوگرم / مترمربع</span></td>
          <td width="5%" rowspan="2" bgcolor="#006699"><p>کل تولید <span class="style2">تن</span></p></td>
          <td width="5%" rowspan="2" bgcolor="#006699">سطح زیر کشت<br />
            <span class="style2">مترمربع</span></td>
          <td width="6%" rowspan="2" bgcolor="#006699"><p>تعداد دوره پرورشی</p></td>
          <td width="6%" rowspan="2" bgcolor="#006699">نحوه تامین کمپوست</td>
          <td width="6%" rowspan="2" bgcolor="#006699"><p>کمپوست مصرفی<br />
              <span class="style2">تن / سال</span> </p></td>
          <td width="4%" rowspan="2" bgcolor="#006699">نوع قارچ</td>
          <td width="5%" rowspan="2" bgcolor="#006699">مسئول فنی</td>
          <td width="5%" rowspan="2" bgcolor="#006699"><p>تعداد شاغل<br />
              <span class="style2">نفر</span> </p></td>
          <td colspan="3" bgcolor="#006699">مشخصات بهره بردار</td>
          <td width="5%" rowspan="2" bgcolor="#006699">ردیف</td>
        </tr>
        <tr class="text1">
          <td width="10%" bgcolor="#006699" class="text1">شماره همراه </td>
          <td width="11%" bgcolor="#006699" class="style8"><img src="../../files/sort.png" width="15" height="24"  alt=""/><span class="text1"> کد ملی</span></td>
...
if ($row['nt_comp']=='3')  $v_nt_comp='ترکیبی';
  ...
  ?>
          <td width="7%" height="53" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>  <form  action="../send_pm1.php#1" method="post" onsubmit="target_popup2(this)">
