...
?>
   ...
   <?php if ($row['id_ostan']==$id_ostan1) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="49" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl" >
      ...
      <tr >
        <td height="48" align="right" bgcolor="#F1F1F1" class="input_text" ><div align="right">
          <select name="z_sal" class="input_text  required" id="z_sal" style="height:40px ; width:170px ; direction:rtl">
            ...
            <option value="1397" <?php if (isset($z_sal) && $z_sal=='1397') echo 'selected=selected'?>>1397</option>
            <option value="1396" <?php if (isset($z_sal) && $z_sal=='1396') echo 'selected=selected'?>>1396</option>
            <option value="1395" <?php if (isset($z_sal) && $z_sal=='1395') echo 'selected=selected'?>>1395</option>
          </select>
        </div></td>
