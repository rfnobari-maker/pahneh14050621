...
if (isset($_POST['gaz'])) $gaz = $_POST['gaz'];
if (isset($_POST['barg'])) $barg = $_POST['barg'];
if (isset($_POST['mor_cod_m'])) $mor_cod_m = $_POST['mor_cod_m'];
if (isset($_POST['m_cod_m'])) $m_cod_m = $_POST['m_cod_m'];
if (isset($_POST['z_es1'])) $z_es1 = $_POST['z_es1'];
if (isset($_POST['z_es2'])) $z_es2 = $_POST['z_es2'];
?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             <p> <span class="style19">لیست واحدهای فاقد عملکرد تولید </span> </p>
             <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="536" border='0' align="center" cellpadding='0' cellspacing='0'>
                 <tr bgcolor='#f1f1f1' >
                 ...
                 <tr bgcolor='#f1f1f1' >
                   ...
                   <td  align='center' bgcolor="#FFFFFF" ><span ><font size="2" class="normalTextSmall">: عملکرد سال </font></span></td>
                  </tr>
                 <tr bgcolor='#f1f1f1' >
                   <td width="204" height="46" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_city5" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
