                   ...
                   <div align="right">
                    <select name="mah_qroup" class="required input_text country" id="mah_qroup" style="width:170px ; height:40px" tabindex="22" dir="rtl"  >
                      ...
                      <?php
                        ...
                        $query = "SELECT DISTINCT group_cod,group_name FROM `product_b_new` ORDER BY group_cod ASC" ;
                   ...
                   <div align="right">
                     <select name="mah_name" class="required input_text mar" style="width:170px ; height:40px" tabindex="23" dir="rtl">
                       <?php
                         if (!empty($mah_qroup)) {
                           // استفاده از product_b
                          echo $query = "SELECT  product_cod,product_name FROM `product_b_new` WHERE `group_cod` = :mah_qroup ORDER BY product_name ASC" ;
                           $stmt = $dbh->prepare($query);
...
$(document).ready(function() {
  $(".country").change(function() {
    ...
    $.ajax({
      type: "POST",
      url: "ajax_city_new.php", // این فایل از قبل موجود است
      data: dataString,
      cache: false,
