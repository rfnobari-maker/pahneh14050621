...
and $f_z_es2 and  Mushroom_prod.unit_id is null 
 ORDER BY Mushroom.bah_cod_m ASC"; 
$stmt = $dbh->prepare($query);
$stmt->execute(array(':mor_cod_m'=>$login_session));
?>
<p align="center"> لیست واحدهای پرورش قارچ فاقد عملکرد سال <?php echo $y_prod ?></p>
         <table width="98%" height="91" border="1" align="center" cellpadding="1" cellspacing="1" >
           <tr align="center" class="text_r">
             <td width="6%" bgcolor="#CCCCCC">همراه کارشناس</td>
             <td width="6%" bgcolor="#CCCCCC">نام و نام خانوادگی کارشناس</td>
...
?>
    <tr>
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo user_tel($row['mor_cod_m']); ?></span></td>
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo user_name($row['mor_cod_m']); ?></span></td>
    ...
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo $row['m_arseh']; ?></span></td>
