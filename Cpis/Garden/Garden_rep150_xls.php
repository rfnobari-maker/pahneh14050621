...
?>
<br />
<table width="98%" height="96" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td width="11%" bgcolor="#999999">نام شهر</td>
             ...
             <tr>
               <?php
 $query = "SELECT  Garden_prod.bah_cod_m ,Garden_prod.num_bah,Garden_prod.mor_cod_m ,Garden_prod.add_abadi,Garden_prod.add_city,
...
FROM Garden_prod
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah Group by add_abadi,add_city,bah_cod_m  ORDER BY add_abadi,add_city,bah_cod_m  "; 
