...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style19">گزارش  واحد های پرورش قارچ به تفکیک استان</span><br />
...
$r = 1 ;
 foreach($stmt as $row){
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="7%" height="45" ><?php echo round($row['comp'],1) ; ?></td>
...
?>
             ...
             <tr>
               <td height="45" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> ><?php echo round($row['comp'],1) ; ?></td>
