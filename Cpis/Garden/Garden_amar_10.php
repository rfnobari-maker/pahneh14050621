...
?>
           ...
           <table width="103" height="56" border="0" align="center">
             <tr>
               <td width="97"><form  action="#" method="post">
...
$r = 1 ;
 foreach($stmt as $row){
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="5%" height="42" ><?php echo round($row['m_tol'],1)*1 ; ?></td>
...
?>
             ...
             <tr>
               <td height="38" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> ><?php echo round($row['m_tol'],1)*1 ; ?></td>
...
if ($id_ostan1 !== '-1') 
{
  $query = "SELECT id_ostan,id_city, sum(no_mtol1_1) mah_tol FROM Greenhous_prod WHERE y_prod ='$z_sal'  and $v_id_ostan and $v_id_city and $v_id_mar and  $f_add_abadi and $f_add_city   
GROUP BY id_city
ORDER BY id_city  "  ;
}
$stmt = $dbh->prepare($query);
...
?>
           ...
           <p><a href="Garden.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a>
      </td>
  </tr>
  <tr>
