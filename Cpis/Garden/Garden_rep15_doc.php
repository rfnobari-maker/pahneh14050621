...
header("Content-Disposition: attachment;Filename=بهره برداران باغی.doc");
include("../../lock_cp.php");
include("../../event.php");
...
<table width="98%" height="100" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td width="8%" bgcolor="#999999">همراه بهره بردار </td>
               <td width="8%" bgcolor="#999999">کد ملی بهره بردار </td>
               <td width="16%" bgcolor="#999999">نام و نام خانوادگی بهره بردار </td>
...
?>
        ...
        <td align="center" height="24"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $mahtol ;?></td>
               ...
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><span class="normalTextSmall"><?php echo bah_tel_m($row['bah_cod_m']) ?></span></td>
