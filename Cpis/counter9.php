...
{
include_once('../login/config.php');
$query = "SELECT count(*) FROM  bah WHERE id_ostan = '$id_ostan' and ok = '1' group by id_ostan " ;
$result = $dbh->prepare($query); 
$result->execute(); 
$number_of_rows = $result->fetchColumn(); 
return $number_of_rows ; 
...
{
include_once('../login/config.php');
$query = "SELECT id FROM  bah WHERE id_ostan = '$id_ostan' and id_city = '$id_city' and ok = '1' " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT id FROM  bah WHERE  mor_cod_m = '$mor_cod_m' and ok = '1' " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT id FROM  bah WHERE  add_abadi = '$add_abadi' and ok = '1' " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT id FROM  bah WHERE  add_city = '$add_city' and ok = '1' " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_abadi_bah = $stmt -> rowCount();
return $count_abadi_bah ; 	
...
{
include_once('../login/config.php');
$stmt = $dbh->prepare("SELECT count(id) FROM bah WHERE add_city = '$add_city' and ok = '1'");
$stmt->execute();
...
include_once('../login/config.php');
$query = "SELECT id FROM $Agri_table where id_ostan= '$id_ostan'  "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
$Agri_table = 'Agri'.$z_sal ; 
include_once('../login/config.php');
$query = "SELECT id FROM $Agri_table  "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
$sal1 = $sal-1 ;
$z_sal = $sal1.'_'.$sal ;
$Agri_prod_table = 'Agri_prod'.$z_sal ; 
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM $Agri_prod_table where id_ostan= '$id_ostan' and mah_tol > 0  "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
$Agri_prod_table = 'Agri_prod'.$z_sal ; 
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM $Agri_prod_table where mah_tol > 0 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
?>
<?php
function ostan_Vege_count($id_ostan,$sal)
{
$sal1 = $sal-1 ;
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Vege_prod where id_ostan= '$id_ostan' and z_sal = '$z_sal' and mah_tol > 0 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Vege = $stmt -> fetchColumn(); 
return $count_ostan_Vege ; 	

}
?>
<?php
function total_Vege_count($sal)
{
$sal1 = $sal-1 ;
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Vege_prod where z_sal = '$z_sal' and mah_tol > 0 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Garden_prod where id_ostan= '$id_ostan' and z_sal = '$sal' and mah_tol > 0 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Garden_prod where z_sal = '$sal' and mah_tol > 0 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Greenhous_prod where id_ostan= '$id_ostan' and y_prod = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Greenhous_prod where y_prod = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
?>
<?php
function ostan_Mushroom_count($id_ostan,$sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Mushroom_prod where id_ostan= '$id_ostan' and y_prod = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Mush = $stmt -> fetchColumn();
return $count_ostan_Mush ; 	

}
?>
<?php
function total_Mushroom_count($sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Mushroom_prod where y_prod = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_Mush = $stmt ->fetchColumn(); 
return $count_Mush ; 	
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Aquatic where id_ostan= '$id_ostan' and sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Aquatic where sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
?>
<?php
function ostan_bee_count($id_ostan,$sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM bee where id_ostan= '$id_ostan' and sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_bee = $stmt -> fetchColumn();
return $count_ostan_bee ; 	

}
?>
<?php
function total_bee_count($sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM bee where sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
<?php
function ostan_ind_count($id_ostan,$sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct NationalCode )   FROM ind_unit_prod where id_ostan= '$id_ostan' and y_prod = '$sal' and d_prod = '12'"  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_ind = $stmt -> fetchColumn();
return $count_ostan_ind ; 	

}
?>
<?php
function total_ind_count($sal)
{
include_once('../login/config.php');
$query = "SELECT count(distinct NationalCode )   FROM ind_unit_prod where y_prod = '$sal' and d_prod = '12' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ind = $stmt -> fetchColumn(); 
return $count_ind ; 	
