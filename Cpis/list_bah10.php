...
?>
  ...
  <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="40" colspan='2' align='center' bgcolor="#FFFFFF"><span class="style1">لیست بهره برداران تحت پوشش </span></td>
      </tr>
      <tr bgcolor='#f1f1f1' >
...
?></td>
      ...
      <tr >
        <td height="12" align="right" bgcolor="#F1F1F1" class="input_text" ><select dir="rtl"  name="id_mar" id="bakh" style="width:170px ; height:40px">
...
?>
   ...
   <?php if ($row['id_mar']==$id_mar) echo 'selected=selected'?>> <?php echo $row['mar'] ;?></option>
        ...
        <td height="47"  align='center' bgcolor="#F1F1F1" class="style8"><font size="2" class="style8">: مرکز خدمات</font></td>
      </tr>
      <tr >
        ...
        <td width="163" height="47"  align='center' bgcolor="#FFFFFF" class="style8">زمینه فعالیت</td>
      </tr>
      <tr >
...
$query = "SELECT * FROM  bah where  $v_id_ostan and  $v_id_city and $v_id_mar and $v_no_fa  ORDER BY BINARY last_name ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
