...
$r = 1 ;
 foreach($stmt as $row){
?>
    <td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> height="58" class="normalTextSmaller"><form  action="send_sms.php" method="post" onsubmit="target_popup(this)">
    ...
    <td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><form  action="send_pm.php" method="post">
      <input type="hidden" name="username" value="<?php echo $row['username'] ;?>" />
...
<td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="7%" class="normalTextSmaller">
    ...
    <td width="6%" class="normalTextSmaller"  <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php 
