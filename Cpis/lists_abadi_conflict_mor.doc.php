...
inner join users ON list_abadi.mor_cod_m = users.username and list_abadi.id_city != users.id_city where  $v_id_ostan and  $v_id_city and $v_id_mar group by list_abadi.mor_cod_m   ORDER BY  list_abadi.add_abadi ASC"; 
