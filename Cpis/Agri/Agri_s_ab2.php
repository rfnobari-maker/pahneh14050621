...
$query = "
    SELECT a.*, o.ostan
    FROM Agri_ab_ostan a
    JOIN ostanname o ON a.id_ostan = o.id_ostan
    WHERE a.z_sal = :z_sal
      AND a.group_cod = :mah_qroup
      AND a.product_cod = :mah_name
    ORDER BY FIELD(a.id_ostan,'03','04','24','10','30','16','18','23','31','14','29','09','28','06','19','20','11','07','26','25','12','08','05','17','27','01','15','02','00','22','13','21')
";
$stmt = $dbh->prepare($query);
$stmt->execute(array(
    ':z_sal'     => $z_sal,
...
?>
            ...
            <table class="agri-table">
              ...
              <tr>
                ...
                foreach($stmt as $row){
                $t_r = $r ;
                $id_ostan = $row['id_ostan'] ; // اضافه شدن id_ostan
                ?>
