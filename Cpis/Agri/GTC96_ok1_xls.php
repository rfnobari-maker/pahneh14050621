...
<body>
      <p align="center"  class="style8">گزارش تطبیقی گندم کاران 97-96
        <?php
 include_once('../../login/config.php');
  $query = "select * from GTC96_bah_ok_1 where 1  ORDER BY bah_cod_m ASC "; 
...
?>
      ...
      <table width="85%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#0099FF">
        <tr class="style8">
          <td align="center" width="7%" bgcolor="#CCCCCC">شماره تماس بهره بردار</td>
          <td align="center" width="6%" bgcolor="#CCCCCC">میزان فروش / تن</td>
          <td align="center" width="6%" bgcolor="#CCCCCC"> تولید قطعی /تن</td>
          <td align="center" width="6%" bgcolor="#CCCCCC"> پیش بینی تولید /تن</td>
          ...
          <td align="center" width="12%" bgcolor="#CCCCCC">نام و نام خانوادگی بهره بردار در سامانه </td>
