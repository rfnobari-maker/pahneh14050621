...
?>
            ...
            <table class="agri-table">
              <tr class="text1">
                ...
                <td width="17%" height="35" rowspan="2" bgcolor="#006699">استان </td>
              ...
              <?php
                  $diff_dem = $row['s_dem'] - $row['total_city_dem'];
                  $diff_abi = $row['s_abi'] - $row['total_city_abi'];

                  $color_dem = ($diff_dem >= 0) ? "#008000" : "#ff0000"; // green or red
                  $color_abi = ($diff_abi >= 0) ? "#008000" : "#ff0000"; // green or red
              ?>
              <tr style='font-weight:bold;'>
                <td height="46" colspan="2" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>></td>
                <td colspan="2" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>></td>
                <td class="normalTextSmall" style='color:<?php echo $color_dem; ?>;' align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $diff_dem; ?></td>
                <td class="normalTextSmall" style='color:<?php echo $color_abi; ?>;' align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $diff_abi; ?></td>
                <td class="normalTextSmall" align="right" style="padding-right: 20px;" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>> تراز</td>
              </tr>
              <?php
              $r++ ;
              }
