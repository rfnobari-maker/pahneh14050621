...
if (isset($_POST['ragham'])) $ragham = $_POST['ragham'];
...
?>
            ...
            <table width="90%"  align="center" class="my-table" >
              <tr class="text1">
                <td width="15%" height="38" rowspan="2" bgcolor="#006699">  تولید قطعی<br />
                  <span class="style3">تن </span></td>
                <td width="15%" rowspan="2" bgcolor="#006699">   پیش بینی تولید <br />
                <span class="style3">تن</span></td>
          <td width="16%" rowspan="2" bgcolor="#006699">   سطح برداشت<br />
            <span class="style3">هکتار</span></td>
          <td width="14%" rowspan="2" bgcolor="#006699"> سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td height="31" colspan="2" bgcolor="#006699">برنامه ابلاغی</td>
          <td width="14%" rowspan="2" bgcolor="#006699">نام استان</td>
          <td width="5%" rowspan="2" bgcolor="#006699">ردیف</td>
        </tr>
              <tr class="text1">
                <td width="9%" bgcolor="#006699">پیش بینی تولید<br />
                <span class="style3">تن </span></td>
...
$stmt->execute();
	?>
        <tr>
          <td height="38" rowspan="2" bgcolor="#006699" class="text1">  تولید قطعی<br />
            <span class="style3">تن </span></td>
          <td rowspan="2" bgcolor="#006699" class="text1">   پیش بینی تولید <br />
            <span class="style3">تن</span></td>
          <td rowspan="2" bgcolor="#006699" class="text1">   سطح برداشت<br />
            <span class="style3">هکتار</span></td>
          <td rowspan="2" bgcolor="#006699" class="text1"> سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td height="31" colspan="2" bgcolor="#006699" class="text1"  >برنامه ابلاغی</td>
          <td colspan="2" rowspan="2" bgcolor="#006699" class="text1"  >کل</td>
          </tr>
        <tr>
          <td bgcolor="#006699" class="text1">پیش بینی تولید<br />
            <span class="style3">تن </span></td>
          <td bgcolor="#006699" class="text1">سطح زیر کشت <br />
            <span class="style3">هکتار</span></td>
          </tr>
<?php 
foreach($stmt as $row){ 
