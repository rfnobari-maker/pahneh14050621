...
<body>
 ...
 include_once('../../login/config.php');
  $query = "SELECT 
Vege_prod.bah_cod_m,Vege_prod.cod_mah
,sum(Vege_prod.zer_kesht) as zer_kesht
,sum(Vege_prod.mah_tol) as mah_tol
,Vege_prod.mah_bem FROM Vege_prod 
inner join zanjan_bah on zanjan_bah.bah_cod_m = Vege_prod.bah_cod_m
WHERE Vege_prod.id_ostan='19' and Vege_prod.z_sal = '1398-1399'  and Vege_prod.mah_tol>0 
group by  Vege_prod.cod_mah ,Vege_prod.bah_cod_m"; 
