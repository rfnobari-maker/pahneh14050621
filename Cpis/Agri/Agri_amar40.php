...
if ($id_ostan1 == '') 
{
echo $query = "SELECT id_ostan, no_kesh ,
...
where cod_qroup ='$mah_qroup' Group by id_ostan
...
sum(mah_tolp) mahtolp 
FROM $Agri_prod_table
where id_ostan = '$id_ostan1'  and  cod_qroup ='$mah_qroup'
Group by id_city
 "  ;
