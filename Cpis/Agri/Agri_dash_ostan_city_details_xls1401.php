...
<body>
<div align="center" dir="rtl">اطلاعات محصولات زراعی سال 1402-1401 به تفکیک استان و شهرستان </div> 
<?php
 $query = "SELECT z_sal,id_ostan,id_city,cod_mah,cod_qroup,no_kesh,sum(s_bar_a+s_bar_b)
 as sb , sum(mah_tol) as mah_tol FROM Agri_prod1401_1402 WHERE mah_tol>0  group by id_ostan  , id_city
