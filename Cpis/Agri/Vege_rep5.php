...
if (isset($_POST['ra_kesh'])) $ra_kesh = $_POST['ra_kesh'];
if (isset($_POST['z_sal'])) $z_sal = $_POST['z_sal'];
if (isset($_POST['b_time'])) $b_time = $_POST['b_time'];
if (isset($_POST['no_ab'])) $no_ab = $_POST['no_ab'];
if (isset($_POST['dah_bazar'])) $dah_bazar = $_POST['dah_bazar'];
if (isset($_POST['mah_bazar'])) $mah_bazar = $_POST['mah_bazar'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style8">گزارش تولید به تفکیک شهرستان و رقم</span><br />
      </p>
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56">
                 <form  action="Vege_rep5_xls.php" method="post">
                ...
                <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
                 ...
                 <td width="56"><form  action="Vege_rep5_doc.php" method="post">
                   <input type="hidden" name="id_ostan"  value="<?php echo  $id_ostan1 ;?>" />
                   <input type="hidden" name="ra_kesh"   value="<?php echo  $ra_kesh ;?>" />
                   <input type="hidden" name="z_sal"     value="<?php echo $z_sal ;?>" />
                   <input type="hidden" name="b_time" value="<?php echo $b_time;?>" />
            ...
            <table width="90%"  align="center" class="my-table" >
              <tr class="text1">
                <td width="11%" height="38" bgcolor="#006699"> مجموع تولید قطعی<br />
                  <span class="style3">تن </span></td>
                <td width="14%" bgcolor="#006699"> مجموع  پیش بینی تولید <br />
                <span class="style3">تن</span></td>
          <td width="14%" bgcolor="#006699"> مجموع  سطح برداشت<br />
            <span class="style3">هکتار</span></td>
          <td width="13%" bgcolor="#006699">مجموع  سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td width="15%" bgcolor="#006699">نام رقم</td>
          <td width="15%" bgcolor="#006699"> شهرستان</td>
          <td width="14%" bgcolor="#006699">استان</td>
...
switch ($mah_name) {
  ...
  ?>
          ...
          <td  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $v_ragham ; ?></td>
	...
	?>
        <tr>
          ...
          <td bgcolor="#006699" class="text1">مجموع  سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td bgcolor="#006699" class="text1">&nbsp;</td>
