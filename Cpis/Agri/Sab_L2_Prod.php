...
// تعریف ثابت برای ID استان مورد نظر
$id_ostan_target = '18';
    ...
    <td  colspan="3" valign="middle" >
      ...
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 350px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 <td height="48" align="right" bgcolor="#FFFFFF" class="input_text" ><select name="id_ostan" class="input_text" id="ostan" style="width:170px ; height:40px" dir="rtl" >
                 ...
                 <td  align='center' bgcolor="#FFFFFF" class="style8"><span class="style8"> : استان</span></td>
               </tr>
