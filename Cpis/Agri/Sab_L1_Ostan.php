...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style8"> مشاهده برنامه الگوی کشت ابلاغی محصولات زراعی به تفکیک استان</span><br />
      </p>
...
?>
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td><form  action="Sab_L1_kol" method="post">
...
$(function() {
  $(".submit<?php echo $no ?>").click(function() {
    ...
    const dataString = `s_abi=${s_abi}&s_dem=${s_dem}&t_abi=${t_abi}&t_dem=${t_dem}&a_abi=${a_abi}&a_dem=${a_dem}&id=${id}&id_ostan=${id_ostan}&z_sal=${z_sal}`;
