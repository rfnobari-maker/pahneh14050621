...
header("Content-Disposition: attachment;Filename='اطلاعات_صیفی_استان.xls");
include('../../lock_cp.php');
include('../../event.php');
...
<body>
<div align="center" dir="rtl">اطلاعات محصولات صیفی سال 1402-1401 به تفکیک استان </div> 
<?php
 $query = "SELECT z_sal,id_ostan,cod_mah,sum(s_bar)
 as sb , sum(mah_tol) as mah_tol FROM Vege_prod WHERE z_sal = '1401-1402' 
 and s_bar > 0  group by id_ostan   ,cod_mah  "  ;
