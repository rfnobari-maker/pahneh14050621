...
header("Content-Disposition: attachment;Filename=اطلاعات_زراعی_آبادی_محصول.xls");
include('../../lock_cp.php');
...
ORDER BY id_ostan,id_city,add_deh,add_abadi"; 
...
<table width="90%" height="90" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr align="center" class="text1">
    ...
    <td width="7%" bgcolor="#999999">آبادی</td>
    ...
    <td width="4%" bgcolor="#999999">آدرس آبادی</td>
...
<td align="center" height="40" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['mah_tol'];?></td>
 ...
 <td align="center" class="normalTextSmaller" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo $row['abadi'];?></td>
 ...
 <td align="center" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo '"'.$row['add_abadi'].'"';?></td>
