...
?>
            ...
            <table width="95%" height="90" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             ...
             <tr align="center" class="text1">
               ...
               <td width="8%" height="20" bgcolor="#999999">جمع</td>
...
?>
               ...
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php if($row['cod_qroup'] == '4') echo group_name_amar($row['cod_qroup']).'**'; else echo group_name_amar($row['cod_qroup']);?>                 <br /></td>
