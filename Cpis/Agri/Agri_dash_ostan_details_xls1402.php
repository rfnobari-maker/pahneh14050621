...
<body>
<div align="center" dir="rtl">اطلاعات محصولات زراعی سال 1403-1402 به تفکیک استان براساس کدینگ سامانه </div> 
<?php
 $query = "SELECT z_sal,id_ostan,cod_mah,cod_qroup,no_kesh,sum(s_bar_a+s_bar_b)
 as sb , sum(mah_tol) as mah_tol FROM Agri_prod1402_1403 WHERE mah_tol>0  group by id_ostan 
