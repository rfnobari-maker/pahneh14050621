 ...
 <p align="center" style="color:#900 ; font-family:Tahoma; font-size:12px" ><?php echo $mess ?><span class="style21"><a name="1" id="1"></a></span></p>
       ...
       <div id="box">
        <table width="491" border="0" align="center">
          <tr>
            <td width="250" height="49" colspan="2"><span class="input_text"><div align="right" dir="rtl">
...
?>
   ...
   <?php if ($row['id_ostan']==$id_ostan) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
            ...
            <td><div align="right" class="style8">: استان</div></td>
          </tr>
          <tr>
            <td height="49" colspan="2"><span class="input_text">
...
?>
   ...
   <?php if ($row['id_city']==$id_city) echo 'selected=selected'?>> <?php echo $row['city'] ;?></option>
          ...
          <tr>
            <td height="49" colspan="2"><div align="right" dir="rtl">
              <p>
                <select name="s_access" class="input_text" id="s_access" style="width:200px ; height:40px">
                  ...
                  <option value="2" <?php if ($s_access=='2') echo 'selected=selected'?>>رئیس مراکز جهاد کشاورزی</option>
                  <option value="3" <?php if ($s_access=='3') echo 'selected=selected'?>>مدیر شهرستان جهاد کشاورزی</option>
                  <option value="4" <?php if ($s_access=='4') echo 'selected=selected'?>>مدیر استانی سامانه</option>
                  <option value="5" <?php if ($s_access=='5') echo 'selected=selected'?>>مدیر کشوری سامانه </option>
                  <option value="98" <?php if ($s_access=='98') echo 'selected=selected'?>>کاربر admin استان </option>
                </select>
              </p>
            </div></td>
            <td><div align="right" class="style8">:گروه</div></td>
          </tr>
          <tr>
   ...
   <tr>
     <td width="129" height="24" class="style2">حداکثر حجم :<span class="RedTitleSmaller"> 500</span> <span class="RedTitleSmaller">کیلو بایت</span></td>
...
echo $query = "SELECT username from users where S_access = $s_access and $v_id_ostan and $v_id_city  ";
$stmt = $dbh->prepare($query);
$stmt->execute();
 foreach($stmt as $row){
 $r_user  = $row['username']; 
