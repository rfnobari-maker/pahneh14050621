...
<p class="style8">گزارش خلاصه روزانه</p>
...
?></td>
                 <td width="111"  align='center' bgcolor="#DDDDDD" class="style8">:اساس گزارش</td>
               </tr>
               <tr >
...
?>
 ...
 <table width="85%" height="248" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td bgcolor="#999999"> افزایش یا کاهش تعداد بهره بردار نسبت به روز قبل</td>
               <td bgcolor="#999999">مساحت گلخانه در روز قبل/ مترمربع</td>
               <td bgcolor="#999999">تعداد بهره بردار در روز قبل (نفر)</td>
               <td width="12%" bgcolor="#999999">مساحت گلخانه در روز جاری/ مترمربع</td>
               <td width="11%" bgcolor="#999999">تعداد بهره بردار در روز جاری (نفر)</td>
<?PHP if($Base != '-1') {?> 
