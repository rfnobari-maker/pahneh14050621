...
?>
  ...
  <td width="8%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="ostan_benef.php" method="post" onsubmit="return ray.ajax()">
...
?>
  <tr>
    <td colspan="4" rowspan="2" bgcolor="#CCCCCC" class="normalTextSmaller">&nbsp;</td>
    <td height="44"  class="RedTitleSmall"  >بهره بردار</td>
    <td  class="RedTitleSmall"  >آبادی</td>
    <td  class="RedTitleSmall"  >شهر</td>
    <td  class="RedTitleSmall"  >کارشناس  پهنه<br />
    </td>
    <td  class="RedTitleSmall"  >مرکز</td>
    <td  class="RedTitleSmall"  >شهرستان</td>
    <td colspan="5" rowspan="2"   class="morph">جمع کل</td>
    </tr>
  <tr>
    <td height="22"  class="normalTextSmaller"  ><?php echo kol_bah_count();?></td>
