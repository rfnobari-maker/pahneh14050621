...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_ostan_city = $result->fetchColumn(); 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_ostan_mar = $result->fetchColumn(); 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_city_mar = $result->fetchColumn(); 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_ostan = $result->fetchColumn(); 
return $count_ostan ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_city_ostan = $result->fetchColumn(); 
return $count_city_ostan ; 	
...
{
include_once('../login/config.php');
$query = "SELECT count(DISTINCT add_city) FROM list_city WHERE  id_ostan = '$id_ostan' "  ;
$result = $dbh->prepare($query); 
$result->execute(); 
$count_shahr = $result->fetchColumn(); 
return $count_shahr ; 	
...
{
include_once('../login/config.php');
$query = "SELECT  count(DISTINCT add_city) FROM public_city WHERE  id_ostan = '$id_ostan' "  ;
$result = $dbh->prepare($query); 
$result->execute(); 
$count_shahr = $result->fetchColumn(); 
return $count_shahr ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_abadi = $result->fetchColumn(); 
return $count_abadi ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_jens_mor = $result->fetchColumn(); 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$city_bah_count = $result->fetchColumn(); 
return $city_bah_count ; 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$city_bee_count = $result->fetchColumn(); 
return $city_bee_count ; 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$shahr_count = $result->fetchColumn(); 
return $shahr_count ; 
...
$result = $dbh->prepare($query); 
$result->execute(); 
$abadi_bah_count = $result->fetchColumn(); 
return $abadi_bah_count ; 
...
{
include_once('../login/config.php');
$query = "SELECT count(*) FROM public_abadi4  "  ;
$result = $dbh->prepare($query); 
$result->execute(); 
$kol_abadi = $result->fetchColumn(); 
...
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT count(*) FROM Agri where id_ostan= '$id_ostan' and z_sal = '$z_sal' "  ;
$result = $dbh->prepare($query); 
$result->execute(); 
$count_ostan_Agri = $result->fetchColumn(); 
...
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT count(*) FROM Agri where z_sal = '$z_sal' "  ;
$result = $dbh->prepare($query); 
$result->execute(); 
$count_Agri = $result->fetchColumn(); 
return $count_Agri ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_Garden = $result->fetchColumn(); 
return $count_Garden ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_Greenhouse = $result->fetchColumn(); 
return $count_Greenhouse ; 	
...
$result = $dbh->prepare($query); 
$result->execute(); 
$count_Aquatic = $result->fetchColumn(); 
...
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Agri where z_sal = '$z_sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Agri = $stmt -> fetchColumn(); 
return $count_ostan_Agri ; 	
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Garden where z_sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Garden = $stmt -> fetchColumn(); 
return $count_ostan_Garden ; 	
...
{
include_once('../login/config.php');
$query = "SELECT count(distinct bah_cod_m ,add_abadi,add_city)   FROM Greenhous where sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
