...
header("Content-Disposition: attachment;Filename=فرم های ثبت شده.xls");
include('../lock_cp.php');
include('counter.php');
$sal = $_POST['sal'] ; 
?>
...
$stmt->execute();
?>
<p align="center" class="style8">فرم های ثبت شده به تفکیک استان و نوع بهره برداری  در <?php echo $sal ?></p>
