   ...
   if(isset($_POST['action']))
{
 ...
 if ($sh_meli == '')  { $v_sh_meli  = 1      ; }else{ $v_sh_meli = "sh_meli = '$sh_meli'" ;}
$start=0;
$limit=25;
if(isset($_GET['id']))
{
...
$query = "SELECT * FROM  bah where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city  and $v_mor_cod_m and $v_bah_cod_m and $v_sh_meli ORDER BY BINARY last_name ASC LIMIT $start, $limit "; 
$query1 = "SELECT * FROM  bah where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $v_mor_cod_m and $v_bah_cod_m and $v_sh_meli ORDER BY BINARY last_name ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
      ...
      <td height="57" bgcolor="#999999"><p>مشاهده</p>
        <p>اطلاعات</p></td>
      <td width="10%" bgcolor="#999999">وضعیت رکورد</td>
      <td width="10%" bgcolor="#999999">کارشناس مروج</td>
      <td height="57" bgcolor="#999999">شماره همراه</td>
      <td width="10%" bgcolor="#999999"> کد ملی/ شناسه ملی<br /></td>
      <td width="12%" bgcolor="#999999">نام خانوادگی / نام شرکت</td>
...
?>
      ...
      <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo $row['ok'];?></td>
