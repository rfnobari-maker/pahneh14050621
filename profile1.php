 ...
 ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" >
                <tr>
                      <td width="282" height="235" align="center" bgcolor="#FFFFCC"><p align="justify" class="normalTextSmall"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >تصویر کاربر </p>
    ...
    <input type="hidden" name="cod_p" style="height:26px ; width:150px ; background:#0CF ; font-size:12px ; font-family:Tahoma ; font-size:14px; vertical-align:middle" dir="rtl"  value="<?php echo $cod_p ;?>" />
          <table style="border:3px solid #069;" width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="38" colspan="5" align="center"><img src="Centers/files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="42"><div align="right">
                <input name="cod_p2" type="text" class="required" id="cod_p" style="width:150px; height:30px ; " tabindex="14" dir="rtl" lang="fa" value="<?php echo $cod_p ; ?>" maxlength="35" xml:lang="fa"/>
              </div></td>
            ...
            <tr>
              <td height="38"><div align="right"><span class="style2"><img src="Centers/files/sms.png" width="25" height="25" /></span>
...
?>
<form name="myform" class="myform" method="post" action="Centers/index.php">
</form>
