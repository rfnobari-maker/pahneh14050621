...
<body onload="new_captcha();">
    ...
    <div class="login-container">
        <div class="login-header">
          <img src="../files/jahad.png" alt="Logo" style="width: 150px; margin-bottom: 15px;">
          <h2>مرکز فاوا</h2>
        ...
        <form action="" method="post" class="login-form">
            ...
            <div class="captcha-container">
                <input name="security_code" type="text" id="security_code" placeholder="کد امنیتی" tabindex="3" autocomplete="off" required>
    ...
    <div class="news-links-container">
        ...
        <div class="news-section">
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/>آخرین تقسیمات کشوری مرکز آمار ایران در سال <span class="style8">1403</span>در سامانه اعمال و به‌روزرسانی گردید</p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/>امکان ثبت و ویرایش اطلاعات عملکرد گلخانه و واحد پرورش قارچ <span class="style8">1404</span>فعال  شد</p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/>امکان ثبت و ویرایش اطلاعات گلخانه و واحد پرورش قارچ  <span class="style8">1403</span>مسدود  شد</p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/> ثبت و ویرایش اطلاعات زراعی و صیفی <span class="style8">1405-1404 </span> فعال شد</p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/><a href="help/ab_1404.pdf" target="new" class="link">ابلاغیه معاون محترم وزیر در خصوص برنامه الگوی کشت محصولات زراعی سال 1405-1404 </a></p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/> ثبت و ویرایش اطلاعات مزارع تکثیر و پرورش آبزیان <span class="style8"> 1404 </span> فعال  شد </p>
            <p dir="rtl"><img src="../files/jadid.gif" width="35" height="15"  alt=""/> ثبت و ویرایش اطلاعات مزارع تکثیر و پرورش آبزیان <span class="style8"> 1403 </span> مسدود  شد </p>
