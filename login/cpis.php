...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    require_once dirname(__FILE__) . '/sys_access.php';
    ...
    if (strcmp(md5($security_code_input), $captcha_session) != 0) {
        ...
        $r = pahneh_sys_fetch_user($dbh, $myusername);
        ...
        if ($r) {
            ...
            if ($p == $salted_hash) {
                ...
                if ($access == 1) {
                    if (!pahneh_sys_can($r, 'cpis')) {
                        $error = "دسترسی شما به سامانه الگوی کشت فعال نیست";
                    } else {
...
<div class="footer-container">
  <p>پشتیبانی: <a href="tel:02143541691">۴۳۵۴۱۶۹۱-۰۲۱</a></p>
   ...
   <div id="modal" class="modal">
    ...
    const images = ['5.jpg', '3.jpg', '4.jpg', '6.jpg', '7.jpg' , '8.jpg'];
