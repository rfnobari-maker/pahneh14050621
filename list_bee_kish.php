...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
      ...
      <tr >
        ...
        <td height="47" align="right" bgcolor="#FFFFFF" class="style1" ><font size="2" class="style8">: جنسیت زنبوردار</font></td>
        <td height="47" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
...
where  $v_id_ostan  and  $v_m_ostan and  $v_m_city and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi
and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  and $v_jens ORDER BY bah_cod_m ASC
LIMIT $start, $limit ";
// SELECT * FROM  bee where  $v_id_ostan  and $v_m_ostan and $v_m_city  and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  ORDER BY bah_cod_m ASC 
 

$query1 = "SELECT bee.*,bah.m_tah,bah.date_t,bah.tel_m,bah.m_tah,bah.name,bah.last_name,ostanname.ostan,cityname.city,bah.jens,bah.no_bah 
FROM  bee 
left join bah on bah.bah_cod_m = bee.bah_cod_m and bah.num_bah = bee.num_bah
left join ostanname on bee.id_ostan = ostanname.id_ostan 
left join cityname on bee.id_ostan = cityname.id_ostan and  bee.id_city = cityname.id_city
