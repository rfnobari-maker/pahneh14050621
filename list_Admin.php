...
<body>
  ...
  <tr>
    ...
    <td width="840" >
 <?php include('top.php'); ?>
<p align="center" ><span class="style1">ادمین استان  </span></p>
 <p align="center" ><img src="files/horizontal-line-700x223.png" width="700" height="19"  alt=""/><br />
 <p class="style8"> <?php echo $_POST['mess'] ; ?></p>
 <p>
   <?php 
  $query = "SELECT username,name,Last_name,pic,tel_m,cod_m,id_city  FROM  users WHERE  id_ostan = '$id_ostan' and S_access = '98'  " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count = $stmt -> rowCount();
if($count>0){
?>
   <span class="RedTitleSmall">ادمین استانی سامانه</span><br />
 </p>
