...
header("Content-Disposition: attachment;Filename=لیست بهره برداران زراعی.xls");
?>
<?php 
include('../../lock_p3.php');
include('../../event.php') ;
...
$query = "SELECT id,id_ostan,id_city,add_abadi,add_city,bah_cod_m,m_cod_m,mor_cod_m,sh_gat,no_mal,no_kesh,m_zamin,t_mah,z_sal from Agri where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_no_kesh and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal ORDER BY id ASC";
