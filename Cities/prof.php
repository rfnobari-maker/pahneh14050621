    ...
    <div class="container">
        ...
        <div class="content-section">
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="Promotion" title="ترویج">
                        <img src="../files/farmer-512.png" alt="ترویج" class="card-icon">
                    </a>
                    <a href="Promotion" class="btn">ترویج</a>
                </div>
            </div>
        </div>
