                                ...
                                foreach($centers as $row){
                                    ...
                                    $show_buttons = false;
                                       ...
                                       if ($row['promoter_count'] > 0 && $row['promoter_count'] == $row['confirmed_promoter_city']) {
                                        $status_img = 'ok.png';
                                        $status_title = 'اطلاعات مرکز قبلاً تایید شده است';
                                    } elseif ($row['promoter_count'] > 0 && $row['promoter_count'] == $row['unconfirmed_promoter_city']) {
                                        $status_img = 'notok.png';
                                        $status_title = 'عدم تائید اطلاعات مرکز قبلاً ثبت شده است';
                                    } else {
                                        ...
                                        if ($row['promoter_count'] > 0 && $row['promoter_count'] == $row['confirmed_promoter_count']) {
                                            ...
                                            $status_img = 'lock.gif';
                                            $status_title = 'بعلت عدم تایید اطلاعات کلیه مروجین توسط رئیس مرکز ، امکان تایید وجود ندارد';
                                        }
                                    }
                                ?>
                                <tr>
                                    <td height="58" class="normalTextSmaller" <?php echo $row_bg_color; ?>>
                                        <form action="../send_pm2.php#1" method="post" onsubmit="target_Agri17(this)">
                                    ...
                                    <td <?php echo $row_bg_color; ?>><?php echo htmlspecialchars($row['markaz']); ?><br /><?php echo htmlspecialchars($row['id_mar']); ?><br /></td>
