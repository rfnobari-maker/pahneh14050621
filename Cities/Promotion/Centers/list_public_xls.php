...
<tr>
  <td>
      <?php 
if ($id_ostan == 0) { $v_id_ostan = 'id_ostan' ;} else { $v_id_ostan = "id_ostan='$id_ostan'" ;}
...
?>
    ...
    <tr align="center" class="text_r">
      <td width="3%" bgcolor="#999999">آدرس مرکز</td>
    <td width="3%" bgcolor="#999999">غالب دامی3</td>
    <td width="3%" bgcolor="#999999">غالب دامی 2</td>
    <td width="3%" bgcolor="#999999">غالب دامی 1</td>
    <td width="3%" bgcolor="#999999">غالب باغی 3</td>
    <td width="4%" bgcolor="#999999">غالب باغی 2</td>
    <td width="4%" bgcolor="#999999">غالب باغی1</td>
    <td width="3%" bgcolor="#999999">غالب زراعی3</td>
    <td width="3%" bgcolor="#999999">غالب زراعی2</td>
    <td width="3%" height="42" bgcolor="#999999">غالب زراعی1</td>
    <td width="4%" bgcolor="#999999">فعالیت غالب</td>
    <td width="5%" bgcolor="#999999">فاصله نزدیکترین آبادی<br /></td>
    <td width="5%" bgcolor="#999999">فاصله دورترین آبادی<br /></td>
    <td width="4%" bgcolor="#999999">فاکس</td>
    <td width="4%" bgcolor="#999999">تلفن</td>
    <td width="4%" bgcolor="#999999">کد پستی</td>
    <td width="4%" bgcolor="#999999">عرض جغرافیایی</td>
    <td width="4%" bgcolor="#999999">طول جغرافیایی</td>
    <td width="5%" bgcolor="#999999">سال تاسیس</td>
    <td width="3%" bgcolor="#999999">سطح مرکز</td>
