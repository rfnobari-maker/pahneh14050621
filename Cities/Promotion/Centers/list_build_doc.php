...
header("Content-Disposition: attachment;Filename=build_list.doc");
?>
<?php 
include('../../../lock_p3.php');
include('../../../event.php') ;
...
$query = "SELECT * FROM  promo_cent_build where  $v_id_ostan and  $v_id_city order by id_ostan,id_city "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
        <p align="center">اطلاعات ساختمان مراکز</p>
