...
if($sql->execute()){
echo "<font face='Tahoma' size='16px' color=green ><center>رمز شما با موفقیت تغییر یافت <br> جهت ارتقاء امنیت اطلاعات ، لطفا در بازه های زمانی محدود نسبت به تغییر مجدد رمز خود اقدام نمایید <br> اکنون با کلیک دکمه برگشت از سامانه خارج شده و مجددا با کلمه عبور جدید وارد شوید
</center>";
...
?>
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
 <p>&nbsp;</p><p><a href="../index.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>        <p>&nbsp;</p>
      <p>&nbsp;</p></td>
  </tr>
  <tr>
