...
?></td>
      ...
      <tr bgcolor='#f1f1f1' >
        <td rowspan="2" align="right" bgcolor="#FFFFFF" class="input_text" >
          ...
          <select  name="id_city" disabled="disabled" id="id_city" style="width:170px ; height:40px" dir="rtl">
...
?>
   ...
   <?php if ($row['id_city']==$id_city) echo 'selected=selected'?>> <?php echo $row['city'] ;?></option>
      ...
      <tr >
        <td height="46"  align='center' bgcolor="#FFFFFF" class="style8">&nbsp;</td>
      </tr>
      </table>
  </div>
  <p>
...
if ($add_deh == 0) { $v_add_deh = 'add_deh=add_deh' ;} else { $v_add_deh = "add_deh='$add_deh'" ;}
  $query = "SELECT mar,city,ostan,id_mar,id_city,id_ostan FROM  mar where  $v_id_ostan and  $v_id_city order by id_ostan,id_city "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
  ...
  <table width="95%" height="168" border="0" align="center" cellpadding="0" cellspacing="2" >
...
?>
      ...
      <td width="6%" height="81" class="tilt" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>>
      ...
      <td width="8%" height="81" class="tilt" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>>
