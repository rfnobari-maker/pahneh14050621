    ...
    <div class="container">
        ...
        <div class="content-section">
            ...
            <?php  if(strstr($perm,'Bsh')) { ?>
              ...
              <div class="card">
                    <a href="Garden_s_ab" title="ثبت برش مراکز جهاد کشاورزی ">
                        <img src="../../files/region.png" alt="مشاهده برش مراکز جهاد کشاورزی " class="card-icon">
                    </a>
                    <a href="Garden_s_ab" class="btn">ثبت برش مراکز جهاد کشاورزی </a>
                </div>
            </div>
