...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h1 class="section-title">باغبانی</h1>
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="Garden_rep17.php" title="گزارش ویژه محصولات باغی">
                ...
                <div class="card">
                    <a href="Greenhous.php" title="گلخانه">
                        <img src="../../files/greenhous.png" alt="گلخانه" class="card-icon">
                    </a>
                    <a href="Greenhous.php" class="btn">گلخانه</a>
                </div>
                <div class="card">
                    <a href="Mushroom.php" title="پرورش قارچ خوراکی">
                        <img src="../../files/mushroom.png" alt="پرورش قارچ خوراکی" class="card-icon">
                    </a>
                    <a href="Mushroom.php" class="btn">پرورش قارچ خوراکی</a>
                </div>
            </div>
        </div>
