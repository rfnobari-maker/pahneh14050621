...
<body>
      <p align="center"  class="style8">گزارش اختصاصی محصولات گلخانه 
        <?php
...
where  $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesht  and $v_mor_cod_m and $v_bah_cod_m and 
 ...
 and $v_mtol1 and $v_mtol2  ORDER BY bah_cod_m ASC"; 
...
?>
      ...
      <table width="85%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#0099FF">
        <tr class="style8">
          ...
          <td align="center" width="4%" bgcolor="#CCCCCC">پایان برداشت </td>
          <td align="center" width="4%" bgcolor="#CCCCCC">شروع برداشت</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">پایان کشت</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">شروع کشت</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">سطح زیر کشت <br />
مترمربع</td>
          <td align="center" width="6%" bgcolor="#CCCCCC">نوع کشت</td>
          ...
          <td width="15%" align="center" bgcolor="#CCCCCC" class="text_r">نام خانوادگی</td>
          <td width="15%" align="center" bgcolor="#CCCCCC" class="text_r">نام</td>
...
if ($row['date_2_bar'] == '12') $n_date_2_bar = 'اسفند' ;
  ...
  ?>
          ...
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mah_name_green($row['mah_cod']) ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(($row['m_tol'] / ($row['s_kesh']/10000)),2) ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['m_tol'],4)*1 ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $n_date_2_bar ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $n_date_1_bar ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $n_date_2_kesh ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $n_date_1_kesh  ; ?></td>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['s_kesh']+0 ; ?></td>
