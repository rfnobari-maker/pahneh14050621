            ...
            <div class="cards-container">
                <div class="card">
                    <a href="liste_Greenhousn.php" title="لیست واحدهای گلخانه">
                        <img src="../../files/greenhous.png" alt="لیست واحدهای گلخانه" class="card-icon">
                    </a>
                    <a href="liste_Greenhousn.php" class="btn">لیست واحدهای گلخانه</a>
                </div>
                <div class="card">
                    <a href="list_Greenhous_nonP.php" title="لیست واحدهای فاقد عملکرد">
                        <img src="../../files/inactive_abadi.png" alt="لیست واحدهای فاقد عملکرد" class="card-icon">
                    </a>
