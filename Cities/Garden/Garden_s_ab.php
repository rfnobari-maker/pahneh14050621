...
<body>
                                ...
                                <tr id="row-<?php echo $r; ?>">
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <form name="form<?php echo $r; ?>">
                                            ...
                                            <input name="submit" type="submit" class="submit-btn submit<?php echo $r; ?>" id="submit<?php echo $r; ?>" style="width:40px; height:35px; font-size:14px; color:#900; font-family:tahoma; text-align:center" tabindex="<?php echo ($r*10+11); ?>" value="ثبت" />
                                    ...
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="a_dem" type="text" class="style8" id="a_dem<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+10); ?>" dir="rtl" lang="fa" value="" maxlength="8" align="baseline" xml:lang="fa" readonly />
                                    </td>
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="a_abi" type="text" class="style8" id="a_abi<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+9); ?>" dir="rtl" lang="fa" value="" maxlength="8" align="baseline" xml:lang="fa" readonly />
                                    </td>
                                    
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="t_dem" type="text" class="input-field t_dem<?php echo $r; ?> required number" id="t_dem<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+8); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['t_dem'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                                        <div class="balance-info" id="info_t_dem_<?php echo $r; ?>"></div>
                                    </td>
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="t_abi" type="text" class="input-field t_abi<?php echo $r; ?> required number" id="t_abi<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+7); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['t_abi'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                                        <div class="balance-info" id="info_t_abi_<?php echo $r; ?>"></div>
                                    </td>
                                    
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="s_bar_dem" type="text" class="input-field s_bar_dem<?php echo $r; ?> required digits" id="s_bar_dem<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+6); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['s_bar_dem'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                                        <div class="balance-info" id="info_s_bar_dem_<?php echo $r; ?>"></div>
                                    </td>
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="s_bar_abi" type="text" class="input-field s_bar_abi<?php echo $r; ?> required digits" id="s_bar_abi<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+5); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['s_bar_abi'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                                        <div class="balance-info" id="info_s_bar_abi_<?php echo $r; ?>"></div>
                                    </td>
                                    
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="s_nobar_dem" type="text" class="input-field s_nobar_dem<?php echo $r; ?> required digits" id="s_nobar_dem<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+4); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['s_nobar_dem'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                                        <div class="balance-info" id="info_s_nobar_dem_<?php echo $r; ?>"></div>
                                    </td>
                                    <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'; ?>>
                                        <input name="s_nobar_abi" type="text" class="input-field s_nobar_abi<?php echo $r; ?> required digits" id="s_nobar_abi<?php echo $r; ?>" style="width:80px; height:30px;" tabindex="<?php echo ($r*10+3); ?>" dir="rtl" lang="fa" value="<?php echo htmlspecialchars($row['s_nobar_abi'] * 1, ENT_QUOTES, 'UTF-8'); ?>" maxlength="8" align="baseline" xml:lang="fa" />
                            ...
                            <div dir="rtl" class="pagination-container" style="text-align:center; margin: 20px auto;">
                                <ul class="pagination" style="display: flex; list-style: none; justify-content: center; flex-wrap: wrap; gap: 5px; padding: 0;">
                                    ...
                                    <li>
                                        ...
                                        <?php else: ?>
                                            <form action="Garden_s_ab.php?id=<?php echo $i; ?>#1" method="post">
                                                <input type="hidden" name="action" value="1" />
                                                <input type="hidden" name="id_ostan" value="<?php echo htmlspecialchars($id_ostan1, ENT_QUOTES, 'UTF-8'); ?>" />
                                                <input type="hidden" name="id_city" value="<?php echo htmlspecialchars($id_city, ENT_QUOTES, 'UTF-8'); ?>" />
                                                <input type="hidden" name="id_mar" value="<?php echo htmlspecialchars($id_mar, ENT_QUOTES, 'UTF-8'); ?>" />
                                    ...
                                    <?php if ($end_page < $total): ?>
                                        ...
                                        <?php endif; ?>
                                        <li>
                                            <form action="Garden_s_ab.php?id=<?php echo $total; ?>#1" method="post">
                                                <input type="hidden" name="action" value="1" />
                                                <input type="hidden" name="id_ostan" value="<?php echo htmlspecialchars($id_ostan1, ENT_QUOTES, 'UTF-8'); ?>" />
                                                <input type="hidden" name="id_city" value="<?php echo htmlspecialchars($id_city, ENT_QUOTES, 'UTF-8'); ?>" />
                                                <input type="hidden" name="id_mar" value="<?php echo htmlspecialchars($id_mar, ENT_QUOTES, 'UTF-8'); ?>" />
                            ...
                            <script>
                                document.querySelector('.pagination-container form[action="Garden_s_ab.php"]').addEventListener('submit', function(e) {
                                    ...
                                    if (isNaN(value) || value < 1 || value > <?php echo $total; ?>) {
                                        ...
                                        this.action = 'Garden_s_ab.php?id=' + value + '#1';
                                    }
                                });
                            </script>
    ...
    <script>
    // ============================================================
    // توابع کمکی - اصلاح شده برای پشتیبانی کامل از ممیز
    // ============================================================
    function formatNumberWithSeparator(num) {
        if (num === '' || num === null || num === undefined) return "";
        
        var cleanStr = String(num).replace(/٬/g, '').replace(/,/g, '');
        var number = parseFloat(cleanStr);
        
        if (isNaN(number)) return "";
        if (number === 0) return "0";
        
        var rounded = parseFloat(number.toFixed(4));
    ...
    function unformatNumber(str) {
        if (!str || str === '') return "0";
        var clean = String(str).replace(/٬/g, '').replace(/,/g, '').trim();
        if (clean === '') return "0";
        return clean;
    }
    ...
    // ============================================================
    function calcRow<?php echo $no ?>(row) {
        // دریافت مقادیر
    ...
    function setMaxValue<?php echo $no ?>(field, maxValue) {
        var row = <?php echo $no ?>;
        var formattedValue = formatNumberWithSeparator(maxValue);
        $('#' + field + row).val(formattedValue);
        $('#' + field + row).trigger('change');
        $('#' + field + row).focus();
    }
    
    // ============================================================
    // مدیریت رویدادها (۶ فیلد باغی) - با محاسبه عملکرد
    // ============================================================
    $(document).ready(function() {
        ...
        ['s_bar_abi', 's_bar_dem', 's_nobar_abi', 's_nobar_dem', 't_abi', 't_dem'].forEach(function(field) {
            ...
            // رویداد تغییر (برای اعتبارسنجی و محاسبه عملکرد)
            input.on('change', function() {
                ...
                // محاسبه عملکرد پس از هر تغییر
                calcRow<?php echo $no ?>(row);
            });
            
            // رویداد تایپ (برای فرمت کردن اعداد)
            var timer;
            input.on('input', function() {
                ...
                // اعتبارسنجی با تاخیر (برای جلوگیری از درخواست‌های زیاد)
                timer = setTimeout(function() {
                    var currentValue = $(input).val();
                    var cleanCurrent = unformatNumber(currentValue);
                    if (parseFloat(cleanCurrent) > 0) {
                        validateField<?php echo $no ?>(field, cleanCurrent);
                    } else {
                        var infoDiv = $('#info_' + field + '_' + row);
                        infoDiv.html('').removeClass('balance-valid balance-warning balance-error');
                        $('#' + field + row).removeClass('error success');
    ...
    // ============================================================
    // ثبت داده‌ها (۶ فیلد باغی) - با ارسال عملکرد
    // ============================================================
    $(function() {
