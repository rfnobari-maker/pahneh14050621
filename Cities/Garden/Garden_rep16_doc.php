...
?>
<p dir="rtl" align="center" class="style8">گزارش محصولات باغی<?php echo mah_name($mah_name) ?> استان <?php echo ostan_name($id_ostan1) , $shahr ?> در سال <?php echo $z_sal ?></p>
<table width="95%" height="159" border="1" bordercolor="#0099CC"  d align="center" cellpadding="0" cellspacing="0" >
