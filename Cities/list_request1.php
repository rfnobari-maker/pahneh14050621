...
?>
<td width="8%" height="60" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
    <?php if($status=='1') { ?>
    <form action="ans_n_1.php" method="POST">
    ...
    <button onclick="return confirm('از رد درخواست مطمئن هستید ؟ ')"><img src="../files/notok.png" border="0"  title="رد درخواست" width="39" height="39" >    </button>
     </form>
    <?php }?>
            </td>
<td width="8%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php if($status=='1') { ?>
<?php if($no_request == '1') { ?>
...
<?php }?>
<?php if($no_request == '4') { ?>
    <form action="change_mor_mar.php" method="post">
    <input type="hidden" name="id_mar" value="<?php echo $id_mar ;?>" />
    <input type="hidden" name="mar" value="<?php echo $mar ;?>" />
    <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
    <button onclick="return confirm('از ثبت آبادی جدید مطمئن هستید ؟ ')"><img src="../files/ok.png" border="0"  title="تایید درخواست"    width="39" height="39" /></button>
  </form>
<?php }?>
<?php if($no_request == '5') { ?>
