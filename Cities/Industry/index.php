...
<tr>
  ...
  <?php include('top.php'); ?>
           ...
           <div class="box" align="center">
             <p><a href="list_ind_unit.php"><img src="../../files/Ind.png" alt="" width="83" height="83" border="0" class="tricky_image" /></a></p>
                     <p><a href="list_ind_unit.php" class="btn">لیست و عملکرد  واحد های صنعتی</a></p>
              </div>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
