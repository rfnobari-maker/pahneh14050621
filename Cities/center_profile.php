...
{ 
 ...
 $cod_m = $_POST['cod_m'] ; 
$query = "SELECT cod_m,name,Last_name,jens,sh_sh,date_t,m_sodor,fname,m_tah,univer,m_date,avre,v_tahol,cod_p,tel_s,tel_m,addres,pic,markaz,city FROM  users WHERE username = '$username' and cod_m = '$cod_m' " ;
