...
<body>
  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
      <span class="style8"> رسم نمودار میانگین قیمت محصول در شهرستان </span><br />
      </p>
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 <td width="34%" height="46" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
                   <select name="year" class="input_text  required" id="year" style="height:40px ; width:170px ; direction:rtl" >
                 ...
                 <td width="16%"  align='center' bgcolor="#DDDDDD" class="style8">: سال </td>
                 <td width="35%" height="46" align="right" bgcolor="#DDDDDD" class="input_text" >
...
?>
  ...
  $id_ostan1= $_POST['id_ostan'] ; 
?></td>
                 <td width="15%"  align='center' bgcolor="#DDDDDD" class="style8">: استان</td>
               </tr>
               <tr bgcolor='#f1f1f1' >
                 <td height="47" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <select name="mont" class="input_text  required" id="no_bah2"  style="height:40px ; width:170px ; direction:rtl" >
                 ...
                 <td align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city2" class="style8" id="id_city" disabled="disabled" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
$query="SELECT substr(s_date,9,2),p_price from price_record where p_cod='$p_cod' and year = '$year' and mont = '$mont' and id_ostan = '$id_ostan1' and id_city = '$id_city' group by s_date ";
...
?>
<div align="center" class="style19" dir="rtl">نمودار میانگین قیمت شهرستانی <?php echo p_name($p_cod) ; ?> طی <?php echo $v_mont?> ماه <?php echo $year?></div>
