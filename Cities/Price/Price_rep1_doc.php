...
$start=0;
 $query = "SELECT  price_record.* , price_pro_list.p_name from price_record 
...
?>
    ...
    <table width="100%" border="1" align="center" cellpadding="1" cellspacing="1"  bordercolor="#0099CC">
              <tr class="text1">
                <td width="19%" bgcolor="#999999">درصد تغییرات نسبت به روز قبل<br /></td>
                <td width="19%" bgcolor="#999999">میزان تغییرات نسبت به روز قبل 
                ریال</td>
                <td width="13%" bgcolor="#999999">قیمت روز قبل</td>
                <td width="13%" bgcolor="#999999">قیمت                ریال</td>
                <td width="14%" bgcolor="#999999">تاریخ قیمت گیری</td>
                <td width="26%" bgcolor="#999999">نام محصول</td>
