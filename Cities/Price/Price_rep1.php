...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td width="214" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city5" class="style8" id="id_city5" style="width:170px ; height:40px" dir="rtl"  disabled="disabled" onchange="this.form.submit()">
