  ...
  <tr>
    ...
    <?php endforeach; ?>
            ...
            <tr bgcolor='#f1f1f1' >
             ...
             <select name="id_city5" disabled="disabled" class="input_text" id="shahrestan" style="width:170px ; height:40px" dir="rtl"  >
...
<select name="id_mar" disabled="disabled" class="input_text" id="markaz" style="width:170px ; height:40px" dir="rtl" >
