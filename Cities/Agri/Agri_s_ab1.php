...
<select name="id_mar" class="input_text" id="markaz" style="width:170px ; height:40px" dir="rtl" >
 ...
 {  
$query = "
INSERT INTO Agri_ab_mar (group_cod, group_name, product_cod, product_name, id_ostan,id_city,id_mar ,  z_sal)
SELECT p.group_cod, p.group_name, p.product_cod, p.product_name, :id_ostan1, :id_city, :id_mar, :z_sal
FROM product_z p
LEFT JOIN Agri_ab_mar a 
...
$(function() {
  $(".submit<?php echo $no ?>").click(function() {
    ...
    const dataString = `s_abi=${s_abi}&s_dem=${s_dem}&t_abi=${t_abi}&t_dem=${t_dem}&a_abi=${a_abi}&a_dem=${a_dem}&id=${id}&id_ostan=${id_ostan}&id_city=${id_city}&id_mar=${id_mar}&z_sal=${z_sal}`;
