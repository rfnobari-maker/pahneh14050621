...
inner join users On del_rec.mor_cod_m = users.username
 WHERE del_rec.Table_name = '$Agri_prod_table' and $v_cod_mah and users.id_ostan = '$id_ostan' and users.id_city = '$id_city' and $v_mor_cod_m and $v_bah_cod_m ORDER BY del_rec.Date DESC  " ;
