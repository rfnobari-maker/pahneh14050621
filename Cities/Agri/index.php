    ...
    <div class="container">
        ...
        <div class="content-section">
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="liste_Agri.php" title="لیست زراعی">
                        <img src="../../files/Sback.PNG" alt="لیست بهره برداری های زراعی" class="card-icon">
                    </a>
                    <a href="liste_Agri.php" class="btn">لیست بهره برداری های زراعی</a>
                </div>
                <div class="card">
                    <a href="Agri_rep14.php" title="اطلاعات زراعی بهره بردار">
                ...
                <div class="card">
                    <a href="Agri_rep15.php" title="زراعی بهره بردار / محصول">
                ...
                <div class="card">
                    <a href="Agri_rep22.php" title="گزارش تولید به تفکیک محصول">
                        <img src="../../files/agri_prod.png" alt="گزارش تولید به تفکیک محصول" class="card-icon">
                    </a>
                    <a href="Agri_rep22.php" class="btn">گزارش تولید به تفکیک محصول</a>
                </div>
                <div class="card">
                    <a href="Agri_rep17.php" title="گزارش ویژه زراعت">
                        <img src="../../files/filter_data.png" alt="گزارش ویژه محصولات زراعی" class="card-icon">
                    </a>
                    <a href="Agri_rep17.php" class="btn">گزارش ویژه محصولات زراعی</a>
                </div>
                <div class="card">
