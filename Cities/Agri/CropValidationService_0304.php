 ...
 '464' => '490','150' => '148');
        ...
        if ($no_kesh == '1') {
            if ($overall_total_for_type > $allocated_irrigated) {
                return array('isValid' => false, 'message' => ' مجموع سطح زیر کشت آبی این محصول (' . $overall_total_for_type . ') بیش از میزان ابلاغی آبی (' . $allocated_irrigated . ') است');
            }
        } elseif ($no_kesh == '2') {
            if ($overall_total_for_type > $allocated_dry_farmed) {
                return array('isValid' => false, 'message' => ' مجموع سطح زیر کشت دیم این محصول (' . $overall_total_for_type . ') بیش از میزان ابلاغی دیم (' . $allocated_dry_farmed . ') است');
            }
        } else {
            return array('isValid' => false, 'message' => ' نوع کشت نامعتبر است.');
        }
