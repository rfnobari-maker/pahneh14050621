...
<body>
  ...
  <tr>
        ...
        <div style="width: 350px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
          <table width="100%" height="284" border='0' align="center" cellpadding='0' cellspacing='0'>
            ...
            <tr bgcolor='#f1f1f1' >
              ...
              <select name="id_ostan" disabled="disabled" class="input_text" id="ostan" style="width:170px ; height:40px" dir="rtl" >
    ...
    <?php endforeach; ?>
            ...
            <tr bgcolor='#f1f1f1' >
              <td height="71" align="right" bgcolor="#FFFFFF" class="input_text" ><select name="id_city5" disabled="disabled" class="style8" id="shahrestan" style="width:170px ; height:40px" dir="rtl"  >
...
$start=($id-1)*$limit;
 $query = "SELECT  * from Agri_ab_city where z_sal = '$z_sal' and id_ostan = '$id_ostan1' and id_city = '$id_city' and ((s_abi>0)or(s_dem>0)) group by group_cod,product_cod ASC LIMIT $start, $limit "; 
 $query1 = "SELECT  count(*) from Agri_ab_city where z_sal = '$z_sal' and id_ostan = '$id_ostan1' and id_city = '$id_city' and ((s_abi>0)or(s_dem>0))"; 
...
if (isset($query1)) {
    ...
    {
        global $id_ostan1,$id_city,$z_sal, $dis;
        ?>
    ...
    <div dir="rtl" class="pagination-container" style="text-align:center; margin: 20px auto;">
        <ul class="pagination" style="display: flex; list-style: none; justify-content: center; flex-wrap: wrap; gap: 5px; padding: 0;">
            ...
            <?php if ($id > 1): ?>
                <li>
                    <form action="Sab_L2.php?id=<?= $id - 1 ?>#1" method="post">
            ...
            <?php if ($start_page > 1): ?>
                <li>
                    <form action="Sab_L2.php?id=1#1" method="post">
                        <?php generate_hidden_inputs_agri(); ?>
            ...
            <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                <li>
                    ...
                    <?php else: ?>
                        <form action="Sab_L2.php?id=<?= $i ?>#1" method="post">
                            <?php generate_hidden_inputs_agri(); ?>
            ...
            <?php if ($end_page < $total): ?>
                ...
                <?php endif; ?>
                <li>
                    <form action="Sab_L2.php?id=<?= $total ?>#1" method="post">
                        <?php generate_hidden_inputs_agri(); ?>
        ...
        <div style="margin-top: 15px;">
            <form method="post" action="Sab_L2.php" style="display: inline-flex; align-items: center; gap: 10px;">
                <?php generate_hidden_inputs_agri(); ?>
                <span>به صفحه:</span>
    ...
    <script>
    document.querySelector('.pagination-container form[action="Sab_L2.php"]').addEventListener('submit', function (e) {
        ...
        if (isNaN(value) || value < 1 || value > <?= $total ?>) {
            ...
            this.action = `Sab_L2.php?id=${value}#1`;
        }
    });
    </script>
