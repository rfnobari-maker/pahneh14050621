...
switch ($mah_name) {
  ...
  ?>
                     ...
                     <option value="8" <?php if ($ragham=='8') { echo 'selected="selected"' ; }?>>باتبا</option>
               ...
               <tr >
                 <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
                   <select name="ra_kesh" id="ra_kesh" class="input_text  required"  style="height:40px ; width:150px ; direction:rtl" tabindex="7">
                     ...
                     <?php }?>
                     <?php if ($mah_name=='174') {?> 
                  <option value="3"<?php if ($ra_kesh=='3') { echo 'selected="selected"' ; }?>>با مالچ</option>
                  <option value="4"<?php if ($ra_kesh=='4') { echo 'selected="selected"' ; }?>>بدون مالچ</option>
                    <?php }?>
                   </select>
                 </div></td>
...
if(isset($_GET['id']))
{
 ...
 $query1 = "SELECT * from  Vege_prod where  $v_id_ostan  and  $v_id_city  and  $v_id_mar and  $f_add_abadi and 
  $f_add_city and $v_mor_cod_m and $v_bah_cod_m and $v_z_sal  and  $v_cod_mah and $v_sba1 and
  $v_sba2    and  $v_ragham  and $v_no_ab and $v_zka1 and $v_zka2 and $v_mah_bazar and $v_dah_bazar and
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56"><form  action="Vege_rep2_xls.php" method="post">
