...
include('login/config.php');
	$query = "INSERT INTO pm (file,title,r_user,s_user,message,no_pm,s_date,s_time,m_send) VALUES (:file,:title,:r_user,:s_user,:message,:no_pm,:s_date,:s_time,:m_send)";
    $q = $dbh->prepare($query);
    $q->execute(array(':file'=>$file_send,':title'=>$title,':r_user'=>$r_user,':s_user'=>$s_user,':message'=>$message,':no_pm'=>'1',':s_date'=>$date_edit,':s_time'=>$time,':m_send'=>'2'));
