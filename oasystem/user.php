...
?>
   ...
   <tr>
     ...
     <td>&nbsp;</td>
     <td height="38"><div align="right">
       <input name="cod_m" type="text" class="required digits input_text" id="cod_m" style="width:150px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $_POST['cod_m']?>"  minlength='10' maxlength="10" xml:lang="fa" />
     </div></td>
   ...
   <tr>
     <td><div align="right" >
       <select name="expert_unit" class="required input_text" style="height:40px ; width:200px ; direction:rtl" tabindex="13">
         ...
         <option value="5" <?php if ($_POST['expert_unit']=='5')  { echo 'selected="selected"';} ?>>اشیلات و آبزیان</option>
     ...
     <td>&nbsp;</td>
     <td><div align="right" class="input_text" >
     <select name="id_aria" class="required input_text" id="bakh" style="width:170px ; height:40px" tabindex="12" dir="rtl" >
     <option value="0">---</option>
     <?php
 ...
 <div align="center">
   ...
   <p>
     ...
     <a href="index.php"><input name="action2" type="button" style="width:150px ; height:45px" tabindex="15"  value="انصراف و بازگشت" /></a>
     <input name="action" type="submit" style="width:150px ; height:45px" tabindex="14" value="ثبت و ادامه" />
   </p>
   </p>
 </div>
 <p align="center" >&nbsp;</p>
