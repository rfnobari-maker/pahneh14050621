...
?>
   ...
   <tr>
     <td height="57"><div align="right">
       <input name="id_mar" type="text" class="required digits input_text" id="id_mar" style="width:150px; height:30px ; " tabindex="4" dir="rtl" lang="fa" value="<?php echo $id_mar?>" maxlength="11" readonly="readonly" xml:lang="fa" />
     </div></td>
