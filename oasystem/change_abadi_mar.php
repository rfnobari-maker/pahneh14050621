...
$query = "SELECT public_abadi4.add_abadi from public_abadi4 
inner join list_abadi ON public_abadi4.add_abadi = list_abadi.add_abadi 
where  public_abadi4.id_abadi = :id_abadi and public_abadi4.id_ostan = :id_ostan"; 
...
//
?>
 <form name="myform1" class="myform" method="post" action="change_mor_mar.php">
