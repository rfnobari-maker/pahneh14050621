...
<body>
 ...
 ?>
<p align="center" >&nbsp;</p>
<p align="center" ><span class="style1">تغییر مرکز و مروج شهر</span></p>
...
$query = "SELECT * from list_city where   add_city = :add_city and id_ostan = :id_ostan"; 
...
//
?>
 <form name="myform1" class="myform" method="post" action="change_city_mor_mar.php">
