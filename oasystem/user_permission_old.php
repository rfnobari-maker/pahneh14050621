...
if($select_all =='p1p2p3p4d1d2d3d4d5d6d7d8d9')
{
$perm = $select_all ;  
}
else
{
 $perm=$p1.$p2.$p3.$p4.$d1.$d2.$d3.$d4.$d5.$d6.$d7.$d8.$d9 ;  
}
...
<tr bgcolor='#f1f1f1' >
  ...
  <td width="27"  align='center' bgcolor="#F1F1F1" class="style1"><input type="checkbox" name="p1" id="p1" class="checkbox" value="p1"  <?php if(strstr($row2['perm'],'p1')) echo "checked='checked'" ?> /></td>
  </tr>
<tr bgcolor='#f1f1f1' >
  <td width="376" height="38"  align='center' bgcolor="#FFFFCC" class="style1">زراعت </td>
  <td width="24"  align='center' bgcolor="#FFFFCC" class="style1"><input name="d1" type="checkbox" id="d1" value="d1" <?php if(strstr($row2['perm'],'d1')) echo "checked='checked'" ?> ;  /></td>
  <td  align='center' bgcolor="#FFFFCC" class="style1">شهرها و آبادی ها</td>
  <td  align='center' bgcolor="#FFFFCC" class="style1"><input type="checkbox" name="p2" id="p2" class="checkbox"  value="p2"  <?php if(strstr($row2['perm'],'p2')) echo "checked='checked'" ?> /></td>
  </tr>
<tr bgcolor='#f1f1f1' >
...
<tr bgcolor='#f1f1f1' >
  ...
  <td  align='center' bgcolor="#CCCC33" class="style1">
 <input type="checkbox" name="select_all" id="select_all" value="p1p2p3p4d1d2d3d4d5d6d7d8d9"  <?php if($row2['perm']=='p1p2p3p4d1d2d3d4d5d6d7d8d9') echo "checked='checked'" ?> /></td>
  </tr>
