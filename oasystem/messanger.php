...
$query = "SELECT * FROM  pm WHERE  r_user = '$login_session' and (del != 'T' OR del IS NULL) ORDER BY id DESC LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  pm WHERE  r_user = '$login_session' and (del != 'T' OR del IS NULL) ORDER BY id DESC  "  ;
