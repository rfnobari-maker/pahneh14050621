...
<p align="center" ><span class="style1">ثبت آبادی جديد</span></p>
 ...
 <form id="form1" name="form1" method="post" action="">
   ...
   <p class="RedTitleSmaller">.کد آبادی برابر با 6 رقم آخر سمت راست ، آدرس آماری آبادی می باشد *</p>
   <p>
 ...
 $query = "SELECT * from public_abadi4 where id_abadi = :id_abadi and id_ostan = :id_ostan"; 
$stmt = $dbh->prepare($query);
$stmt->execute(array(':id_abadi'=>$id_abadi,':id_ostan'=>$id_ostan));
...
if ($count>0)
{
	?>
 <form name="myform1" class="myform" method="post" action="">
 <input type="hidden" name="error"  value="آبادی مورد نظر در حال حاضر در لیست آبادی های فعال قرار دارد" />
  </form>
 <script type="text/javascript">document.myform1.submit();</script>
<?php
}
...
{
?>
 <form name="myform1" class="myform" method="post" action="doactive_abadi.php">
