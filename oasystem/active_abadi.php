...
<body>
  ...
  <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="40" colspan='2' align='center' bgcolor="#FFFFFF"><span class="style1">لیست آبادی فعال</span></td>
      </tr>
      <tr bgcolor='#f1f1f1' >
...
if ($id_mar1 == 0) { $v_id_mar = 1 ;} else { $v_id_mar = "id_mar='$id_mar1'" ;}
...
?>
  ...
  <tr align="center" class="style8">
    ...
    <td width="13%" bgcolor="#CCCCCC">دهستان</td>
...
<td width="6%" height="55" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
  <form  action="doinactive_abadi.php" method="post">
    <input type="hidden" name="add_abadi" value="<?php echo $row['add_abadi'] ;?>" />
    <input type="hidden" name="id_mar" value="<?php echo $row['id_mar'] ;?>" />
    <button onclick="return confirm('از حذف آبادی با نام <?php echo $row['abadi'] ;?> مطمئن هستید ؟ ')"><img src="../files/notok.png" border="0"  title=" غیرفعال کردن آبادی" width="30" height="30" /></button>
  </form></td>
<td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="7%">
  <form  action="change_mor_mar.php" method="post">
   ...
   <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="19%" class="normalTextSmaller"><?php echo user_name($row['mor_cod_m']);?><br />
