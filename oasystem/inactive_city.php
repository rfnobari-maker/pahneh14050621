...
$stmt->execute();
?>
           <p><span class="normalTextSmall">لیست شهرهای های غیر فعال استان</span></p>
           <p><a href="inactive_city_xls.php"><img src="../files/xls.png" width="75" height="80"  alt=""/></a></p>
  ...
  <tr align="center" class="style8">
    ...
    <td width="27%" bgcolor="#CCCCCC">آدرس آماری شهر</td>
    <td width="19%" bgcolor="#CCCCCC">نام شهر</td>
    <td width="20%" bgcolor="#CCCCCC">بخش</td>
...
<td height="55" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
  <form  action="doactive_city.php" method="post">
    <input type="hidden" name="add_city" value="<?php echo $row['add_city'] ;?>" />
    <button><img src="../files/ok.png" border="0" title="فعال سازی شهر" width="39" height="39" /></button>
</form></td>
<td <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $row['add_city'];?></span></td>
