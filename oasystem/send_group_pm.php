        ...
        <table width="491" border="0" align="center">
          <tr>
            ...
            <td width="250"><div align="right" dir="rtl">
                            <p>
                <select name="s_access" class="input_text" id="s_access" style="width:150px; height:30px  ">
                  <option value="1">مروجین کشاورزی</option>
                  <option value="2">روسای مراکز</option>
                  <option value="3">مدیران شهرستان</option>
                  <option value="4">مدیریت سامانه</option>
              </select>
              </p>
            </div></td>
...
$query = "SELECT username from users where id_ostan = '$id_ostan' and S_access = $s_access";
