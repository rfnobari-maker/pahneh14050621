...
?>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="11%" height="54" bgcolor="#006699">کارشناس مروج</td>
    <td width="10%" bgcolor="#006699">شماره همراه</td>
    <td width="10%" bgcolor="#006699">نام پدر</td>
  ...
  <tr>
    ...
    <td width="7%"> <form  action="view_benef.php" method="post">
    <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
    <button><img src="../files/view.png" title="نمایش اطلاعات بهره بردار"  width="33" height="26"  alt=""/></button>
    </form>
    </td>
    <td height="47" class="normalTextSmaller"><img id="img1" src="../files/users/<? echo $pic ?>" width="37" height="43"  alt=""/><br />      
      <?php echo user_name($mor_cod_m)?><br/><?php echo $mor_cod_m?><br /></td>
    <td class="normalTextSmaller"><?php echo $tel_m ?></td>
    <td class="normalTextSmaller"><?php echo $fname ?></td>
