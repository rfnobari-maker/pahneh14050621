...
$city = $_POST['city'] ;
echo $query = "SELECT * FROM  users WHERE  id_ostan = '$id_ostan_sh' and id_city = '$id_city' and S_access = '1'"  ;
...
<?php } else { echo '<p style="color:red">'.'مجوز دسترسی به این صفحه را ندارید '.'</p>';}?>
           ...
           <p>&nbsp;</p>
           <p> 
        	 <form name="myform1" class="myform" method="post" action="city_promo.php">
