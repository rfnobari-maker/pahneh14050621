...
?>
    ...
    <form action="search_promo.php" method="post" id="form1" name="form1">
        <div align="center">
          <p>
   ...
   <tr>
     ...
     <td width="200"><div align="right" >
       <input name="ostan" type="text" class="required" id="ostan" style="width:200px; height:30px ; background:#0CF " dir="rtl" lang="fa" value="<?php echo $ostan1 ; ?>" maxlength="50" xml:lang="fa" readonly="readonly"/>
       </div></td>
