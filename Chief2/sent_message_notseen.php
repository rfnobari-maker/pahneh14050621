...
$date_edit ; 
include('../login/config.php');
$query = "SELECT * FROM  pm WHERE   s_user = '$login_session'  and ru_read = '1' ORDER BY id DESC LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  pm WHERE   s_user = '$login_session' and ru_read = '1' ORDER BY id DESC  "  ;
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><span class="style8">لیست پیامهای ارسالی مشاهده نشده</span></p>
...
<table width="900" height="176" border="1" align="center" cellpadding="1" cellspacing="1" >
            ...
            <th width="94" rowspan="2" bgcolor="#006699">شماره همراه</th>
...
$r = $start+1 ;
  ...
  <button><img src="../files/view.png" border="0"  title="مشاهده پیام" width="29" height="30" /></button>
            ...
            <td><span class="normalTextSmaller"><?php echo user_tel($row['r_user']);?></span></td>
      ...
      <button><img id="img1" src="../files/users/<?php echo user_pic($row['r_user']) ?>" width="37" height="45"  alt=""/></button>
      </form></td>
