...
?>
<p align="center" >&nbsp;</p>ارسال پاسخ پیام <span style="color:#900 ; font-family:Tahoma; font-size:12px"><span class="style21"><a name="1" id="1"></a></span></span>
<p align="center" ><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
 ...
 <form action="" method="post" enctype="multipart/form-data" id="form1" name="form1" >
   ...
   <tr>
     ...
     <td width="150"><div align="right">  : موضوع پیام</div></td>
   </tr>
   <tr>
     <td height="104" colspan="2"><div align="right">
       <textarea name="message" cols="45" rows="10" style="color:#06C ; font-family:Tahoma" autofocus="autofocus" class="required" id="textarea" dir="rtl" > <?php echo $v_message ?></textarea>
       </div></td>
...
?>
       <p> <button  id="send" style="width:150px ; height:45px" onclick="close_window()">بستن پنجره</button></p>
 <p align="center" >&nbsp;</p>
    </form>      </td>
  </tr>
  <tr>
