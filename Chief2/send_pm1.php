 ...
 <p align="center" style="color:#900 ; font-family:Tahoma; font-size:12px" ><?php echo $mess ?></p>
       ...
       <div id="box">
        <table width="501" border="0" align="center">
          <tr>
            <td width="129" height="66"><p class="normalTextSmaller"><img id="img1" src="../files/users/<?php  echo user_pic($username) ?>" width="57" height="64"  alt=""/><br />
                <img src="../files/mobile.jpg" width="15" height="30"  alt=""/> <?php echo user_tel($username);?>
            </p></td>
   ...
   <tr>
     <td height="24" class="style2">حداکثر حجم :<span class="RedTitleSmaller"> 1000</span> <span class="RedTitleSmaller">کیلو بایت</span></td>
...
include('../login/config.php');
	...
	sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,'','ارسال پیام خصوصی / '.user_name($r_user)) ; 
  }
  ?>
<?php  
   // فانكشن آپلود فايل 
...
// کنترل حجم فایل
           if ((($_FILES[$file_id]['size'])<1000) || (($_FILES[$file_id]['size'])>1000000))
		    { //Check if the file is made
            $file_name = '';
            $result =  "  حجم فایل ارسالی نباید از 1 کیلوبایت کمتر و از 1000 کیلوبایت بیشتر باشد "; //Show the error message
			echo "<br/>\n" ;
        } else {
