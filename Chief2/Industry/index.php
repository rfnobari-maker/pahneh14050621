  ...
  <?php include('top.php'); ?>
           ...
           <div class="box" align="center">
             <p><a href="list_ind_unit_prod.php"><img src="../../files/Ind.png" alt="" width="83" height="83" border="0" class="tricky_image" /></a></p>
                     <p><a href="list_ind_unit_prod.php" class="btn">لیست و عملکرد  واحد های صنعتی</a></p>
              </div>
           <div class="box" align="center">
             <p><a href="Ind_rep1.php"><img src="../../files/filter_data.png" alt="" width="100" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="Ind_rep1.php" class="btn">گزارش محصولات تولیدی </a></p>
           </div>
           <div class="box" align="center">
             <p><a href="Ind_rep2.php"><img src="../../files/filter_data_icon.jpg" alt="" width="86" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="Ind_rep2.php" class="btn">آمار   واحد های صنعتی</a></p>
           </div>

            </td>
          </tr>
          <tr>
            <td  height="94"colspan="3" valign="middle" ><p class="LinkRedTitle"><a href="../prof.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
          </tr>
          <tr>
