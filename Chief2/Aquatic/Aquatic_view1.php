...
if  (isset($_POST['bah_cod_m']))
{
 ...
 $sal = $_POST['sal'];
 $m_poul = $_POST['m_poul'];
 $query = "SELECT * from Aquatic where bah_cod_m = '$bah_cod_m' and sal = '$sal' and num_bah = '$num_bah' "; 
    ...
    <form action="liste_Aquatic.php" method="post" id="form1" name="form1">
      <table width="99%" height="570" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right">
            <select name="sal" disabled="disabled" class="input_text  required" id="sal"  style="height:40px ; width:120px ; direction:rtl" tabindex="19">
