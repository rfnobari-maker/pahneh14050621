...
$stmt->execute();
?>
<p class="style8">فرم های ثبت شده به تفکیک بهره بردار   </p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p><form  id="reg-form" method="post" action="#1">
...
?>
 ...
 <table width="122" height="56" border="0" align="center">
   <tr>
     <td width="56"><form  action="summary2_xls.php" method="post">
       <input type="hidden" name="sal"  value="<?php echo  $sal ;?>" />
       <button><img src="../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
     </form></td>
     <td width="56"><form  action="summary2_doc.php" method="post">
       <input type="hidden" name="sal"  value="<?php echo  $sal ;?>" />
 ...
 <table width="85%" height="248" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
    ...
    <td height="51" colspan="8" bgcolor="#999999">تعداد بهره برداری های ثبت شده</td>
    <td width="13%" rowspan="2" bgcolor="#999999"> تعداد بهره بردار</td>
    <td width="15%" rowspan="2" bgcolor="#999999">استان </td>
    <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
    </tr>
  <tr align="center" class="text1">
    <td bgcolor="#999999">صنایع</td>
    <td bgcolor="#999999">زنبور عسل </td>
    <td height="56" bgcolor="#999999">آبزی پروری</td>
    <td bgcolor="#999999">قارچ</td>
    <td bgcolor="#999999">گلخانه</td>
    <td bgcolor="#999999">باغی</td>
    <td width="10%" bgcolor="#999999">صیفی</td>
    <td width="10%" bgcolor="#999999">زراعی</td>
    </tr>
  <tr>
  <?php
$r = 1 ;
...
//echo $row2['User_Name'] ; 
?>
    <td width="10%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_ind_count($row['id_ostan'],$sal) ?></td>
    <td width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_bee_count($row['id_ostan'],$sal) ?></td>
    <td width="10%" height="38"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Aquatic_count2($row['id_ostan'],$sal) ?></td>
    <td width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Mushroom_count($row['id_ostan'],$sal) ?></td>
    <td width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Greenhous_count2($row['id_ostan'],$sal) ?></td>
    <td width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Garden_count2($row['id_ostan'],$sal) ?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Vege_count($row['id_ostan'],$sal) ?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Agri_count2($row['id_ostan'],$sal) ?></td>
...
?>
  ...
  <tr>
    ...
    <td height="41" bgcolor="#FFFFCC"  class="normalTextSmaller"  ><?php echo total_Aquatic_count2($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo total_Mushroom_count($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo total_Greenhous_count2($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo total_Garden_count2($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo total_Vege_count($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo total_Agri_count2($sal)?></td>
    <td bgcolor="#FFFFCC"  class="normalTextSmall"  ><?php echo kol_bah_count();?></td>
    </tr>

         </table>
<?php }?>
           <p><a href="benef.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>           </p></td>
  </tr>
  <tr>
