  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
        ...
        <p class="style1">آمار زنبورستان ها به تفکیک استان</p>
...
<form method="post" name="form1" id="form"  action="">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="71%" height="68"><div align="right">
              ...
              <td width="29%" class="style8"> : سال </td>
            </tr>
          </table>
          <p>
...
$query = "SELECT bee.id_ostan,ostanname.ostan,count(*) as jam,
...
WHERE bee.sal='$sal' 
group by bee.id_ostan
order by binary ostanname.ostan "  ;
...
?>
    ...
    <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
             ...
             <tr align="center" class="text1">
               <td width="6%" height="67" bgcolor="#999999">حوزوی</td>
...
$r = 1 ;
 foreach($stmt as $row){
?>
    <td height="39"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah9'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah8'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah7'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah6'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah5'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah4'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah3'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah2'];?></td>
    <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_tah1'];?></td>
