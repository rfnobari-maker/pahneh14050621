...
?>
 ...
 <table width="85%" height="237" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
    ...
    <td height="56" colspan="4" bgcolor="#999999">تعداد بهره برداری های ثبت شده</td>
...
//echo $row2['User_Name'] ; 
?>
  <td width="15%" height="38"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Aquatic_count2($row['id_ostan'],$sal) ?></td>
    <td width="16%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Greenhous_count2($row['id_ostan'],$sal) ?></td>
    <td width="13%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Garden_count2($row['id_ostan'],$sal) ?></td>
