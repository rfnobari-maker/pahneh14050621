...
<p class="style8">داشبورد مدیریتی  استان های تحت پوشش</p>
  ...
  <tr align="center" class="text1">
    <td bgcolor="#999999"><br />      بهره بردار<br /></td>
...
?>
  ...
  <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="ostan_benef.php" method="post" onsubmit="return ray.ajax()">
