...
?>
           ...
           <table width="122" height="56" border="0" align="center">
             <tr>
               <td width="56"><form  action="Agri_rep13_xls.php" method="post">
                 <input type="hidden" name="id_ostan" value="<?php echo  $id_ostan1 ;?>" />
                 <input type="hidden" name="z_sal" value="<?php echo $z_sal ;?>" />
                 <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
               </form></td>
               <td width="56"><form  action="Agri_rep13_doc.php" method="post">
                 <input type="hidden" name="id_ostan" value="<?php echo  $id_ostan1 ;?>" />
                 <input type="hidden" name="z_sal" value="<?php echo $z_sal ;?>" />
           ...
           <table width="98%" height="142" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td height="39" colspan="3" bgcolor="#999999">میزان تولید ، کل / بیمه شده<br />
...
$r = 1 ;
 ...
 $cod_mah = $row['cod_mah'] ;
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="8%" height="57" ><?php echo Num2Fa(round(sum_per_mah_tol($cod_mah,'1',$id_ostan1,$z_sal) + sum_per_mah_tol($cod_mah,'2',$id_ostan1,$z_sal)*1,1)) ?><br />
                 <?php echo Num2Fa(round(sum_per_mah_tol_bem($cod_mah,'1',$id_ostan1,$z_sal) + sum_per_mah_tol_bem($cod_mah,'2',$id_ostan1,$z_sal)*1,1)) ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="8%" ><?php echo Num2Fa(round(sum_per_mah_tol($cod_mah,'2',$id_ostan1,$z_sal)*1,1)) ?><br />
                <?php echo Num2Fa(round(sum_per_mah_tol_bem($cod_mah,'2',$id_ostan1,$z_sal)*1,1)) ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="8%" ><?php echo Num2Fa(round(sum_per_mah_tol($cod_mah,'1',$id_ostan1,$z_sal)*1,1)) ?><br />
                 <?php echo Num2Fa(round(sum_per_mah_tol_bem($cod_mah,'1',$id_ostan1,$z_sal)*1,1)) ?></td>
               <td width="9%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round((sum_mah_s_bar_a($cod_mah,'1',$id_ostan1,$z_sal) + sum_mah_s_bar_a($cod_mah,'2',$id_ostan1,$z_sal)),1)) ?><br />
                 <?php echo Num2Fa(round((sum_mah_s_bar_b($cod_mah,'1',$id_ostan1,$z_sal) + sum_mah_s_bar_b($cod_mah,'2',$id_ostan1,$z_sal)),1)) ?></td>
               <td width="9%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round(sum_mah_s_bar_a($cod_mah,'2',$id_ostan1,$z_sal),1)) ?><br />
                 <?php echo Num2Fa(round(sum_mah_s_bar_b($cod_mah,'2',$id_ostan1,$z_sal),1)) ?></td>
               <td width="10%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round(sum_mah_s_bar_a($cod_mah,'1',$id_ostan1,$z_sal),1)) ?><br />
                 <?php echo Num2Fa(round(sum_mah_s_bar_b($cod_mah,'1',$id_ostan1,$z_sal),1)) ?></td>
               <td width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round((sum_mah_zer_kesht_a($cod_mah,'1',$id_ostan1,$z_sal) + sum_mah_zer_kesht_a($cod_mah,'2',$id_ostan1,$z_sal)),1)) ?><br />
                 <?php echo Num2Fa(round((sum_mah_zer_kesht_b($cod_mah,'1',$id_ostan1,$z_sal) + sum_mah_zer_kesht_b($cod_mah,'2',$id_ostan1,$z_sal)),1)) ?></td>
               <td width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round(sum_mah_zer_kesht_a($cod_mah,'2',$id_ostan1,$z_sal),1)) ?><br />
                 <?php echo Num2Fa(round(sum_mah_zer_kesht_b($cod_mah,'2',$id_ostan1,$z_sal),1)) ?></td>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Num2Fa(round(sum_mah_zer_kesht_a($cod_mah,'1',$id_ostan1,$z_sal),1)) ?><br />
