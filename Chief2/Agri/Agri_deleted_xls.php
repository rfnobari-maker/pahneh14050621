...
?>
           <table width="98%" height="162" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td align="center" height="61" colspan="3" bgcolor="#999999">کارشناس<br /></td>
             ...
             <tr align="center" class="text1">
               <td align="center" height="57" bgcolor="#999999">کد ملی </td>
...
?>
             <tr>
               ...
               <td align="center" width="8%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo  mah_name($mah_name)?></td>
