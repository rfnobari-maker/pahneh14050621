                       ...
                       <div class="main" align="center">
                         <table id='myTable9' align="center">
                           ...
                           <thead>
                             <tr>
                               <th></th>
                               <?php $query = "SELECT  DISTINCT no_ab FROM Agri where no_kesh = '1' and id_ostan = '$id_ostan' and z_sal = '$z_sal' order by no_ab "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
 foreach($stmt as $row){
	 $no_ab = $row['no_ab'] ; 
...
$stmt->execute();
 foreach($stmt as $row){
	 $no_ab = $row['no_ab'] ; 
?>
                               <td><?php echo  sum_m_zamin_no_ab($no_ab,$id_ostan,$z_sal) ;?></td>
                               <?php }?>
                             </tr>
                           </tbody>
                           <tr>
                       ...
                       <div class="main" align="center">
                         <table id='myTable8' align="center">
                           ...
                           <thead>
                             <tr>
                               <th></th>
                               <?php $query = "SELECT  DISTINCT m_ab FROM Agri where no_kesh = '1' and id_ostan = '$id_ostan' and z_sal = '$z_sal' order by m_ab "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
 foreach($stmt as $row){
	 $m_ab = $row['m_ab'] ; 
...
$stmt->execute();
 foreach($stmt as $row){
	 $m_ab = $row['m_ab'] ; 
?>
                               <td><?php echo  sum_m_zamin_m_ab($m_ab,$id_ostan,$z_sal) ;?></td>
                               <?php }?>
                             </tr>
                           </tbody>
                           <tr>
