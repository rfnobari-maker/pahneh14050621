        ...
        <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td height="46" align="right" bgcolor="#DDDDDD" class="input_text" >
                   <select  name="id_ostan" class="style8 ostan" id="id_ostan" style="width:170px ; height:40px" dir="rtl" >
...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <select  name="id_city" class="input_text shahr" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
