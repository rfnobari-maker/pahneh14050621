...
inner join bah ON $Agri_table.bah_cod_m = bah.bah_cod_m
 ...
 $query1 = "SELECT $Agri_table.id,$Agri_table.id_ostan,$Agri_table.id_city,$Agri_table.add_abadi,$Agri_table.add_city
,$Agri_table.m_cod_m,$Agri_table.bah_cod_m,$Agri_table.mor_cod_m,$Agri_table.sh_gat,$Agri_table.no_mal,$Agri_table.no_kesh,$Agri_table.m_zamin,$Agri_table.t_mah,$Agri_table.z_sal ,bah.ok
from $Agri_table 
inner join bah ON $Agri_table.bah_cod_m = bah.bah_cod_m
...
{
	?>
    <form  action="list_Agri_no_editing.php?id=<?php echo $id-1 ?>" method="post">
...
echo "<ul class='page'>";
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="list_Agri_no_editing.php?id=<?php echo $i?>" method="post">
        <input type="hidden" name="action" value="1" />
         <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
        <input type="hidden" name="id_mar" value="<?php echo $id_mar ?>" />
