...
if(isset($_GET['id']))
{
 ...
 $query1 = "SELECT id from $Agri_prod_table where $v_id_ostan and $f_no_kesh  and $v_id_city  and  $v_cod_mah GROUP BY bah_cod_m,id_mar  ORDER BY id_city,id_mar,bah_cod_m ASC "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ; ?>
