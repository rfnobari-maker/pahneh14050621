   ...
   <?php if ($row['id_ostan']==$id_ostan1) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
              ...
              <tr>
                <td height="68"><div align="right">
                  <select name="z_sal" class="input_text  required" id="sal" style="height:40px ; width:170px ; direction:rtl">
        ...
        </div>             <p><span class="style1"><a name="1" id="1"></a></span>
               <?php
...
?>
            ...
            <table width="122" height="56" border="0" align="center">
               <tr>
                 <td><form  action="Agri_amar2_xls.php" method="post">
      ...
      <span class="style8">جدول زراعی کلیه محصولات به جزء سیب زمین ، پیاز و گوجه فرنگی</span>
...
?>
     <p></p>
      <span class="style8"> جدول صیفی سه محصول سیب زمینی ، پیاز و گوجه فرنگی </span>
...
?>
  ...
  <tr>
    ...
    <div><a href="#!" class="vanillatop"></a></div>
