...
$query = "SELECT cod_qroup , cod_mah_amar , cod_mah, no_kesh ,
...
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and cod_qroup !='' Group by cod_qroup , cod_mah_amar "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
...
?>
               ...
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo mah_name_amar($row['cod_mah_amar']);?><br />
                <?php echo $row['cod_mah_amar'];?> <br />
                <?php echo $row['cod_mah'];?> <br /></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php if($row['cod_qroup'] == '4') echo group_name_amar($row['cod_qroup']).'**'; else echo group_name_amar($row['cod_qroup']);?><br />
                <?php echo $row['cod_qroup'];?> <br /></td>
