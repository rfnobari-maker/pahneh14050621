...
header("Content-Disposition: attachment;Filename='گزارش_2_آمارنامه.xls");
include('../../../lock_ce.php');
include('../../../event.php');
...
<body>
<p align="center" dir="rtl">برآورد سطح، میزان تولید و عملکرد در هکتار محصولات زراعی به تفکیک استان / شهرستان <?php if($id_ostan1!='') echo 'استان '.ostan_name($id_ostan1);?><?php echo ' در سال  '.$z_sal?></p>
       <?php
if ($id_ostan1 == '') 
{
...
if ($t_row>0) { ;
?>
<p align="center" dir="rtl">جدول زراعی شامل کلیه محصولات به جزء سیب زمین ، پیاز و گوجه فرنگی</p>   
            <table width="95%" height="136" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             ...
             <tr align="center" class="text1">
               <td height="21" bgcolor="#999999">دیم</td>
               <td bgcolor="#999999">آبی</td>
               <td width="10%" height="21" bgcolor="#999999">جمع</td>
               <td width="8%" bgcolor="#999999">دیم</td>
               <td width="9%" bgcolor="#999999">آبی</td>
               <td height="21" bgcolor="#999999">جمع</td>
...
?>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="8%" height="27" ><?php echo round($mahtol_d/$s_d*1000,0) ; ?></td>
...
?>
<p></p>
<p align="center" dir="rtl">جدول صیفی شامل سه محصول سیب زمین ، پیاز و گوجه فرنگی</p>   
...
?>
               ...
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="8%" ><?php echo round($mahtol_a/$s_a*1000,0) ;?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="10%" height="28" ><?php echo $mahtol_a ;  ?></td>
