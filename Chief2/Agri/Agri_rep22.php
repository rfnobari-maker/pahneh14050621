...
<form  id="reg-form" method="post" action="#1">
  ...
  <div style=" width: 450px; padding: 15px;border: 3px solid navy; margin:auto ; border-radius:15px" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      ...
      <tr bgcolor='#f1f1f1' >
        <td width="319" height="51" align="right" bgcolor="#F1F1F1" class="input_text" ><select  name="id_ostan" class="input_text" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
          <?php
...
?>
           ...
           <table width="122" height="56" border="0" align="center">
             <tr>
               <td width="56"><form  action="Agri_rep22_xls.php" method="post">
...
sum($Agri_prod_table.zer_kesht_a) zer_k1, 
sum(if($Agri_prod_table.no_kesh = '1',$Agri_prod_table.zer_kesht_a,0)) as zer_k1_abi, 
sum(if($Agri_prod_table.no_kesh = '2',$Agri_prod_table.zer_kesht_a,0)) as zer_k1_dim,

sum($Agri_prod_table.zer_kesht_b) zer_k2, 
sum(if($Agri_prod_table.no_kesh = '1',$Agri_prod_table.zer_kesht_b,0)) as zer_k2_abi, 
sum(if($Agri_prod_table.no_kesh = '2',$Agri_prod_table.zer_kesht_b,0)) as zer_k2_dim,

sum($Agri_prod_table.mah_tolp) m_tolp, 

sum($Agri_prod_table.s_bar_a) s_bar1, 
sum(if($Agri_prod_table.no_kesh = '1',$Agri_prod_table.s_bar_a,0)) as s_bar1_abi, 
sum(if($Agri_prod_table.no_kesh = '2',$Agri_prod_table.s_bar_a,0)) as s_bar1_dim,

sum($Agri_prod_table.s_bar_b) s_bar2, 
sum(if($Agri_prod_table.no_kesh = '1',$Agri_prod_table.s_bar_b,0)) as s_bar2_abi, 
sum(if($Agri_prod_table.no_kesh = '2',$Agri_prod_table.s_bar_b,0)) as s_bar2_dim,

sum($Agri_prod_table.mah_tol) m_tol, 
sum(if($Agri_prod_table.no_kesh = '1',$Agri_prod_table.mah_tol,0)) as m_tol_abi, 
sum(if($Agri_prod_table.no_kesh = '2',$Agri_prod_table.mah_tol,0)) as m_tol_dim 
