...
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah Group by bah_cod_m  ORDER BY bah_cod_m ASC LIMIT $start, $limit "; 
 $query1 = "SELECT  Garden_prod.bah_cod_m ,
sum(Garden_prod.s_kesht_b)   s_keshtb,
sum(Garden_prod.s_kesht_gb) s_keshtgb,
sum(Garden_prod.tree_b)  treeb,
sum(Garden_prod.tree_gb) treegb ,
...
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>> <form  action="manager_Garden2.php" method="post" onsubmit="target_popup2(this)">
...
?>
          ...
          <p><a href="Garden.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
  </tr>
  <tr>
