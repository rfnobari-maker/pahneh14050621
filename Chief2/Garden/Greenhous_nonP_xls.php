...
header("Content-Disposition: attachment;Filename=Greenhous_nonP.xls");
?>
<?php 
include('../../lock_ce.php');
include('../../event.php') ;
...
?>
           ...
           <table width="98%" height="84" border="0" align="center" cellpadding="1" cellspacing="1" >
             <tr align="center" class="text_r">
               <td width="11%" rowspan="2" bgcolor="#999999">همراه کارشناس</td>
               <td width="11%" rowspan="2" bgcolor="#999999">نام و نام خانوادگی کارشناس</td>
    ...
    <td width="11%" rowspan="2" bgcolor="#999999">مساحت مفید گلخانه/مترمربع</td>
    ...
    <td width="4%" rowspan="2" bgcolor="#999999">ردیف</td>
             ...
             <tr align="center" class="text_r">
               <td height="42" bgcolor="#999999">دهم ثانیه</td>
...
?>
  <tr>
    ...
    <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['m_zamin_gol']; ?></td>
