...
header("Content-Disposition: attachment;Filename=Mush_rep4.xls");
include("../../lock_ce.php");
...
<div align="center"> گزارش واحدهای پرورش قارچ به تفکیک استان</div>
           <table width="99%" height="208" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td bgcolor="#999999">سطح زيركشت كل(متر مربع)</td>
               <td bgcolor="#999999">لیسانس و بالاتر</td>
               <td bgcolor="#999999">دیپلم و فوق دیپلم</td>
               <td bgcolor="#999999">زیر دیپلم</td>
               <td width="6%" bgcolor="#999999">غیر فعال 3</td>
               <td width="5%" bgcolor="#999999">غیر فعال 2</td>
               <td width="6%" bgcolor="#999999">غیر فعال 1</td>
               <td width="7%" bgcolor="#999999">فعال</td>
               <td bgcolor="#999999">تعداد واحد</td>
...
$r = 1 ;
 foreach($stmt as $row){
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="8%" height="35" ><?php echo round($row['comp'],1) ; ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="8%" ><?php echo $row['mah_tol'] ; ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="9%" ><?php echo  round((($row['mah_tol'] *1000 ) / $row['zer_kesh']),2) ; ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="9%" ><?php echo $row['zer_kesh'] ; ?></td>
               <td width="4%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['lisan'] ; ?></td>
               <td width="3%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['dep'] ; ?></td>
               <td width="6%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['z_dep'] ; ?></td>
               ...
               <td width="9%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['unit'] ; ?><br /></td>
...
?>
             <tr align="center" class="text1">
               ...
               <td bgcolor="#999999">دیپلم و فوق دیپلم</td>
               <td bgcolor="#999999">زیر دیپلم</td>
               <td bgcolor="#999999">غیر فعال 3</td>
               <td bgcolor="#999999">غیر فعال 2</td>
               <td bgcolor="#999999">غیر فعال 1</td>
               <td bgcolor="#999999">فعال</td>
               <td bgcolor="#999999">تعداد واحد</td>
               <td colspan="2" bgcolor="#999999">&nbsp;</td>
              </tr>
             <tr>
               <td height="38" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> ><?php echo round($row['comp'],1) ; ?></td>
