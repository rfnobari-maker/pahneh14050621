...
<body>
  ...
  <tr>
          ...
          <tr>
            <td><?php include('../../oChief/Garden/menu.php'); ?>
</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="4"><p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="840" >
      <?php include('../../oChief/Garden/top.php');?>
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56"><form  action="../../oChief/Garden/Garden_rep17_xls.php" method="post">
                 ...
                 <td width="56"><form  action="../../oChief/Garden/Garden_rep17_doc.php" method="post">
                   <input type="hidden" name="id_ostan"  value="<?php echo  $id_ostan1 ;?>" />
                   <input type="hidden" name="id_city"   value="<?php echo  $id_city ;?>" />
                   <input type="hidden" name="id_mar"    value="<?php echo  $id_mar ;?>" />
                   <input type="hidden" name="add_abadi" value="<?php echo  $add_abadi ;?>" />
...
foreach($stmt as $row){ 
  ?>
          <td width="6%" height="53" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>  <form  action="../../oChief/send_pm1.php#1" method="post" onsubmit="target_popup2(this)">
     ...
     <button><img src="../../files/receive_mail.png" width="23" height="25" title="ارسال پیام " /></button>
          ...
          <td width="6%" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
            <form  action="../../oChief/Garden/Gardendata_view1.php" method="post" onsubmit="target_popup2(this)">
...
{
	?>
    <form  action="../../oChief/Garden/Garden_rep17.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="../../oChief/Garden/Garden_rep17.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
         <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
        <input type="hidden" name="id_mar" value="<?php echo $id_mar ?>" />
...
?>
          ...
          <p><a href="../../oChief/Garden/index.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    
          </p></td>
  </tr>
  <tr>
