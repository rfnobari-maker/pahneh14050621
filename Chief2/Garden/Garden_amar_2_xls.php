...
?>
             <tr>
               <td height="23" align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> ><?php echo round(($row['m_tol_dim']*1000)/$row['zer_k1_dim'],1) ;?><br /></td>
               ...
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['zer_k2'],2)*1 ; ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['zer_k2_dim'],2)*1 ; ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['zer_k2_abi'],2)*1 ; ?></td>
...
?>
             ...
             <tr>
               <td height="23" align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> ><?php echo round(($row['m_tol_dim']*1000)/$row['zer_k1_dim'],1) ;?></td>
