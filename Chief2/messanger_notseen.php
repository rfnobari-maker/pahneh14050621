...
$query = "SELECT * FROM  pm WHERE  r_user = '$login_session' and del <> 'T' and ru_read='1' ORDER BY id DESC  LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  pm WHERE  r_user = '$login_session' and del <> 'T' and ru_read='1' ORDER BY id DESC   "  ;
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><span class="style8">لیست پیام های دریافتی مشاهده نشده</span></p>
