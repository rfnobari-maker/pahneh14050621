...
<div style="float:right ; margin-right:30px ; margin-left:20px ; margin-top:15px ; padding:10px ">
 <a title="ویرایش اطلاعات کاربری" href="profile"><img class="polaroid" src="<?php echo htmlspecialchars($root); ?>/files/users/<?php echo htmlspecialchars($pic); ?>" width="79" height="103" id="img" alt="تصویر کاربر "/></a></div>
  ...
  <div class="box_pm">
    <p><a href="messanger" title="ارسال و دریافت پیام"><img src="<?php echo htmlspecialchars($root); ?>/files/messanger.png" alt="users" width="83" height="83" border="0" class="tricky_image" /></a>
<?php if ($count_pm > 0)
...
<div class="box_pm">
    <p><a href="support" onClick="target_popup2(this)" title="ارتباط با پشتیبان سامانه"><img src="<?php echo htmlspecialchars($root); ?>/files/support-png-icon.jpg" alt="users" width="83" height="83" border="0" class="tricky_image" /></a>
   </p>
</div>
</div>
