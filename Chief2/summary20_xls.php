...
header("Content-Disposition: attachment;Filename=bah_list.xls");
include('../lock_ce.php');
include('counter.php');
$sal = $_POST['sal'] ; 
?>
...
//echo $row2['User_Name'] ; 
?>
   <td align="center" width="15%" height="29"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Aquatic_count2($row['id_ostan'],$sal) ?></td>
    <td align="center" width="16%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Greenhous_count2($row['id_ostan'],$sal) ?></td>
    <td align="center" width="13%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_Garden_count2($row['id_ostan'],$sal) ?></td>
...
?>
  ...
  <tr>
    <td align="center" height="25" bgcolor="#FFFFCC"  class="normalTextSmaller"  ><?php echo total_Aquatic_count2($sal)?></td>
