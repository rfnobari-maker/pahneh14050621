...
if(isset($_GET['id']))
{
 ...
 $query1 = "SELECT  id from $Agri_prod_table where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah and  $v_dis ORDER BY bah_cod_m ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
?>
          ...
          <td width="7%" rowspan="2" bgcolor="#006699">خسارت دیده ؟</td>
          <td width="7%" rowspan="2" bgcolor="#006699">میزان تولید قطعی<br />
            <span class="style2">تن</span></td>
          <td colspan="2" bgcolor="#006699"><p>سطح برداشت <br />
            <span class="style2">هکتار</span>          </p></td>
          <td width="6%" rowspan="2" bgcolor="#006699"><p>پیش بینی<br />
            تولید<br />
  <span class="style2">تن </span></p></td>
        ...
        <tr class="text1">
          <td width="8%" bgcolor="#006699">دوم</td>
          <td width="9%" bgcolor="#006699">اول</td>
...
if ($row['no_kesh']=='2') $v_no_kesh='دیم' ;	 
 $t_r = $r ; 
  ?>
          <td colspan="5" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
...
<div class="column" >
   ...
   <span class="success<?php echo $t_r ?>" style="display:none"><img src="../../files/Tick.png" width="15" height="15"  alt=""/></span>
              ...
              <div class="column" >
                <select name="mah_kh" class="required input_text  required" id="mah_kh<?php echo $t_r ;?>"  style="height:40px ; width:50px ; direction:rtl" tabindex="<?php echo $r.'4'?>">
              ...
              <div class="column" >
        <input name="mah_tol"  type="text" class="mah_tol<?php echo $t_r ?> required number input_text" id="mah_tol<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'3'?>"  dir="rtl" lang="fa" value="<?php  echo $row['mah_tol']*1 ; ?>" maxlength="4"  align="baseline" xml:lang="fa" /> </div>
              <div class="column" >
        <input name="s_bar_b"  type="text" class="s_bar_b<?php echo $t_r ?> required digits input_text" id="s_bar_b<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'2'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_bar_b']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
              <div class="column" >
        <input name="s_bar_a"  type="text" class="s_bar_a<?php echo $t_r ?> required digits input_text" id="s_bar_a<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_bar_a']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
            </div>
            </form>
          </td>
          ...
          <br />
          <input name="zer_kesht_b<?php echo $t_r ?>" type="hidden" class="zer_kesht_b<?php echo $t_r ?> required digits style8" id="zer_kesht_b<?php echo $t_r ?>" style="width:40px; height:30px ; " tabindex="<?php echo $r.'1'?>" dir="rtl" lang="fa" value="<?php echo $row['zer_kesht_b']*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" /></td>
          <td class="normalTextSmall" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC'?>><?php echo $row['zer_kesht_a']; ?><br />
          ...
          <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mah_name($row['cod_mah']); ?><br />
            <input name="cod_mah<?php echo $t_r ?>" type="hidden" class="cod_mah<?php echo $t_r ?> required digits style2" id="cod_mah<?php echo $t_r ?>" style="width:30px; height:30px ; " tabindex="<?php echo $r.'1'?>" dir="rtl" lang="fa" value="<?php echo $row['cod_mah'] ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" /></td>
          <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $v_no_kesh?><br />
            <input name="no_kesh<?php echo $t_r ?>" type="hidden" class="no_kesh<?php echo $t_r ?> required digits style2" id="no_kesh<?php echo $t_r ?>" style="width:30px; height:30px ; " tabindex="<?php echo $r.'1'?>" dir="rtl" lang="fa" value="<?php echo $row['no_kesh'] ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" /></td>
...
echo "<ul class='page'>";
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="AgriP_edit_T_98.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
         <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
        <input type="hidden" name="id_mar" value="<?php echo $id_mar ?>" />
