...
?>
  ...
  <div style=" width: 550px; padding: 15px;border: 3px solid navy; margin:auto" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="40" colspan='2' align='center' bgcolor="#FFFFCC"><font size="2" class="style1">تعیین معیار جستجو </font></td>
      </tr>
      <tr bgcolor='#f1f1f1' >
        <td align="right" bgcolor="#F1F1F1" class="input_text" ><form method="post" name="form1" id="form"  action="">
...
?></td>
      ...
      <tr bgcolor='#f1f1f1' >
        <td align="right" bgcolor="#FFFFFF" class="input_text" ><form method="post" name="form1" id="form2"  action="#1">
...
?></td>
      ...
      <tr >
        <td bgcolor="#f1f1f1" class="input_text" align="right" ><form method="post" name="form2" id="form2" >
