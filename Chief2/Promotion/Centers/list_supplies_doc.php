...
header("Content-Disposition: attachment;Filename=supplies_list.doc");
?>
<?php 
include('../../../lock_ce.php');
include('../../../event.php') ;
...
?>
  ...
  <table width="95%" height="94" border="2" align="center" cellpadding="2" cellspacing="2" >
    <tr align="center" class="text1">
      ...
      <td width="4%" bordercolor="#FFFFFF" bgcolor="#999999">تبلت</td>
...
//
$query = "SELECT SUM(num) as num_taj1 FROM promo_cent_supplies where  id_ostan = '$id_ostan' and  id_city='$id_city' and id_mar = '$id_mar' and no_taj = '20' ";
$stmt = $dbh->prepare($query);
$stmt->execute();
...
?>
  <td align="center" width="4%" height="43"  <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $row20['num_taj1'] ?></span></td>
               ...
               <td align="center" bordercolor="#FFFFFF"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row20['num_taj1'] ?></td>
