...
<table width="93%" height="75" border="1" align="center" cellpadding="0" cellspacing="0" >
  <tr align="center" class="style8">
    ...
    <td width="9%" bgcolor="#CCCCCC">تاریخ آخرین بازدید از سامانه</td>
      ...
      <td width="10%" bgcolor="#CCCCCC">سن</td>
      ...
      <td width="11%" bgcolor="#CCCCCC">کد مرکز </td>
...
?>
      ...
      <td bgcolor="#FFFFFF"  class="normalTextSmaller"><?php echo $row['id_mar']; ?></td>
