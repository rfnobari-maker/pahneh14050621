...
<p class="style1">اطلاعات مروجین کشاورزی استان</p>
    ...
    <td colspan="3" bgcolor="#999999"> تعداد مروجین به تفکیک مدرک تحصیلی</td>
...
<td  class="normalTextSmall" <?php  if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="RightMenuCell"><?php echo city_mor_mtah_count($row['id_city'],3)?></span></td>
    <td class="normalTextSmall" <?php  if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="RightMenuCell"><?php echo city_mor_mtah_count($row['id_city'],2)?></span></td>
    <td class="normalTextSmall" <?php  if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="RightMenuCell"><?php echo city_mor_mtah_count($row['id_city'],1)?></span></td>
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> class="normalTextSmall"><?php echo city_mor_count($row['id_city'])?></td>
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  class="normalTextSmall"><?php echo city_mor_jens_count($row['id_city'],1)?></td>
    <?php 
$pic =   $row['pic'] ;
if ($pic == '') $pic = 'no_pic.png'

 ?>
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><span class="normalTextSmaller"><?php echo city_mor_jens_count($row['id_city'],2)?></span></td>
