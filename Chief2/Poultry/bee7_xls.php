...
header("Content-Disposition: attachment;Filename=زنبورستان_به_تفکیک_استان.xls");
include('../../lock_ce.php');
?>
...
$stmt->execute();
?>
<P  class="style1" align="center">گزارش زنبورستان به تفکیک استان بر اساس سرشماری سال : <?php echo $sal?></p>  
...
?>
    ...
    <td align="center" class="style1" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['ostan'];?><br /></td>
