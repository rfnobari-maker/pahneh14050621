...
header("Content-Disposition: attachment;Filename=bee_list_kol.xls");
?>
<?php 
include('../../lock_ce.php');
include('../../event.php') ;
...
<body>
<div align="center" class="style1">لیست نهایی تولید زنبورستان های استان <?php echo ostan_name($id_ostan1)?> به تفکیک شهرستان بر اساس سرشماری <?php echo $sal?></div>
...
?>
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          ...
          <td width="2%" colspan="4" align="center" bgcolor="#FFCC99">تلفات ناشی از بیماری </td>
