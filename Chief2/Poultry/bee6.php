  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
        ...
        <p class="style1">آمار تولید زنبورستان به تفکیک استان </p>
...
?>
  ...
  <table width="69" height="56" border="0" align="center">
    <tr>
      <td width="63"><form  action="bee6_xls.php" method="post">
        <input type="hidden" name="sal" value="<?php echo  $sal ;?>" />
        <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
      </form></td>
    </tr>
  </table>
  <table width="99%" height="205" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
...
$r = 1 ;
 ...
 if(ostan_status($row['id_ostan'])=='1') $conf_status='../../files/icon1Active.png'; 
 if(ostan_status($row['id_ostan'])=='2') $conf_status='../../files/icon1Inactive.png'; ?>
               <td width="2%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(($row['t_zah']/1000),3) ; ?></td>
               <td width="4%" height="38"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['t_bar'],0) ; ?></td>
               ...
               <td width="3%"  class="normalTextSmaller"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><img src="<?php echo $conf_status ;?>" border="0"  title="آخرین وضعیت تایید اطلاعات توسط استان" width="21" height="20" /></td>
               <td width="10%"  class="normalTextSmaller"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><div align="right" style="margin-right:2px"> <?php echo ostan_name($row['id_ostan']);?></div></td>
