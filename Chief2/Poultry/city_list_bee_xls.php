...
if ($id_mar == '') { $v_id_mar = 'id_mar=id_mar' ;} else { $v_id_mar = "id_mar='$id_mar'" ;}
$query = "SELECT * FROM  bee where  id_ostan = '$id_ostan' and  $v_id_city and $v_id_mar and sal = '$sal' "  ;
...
?>
 ...
 ?></td>
          ...
          <td class="normalTextSmall"><?php echo city_name1($row['id_city'],$id_ostan); ?></td>
