...
<body>
 ...
 <table style="border:3px solid #069;" width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
 <?php  if ($no_bah=='1') { ?>
  <td height="26" colspan="5" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقیقی</strong></div></td>
   </tr>
   <tr>
   ...
   <tr>
     <td width="221" height="30"><div align="right">
   ...
   <tr>
     ...
     <td width="160">&nbsp;</td>
     <td height="30" dir="rtl"><div align="right">
   ...
   <tr>
     <td height="37"><div align="right"><span class="style2"><img src="../files/sms.png" width="28" height="32" /></span>
   ...
   <tr>
     ...
     <td width="160">&nbsp;</td>
     <td><div align="right">
       <input name="cod_p" type="text" class="" id="cod_p" style="width:150px; height:30px ; " tabindex="12" dir="rtl" lang="fa" value="<?php echo $cod_p ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
     </div></td>
  ...
  <?php if($s_bah==2) {?>
   <tr>
     ...
     <td height="45" bgcolor="#FFFFCC"><div align="right">
       <input name="city_s" type="text" class="required" id="city_s"  placeholder="شهر" style="width:150px; height:30px ; " tabindex="14" dir="rtl" lang="fa" value="<?php echo $tel_s ; ?>" maxlength="50" readonly="readonly" xml:lang="fa"/>
     </div></td>
     <td height="45" bgcolor="#FFFFCC"><div align="right">
 ...
 <?php }  if ($no_bah=='2') { ?>
     <p class="one" >&nbsp;</p>
     <td height="27" colspan="5" bgcolor="#CCCCCC"  align="right" ><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقوقی</strong></div></td>
   </tr>
   <tr>
     <td height="40"><div align="right">
   ...
   <tr>
     ...
     <td bgcolor="#FFFFFF">&nbsp;</td>
     <td bgcolor="#FFFFFF"><div align="right">
       <input name="name" type="text" class="required" id="name" style="width:150px; height:30px ; " tabindex="8" dir="rtl" lang="fa" value="<?php echo $name ; ?>" maxlength="50" readonly="readonly" xml:lang="fa" />
     </div></td>
     <td bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">: نام مدیرعامل</div></td>
   </tr>
   <tr>
     <td height="37" bgcolor="#FFFFFF"><div align="right"><span class="style2"><img src="../files/sms.png" width="28" height="32" /></span>
 ...
 <table width="95%" height="262" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
   <tr>
     <td height="29" colspan="6" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>زمینه فعالیت کشاورزی</strong></div></td>
   </tr>
   <tr>
     <td width="166" height="42" bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
     ...
     <td width="180" bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:صنایع کشاورزی</div></td>
     <td width="102" bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
     ...
     <td width="177" bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:طیور سنتی</div></td>
     <td width="94" bgcolor="#FFFFFF"><div align="right">
       <p>
     ...
     <td width="173" bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:دارای اراضی زراعی </div></td>
   </tr>
   <tr>
     <td height="42" bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
     ...
     <td bgcolor="#FFFFCC"><div style="margin-right:30px" align="right">:دام سبک</div></td>
   ...
   <tr>
     <td height="42" bgcolor="#FFFFCC">&nbsp;</td>
   ...
   <tr>
     <td height="59" colspan="6"><table width="100%" border="0" style="border:3px solid #069;">
       <tr>
         <td width="38%" height="47">
           <input name="cancel" type="submit" id="cancel" style="width:150px ; height:45px"  title="انصراف و برگشت"  value="انصراف"/></td>
         <td width="23%">
           <input name="notconfi" type="submit" id="notconfi" style="width:150px ; height:45px" title="عدم تایید و برگشت به مروج"  value="عدم تایید" /></td>
         <td width="39%">
           <input name="confi" type="submit" id="confi" style="width:150px ; height:45px" title="تایید اطلاعات بهره بردار"  value="تایید اطلاعات" /></td>
         </tr>
       </table></td>
   </tr>
    </table>
      <input type="hidden" name="back_no" value="<?php echo $back_no ;?>"/>
...
renderForm($error,$date_s,$mor_cod_m,$bah_cod_m,$no_bat,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,$fname,$m_tah,$er_mtah,$tel_s,$tel_m,$ostan_s,$shahr_s,$city_s,$rosta_s,$co_name,$no_co,$sh_meli,$co_sabt,$fa_1,$fa_2,$fa_3,$fa_4,$fa_5,$fa_6,$fa_7,$fa_8,$fa_9,$fa_10,$fa_11,$fa_12,$fa_13,$add_abadi,$add_city);
?>
<?php
//تایید
...
$query = "UPDATE bah  SET confi=?
		WHERE bah_cod_m=?";
$q = $dbh->prepare($query);
$q->execute(array('1',$bah_cod_m));
date_default_timezone_set('Asia/Tehran') ;
$date_edit = jdate("Y/m/d");
$time = date('H:i:s') ;
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'تایید اطلاعات بهره بردار /'.$bah_cod_m,$id_ostan) ; 
...
$query = "UPDATE bah  SET confi=?
		WHERE bah_cod_m=?";
$q = $dbh->prepare($query);
$q->execute(array('2',$bah_cod_m));
date_default_timezone_set('Asia/Tehran') ;
$date_edit = jdate("Y/m/d");
$time = date('H:i:s') ;
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'عدم تایید اطلاعات بهره بردار /'.$bah_cod_m,$id_ostan) ; 
alert('عدم تایید اطلاعات بهره بردار با موفقیت ثبت شد') ; 
$action='1' ; 
}
// انصراف
...
{
?>
<form name="form01" class="form01" method="post" action="mor_list_bah.php">
<input name="mor_cod_m" value="<?php echo $mor_cod_m ;?>"/>
</form>
<script type="text/javascript">document.form01.submit();</script>
<?php 
}
if ($back_no=='3')
{
?>
<form name="form02" class="form02" method="post" action="city_list_bah.php">
<input name="add_city" value="<?php echo $add_city ;?>"/>
</form>
<script type="text/javascript">document.form02.submit();</script>
<?php 
}
if ($back_no=='4')
{
?>
<form name="form02" class="form02" method="post" action="abadi_list_bah.php">
<input name="add_abadi" value="<?php echo $add_abadi ;?>"/>
</form>
<script type="text/javascript">document.form02.submit();</script>
<?php 
}
