...
include('counter.php');
$query = "SELECT username,tel_m,cod_m,name,Last_name,pic FROM  users WHERE  cod_m = $cod_m "  ;
...
<td   width="7%" class="normalTextSmaller">
    ...
    <td width="6%" class="normalTextSmaller" ><?php echo mor_abadi_count($row['cod_m'],$id_ostan)?></td>
