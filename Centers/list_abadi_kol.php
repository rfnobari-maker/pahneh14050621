...
$query = "SELECT * FROM  list_abadi " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
           <p><span class="style1">اطلاعات عمومی  آبادی های تحت پوشش </span></p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <table width="90%" height="100" border="0" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
    <td height="50" colspan="3" bgcolor="#999999">عملیات</td>
    <td width="13%" height="50" bgcolor="#999999"><p> آخرین بروز رسانی اطلاعات<br />
    </p></td>
    <td colspan="2" bgcolor="#999999">مشخصات مروج آبادی</td>
    <td width="13%" bgcolor="#999999">نام آبادی</td>
    <td width="12%" bgcolor="#999999">دهستان</td>
...
?>
<td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> width="7%" height="48"><img src="../files/send_mail.png" width="30" height="30"  alt=""/></td>
<td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> width="6%"><img src="../files/receive_mail.png" width="30" height="30"  alt=""/></td><td width="6%"><form  action="public_abadi.php" method="post">
  ...
  <button><img src="../files/view.png" border="0"  title="مشاهده اطلاعات عمومی آبادی" width="28" height="23" /></button>
   ...
   <td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo $up_date ;?></td>
    <td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> width="18%" class="normalTextSmaller"><?php echo $row2['Last_name'].' '.$row2['name'];?></td>
 <td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> width="6%" class="normalTextSmaller"><img src="../files/users/<?php echo $pic_mo;?>" width="37" height="45"  alt=""/></td>
 <td <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo $row['abadi'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo $row['deh'];?></td>
    <td class="normalTextSmaller" <? if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo $row['city'];?></td>
