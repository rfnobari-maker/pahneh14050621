...
float: left;
      ...
      <div style="float:right ; margin-right:30px ; margin-top:15px ; padding:10px "  > <img src="../files/users/<?php echo $pic ?>" width="76" height="98"  alt="تصویر کاربر "/></div>
...
$row2 = $stmt2->fetch(PDO::FETCH_ASSOC);
 ...
 <?php if ($row2['id_mar'] <> $id_mar )
   {
   echo '<img src=../files/return.png width=86 height=86 >' ;
   echo '<p align=center class=style8> متاسفانه عملکرد مروج ، برای شما قابل مشاهده نیست </p> ' ;
   echo '<p align=center class=style8> محل فعالیت مروج ، مرکز جهاد کشاورزی  '.$row2['markaz'].' ثبت شده است   </p> ' ;
   echo '<p>&nbsp;</p>' ;
   echo '<p>&nbsp;</p>' ;
    }
else 
...
?>
      ...
      <p>
        <!--end form --> 
      <a href="promotes.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/></a></p>
    <p>&nbsp;</p></td>
  </tr>
  <tr>
