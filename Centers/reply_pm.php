 ...
 <form action="" method="post" enctype="multipart/form-data" id="form1" name="form1" >
   ...
   <tr>
     <td height="53" colspan="2"><div align="right">
       <input name="title" type="text" class="required input_text" id="title" style="width:250px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $title ?>" maxlength="250" readonly="readonly" xml:lang="fa" />
       </div></td>
...
sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','ارسال پاسخ پیام خصوصی / '.user_name($r_user)) ; 
  }
  ?>
<?php  
   // فانكشن آپلود فايل 
