...
<body>
    <div class="container">
        ...
        <div class="content-section">
            <h1 class="section-title">بهره برداران کشاورزی</h1>
            <img src="../files/horizontal-line-700x223.png" alt="divider" class="divider">

            <div class="cards-container">
                <div class="card">
                    <a href="list_bah.php" title="لیست بهره برداران کشاورزی">
                        <img src="../files/farmer.png" alt="لیست بهره برداران" class="card-icon">
                    </a>
                    <a href="list_bah.php" class="btn">لیست بهره برداران کشاورزی</a>
                </div>

                <div class="card">
                    <a href="GetPerson.php#1" title="استعلام مشخصات بهره بردار">
                ...
                <div class="card">
                    <a href="search_benef.php" title="سوابق بهره بردار">
