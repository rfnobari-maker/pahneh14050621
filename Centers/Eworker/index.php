...
<tr>
          ...
          <tr>
            <td>
  <?php include('top.php'); ?>
           <p align="center" class="style8"  >مدیریت زراعت </p>
           <p align="center"  ><img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <div class="box" align="center">
             <p><img src="../../files/zera.png" alt="bee" width="86" height="86" border="0" class="tricky_image" /></p>
                <p><a href="Agri1.php" class="btn">ثبت بهره برداری زراعی جدید</a></p>
                <p>&nbsp;</p>
                <p><a href="manager_Agri.php" class="btn">مدیریت بهره برداری زراعی</a></p>
                <p>&nbsp;</p>
           ...
           <p class="style9">&nbsp;</p>
            ...
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
            <p class="style9"><a href="../index.php"> <input type="submit" name="action" value="بازگشت" style="width:150px ; height:45px" tabindex="39" />
              </a>            </p>
            <p>&nbsp;</p></td>
          </tr>
          <tr>
