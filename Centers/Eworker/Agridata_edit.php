...
$t_mah = $_POST['t_mah'] ;
// بانک اطلاعات کشت 
$query = "DELETE FROM Agri_prod WHERE bah_cod_m=? AND sh_gat=? AND z_sal=? ";
$q = $dbh->prepare($query);
$q->execute(array($bah_cod_m,$sh_gat,$z_sal));
...
$query = "INSERT INTO Agri_prod (date_s,mor_cod_m,bah_cod_m,num_bah,sh_gat,id_ostan,id_city,id_mar,add_abadi,add_city,no_kesh,z_sal,mah_mas,cod_qroup,cod_mah,zer_kesht_a,zer_kesht_b,s_bar_a,s_bar_b,mah_tol,mah_tolp,mah_bem)                        VALUES(:date_s,:mor_cod_m,:bah_cod_m,:num_bah,:sh_gat,:id_ostan,:id_city,:id_mar,:add_abadi,:add_city,:no_kesh,:z_sal,:mah_mas,:cod_qroup,:cod_mah,:zer_kesht_a,:zer_kesht_b,:s_bar_a,:s_bar_b,:mah_tol,:mah_tolp,:mah_bem)";
$q = $dbh->prepare($query);
$q->execute(array(':date_s'=>$date_s,':mor_cod_m'=>$mor_cod_m,':bah_cod_m'=>$bah_cod_m,':num_bah'=>$num_bah,':sh_gat'=>$sh_gat,':id_ostan'=>$id_ostan,':id_city'=>$id_city,':id_mar'=>$id_mar,':add_abadi'=>$add_abadi,':add_city'=>$add_city,':no_kesh'=>$no_kesh,':z_sal'=>$z_sal,':mah_mas'=>$mah_mas,':cod_qroup'=>$cod_qroup,':cod_mah'=>$cod_mah,':zer_kesht_a'=>$zer_kesht_a,':zer_kesht_b'=>$zer_kesht_b,':s_bar_a'=>$s_bar_a,':s_bar_b'=>$s_bar_b,':mah_tol'=>$mah_tol,':mah_tolp'=>$mah_tolp,':mah_bem'=>$mah_bem));
// پایان حلقه تنوع محصول 
$num3_t_mah--;
}
$query = "UPDATE  Agri SET 
num_bah=?,add_abadi=? ,add_city=?,m_zamin=?,no_mal=?,lng=?,lat=?,m_cod_m=?,m_vaz_sok=?,no_kesh=?,m_ab=?,md_ab=?,h_ab=?,no_sab=?,no_ab=?,es=?,z_sal=?,s_ayesh=?,t_mah=? WHERE bah_cod_m=? and id=? " ;
$q = $dbh->prepare($query);
$q->execute(array($num_bah,$add_abadi,$add_city,$m_zamin,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesh,$m_ab,$md_ab,$h_ab,$no_sab,$no_ab,$es,$z_sal,$s_ayesh,$t_mah,$bah_cod_m,$id));
...
{
$query = "UPDATE  malek SET m_addres=?,m_jens=?,m_name=?,m_last_name=?,m_fname=?,m_tel_m=? WHERE m_cod_m=?" ;
$q = $dbh->prepare($query);
$q->execute(array($m_addres,$m_jens,$m_name,$m_last_name,$m_fname,$m_tel_m,$m_cod_m));
}

 // ثبت در بانک پیگیری
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'تصحیح اطلاعات زراعی - '.$bah_cod_m) ; 
unset($error,$date_s,$mor_cod_m,$sh_gat,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$no_kesh,$z_sal,$mah_mas,$cod_qroup,$cod_mah,$zer_kesht_a,$zer_kesht_b,$s_bar_a,$s_bar_b,$mah_tol,$mah_tolp,$mah_bem,$m_zamin,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesh,$m_ab,$md_ab,$h_ab,$no_sab,$no_ab,$es,$z_sal,$s_ayesh,$m_addres,$m_jens,$m_name,$m_last_name,$m_fname,$m_tel_m);
alert ('اطلاعات بهره برداری زراعی  با موفقیت تصحیح شد ') ;
?>
<form  name="myform" class="myform" method="post" action="manager_Agri.php">
      ...
      <table width="99%" height="1147" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td><div align="right"><span class="style2">مترمربع</span>
            <input name="m_zamin" type="text" class="input_text required" id="m_zamin" style="width:100px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $m_zamin ; ?>" maxlength="15"  align="baseline" xml:lang="fa" />
            </div></td>
   ...
   <option value="1395-1396" <?php if ($z_sal=='1395-1396') { echo 'selected="selected"' ; } ?>>1395-1396</option>
        ...
        <tr>
          <td height="131" colspan="5"><table width="100%" height="112" border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td width="11%" rowspan="2" bgcolor="#FFFFCC">محصول بیمه شده ؟</td>
              ...
              <td width="9%" rowspan="2" bgcolor="#FFFFCC">مساحت<br />
                <span class="style2">مترمربع</span></td>
              <td width="4%" rowspan="2" bgcolor="#FFFFCC">ردیف</td>
            </tr>
            <tr>
              <td width="8%" bgcolor="#FFFFCC">قطعی</td>
              ...
              <td width="8%" bgcolor="#FFFFCC">اول</td>
              <td width="12%" bgcolor="#FFFFCC">نام</td>
              <td width="13%" bgcolor="#FFFFCC">گروه</td>
              </tr>
<?php 
$n = 1 ;
$num2_t_mah = $t_mah ;
...
while ($xx > 0)
{
$query = "INSERT INTO Agri_prod (bah_cod_m,sh_gat,z_sal)              
        VALUES(:bah_cod_m,:sh_gat,:z_sal)";
$q = $dbh->prepare($query);
$q->execute(array(':bah_cod_m'=>$bah_cod_m,':sh_gat'=>$sh_gat,':z_sal'=>$z_sal));
$xx-- ; 
}
...
$sql = "DELETE FROM Agri_prod where bah_cod_m = :bah_cod_m and sh_gat=:sh_gat and z_sal = :z_sal ORDER BY id DESC LIMIT $xx ";
...
?>
            ...
            <tr>
              <td height="36" bgcolor="#FFFFFF"><div align="center">
                <select name="mah_bem<?php echo $num2_t_mah ;?>" class="required input_text  required" id="mah_bem<?php echo $num2_t_mah ;?>"  style="height:40px ; width:100px ; direction:rtl" tabindex="30">
                  <option value="">انتخاب کنید</option>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  echo $mah_tol ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  echo $mah_tolp ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_b<?php echo $num2_t_mah ;?>" type="text" class="s_bar_b required number input_text" id="s_bar_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $s_bar_b ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_a<?php echo $num2_t_mah ;?>" type="text" class="s_bar_a required number input_text" id="s_bar_a<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $s_bar_a ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="zer_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_b required number input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_b ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
    <input name="zer_kesht_a<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_a required number input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_a ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
...
?>
   ...
   <?php if ($row['group_cod']==$group_cod) echo 'selected=selected'?>> <?php echo $row['group_name'] ;?></option>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_mas<?php echo $num2_t_mah ;?>" type="text" class="mashat required number input_text" id="mashat<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $mah_mas ;?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
...
?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right"><span class="style2">مترمربع</span>
            <input name="s_ayesh" type="text" class="mashat input_text required number" id="s_ayesh" style="width:100px; height:30px ; " tabindex="31" dir="rtl" lang="fa" value="<?php echo $s_ayesh ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
            </div></td>
