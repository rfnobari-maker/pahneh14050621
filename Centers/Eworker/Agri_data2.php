...
$query = "INSERT INTO Agri (date_s,mor_cod_m,bah_cod_m,num_bah,sh_gat,id_ostan,id_city,id_mar,add_abadi,add_city,m_zamin,no_mal,lng,lat,m_cod_m,m_vaz_sok,no_kesh,m_ab,md_ab,h_ab,no_sab,no_ab,es,z_sal,s_ayesh,t_mah)                        VALUES(:date_s,:mor_cod_m,:bah_cod_m,:num_bah,:sh_gat,:id_ostan,:id_city,:id_mar,:add_abadi,:add_city,:m_zamin,:no_mal,:lng,:lat,:m_cod_m,:m_vaz_sok,:no_kesh,:m_ab,:md_ab,:h_ab,:no_sab,:no_ab,:es,:z_sal,:s_ayesh,:t_mah)";
$q = $dbh->prepare($query);
...
$q->execute(array(':date_s'=>$date_s,':mor_cod_m'=>$mor_cod_m,':m_cod_m'=>$m_cod_m,':m_addres'=>$m_addres,':m_jens'=>$m_jens,':m_name'=>$m_name,':m_last_name'=>$m_last_name,':m_fname'=>$m_fname,':m_tel_m'=>$m_tel_m));
 ...
 // ثبت در بانک پیگیری
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'ثبت اطلاعات زراعی - '.$bah_cod_m) ; 
unset($error,$date_s,$mor_cod_m,$bah_cod_m,$sh_gat,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$no_kesh,$z_sal,$mah_mas,$cod_qroup,$cod_mah,$zer_kesht_a,$zer_kesht_b,$s_bar_a,$s_bar_b,$mah_tol,$mah_tolp,$mah_bem,$m_zamin,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesh,$m_ab,$md_ab,$h_ab,$no_sab,$no_ab,$es,$z_sal,$s_ayesh,$m_addres,$m_jens,$m_name,$m_last_name,$m_fname,$m_tel_m);
        ...
        <tr>
          <td height="131" colspan="5"><table width="100%" height="112" border="1" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="6%" rowspan="2" bgcolor="#FFFFCC">مساحت<br />
                <span class="style2">مترمربع</span></td>
              <td width="3%" rowspan="2" bgcolor="#FFFFCC">ردیف</td>
            </tr>
            <tr>
              ...
              <td width="9%" bgcolor="#FFFFCC">دوم</td>
              <td width="8%" bgcolor="#FFFFCC">اول</td>
              <td width="15%" bgcolor="#FFFFCC">نام</td>
...
?>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>2" style="width:70px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  $mah_tol.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  $mah_tolp.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
...
?>
   ...
   <?php if ($row['group_cod']==$group_cod) echo 'selected=selected'?>> <?php echo $row['group_name'] ;?></option>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_mas<?php echo $num2_t_mah ;?>" type="text" class="mashat required digits input_text" id="mashat<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php $mah_mas ;?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
...
?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right"><span class="style2">مترمربع</span>
            <input name="s_ayesh" type="text" class="mashat input_text required digits" id="s_ayesh" style="width:100px; height:30px ; " tabindex="31" dir="rtl" lang="fa" value="<?php echo $s_ayesh ; ?>" maxlength="70"  align="baseline" xml:lang="fa" />
            </div></td>
