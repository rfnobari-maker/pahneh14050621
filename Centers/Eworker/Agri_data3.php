...
$query = "INSERT INTO Agri_prod (date_s,mor_cod_m,bah_cod_m,num_bah,sh_gat,id_ostan,id_city,id_mar,add_abadi,add_city,no_kesh,z_sal,mah_mas,cod_qroup,cod_mah,zer_kesht_a,zer_kesht_b,s_bar_a,s_bar_b,mah_tol,mah_bem)                        VALUES(:date_s,:mor_cod_m,:bah_cod_m,:num_bah,:sh_gat,:id_ostan,:id_city,:id_mar,:add_abadi,:add_city,:no_kesh,:z_sal,:mah_mas,:cod_qroup,:cod_mah,:zer_kesht_a,:zer_kesht_b,:s_bar_a,:s_bar_b,:mah_tol,:mah_bem)";
$q = $dbh->prepare($query);
        ...
        <tr>
          <td height="131" colspan="5"><table width="100%" height="112" border="1" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="5%" rowspan="2" bgcolor="#FFFFCC">مساحت<br />
                <span class="style2">مترمربع</span></td>
...
?>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>2" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>2" style="width:70px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  $mah_tol.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
