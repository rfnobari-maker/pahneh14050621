...
include('../../login/config.php');
$query = "INSERT INTO Eworker (date_s,cod_m,id_ostan,id_city,id_mar,add_abadi,cod_sh_m,jens,sal_z,v_tah,no_fam,f_tm,r_tah,g_tah,addres,no_oz,oz_ta,name_co)                       VALUES(:date_s,:cod_m,:id_ostan,:id_city,:id_mar,:add_abadi,:cod_sh_m,:jens,:sal_z,:v_tah,:no_fam,:f_tm,:r_tah,:g_tah,:addres,:no_oz,:oz_ta,:name_co)";
$q = $dbh->prepare($query);
$q->execute(array(':date_s'=>$date_s,':cod_m'=>$cod_m,':id_ostan'=>$id_ostan,':id_city'=>$id_city,':id_mar'=>$id_mar,':add_abadi'=>$add_abadi,':cod_sh_m'=>$cod_sh_m,':jens'=>$jens,':sal_z'=>$sal_z,':v_tah'=>$v_tah,':no_fam'=>$no_fam,':f_tm'=>$f_tm,':r_tah'=>$r_tah,':g_tah'=>$g_tah,':addres'=>$addres,':no_oz'=>$no_oz,':oz_ta'=>$oz_ta,':name_co'=>$name_co));
 // ثبت در بانک پیگیری
...
<body>
  ...
  <tr>
    <td>
      <?php include('top.php'); ?>
           <p class="style8">ثبت اطلاعات مدد کار ترویجی<br />
    ...
    <form action="" method="post" id="form1" name="form1">
      <table width="90%" height="245" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td><div align="right">: آبادی</div></td>
          <td>&nbsp;</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="50" colspan="4"><div align="right"><span style="text-align: right">
                  <textarea name="addres" cols="80" rows="4" class="required input_text" id="addres" tabindex="9"><?php echo $m_addres ;?></textarea>
                </span></div></td>
     ...
     <input type="submit" name="action" value="ثبت اطلاعات" id="submit" style="width:150px ; height:45px" tabindex="13" />
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
