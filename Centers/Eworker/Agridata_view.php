  ...
  <tr>
    ...
    <form action="liste_Agri.php" method="post" id="form1" name="form1">
      <table width="99%" height="1147" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          <td width="31%" height="40"><div align="right"><?php echo city_name1($id_city,$id_ostan1) ?></div></td>
...
?>
    ...
    <input name="zer_kesht_a<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_a required digits input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_a ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" />
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                ...
                <span style="margin:10px"><div align="right"></div></td>
...
?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right"><span class="style2">مترمربع</span>
            <input name="s_ayesh" type="text" class="mashat input_text required digits" id="s_ayesh" style="width:100px; height:30px ; " tabindex="31" dir="rtl" lang="fa" value="<?php echo $s_ayesh ; ?>" maxlength="70" readonly="readonly"  align="baseline" xml:lang="fa" />
            </div></td>
          ...
          <div align="center">
        <p>
     <input type="submit" name="action" value="بازگشت" id="submit" style="width:150px ; height:45px" tabindex="32" />
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
