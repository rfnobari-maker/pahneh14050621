...
<tr>
          ...
          <tr>
            <td>
  <?php include('top.php'); ?>
           <p align="center" class="style8"  > محصولات عمده صیفی</p>
           <p align="center"  ><img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <div class="box" align="center">
             <p><a href="liste_Vege.php"><img src="../../files/Vege_list1.png" alt="agri_list" width="83" height="81" border="0" class="tricky_image" /></a></p>
                <p><a href="liste_Vege.php" class="btn">لیست قطعات ثبت اولیه</a></p>
              </div>
           <div class="box" align="center">
             <p><a href="liste_T_Vege.php"><img src="../../files/Vege_list2.png" alt="Vege" width="83" height="81" border="0" class="tricky_image" /></a></p>
             <p><a href="liste_T_Vege.php" class="btn">لیست قطعات تکمیلی</a></p>
           </div>
           <div class="box" align="center">
           ...
           <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p>
            <p class="style9">&nbsp;</p><p><a href="index.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
          </tr>
          <tr>
