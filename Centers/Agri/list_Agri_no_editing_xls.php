...
header("Content-Disposition: attachment;Filename=لیست_بهره_برداران_زراعی_فاقد_ویرایش.xls");
include('../../lock_p2.php');
include('../../event.php') ;
...
inner join bah ON $Agri_table.bah_cod_m = bah.bah_cod_m
  where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_no_kesh and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $v_m_cod_m and  $Agri_table.date_s not like '%/%' and $f_ok ORDER BY mor_cod_m ASC";
$stmt= $dbh->prepare($query);
$stmt->execute(array(':mor_cod_m'=>$login_session));
?>
             <p align="center" dir="rtl">لیست قطعات زراعی فاقد ویرایش - سال زراعی <?php echo $z_sal?></p>
    ...
    <td width="11%" bgcolor="#999999">وضعیت حیات</td>
...
?>
    ...
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $v_ok ;?></td>
