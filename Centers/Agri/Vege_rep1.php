    ...
    <td width="840" >
      ...
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="421" border='0' align="center" cellpadding='0' cellspacing='0'>
               <tr bgcolor='#f1f1f1' >
...
?></td>
               ...
               <tr >
                 ...
                 <td height="54"  align='center' bgcolor="#DDDDDD" class="style8">: منبع آب</td>
                 <td height="54" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
                 ...
                 <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="style8">:فصل تولید</font></td>
               </tr>
               <tr >
