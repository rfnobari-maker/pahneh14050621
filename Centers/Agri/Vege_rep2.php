...
?>
               ...
               <tr >
                 ...
                 <td height="54" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <select name="mah_bazar" class="required input_text  required" id="mah_bazar"  style="height:40px ; width:150px ; direction:rtl" tabindex="4">
                     <option value="">انتخاب کنید</option>
...
?>
          ...
          <p><a href="Vege_pro.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    
          </p></td>
  </tr>
  <tr>
