...
$query = "SELECT id,id_ostan,id_city,add_abadi,add_city,bah_cod_m,m_cod_m,mor_cod_m,sh_gat,no_mal,no_kesh,m_zamin,t_mah,z_sal from $Agri_table where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_no_kesh and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and  $v_t_mah ORDER BY id ASC";
$stmt= $dbh->prepare($query);
$stmt->execute(array(':mor_cod_m'=>$login_session));
?>
             <p align="center" dir="rtl">لیست قطعات زراعی - سال زراعی <?php echo $z_sal?></p>
      <table width="98%" height="90" border="0" align="center" cellpadding="1" cellspacing="1" >
    ...
    <td width="11%" bgcolor="#999999">شماره همراه بهره بردار</td>
...
?>
    ...
    <td height="31"  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo $v_no_kesh?></span></td>
    ...
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['bah_cod_m'];?></td>
