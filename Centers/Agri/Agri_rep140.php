...
if(isset($_GET['id']))
{
 ...
 $query = "SELECT DISTINCT bah_cod_m,mor_cod_m from Agri where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal  ORDER BY bah_cod_m ASC LIMIT $start, $limit "; 
