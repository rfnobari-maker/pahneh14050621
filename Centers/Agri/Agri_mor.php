...
<p>
    ...
    لیست محصولات زراعی ثبت شده توسط کارشناس پهنه: 
    <strong><?php echo htmlspecialchars(user_name($mor_cod_m), ENT_QUOTES, 'UTF-8'); ?></strong>
...
where $v_mor_cod_m   Group by cod_mah "  ;
