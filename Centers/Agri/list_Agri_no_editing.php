...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 <td width="209" height="46" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_mar" disabled="disabled" class="input_text" id="bakh" style="width:170px ; height:40px" dir="rtl">
...
if ($id < 1) $id = 1; // Ensure id is not zero or negative
$start = ($id - 1) * $limit;
$query1 = "";
