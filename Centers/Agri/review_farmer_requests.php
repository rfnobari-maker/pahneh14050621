...
$f_status  = isset($_POST['f_status']) ? $_POST['f_status'] : '0'; // پیش‌فرض: بررسی نشده

// ۲. ساخت پرس‌وجو
$sql = "SELECT * FROM Agri_req_bah WHERE id_mar = :id_mar AND z_sal = :z_sal";
...
$params = array(':id_mar' => $id_mar, ':z_sal' => $z_sal);
...
function getStatusLabel($status) {
    switch ($status) {
        case '1':  return '<span style="color:#27ae60; font-weight:bold;">تایید شده</span>';
        case '11': return '<span style="color:#e74c3c; font-weight:bold;">رد شده</span>';
                            ...
                            <form method="post" action="review_farmer_requests.php">
                              ...
                              <div class="filter-row">
                                    ...
                                    <select name="f_status">
                                        ...
                                        <option value="0" <?php if($f_status === '0') echo 'selected'; ?>>بررسی نشده</option>
                                        <option value="1" <?php if($f_status === '1') echo 'selected'; ?>>تایید شده</option>
                                        <option value="11" <?php if($f_status === '11') echo 'selected'; ?>>رد شده</option>
