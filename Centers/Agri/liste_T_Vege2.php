...
<body>
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             <p> <span class="style1">ثبت اطلاعات تکمیلی  بهره برداری های جالیزی </span></p>
...
where  Vege.confi='2' and Vege_prod.date_ab <= '$date_check' and $v_confi2 and $v_add_abadi and $v_add_city and $f_b_time and $f_m_ab and $v_bah_cod_m and $v_mor_cod_m and $v_z_sal  group by Vege.id ";
...
if ($row['m_ab']=='11')  $v_m_ab='سایر' ;
  ?>
          <td width="7%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php if ($row['confi2']!='2')  {?>
