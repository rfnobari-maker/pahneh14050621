...
try {
    $stmt = $dbh->prepare("SELECT * FROM Agri_req_bah WHERE id = :id AND reg_status = 0");
    ...
    $sql_update = "UPDATE Agri_req_bah  SET reg_status = :status, center_comment = :comment, center_date = :mdate WHERE id = :id";
