               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td height="46" align="right" bgcolor="#DDDDDD" class="input_text" >
                  <?php $id_ostan1 = $id_ostan?>
                   <select  name="id_ostan" class="style8" id="id_ostan" disabled="disabled" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?></td>
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <select  name="id_city" class="style8" id="id_city" disabled="disabled" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                 ...
                 <select  name="id_mar" class="style8" id="id_mar" disabled="disabled" style="width:170px ; height:40px" dir="rtl" onchange="this.form.submit()">
