            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <a href="liste_Garden.php" title="لیست بهره برداری های باغی">
                        <img src="../../files/tree.png" alt="bee" class="card-icon">
                    </a>
                ...
                <div class="card">
                    <a href="Garden_rep13.php" title="گزارش محصولات باغی">
                        <img src="../../files/Garden_rep13.png" alt="bee" class="card-icon">
                    </a>
                ...
                <div class="card">
                    <a href="Garden_rep15.php" title="گزارش محصولات باغی / بهره بردار">
                        <img src="../../files/Garden_rep15.png" alt="bee" class="card-icon">
                    </a>
                ...
                <div class="card">
                    <a href="Garden_no_edit.php" title="ویرایش نشده ها">
                        <img src="../../files/return.png" alt="bee" class="card-icon">
                    </a>
