...
<body>
  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
      <span class="style8">اطلاعات سالن های  واحد های پرورش قارچ</span><br />
      </p>
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                 ...
                 <td rowspan="2" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_mar" disabled="disabled" class="style8" id="id_mar" style="width:170px ; height:40px" tabindex="4" dir="rtl" onchange="this.form.submit()">
...
$f_no_mush and $v_bah_cod_m and $v_mor_cod_m  ORDER BY id_ostan,id_city,bah_cod_m ASC LIMIT $start, $limit "; 
$query1 = "SELECT Mushroom.id_ostan,Mushroom.id_city,Mushroom.id_mar,Mushroom.bah_cod_m
,Mushroom.no_mush,Mushroom.unit_name
,Mushroom.mor_cod_m,Mushroom.m_zamin,Mushroom.m_arseh,Mushroom.m_salon
,Mushroom_spawn.num_row,Mushroom_spawn.num_t_row,Mushroom_spawn.h_t,Mushroom_spawn.w_t,Mushroom_spawn.num_spawn,Mushroom_spawn.zer_kesh
,Mushroom_prod.t_dpar
...
inner join Mushroom_prod ON Mushroom.id = Mushroom_prod.unit_id and Mushroom_prod.y_prod = '$y_prod'
where  $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and Mushroom_prod.y_prod = '$y_prod' and 
$f_no_mush and $v_bah_cod_m and $v_mor_cod_m  ORDER BY bah_cod_m "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td><form  action="Mush_rep5_xls.php" method="post">
            ...
            <table width="99%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
              <tr class="text1">
                <td width="6%" rowspan="2" bgcolor="#006699">سطح زیر کشت سالن<br />
...
{
	?>
    <form  action="Mush_rep5.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="Mush_rep5.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
        <input type="hidden" name="id_mar" value="<?php echo $id_mar ?>" />
