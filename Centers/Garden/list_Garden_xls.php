...
include ('../../login/config.php');
 $query = "SELECT id_ostan,id_city,id_mar,nah_kesh,no_kesh,sh_gat,mor_cod_m,bah_cod_m,z_sal,no_mal,m_zamin,add_abadi,add_city from Garden where  $v_id_ostan  and  $v_id_city and  $v_id_mar and $v_nah_kesh and $f_no_kesh and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $v_z_sal   ORDER BY id ASC  "; 
...
?>
    ...
    <td width="13%" bgcolor="#999999">شماره همراه بهره بردار</td>
