...
<body>
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             <p> <span class="style1">لیست واحدهای فاقد عملکرد تولید </span> </p>
             <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="582" border='0' align="center" cellpadding='0' cellspacing='0'>
                 ...
                 <tr bgcolor='#f1f1f1' >
                   ...
                   <td  align='center' bgcolor="#DDDDDD" ><span ><font size="2" class="normalTextSmall">: عملکرد سال </font></span></td>
                  </tr>
                 <tr bgcolor='#f1f1f1' >
                   <td height="46" align="right" bgcolor="#FFFFFF" class="input_text" >&nbsp;</td>
                   <td  align='center' bgcolor="#FFFFFF" class="normalTextSmall">&nbsp;</td>
                   <td height="46" align="right" bgcolor="#FFFFFF" class="input_text" ><?php $id_ostan1 = $id_ostan ?>
...
?></td>
                   <td  align='center' bgcolor="#FFFFFF" class="normalTextSmall">: استان</td>
                  </tr>
                 <tr bgcolor='#f1f1f1' >
                   <td width="204" height="46" align="right" bgcolor="#DDDDDD" class="input_text" >&nbsp;</td>
                   <td width="134"  align='center' bgcolor="#DDDDDD" class="normalTextSmall">&nbsp;</td>
                   <td height="46" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_city5" disabled="disabled" class="style8" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?></td>
                   <td  align='center' bgcolor="#DDDDDD" class="normalTextSmall"><span class="style1"><font size="2" class="normalTextSmall">:شهرستان</font></span></td>
                  </tr>
                 <tr >
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                   ...
                   <td rowspan="2" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_mar" disabled="disabled" class="style8" id="id_mar" style="width:170px ; height:40px" dir="rtl" onchange="this.form.submit()">
...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
                 ...
                 <tr >
                   ...
                   <td height="52" align="right" bgcolor="#FFFFFF" class="style1" ><font size="2" class="normalTextSmall">: منبع آب</font></td>
                   <td width="196" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   ...
                   <td width="166"  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="normalTextSmall">: نوع قارچ پرورشی</font></td>
                 </tr>
                 <tr>
                   ...
                   <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">: نوع مجوز</font></td>
                 </tr>
                 <tr >
                   <td height="50" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right"><span class="style2">تن در سال</span>
                   ...
                   <td  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="normalTextSmall">ظرفیت اسمی<br />
                 ...
                 <tr >
                   ...
                   <td height="50"  align='center' bgcolor="#DDDDDD" class="style1" ><font size="2" class="normalTextSmall">: برق</font></td>
                   <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
                   ...
                   <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall"> : گاز طبیعی</font></td>
                 </tr>
                 <tr >
...
<?php 
 ...
 if ($add_abadi  == '0') { $v_add_abadi = 1; }else { $v_add_abadi = "Mushroom.add_abadi = '$add_abadi'" ;}
 if ($add_city == '0')  { $v_add_city  = 1 ; }else{ $v_add_city = "Mushroom.add_city = '$add_city'" ;}
 if ($no_mush == '0')  { $f_no_mush  = 1  ; }else{ $f_no_mush = "Mushroom.no_mush = '$no_mush'" ;}
 ...
 if ($m_cod_m == '')  { $v_m_cod_m  = 1  ; }else{ $v_m_cod_m = "Mushroom.m_cod_m = '$m_cod_m'" ;}
 if ($no_moj == '')  { $f_no_moj  = 1  ; }else{ $f_no_moj = "Mushroom.no_moj = '$no_moj'" ;}
 if ($m_ab == '')  { $f_m_ab  = 1  ; }else{ $f_m_ab = "Mushroom.m_ab = '$m_ab'" ;}
 if ($gaz == '')  { $f_gaz  = 1  ; }else{ $f_gaz = "Mushroom.gaz = '$gaz'" ;}
 if ($barg == '')  { $f_barg  = 1  ; }else{ $f_barg = "Mushroom.barg = '$barg'" ;}
 if ($z_es1 == '')  { $f_z_es1   = 1  ; }else{ $f_z_es1 = "Mushroom.z_es >= $z_es1" ;}
 if ($z_es2 == '')  { $f_z_es2  = 1  ; }else{  $f_z_es2 = "Mushroom.z_es <= $z_es2" ;}
$start=0;
$limit=25;
if(isset($_GET['id']))
{
...
$query = "SELECT Mushroom.* from Mushroom
left join Mushroom_prod On Mushroom_prod.unit_id = Mushroom.id and Mushroom_prod.y_prod='$y_prod'
...
and $f_z_es2 and  Mushroom_prod.unit_id is null 
 ORDER BY Mushroom.bah_cod_m ASC LIMIT $start, $limit  "; 
$query1 = "SELECT Mushroom.id from Mushroom 
left join Mushroom_prod On Mushroom_prod.unit_id = Mushroom.id and Mushroom_prod.y_prod='$y_prod'
 where  $v_mor_cod_m and $v_id_ostan and $v_id_city and  $v_add_abadi and $v_add_city 
and $f_no_mush and $v_bah_cod_m  and $v_m_cod_m and $f_m_ab and $f_gaz and $f_barg and $f_no_moj and $f_z_es1
and $f_z_es2 and  Mushroom_prod.unit_id is null 
 ORDER BY Mushroom.bah_cod_m "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
...
<form  action="list_Mushroom_nonP_xls.php" method="post">
...
if ($row['no_mush']=='3')  $v_no_mush='سایر قارچ های پرورشی خاص';
  ?>
          <td width="2%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>  <form  action="../send_pm1.php#1" method="post" onsubmit="target_popup2(this)">
...
{
	?>
    <form  action="list_Mushroom_nonP.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="list_Mushroom_nonP.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
        <input type="hidden" name="y_prod" value="<?php echo $y_prod ?>" />
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
