...
if(isset($_GET['id']))
{
  ...
  $query = "SELECT id,id_ostan,id_city,id_mar,no_kesht,no_saz,no_gol,sys_kesh,mor_cod_m,bah_cod_m,no_mal,m_zamin,add_abadi,add_city,num_bah,no_moj,m_zamin_gol from Greenhous where $v_id_ostan  and $v_id_city and  $v_id_mar  and $f_no_kesht and $f_no_saz and $f_no_gol and $f_sys_kesh and $f_sys_hot and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and $f_no_moj  ORDER BY mor_cod_m ASC LIMIT $start, $limit "; 
