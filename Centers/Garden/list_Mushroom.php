...
?></td>
                 ...
                 <tr bgcolor='#f1f1f1' >
                   ...
                   <td height="46" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city3" disabled="disabled" class="style8" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
$start=($id-1)*$limit;
 ...
 where  $v_mor_cod_m and $v_id_ostan and $v_id_city and $v_id_mar and  $v_add_abadi and $v_add_city 
