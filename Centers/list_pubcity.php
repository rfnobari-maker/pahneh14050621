...
<body>
  ...
  <tr>
   ...
   <?php include('top.php'); ?>
    <td width="840" ><?php 
$query = "SELECT add_city,mor_cod_m,shahr,bakh FROM  list_city WHERE  id_mar = '$id_mar' " ;
...
?>
               ...
               <td width="6%"><form  action="public_city.php" method="post">
                 ...
                 <button><img src="../files/view.png" border="0"  title="مشاهده اطلاعات عمومی شهر" width="31" height="31" /></button>
               </form></td>
               ...
               <td <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><form action="city_list_bah.php" method="post">
                 <input type="hidden" name="add_city" value="<?php echo $row['add_city'] ;?>" />
