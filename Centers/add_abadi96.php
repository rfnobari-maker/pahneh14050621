...
?>
  ...
  <p>
   ...
   <input type="hidden" name="markaz" value="<?php echo $row3['mar'] ;?>">
   <input type="hidden" name="id_mar" value="<?php echo $row3['id_mar'] ;?>">
...
// echo abadi_name($add_abadi); 
  ...
  $no_request ='4' ; 
  $date_edit ; 
echo $id_abadi = substr($add_abadi,13,6) ;
echo '<p>' ; 
echo $query3 = "SELECT * FROM  public_abadi4  where id_abadi = $id_abadi " ;
$stmt3 = $dbh->prepare($query3);
$stmt3->execute();
$row3 = $stmt3->fetch(PDO::FETCH_ASSOC);
echo '<p>' ; 
echo $abadi = $row3['abadi'] ;
 }
?>