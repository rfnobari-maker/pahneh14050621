...
if ($count_codm>1) {
?>
	 <form name="myform1" class="myform" method="post" id="myCoolForm" action="../../../prof/Agri/bahEdit_history.php">
...
?>
	 <form name="myform1" class="myform" method="post" action="../../../prof/Agri/Agridata_edit.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
           <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
...
<body>
  ...
  <tr>
          ...
          <tr>
            <td><?php include('../../../prof/Agri/menu.php'); ?>
</td>
  </tr>
  <tr>
...
?>
   ...
   <td width="18%" height="68" align="right">   <div align="right">
                   ...
                   <td width="31%"><div align="right"> : کد ملی  </div></td>
                 </tr>
                 <tr>
           ...
           <p><a href="../../../prof/index.php" title="برگشت به صفحه قبل"><img src="../../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>
          <p>&nbsp;</p></td>
  </tr>
  <tr>
