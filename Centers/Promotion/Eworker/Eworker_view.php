...
<body>
  ...
  <tr>
    ...
    <form action="<?php echo $m_page?>" method="post" id="form1" name="form1">
      <table width="90%" height="245" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="33%" height="58"><div align="right">
                  <select name="jens_" disabled="disabled"  class="input_text mar required" id="jens_"  style="height:40px ; width:120px ; direction:rtl" tabindex="2">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td><div align="right">
                  <select name="no_ham" disabled="disabled"  class="input_text mar required" id="no_ham"  style="height:40px ; width:200px ; direction:rtl" tabindex="11">
          ...
          <div align="center">
        <p>
     <input type="hidden" name="cod_m" value="<?php echo $bah_cod_m  ;?>" />
    ...
    <input type="hidden" name="action_lise" value="1" />
     <input type="submit" name="action" value="بازگشت" id="submit" style="width:150px ; height:45px" tabindex="13" />
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
