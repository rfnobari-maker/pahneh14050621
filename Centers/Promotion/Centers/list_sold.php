...
$query = "SELECT tel_m,cod_m,Last_name,name,pic FROM  users WHERE  id_ostan = '$id_ostan' and id_mar = '$id_mar' and S_access = '51'"  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
<p class="style1">لیست سربازان سازندگی ، مرکز</p>
           ...
           <table width="93%" height="115" border="0" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td width="11%" bgcolor="#999999">تلفن همراه</td>
...
?>
               ...
               <td width="6%" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="del_sold.php" method="post">
                   <input type="hidden" name="cod_m" value="<?php echo $row['cod_m'] ;?>" />
                 <button  onclick="return confirm('از حذف سرباز سازندگی با نام <?php echo $row['Last_name'] ;?> مطمئن هستید ؟ ')"><img src="../../../files/delete.jpg" width="31" height="31" title="حذف کاربر" /></button>
                </form></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="7%" class="normalTextSmaller"><form  action="edit_sold.php" method="post">
                 <input type="hidden" name="cod_m" value="<?php echo $row['cod_m'] ;?>" />
                 <button><img src="../../../files/edit.png" border="0"  title="ویرایش اطلاعات همکار" width="31" height="31" /></button>
                </form></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="7%" class="normalTextSmaller"><form  action="view_sold.php" method="post">
                 <input type="hidden" name="cod_m" value="<?php echo $row['cod_m'] ;?>" />
...
?>
           ...
           <p>&nbsp;</p>
             <a href="personnel.php"><button ><img src="../../../files/goback.jpg" width="118" height="47"  alt=""/></button></a>
      </td>
  </tr>
  <tr>
