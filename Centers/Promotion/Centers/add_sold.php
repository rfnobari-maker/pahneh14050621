...
include('top.php');
 ...
 ?>
         ...
         <p align="center" class="style1"> ثبت مشخصات سرباز سازندگی جدید <br />
        ...
        <table style="border:3px solid #069;" width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <tr>
              ...
              <input name="date_kh" type="text" class="pdate required" id="pcal4" style="width:150px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $date_kh ; ?>" maxlength="10" xml:lang="fa" />            </div></td>
     ...
     <input type="hidden" name="previous" value="<?php echo $previous ;?>">
      <a href="personnel.php"><input name="action2" type="button" style="width:150px ; height:45px" tabindex="20"  value="بازگشت" /></a>&nbsp;
     <input type="submit" name="action" value="ثبت اطلاعات" style="width:150px ; height:45px" tabindex="19" />
...
//S_access = 50 نیروهای پشتیبانی
 $sql=$dbh->prepare("INSERT INTO users (username,id_ostan,id_city,id_mar,ostan,city,markaz,cod_m,date_es,date_kh,name,Last_name,sh_sh,date_t,m_sodor,fname,m_tah,r_tah,univer,m_date,avre,v_tahol,tel_s,tel_m,addres,S_access) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
$sql->execute(array($username,$id_ostan,$id_city,$id_mar,$ostan,$city,$mar,$cod_m,$date_es,$date_kh,$name,$last_name,$sh_sh,$date_t,$m_sodor,$fname,$m_tah,$r_tah,$univer,$m_date,$avre,$v_tahol,$tel_s,$tel_m,$addres,51));
    // $mess = "کاربر جدید با موفقیت ثبت شد ";
	sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','ثبت اطلاعات سرباز سازندگی جدید ',$id_ostan) ; 
	 alert('اطلاعات سرباز سازندگی جدید با موفقیت ثبت شد ');
?>
