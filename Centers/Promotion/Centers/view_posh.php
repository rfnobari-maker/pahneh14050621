          ...
          <table style="border:3px solid #069;" width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="42" colspan="2"><div align="right">
                <select name="no_es" disabled="disabled" class="required" id="no_es" style="height:40px ; width:150px ; direction:rtl" tabindex="4">
            ...
            <tr>
              ...
              <td><div align="right">
                <select name="jens" disabled="disabled" class="required" id="jens" style="height:40px ; width:100px ; direction:rtl" tabindex="7">
                  <option value="">انتخاب کنید</option>
            ...
            <tr>
              ...
              <td height="42"><div align="right">
                <select name="v_tahol" disabled="disabled" class="required" id="v_tahol" style="height:40px ; width:150px ; direction:rtl" tabindex="17">
                  <option value="">انتخاب کنید</option>
