  ...
  <table width="50%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <select name="add_abadi" id="select" class="required input_text " dir="rtl"  style="width:300px ; height:30px">
        ...
        <?php
echo $query3 = "SELECT add_abadi,abadi,ostan,city from public_abadi4 where id_ostan = '$id_ostan' and id_city = '$id_city' ORDER BY abadi ASC ";
...
$query3 = "SELECT abadi FROM  public_abadi  where id_abadi = $id_abadi " ;
$stmt3 = $dbh->prepare($query3);
$stmt3->execute();
