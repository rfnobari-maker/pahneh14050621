...
sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','حذف تصویر کاربر') ; 
 }
 //
if($_FILES['pic']['name']) {
...
sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','آپلود تصویر کاربر') ; 
} 
...
sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','ویرایش اطلاعات کاربر') ; 
