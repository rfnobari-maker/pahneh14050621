...
<div id="message-box" dir="rtl" >
   <p>همکار محترم </br>
   <p>پیرو نامه مندرج در همین صفحه آخرین وضعیت همکاران کارشناس پهنه خود را باید مجددا بروز رسانی فرمایید . </br>
   <p>خواهشمند است همکاری لازم جهت تسریع در ساماندهی مراکز را مبذول فرمایید .</p>
...
?>
<p>
  <embed src="../files/pdf/k.pdf" type="application/pdf" width="687" height="936" class="buttonhover" />
</p>
...
return false;
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // بررسی Local Storage برای عدم نمایش پیام
        if (!localStorage.getItem('hideMessage5')) {
        ...
        document.getElementById("close-message").addEventListener("click", function () {
            ...
            if (checkbox.checked) {
                // ذخیره در Local Storage برای جلوگیری از نمایش دوباره پیام
                localStorage.setItem('hideMessage5', 'true');
            }
