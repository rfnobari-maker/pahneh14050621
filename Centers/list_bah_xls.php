...
$id_city1 = $id_city ;
$confi = $_POST['confi'] ; 
if ($id_ostan == '-1') { $v_id_ostan = 1 ;} else { $v_id_ostan = "bah.id_ostan='$id_ostan'" ;}
if ($id_city == 0) { $v_id_city = 1 ;} else { $v_id_city = "bah.id_city='$id_city'" ;}
if ($id_mar == 0) { $v_id_mar = 1 ;} else { $v_id_mar = "bah.id_mar='$id_mar'" ;}
if ($confi == '0')  { $v_confi  = 1  ; }else{ $v_confi = "bah.confi = '$confi'" ;}
 ?>
...
,list_city.ostan,list_city.city as city2,list_city.shahr,list_city.mar
 ...
 where $v_id_ostan and  $v_id_city and $v_id_mar and $v_confi  ORDER BY BINARY last_name ASC "; 
