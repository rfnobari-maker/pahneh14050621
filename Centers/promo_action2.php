...
<head>
    ...
    <script src="jq/jquery-1.9.0.min.js" type="text/javascript" charset="utf-8"></script>
<script src="jq/jquery.maskedinput.js" type="text/javascript"></script>
...
<?php $id_ostan1 = $id_ostan?>
          <select  name="id_ostan" disabled="disabled" id="id_ostan" style="width:170px ; height:40px" tabindex="1" dir="rtl"  onchange="this.form.submit()">
...
?></td>
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="45" align="right" bgcolor="#F1F1F1" class="input_text" ><form method="post" name="form1" id="form2"  action="#1">
          <select  name="id_city" disabled="disabled" id="id_city" style="width:170px ; height:40px" tabindex="2" dir="rtl"  onchange="this.form.submit()">
...
?></td>
      ...
      <tr >
        <td height="23" rowspan="2" align="right" bgcolor="#FFFFFF" class="input_text" ><form method="post" name="form3" id="form3"  action="#1">
          <p>
            <select  name="id_mar" disabled="disabled" id="bakh" style="width:170px ; height:40px" tabindex="3" dir="rtl">
...
$query = "SELECT cod_m,pic,Last_name,name,username,tel_m FROM  users where  $v_id_ostan and  $v_id_city and $v_id_mar and S_access = '1' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
 <img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/><span class="style21"><a name="1" id="1"></a></span></p><form  action="promo_action_xls.php" method="post">
        ...
        <button><img src="../files/xls.png" title="دانلود فایل اکسل"  width="45" height="48"  alt=""/></button>
      </form></p>
...
if ($pic_mo=='') $pic_mo = 'no_pic.png' ; ?>
      ...
      <td height="73" bordercolor="#66CCFF"><?php echo mor_bee_count($cod_m,$v_date_s1,$v_date_s2)?></td>
      <td bordercolor="#66CCFF"><?php echo mor_spoul_count($cod_m,$v_date_s1,$v_date_s2)?></td>
