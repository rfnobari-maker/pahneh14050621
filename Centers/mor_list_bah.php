...
?>
  ...
  <p class="style1">&nbsp;</p>
  <p class="style8">لیست بهره برداران ثبت شده مروج </p>
  <p>
    <?php if(isset($_POST['mor_cod_m']))
{
...
?>
      <td width="7%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
         <form  action="confi_benef.php" method="post">
        <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
        <input type="hidden" name="back_no" value="2" />
        <button>
        <?php if ($row['confi']=='') {?>
...
?>
  ...
  <p>&nbsp;</p>
           <p> <p><a href="promotes.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p>
           <p>&nbsp;</p>
