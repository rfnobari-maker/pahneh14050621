        ...
        <div class="content-section">
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <a href="lists_city.php" class="btn">لیست شهرهای مرکز: <?php echo $count_city; ?></a>
                </div>

                <div class="card">
                    <a href="lists_abadi.php" title="لیست آبادی های مرکز">
                        <img src="../files/abadi.png" alt="users" class="card-icon">
                    </a>
                    <a href="lists_abadi.php" class="btn">لیست آبادی های مرکز: <?php echo $count; ?></a>
                </div>
                ...
                <div class="card">
                    <a href="list_abadi.php" title="اطلاعات عمومی آبادی ها">
                        <img src="../files/pub_abadi.png" alt="users" class="card-icon">
                    </a>
                    <a href="list_abadi.php" class="btn">اطلاعات عمومی آبادی ها</a>
                </div>
                ...
                <div class="card">
                    <a href="promotes.php" title="مروجین مرکز">
                        <img src="../files/morvege1.png" alt="users" class="card-icon">
                    </a>
                    <a href="promotes.php" class="btn">مروجین مرکز: <?php echo $count_mor; ?></a>
                </div>

                <div class="card">
                    <a href="promo_action.php" title="گزارش عملکرد کارشناسان پهنه">
                        <img src="../files/reports.png" alt="" class="card-icon">
                    </a>
                ...
                <div class="card">
                    <a href="change_request.php" title="ثبت درخواست تغییرات">
                        <img src="../files/setting.png" alt="users" class="card-icon">
                    </a>
                    <a href="change_request.php" class="btn">ثبت درخواست تغییرات</a>
                </div>

                <div class="card">
                    <a href="add_abadi.php" title="درخواست ثبت آبادی جدید مرکز">
                        <img src="../files/add_abadi.png" alt="users" class="card-icon">
                    </a>
                    <a href="add_abadi.php" class="btn">درخواست ثبت آبادی جدید</a>
                </div>

                <div class="card">
                    <a href="list_request.php" title="مشاهده لیست درخواست های قبلی">
                        <img src="../files/Sback.PNG" alt="users" class="card-icon">
                    </a>
                    <a href="list_request.php" class="btn">لیست درخواست ها</a>
                </div>
