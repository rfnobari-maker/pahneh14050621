...
<form  name="myform" class="myform" method="post" action="list_bee.php">
     ...
     <input type="submit" name="action" value="بازگشت" style=" margin-top:25px ; width:150px ; height:45px" tabindex="28" />
</form> 
<form action="equip_view.php" method="post" id="equipmentForm" onsubmit="target_Agri17(this)">
    <div align="center">
        <input type="hidden" name="unique_id" value="<?php echo $unique_id; ?>" />
        
        <input type="submit" name="equipment" value="مشاهده لیست تجهیزات" style="margin-top:25px; width:150px; height:45px" tabindex="28" />
    </div>
</form>
