...
<tr>
          ...
          <tr>
            <td>
  <?php include('top.php'); ?>
           <p align="center" class="style8"  >مدیریت طیور و زنبورعسل</p>
           ...
           <div class="box" align="center">
             <p><a href="confi_bee.php"><img src="../../files/conf_bee.png" alt="bee" width="136" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="confi_bee.php" class="btn">تایید اطلاعات زنبورستان ها</a></p>
             <p>&nbsp;</p>
             <p>&nbsp;</p>
             <p>&nbsp;</p>
           </div>
