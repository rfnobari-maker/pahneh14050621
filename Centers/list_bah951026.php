...
?>
  ...
  <p class="style8">لیست بهره برداران مرکز </p>
  <p class="style8"><a href="list_bah_xls.php"><img src="../files/xls.png" width="75" height="80"  alt=""/></a></p>
  <p class="style1">
    <?php 
 $query = "SELECT * FROM  bah where  id_ostan = '$id_ostan' and id_mar = '$id_mar' "  ;
