...
<div id="accordion">
   ...
   <tr>
     ...
     <td align="center"><div align="right" class="normalTextSmaller" style="margin-right:15px" >:طرح هادی</div></td>
            ...
            <input type="submit" name="action" value="تصحیح اطلاعات" style="width:100px ; height:45px ; font-size:10px"" tabindex="11" />
                </div>
   ...
   <tr>
     ...
     <td align="center"><div align="right" class="normalTextSmaller" style="margin-right:15px" >:دسترسی به وسیله نقلیه عمومی</div></td>
            ...
            <p>&nbsp;</p>
            <p><a href="list_pubcity.php" title="برگشت به صفحه قبل"><img src="files/goback.jpg" width="118" height="47"  alt=""/> </a></p>       
            <!-- Tabs -->
...
<?php
 ...
 $t_hadi = $_POST['t_hadi']; 
 $add_city1 = $_POST['add_city'];
// تعریف متغیرهای که هنگام لود فرم خالی رد میشن
 
include('login/config.php');
$query = "UPDATE public_city SET  
nofos_1=?,nofos_2=?,nofos_3=?,nofos_4=?,nofos_5=?,vaz_abadi=?,rah_zamin=?,rah_ahan=?,rah_abi=?,t_hadi=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($nofos_1,$nofos_2,$nofos_3,$nofos_4,$nofos_5,$vaz_abadi,$rah_zamin,$rah_ahan,$rah_abi,$t_hadi,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\پایه',$id_ostan) ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city  SET  
learn_1=?,learn_2=?,learn_3=?,learn_4=?,learn_5=?,learn_6=?,learn_7=?,learn_8=?,learn_9=?,learn_10=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($learn_1,$learn_2,$learn_3,$learn_4,$learn_5,$learn_6,$learn_7,$learn_8,$learn_9,$learn_10,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\آموزشی') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city  SET  
sport_1=?,sport_2=?,sport_3=?,sport_4=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($sport_1,$sport_2,$sport_3,$sport_4,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'فرهنگی و ورزشی') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city  SET  
mazhab_1=?,mazhab_2=?,mazhab_3=?,mazhab_4=?,mazhab_5=?,mazhab_6=?,mazhab_7=?,mazhab_8=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($mazhab_1,$mazhab_2,$mazhab_3,$mazhab_4,$mazhab_5,$mazhab_6,$mazhab_7,$mazhab_8,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\مذهبی') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city  SET  
siyasi_1=?,siyasi_2=?,siyasi_3=?,siyasi_4=?,siyasi_5=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($siyasi_1,$siyasi_2,$siyasi_3,$siyasi_4,$siyasi_5,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\سیاسی و اداری') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city  SET  
niro_1=?,niro_2=?,niro_3=?,niro_4=?,niro_5=?,niro_6=?,up_date=?
WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($niro_1,$niro_2,$niro_3,$niro_4,$niro_5,$niro_6,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\برق ،گاز و آب') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
// تعریف متغیرهای که هنگام لود فرم خالی رد میشن
include('login/config.php');
$query = "UPDATE public_city 
 SET beh_1=?,beh_2=?,beh_3=?,beh_4=?,beh_5=?,beh_6=?,beh_7=?,beh_8=?,beh_9=?,beh_10=?,beh_11=?,beh_12=?,beh_13=?,beh_14=?,beh_15=?,beh_16=?,beh_17=?,up_date=? WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($beh_1,$beh_2,$beh_3,$beh_4,$beh_5,$beh_6,$beh_7,$beh_8,$beh_9,$beh_10,$beh_11,$beh_12,$beh_13,$beh_14,$beh_15,$beh_16,$beh_17,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\بهداشتی و درمانی') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city 
 SET khad_1=?,khad_2=?,khad_3=?,khad_4=?,khad_5=?,khad_6=?,khad_7=?,khad_8=?,khad_9=?,khad_10=?,khad_11=?,khad_12=?,up_date=? WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($khad_1,$khad_2,$khad_3,$khad_4,$khad_5,$khad_6,$khad_7,$khad_8,$khad_9,$khad_10,$khad_11,$khad_12,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\بازرگانی و خدمات') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
...
include('login/config.php');
$query = "UPDATE public_city 
 SET ertebat_1=?,ertebat_2=?,ertebat_3=?,ertebat_4=?,ertebat_5=?,ertebat_6=?,ertebat_7=?,ertebat_8=?,up_date=? WHERE add_city=?";
$q = $dbh->prepare($query);
$q->execute(array($ertebat_1,$ertebat_2,$ertebat_3,$ertebat_4,$ertebat_5,$ertebat_6,$ertebat_7,$ertebat_8,$date_edit,$add_city));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_city,'ویرایش اطلاعات عمومی\ارتباطات و حمل و نقل') ; 
?>
<form name="myform" class="myform" method="post" action="public_city.php">
<input type="hidden" name="add_city"  value="<?php echo $add_city ;?>" />
