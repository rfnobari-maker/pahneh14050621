...
$stmt->execute();
?>
           <p>اطلاعات عمومی  آبادی های تحت پوشش </p>
  ...
  <tr align="center" class="style8">
    ...
    <td width="22%" bgcolor="#CCCCCC">آدرس آماری آبادی</td>
    <td width="18%" bgcolor="#CCCCCC">نام آبادی</td>
...
?>
<td width="10%" height="45" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><form  action="public_abadi.php" method="post">
  <input type="hidden" name="add_abadi" value="<?php echo $row['add_abadi'] ;?>" />
  <button><img src="files/edit.png" border="0"  title="ويرايش اطلاعات عمومی آبادی" width="30" height="30" /></button>
</form></td>
    <td <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo $up_date ;?></td>
    <td <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo $row['add_abadi'];?></td>
