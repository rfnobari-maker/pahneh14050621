 ...
 <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1" >
   <form method="post" name="form1" id="form1" >
     <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
       ...
       <tr bgcolor='#f1f1f1' >
         <td height="45" bgcolor="#DDDDDD" class="input_text" align="right" ><select  name="id_city" id="bakh" style="width:170px ; height:40px" dir="rtl" >
           >
           <option value="0"> شهرستان</option>
           <?php
$query = "SELECT DISTINCT id_city,city FROM list_abadi WHERE  id_ostan = '$id_ostan' and id_city = '$id_city' "  ;
...
?>
 ...
 <p align="center"></p>
 <p align="center"><a href="indexbenef.php"><img src="files/goback.jpg"  alt="" width="128" height="57" border="0"/></a></p>
 <p align="center"></p>
 <p align="center"></p>
    </td>
  </tr>
