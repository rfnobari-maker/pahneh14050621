...
// 3. تابع بارگذاری فرم ویرایش
let isSubmitting = false; // متغیر سراسری برای جلوگیری از ثبت مکرر
...
function loadEditForm(id, z_sal) {
    ...
    .then(data => {
                ...
                <div style="background: #fff; padding: 20px; border-radius: 10px; width: 85%; max-width: 900px; margin: 20px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.4);">
                    ...
                    <form id="editForm">
                        ...
                        <div dir="rtl" style="text-align: center; margin-top: 25px;">
                            <button type="submit" id="submitRequestBtn" style="background: #006699; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 14px;">ثبت درخواست</button>
        ...
        // بارگذاری لیست محصولات بر اساس گروه انتخابی
        ...
        // مدیریت ارسال فرم با غیرفعال کردن دکمه
        document.getElementById('editForm').onsubmit = function(e) {
            ...
            const new_product_cod = new_product_element.value;
