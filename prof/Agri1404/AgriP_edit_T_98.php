...
if (isset($_POST['z_sal'])) {
    ...
    $z_sal = '';  // مقدار پیش‌فرض برای z_sal
    $Agri_prod_table = '';  // مقدار پیش‌فرض برای Agri_prod_table
}
...
<div class="column" >
   ...
   <span class="success<?php echo $t_r ?>" style="display:none"><img src="../../files/Tick.png" width="15" height="15"  alt=""/></span>
              ...
              <div class="column" >
        <input name="mah_tol"  type="text" class="mah_tol<?php echo $t_r ?> required number input_text" id="mah_tol<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'3'?>"  dir="rtl" lang="fa" value="<?php  echo $row['mah_tol']*1 ; ?>" maxlength="10"  align="baseline" xml:lang="fa" /> </div>
              <div class="column" >
