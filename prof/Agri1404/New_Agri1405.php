...
{
	var result = confirm(" از آماده سازی قطعه / قطعات انتخاب شده برای سال زراعی 1405-1404 مطمئن هستید ؟");
	if(result){
		return true;
	}else{
		return false;
...
<body>
 ...
 if(isset($_POST['bah_cod_m'])) $bah_cod_m=$_POST['bah_cod_m'];
  ?>
<p align="center" >&nbsp;</p>
<p align="center" dir="rtl" ><span class="style8">آماده سازی اطلاعات  پایه ، سال زراعی 1405-1404</span><br />
 ...
 <form id="form1" name="form1" method="post" action="#result">
   <p>
     ...
     <br />
     <a href="../../login/help/New_Agri.pdf" target="new" class="LinkTitleNews"> راهنمای استفاده </a>
...
?>
 ...
 <form name="bulk_action_form" action="send_data1405.php" method="post" onSubmit="return delete_confirm();"/>
...
?>
        ...
        <input type="submit" name="Go_send_data" id="send_data" style="height:45px ; width:350px"
         value="مایل به ایجاد اطلاعات فوق در سال زراعی 1405-1404 هستم" />
      </form>
<?php
 }
 else 
 {
echo '<p class=style8> اطلاعات زراعی بهره بردار در سال 1404-1403 یافت نشد </p>'  ;
 }
 }
?>
