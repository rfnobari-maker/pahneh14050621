        ...
        <div class="content-section">
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <a href="delivery.php" class="btn">ثبت گندم تحویلی به دولت</a>
                ...
                <!-- کارت ثبت درخواست تغییرات -->
                <div class="card">
                    <img src="../../files/ostan_cod.png" alt="محصولات صیفی" class="card-icon">
                    <a href="Agri_reg" class="btn">ثبت و پیگیری درخواست تغییر محصول/مساحت </a>
                    <a href="Agri_req_bah" class="btn">ثبت و پیگیری درخواست تغییر بهره بردار </a>
                </div>
