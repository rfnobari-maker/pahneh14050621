...
try {
    // ۱. بررسی وجود درخواست فعال (status نامساوی 3 یا 33) [cite: 2]
    $stmt_check = $dbh->prepare("SELECT id FROM Agri_req_bah WHERE Agri_id = :agri_id AND status NOT IN (3, 33)");
