...
{
function renderForm($error,$date_s,$mor_cod_m,$bah_cod_m,$no_bat,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,
...
<body>
 ...
 <p align="center" >&nbsp;</p>
 <p align="center" ><span class="style1">ثبت اطلاعات بهره بردار صنایع</span> </p>
  ...
  <td height="38" colspan="5" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقیقی  <span class="style8"><?php echo $notfound,$live?></span></strong></div></td>
   ...
   <tr>
     <td height="46"><div align="right">
       <select name="jens1" disabled="disabled" class="required" id="jens" style="height:40px ; width:150px ; direction:rtl ; background:#0CF">
   ...
   <tr>
     ...
     <td width="259"><div align="right">
       <input name="name" type="text" class="required" id="name" style="width:150px; height:30px ; background:#0CF " dir="rtl" lang="fa" value="<?php echo $name ; ?>" maxlength="50" readonly="readonly" xml:lang="fa" />
     </div></td>
...
<?php if($no_co <>'8') { ?>
   <tr>
     ...
     <td bgcolor="#FFFFFF"><div align="right">
       <input name="sh_meli" type="text" class="required digits" id="sh_meli" style="width:150px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $sh_meli ; ?>" maxlength="20" xml:lang="fa"/>
     </div></td>
...
function disableFunction() {
	...
	$("#submit").attr("disabled","");
                      ...
                      <p><a href="benef2.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>
</td>
  </tr>
  <tr>
...
':num_bah'=>$num_bah,':cod_p'=>$cod_p,':jens'=>$jens,':name'=>$name,':last_name'=>$last_name,':date_t'=>$date_t,
...
unset($error,$date_s,$mor_cod_m,$bah_cod_m,$no_bat,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,$fname,$m_tah,$er_mtah,$tel_s,$tel_m,
