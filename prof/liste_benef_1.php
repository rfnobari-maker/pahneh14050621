...
?>
           ...
           <table width="98%" height="166" border="0" align="center" cellpadding="1" cellspacing="1" >
...
$pic = user_pic($mor_cod_m1) ;
 ...
 $t_r = $r ; 
?>
      <td width="7%" height="106" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="edit_benef.php" method="post">
      ...
      <td width="7%" height="106" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="view_benef1.php#1" method="post" onsubmit="target_popup2(this)">
        <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
        <input type="hidden" name="no_bah" value="<?php echo $row['no_bah'] ;?>" />
