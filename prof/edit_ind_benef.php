...
{
?>
	      <form name="myform1" class="myform" method="post" action="edit_ind_benef2.php">
...
?>
   ...
   <?php } ?>
           ...
           <p><a href="manager_ind_benef.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>
          <p>&nbsp;</p></td>
  </tr>
  <tr>
