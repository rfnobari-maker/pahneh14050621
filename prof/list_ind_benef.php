...
?>
      ...
      <td height="57" colspan="3" bgcolor="#999999"><p>عملیات</p></td>
...
?>
    ...
    <button onclick="return confirm('از حذف اطلاعات بهره بردار مطمئن هستید ؟')"><img src="../files/del1.png" title="حذف اطلاعات بهره بردار" width="33" height="26" alt=""/>
      ...
      <td width="7%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="edit_ind_benef.php" method="post">
    ...
    <input type="hidden" name="no_bah" value="<?php echo $row['no_bah'] ;  ;?>" />
      ...
      <td width="7%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="view_ind_benef1.php#1" method="post" onsubmit="target_popup2(this)">
        <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m'] ;?>" />
        <input type="hidden" name="num_bah" value="<?php echo $row['num_bah'] ;?>" />
        <button><img src="../files/view.png" title="نمایش اطلاعات بهره بردار"  width="33" height="26"  alt=""/></button>
      </form></td>
      <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="16%" class="normalTextSmaller"><?php echo $row['tel_m'];?></td>
...
?>
          ...
          <p>&nbsp;</p><p><a href="benef.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p></td>
  </tr>
  <tr>
