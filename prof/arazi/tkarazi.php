...
?>
   ...
   <tr>
     ...
     <td><div align="right">
       ...
       <input name="m_tk" type="text" class="required number input_text" id="m_tk" style="width:150px; height:30px ; " tabindex="7" dir="rtl" lang="fa" value="<?php echo $tel_s ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
   ...
   <tr>
     <td height="46"><div align="right">
       <input name="lat" type="text" class="required number input_text" id="lat" style="width:150px; height:30px ; " tabindex="9" dir="rtl" lang="fa" value="<?php echo $tel_m ; ?>" maxlength="11" xml:lang="fa"/>
       <br />
       <span class="style8">37.010521: مثال</span>     </div></td>
     <td><div align="right"><strong>:Y عرض جغرافیایی</strong></div></td>
     <td width="173">&nbsp;</td>
     <td><div align="right">
       <input name="lng" type="text" class="required number input_text" id="lng" style="width:150px; height:30px ; " tabindex="8" dir="rtl" lang="fa" value="<?php echo $tel_s ; ?>" maxlength="11" xml:lang="fa"/>
       <br />
     ...
     <td height="145" colspan="4" bgcolor="#FFFFFF"><div align="right">
       <textarea name="address" cols="60" rows="8" class="required input_text"  style="width:600px" tabindex="10"><?php echo $comment ;?></textarea>
     </div></td>
   ...
   <tr>
     <td height="56"  colspan="6" bgcolor="#FFFFFF"><table width="100%" align="center" cellpadding="0" cellspacing="0" class="input_text">
       ...
       <tr>
         ...
         <td bgcolor="#FFFFFF" style="text-align: left"><input type="checkbox" class="red"name="tk_29" id="tk_29" /></td>
       </tr>
     </table></td>
   </tr>
   <tr>
...
//sms($tel_m,$text) ;
 // ثبت در بانک پیگیری
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'ثبت گزارش تغییر کاربری اراضی کشاورزی',$id_ostan) ; 
...
alert ('گزارش تغییر کاربری با موفقیت ثبت شد ') ;
?>
