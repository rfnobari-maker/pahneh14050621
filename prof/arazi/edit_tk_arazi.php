...
if ($result==1) {
$file_send =  $name ;
 $mess =  'فایل تصویری شما با موفقیت ارسال شد ';
alert($mess) ;
 } else 
 {
 $mess =  'خطا در بارگذاري فايل :'.$result;
alert($mess) ;
  }
}
else 
...
?>
   ...
   <tr>
     ...
     <td width="221"><div align="right">
       <input name="tk_name" type="text" class="required input_text" id="name" style="width:150px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $tk_name ; ?>" maxlength="50" xml:lang="fa" />
     </div></td>
   ...
   <tr>
     ...
     <td height="45" dir="rtl"><div align="right">
       <input name="tk_cod_m" type="text" class="input_text" id="tk_cod_m"  style="width:150px; height:30px ; " tabindex="4" dir="rtl" lang="fa" value="<?php echo $tk_cod_m ; ?>" maxlength="10" xml:lang="fa" />
     </div></td>
   ...
   <tr>
     ...
     <td><div align="right">
       ...
       <input name="m_tk" type="text" class="required number input_text" id="m_tk" style="width:150px; height:30px ; " tabindex="7" dir="rtl" lang="fa" value="<?php echo $m_tk ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
   ...
   <tr>
     <td height="46"><div align="right">
       <input name="lat" type="text" class="required number input_text" id="lat" style="width:150px; height:30px ; " tabindex="9" dir="rtl" lang="fa" value="<?php echo $lat ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
     <td><div align="right"><strong>:Y عرض جغرافیایی</strong></div></td>
     <td width="173">&nbsp;</td>
     <td><div align="right">
       <input name="lng" type="text" class="required number input_text" id="lng" style="width:150px; height:30px ; " tabindex="8" dir="rtl" lang="fa" value="<?php echo $lng ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
     ...
     <td height="145" colspan="4" bgcolor="#FFFFFF"><div align="right">
      <?php if (strlen($file)> 0) { ?> <a  target="new" href="tk_files/<?php echo $file ;?>"><img src="tk_files/<?php echo $file ;?>" width="150" height="150"  alt=""/> </a> <?php }?>
       <textarea name="address" cols="60" rows="8" class="required input_text"  style="width:400px" tabindex="10"><?php echo $address ;?></textarea>
     </div></td>
     <td bgcolor="#FFFFFF"><div style="margin-right:30px" align="right" ><span class="normalTextSmall">: آدرس دقیق محل</span></div></td>
   </tr>
     <tr>
       <td height="46" colspan="4" bgcolor="#FFFFCC" class="style2"><div align="right" class="input_text" >ارسال تصویری از محل تغییر کاربری با فرمت فایل های تصویری حداکثر حجم فایل 100 کیلو بایت
         <input name="pic" type="file" id="pic" tabindex="11"  accept=".jpg,.jpeg,.gif,.png,.JPG,.JPEG,.GIF,.PNG,.xlsx,.xls,.doc,.docx,.pdf" />
           <br />
         </div></td>
       <td bgcolor="#FFFFCC"><div style="margin-right:30px" align="right" >:تصویر محل</div></td>
     </tr>
   ...
   <tr>
     <td height="56"  colspan="6" bgcolor="#FFFFFF"><table width="100%" align="center" cellpadding="0" cellspacing="0" class="input_text">
       <tr>
         ...
         <td width="24" style="text-align: left"><input type="checkbox" <?php if($tk_15=='on') echo 'checked' ;?> class="red"name="tk_15" id="tk_15" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;برداشت یا افزایش    شن و ماسه</td>
         <td width="48" style="text-align: left"><input type="checkbox" <?php if($tk_1=='on') echo 'checked' ;?> class="red"name="tk_1" id="tk_1" /></td>
         </tr>
       <tr>
         ...
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_15=='on') echo 'checked' ;?> class="red"name="tk_16" id="tk_16" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;ایجاد بنا و    تأسیسات</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_2=='on') echo 'checked' ;?> class="red"name="tk_2" id="tk_2" /></td>
         </tr>
       <tr>
         <td width="455" height="41" style="text-align: right" dir="rtl">&nbsp;سوازندن، قطع و    ریشه کنی و خشک کردن باغات به هر طریق</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_17=='on') echo 'checked' ;?> class="red"name="tk_17" id="tk_17" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;خاکبرداری و    خاکریزی</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_3=='on') echo 'checked' ;?> class="red"name="tk_3" id="tk_3" /></td>
         </tr>
       <tr>
         <td width="455" height="37" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;مخلوط ریزی و شن    ریزی</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_18=='on') echo 'checked' ;?> class="red"name="tk_18" id="tk_18" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;گود برداری</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_4=='on') echo 'checked' ;?> class="red"name="tk_4" id="tk_4" /></td>
         </tr>
       <tr>
         <td width="455" height="40" style="text-align: right" dir="rtl">&nbsp;احداث راه‎آهن و فرودگاه</td>
         <td style="text-align: left"><input name="tk_19" type="checkbox" <?php if($tk_19=='on') echo 'checked' ;?> class="red" id="tk_19" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;احداث کوره‎های آجر    و گچ‎پزی</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_5=='on') echo 'checked' ;?> class="red"name="tk_5" id="tk_5" /></td>
         </tr>
       <tr>
         <td width="455" height="38" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;احداث پارک و فضای    سبز.</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_20=='on') echo 'checked' ;?> class="red"name="tk_20" id="tk_20" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;پی کنی</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_6=='on') echo 'checked' ;?> class="red"name="tk_6" id="tk_6" /></td>
         </tr>
       <tr>
         <td width="455" height="41" style="text-align: right" dir="rtl">&nbsp;پیست‎های ورزشی</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_21=='on') echo 'checked' ;?> class="red" name="tk_21" id="tk_21" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;دیوار کشی اراضی</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_7=='on') echo 'checked' ;?> class="red"name="tk_7" id="tk_7" /></td>
       </tr>
       <tr>
         <td width="455" height="47" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;استخرهای ذخیره آب    غیر کشاورزی</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_22=='on') echo 'checked' ;?> class="red"name="tk_22" id="tk_22" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;دپوی زباله، نخاله    و مصالح ساختمانی، شن و ماسه و ضایعات فلزی.</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_8=='on') echo 'checked' ;?> class="red"name="tk_8" id="tk_8" /></td>
       </tr>
       <tr>
         <td width="455" height="40" style="text-align: right" dir="rtl">&nbsp;احداث پارکینگ مسقف    و غیرمسقف</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_23=='on') echo 'checked' ;?> class="red"name="tk_23" id="tk_23" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;ایجاد سکونتگاههای    موقت</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_9=='on') echo 'checked' ;?> class="red" name="tk_9" id="tk_9" /></td>
       </tr>
       <tr>
         ...
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_24=='on') echo 'checked' ;?> class="red"name="tk_24" id="tk_24" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;استقرار کانکس و    آلاچیق</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_10=='on') echo 'checked' ;?> class="red"name="tk_10" id="tk_10" /></td>
       </tr>
       <tr>
         <td width="455" height="42" style="text-align: right" dir="rtl">&nbsp;صنایع تبدیلی و    تکمیلی و غذایی و طرح‎های موضوع تبصره 4 فوق‎الذکر.</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_25=='on') echo 'checked' ;?> class="red"name="tk_25" id="tk_25" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;احداث جاده و راه</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_11=='on') echo 'checked' ;?> class="red"name="tk_11" id="tk_11" /></td>
       </tr>
       <tr>
         <td width="455" height="42" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;صنایع دستی</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_26=='on') echo 'checked' ;?> class="red"name="tk_26" id="tk_26" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;دفن زباله‎های    واحدهای صنعتی</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_12=='on') echo 'checked' ;?> class="red"name="tk_12" id="tk_12" /></td>
       </tr>
       <tr>
         <td width="455" height="49" style="text-align: right" dir="rtl">&nbsp;طرح‎های خدمات    عمومی</td>
         <td style="text-align: left"><input type="checkbox" <?php if($tk_27=='on') echo 'checked' ;?> class="red"name="tk_27" id="tk_27" /></td>
         <td width="453" style="text-align: right" dir="rtl">&nbsp;رها کردن پساب‎های    واحدهای صنعتی، فاضلاب‎های شهری، ضایعات کارخانجات</td>
         <td style="text-align: left"><input type="checkbox"  <?php if($tk_13=='on') echo 'checked' ;?> class="red"name="tk_13" id="tk_13" /></td>
       </tr>
       <tr>
         ...
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_28=='on') echo 'checked' ;?> class="red"name="tk_28" id="tk_28" /></td>
         <td width="453" bgcolor="#CCCCCC" style="text-align: right" dir="rtl">&nbsp;لوله گذاری</td>
         <td bgcolor="#CCCCCC" style="text-align: left"><input type="checkbox" <?php if($tk_14=='on') echo 'checked' ;?> class="red"name="tk_14" id="tk_14" /></td>
       </tr>
       <tr>
         ...
         <td bgcolor="#FFFFFF" style="text-align: left"><input type="checkbox" <?php if($tk_29=='on') echo 'checked' ;?> class="red"name="tk_29" id="tk_29" /></td>
       </tr>
     </table></td>
   </tr>
   <tr>
 ...
 <div align="center">
   <p>
     ...
     <input type="hidden" name="p_file" value="<?php echo $file ;?>" />
     <input type="hidden" name="s_user" value="<?php echo $login_session ;?>" />
     <input type="submit" name="action" value="ثبت تغییرات" style="width:150px ; height:45px" tabindex="28" />
   </p>
</div>
 <p align="center" >&nbsp;</p>
      </form> 
...
<td  height="109"colspan="3" valign="middle" background="../../files/bottom.gif"><?php include('../../footer.php')?></td>
 ...
 {  
// در صورتی که فایل جدید آپلود نشه فایل قبلی حفظ بشه
$p_file = $_POST['p_file']; 
if($file_send=='') $file_send = $p_file ;
//
$tk_name = $_POST['tk_name']; 
...
$query = "UPDATE tk_arazi 
       SET name=? , last_name=? , add_abadi=? , tk_cod_m=? , no_ka=? , no_ara=? , m_tk=? , lat=? , lng=? , address=? , file=? , tk_1=? , tk_2=? , tk_3=? , tk_4=? , tk_5=? , tk_6=? , tk_7=? , tk_8=? , tk_9=? , tk_10=? , tk_11=? , tk_12=? , tk_13=? , tk_14=? , tk_15=? , tk_16=? , tk_17=? , tk_18=? , tk_19=? , tk_20=? , tk_21=? , tk_22=? , tk_23=? , tk_24=? , tk_25=? , tk_26=? , tk_27=? , tk_28=? , tk_29=? , sa_tk=?
		WHERE id=? ";
$q = $dbh->prepare($query);
$q->execute(array($tk_name, $last_name, $add_abadi, $tk_cod_m, $no_ka, $no_ara, $m_tk, $lat, $lng, $address, $file_send, $tk_1, $tk_2, $tk_3, $tk_4, $tk_5, $tk_6, $tk_7, $tk_8, $tk_9, $tk_10, $tk_11, $tk_12, $tk_13, $tk_14, $tk_15, $tk_16, $tk_17, $tk_18, $tk_19, $tk_20, $tk_21, $tk_22, $tk_23, $tk_24, $tk_25, $tk_26, $tk_27, $tk_28, $tk_29, $sa_tk,$id));
...
//sms($tel_m,$text) ;
 // ثبت در بانک پیگیری
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'ویرایش گزارش تغییر کاربری اراضی کشاورزی -'.$last_name,$id_ostan) ; 
 // once saved, redirect back to the view page 
 //header("Location: user_view.php");
unset($error,$date_s,$mor_cod_m,$tk_name,$last_name,$add_abadi,$id_city,$id_mar,$id_ostan,$tk_cod_m,$no_ka,$no_ara,$m_tk,$lat,$lng,$address,$pic,$tk_1,$tk_2,$tk_3,$tk_4,$tk_5,$tk_6,$tk_7,$tk_8,$tk_9,$tk_10,$tk_11,$tk_12,$tk_13,$tk_14,$tk_15,$tk_16,$tk_17,$tk_18,$tk_19,$tk_20,$tk_21,$tk_22,$tk_23,$tk_24,$tk_25,$tk_26,$tk_27,$tk_28,$tk_29,$sa_tk);
alert ('گزارش تغییر کاربری با موفقیت ویرایش شد ') ;
?>
