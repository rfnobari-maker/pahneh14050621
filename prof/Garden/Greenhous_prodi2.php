...
if ($result > 0 )
{
    alert ('خطا ! عملکرد این واحد در سال '.$y_prod.' قبلاً ثبت شده است') ;
	       ?>
<form  name="myform" class="myform" method="post" action="Greenhous_prodi1.php">
    </form>
...
$no_mtol     = $row['no_mtol'] ;
    ...
    sabt_event($login_session,getUserIP_1(),$date_edit,$time,'','ثبت عملکرد واحد گلخانه2-'.$bah_cod_m,$id_ostan) ;
...
if ($row['no_mtol']=='211300')  $v_no_mtol='گل و گیاه زینتی فضای گلخانه';
if ($row['no_mtol']=='211400')  $v_no_mtol='گل و گیاه زینتی فضای باز ' ;	 
if ($row['no_mtol']=='211500')  $v_no_mtol='گل و گیاه زینتی فضای توام' ;	 
