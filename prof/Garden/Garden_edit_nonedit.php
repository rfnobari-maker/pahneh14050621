...
?>
	 <form name="myform1" class="myform" method="post" action="Gardendata_edit_nonedit.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
           <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
...
<body>
  ...
  <?php include('top.php'); ?>
    <td width="840" >
           ...
           <p class="style8">ویرایش اطلاعات بهره برداری باغی و قلمستان</p><a name="1" id="1"></a><br />
...
?>
   ...
   <td height="68" colspan="2" align="right">   <div align="right">
                   ...
                   <td width="41%"><div align="right"> : کد ملی بهره بردار / مدیرعامل </div></td>
                      ...
                      <select name="nah_kesh" class="input_text  required" id="nah_kesh" style="height:40px ; width:170px ; direction:rtl" tabindex="4" onChange="this.form.submit()">
 ...
 <?php if ($nah_kesh <>'3') {?>
    ...
    <form  action="liste_Garden_not_edit.php?id=<?php echo $id_page .'#1' ?>" method="post" id="form1" name="form1">
