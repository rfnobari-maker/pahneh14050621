...
?>
     ...
     <input type="hidden" name="m_page" value="<?php echo 'Mush.php' ;?>" />
...
{
$query = "SELECT * from Mushroom where bah_cod_m = $bah_cod_m";
$stmt = $dbh->prepare($query);
$stmt->execute();
   ...
   <td height="68" colspan="2" align="right">   <div align="right">
                  ...
                  <tr>
                    ...
                    <td width="37%"><div align="right">
                      ...
                      <select name="no_mush" class="input_text  required" id="no_mush" style="height:40px ; width:170px ; direction:rtl" tabindex="3" >
                        <option value="">انتخاب کنید</option>
                        <option value="1">صدفی</option>
                        <option value="2">دکمه ای</option>
                      </select>
                      <!--< </form> -->
                    </div></td>
                 ...
                 <tr>
                   <td height="107"  colspan="3">
                     <input name="action" type="submit" class="style8" tabindex="5" value="ادامه"  />
                     <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
                     <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
                     <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
