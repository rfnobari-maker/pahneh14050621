...
?>
<form  name="myform_back" class="myform_back" method="post" action="<?php echo $m_page ?>">
...
<script type="text/javascript">document.myform_back.submit();</script>
<?php
}
...
if ($no_mtol=='2')  $v_no_mtol='گل و گیاه زینتی';
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="51"><div align="right">
                  <input name="m_tel_m" type="text" class="digits input_text required" id="m_tel_m" style="width:100px; height:30px;  <?php if($no_mal<>7) echo 'background-color:#FFFFCC " readonly="readonly" ' ?> " tabindex="9" dir="rtl" lang="fa" value="<?php echo $m_tel_m ; ?>" maxlength="11" readonly  align="baseline"  xml:lang="fa" />
                  </div></td>
   ...
   <option value="1398" <?php if ($sal=='1398') { echo 'selected="selected"' ; } ?>>1398</option>
        ...
        <tr>
          ...
          <?php } if($no_mtol=='2') { ?>
            <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
              <tr>
                <td height="37" colspan="4" bgcolor="#FFFFCC">گل و گیاهان زینتی</td>
                </tr>
              <tr>
...
<?php } ?>
     ...
     <input type="submit" name="action11" value="بازگشت" id="submit" style="width:150px ; height:45px" tabindex="40" />
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
