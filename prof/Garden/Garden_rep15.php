...
<body class="agri1-body agri1-page">
    ...
    $pahneh_crumb = array(
        ...
        array('label' => 'گزارش اطلاعات باغی به تفکیک محصول / بهره‌بردار'),
    );
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri15-title">گزارش اطلاعات باغی به تفکیک محصول / بهره‌بردار</h1>
        </header>
        ...
        if (isset($_POST['action'])) {
            ...
            if ($id_city == 0) {
                ...
                $v_id_city = "Garden_prod.id_city='$id_city'";
            }
            if ($id_mar == 0) {
                $v_id_mar = 1;
            } else {
                $v_id_mar = "Garden_prod.id_mar='$id_mar'";
            }
            if ($add_abadi == '0') {
                $f_add_abadi = 1;
            } else {
                $f_add_abadi = "Garden_prod.add_abadi = '$add_abadi'";
            }
            if ($add_city == '0') {
                $f_add_city = 1;
            } else {
                $f_add_city = "Garden_prod.add_city = '$add_city'";
            }
            if ($no_kesh == '0') {
                $f_no_kesh = 1;
            } else {
                $f_no_kesh = "Garden_prod.no_kesh = '$no_kesh'";
            }
            if ($mor_cod_m == '') {
                $v_mor_cod_m = 1;
            } else {
                $v_mor_cod_m = "Garden_prod.mor_cod_m = '$mor_cod_m'";
            }
            if ($bah_cod_m == '') {
                $v_bah_cod_m = 1;
            } else {
                $v_bah_cod_m = "Garden_prod.bah_cod_m = '$bah_cod_m'";
            }
            if ($z_sal == '') {
                $v_z_sal = 1;
            } else {
                $v_z_sal = "Garden_prod.z_sal = '$z_sal'";
            }
            if ($mah_name == '') {
                $v_cod_mah = 1;
            } else {
                $v_cod_mah = "Garden_prod.cod_mah = '$mah_name'";
            }
            ...
            if ($id < 1) $id = 1;
            $start = ($id - 1) * $limit;
            $query = "SELECT Garden_prod.bah_cod_m ,Garden_prod.num_bah,
...
FROM Garden_prod
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah Group by bah_cod_m  ORDER BY bah_cod_m ASC LIMIT $start, $limit";
            $query1 = "SELECT count(*) FROM Garden_prod
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah ";
            $stmt = $dbh->prepare($query);
            $stmt->execute();
            $t_row = $stmt->rowCount();
            if ($t_row > 0) {
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            <div class="agri1-results-toolbar">
                <div class="agri1-col-picker" id="agri1-col-picker">
                    ...
                    <div id="agri1-col-panel" class="agri1-col-panel" role="group" aria-labelledby="agri1-col-panel-title">
                        ...
                        <ul class="agri1-col-list">
                            ...
                            <li><label><input type="checkbox" data-col-toggle="treegb" checked/> درخت غیربارور</label></li>
                            <li><label><input type="checkbox" data-col-toggle="treeb" checked/> درخت بارور</label></li>
                            <li><label><input type="checkbox" data-col-toggle="s_keshtgb" checked/> سطح غیربارور</label></li>
                ...
                <div class="agri1-xls">
                    <form action="Garden_rep15_xls.php" method="post">
                        <input type="hidden" name="id_ostan1" value="<?php echo agri2_h($id_ostan1); ?>"/>
                    ...
                    <form action="Garden_rep15_doc.php" method="post">
                        <input type="hidden" name="id_ostan1" value="<?php echo agri2_h($id_ostan1); ?>"/>
                        <input type="hidden" name="mah_name" value="<?php echo agri2_h($mah_name); ?>"/>
                        <input type="hidden" name="id_city" value="<?php echo agri2_h($id_city); ?>"/>
                        <input type="hidden" name="id_mar" value="<?php echo agri2_h($id_mar); ?>"/>
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        ...
                        <col data-col="mah_tolp" style="width:8%"/>
                        <col data-col="treegb" style="width:8%"/>
                        <col data-col="treeb" style="width:8%"/>
                        <col data-col="s_keshtgb" style="width:8%"/>
                        <col data-col="s_keshtb" style="width:8%"/>
                        <col data-col="bah_cod_m" style="width:12%"/>
                        <col data-col="name" style="width:17%"/>
                        <col data-col="rownum" style="width:6%"/>
                    </colgroup>
                    <thead>
                        <tr>
                            <th class="agri1-ops-col" data-col="ops" rowspan="2">عملیات</th>
                            <th data-col-group="mah" colspan="2">میزان تولید<br />تن</th>
                            <th data-col-group="tree" colspan="2">تعداد درخت<br />اصله</th>
                            <th data-col-group="kesht" colspan="2">سطح زیر کشت<br />هکتار</th>
                        ...
                        <tr>
                            ...
                            <th data-col="treegb">غیربارور</th>
                            <th data-col="treeb">بارور</th>
                            <th data-col="s_keshtgb">غیربارور</th>
                    ...
                    ?>
                        <tr>
                            <td class="agri1-ops" data-col="ops">
                                <form action="manager_Garden2.php" method="post" onsubmit="target_Gar15(this)">
                            ...
                            <td data-col="treegb"><?php echo agri2_h($treegb); ?></td>
                            <td data-col="treeb"><?php echo agri2_h($treeb); ?></td>
                            <td data-col="s_keshtgb"><?php echo agri2_h($s_keshtgb); ?></td>
                            <td data-col="s_keshtb"><?php echo agri2_h($s_keshtb); ?></td>
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                ...
                <li>
                    <form action="Garden_rep15.php?id=<?php echo (int)$id - 1; ?>#1" method="post">
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="Garden_rep15.php?id=1#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="Garden_rep15.php?id=<?php echo (int)$i; ?>#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="Garden_rep15.php?id=<?php echo (int)$total; ?>#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="Garden_rep15.php" method="post">
                    <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                    <span>به صفحه</span>
        ...
        (function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!isNaN(pageId) && pageId >= 1 && pageId <= <?php echo (int)$total; ?>) {
                    this.action = 'Garden_rep15.php?id=' + pageId + '#1';
                } else {
                    e.preventDefault();
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Garden_rep15_hidden_cols';
            var GROUP = {
                mah: ['mah_tol', 'mah_tolp'],
                tree: ['treegb', 'treeb'],
                kesht: ['s_keshtgb', 's_keshtb'],
                spec: ['bah_cod_m', 'name']
            };
