...
$id = isset($_POST['id']) ? $_POST['id'] : '';
  ...
  $query = "SELECT id,lng,lat,m_zamin,m_cod_m,m_ab,h_ab,no_sab,no_ab,es,md_ab,m_vaz_sok,check_cod,t_mah,num_bah from Garden where
...
<body>
  ...
  <?php }?>
        ...
        <tr>
          <td  colspan="5"><table width="100%" height="112" border="1" cellpadding="0" cellspacing="0">
            <tr>
...
<input name="s_kesht_b<?php echo $num2_t_mah ;?>" type="text" onpaste="return false" class="s_kesht_b<?php echo $num2_t_mah ?> mashat required number input_text" id="s_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php   echo $s_kesht_b*1 ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              ...
              <td bgcolor="#FFFFFF"><span style="margin:10px"><div align="right">
                  <select  name="mah_name<?php echo $num2_t_mah ;?>" class="target<?php echo $num2_t_mah ;?> required input_text mar<?php  echo $num2_t_mah ;?>" style="width:200px ; height:40px" tabindex="23" dir="rtl" id="cod_mah<?php echo $num2_t_mah ;?>">
