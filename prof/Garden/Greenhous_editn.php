...
if ($bah_cod_m =='' )  $mess.='کد ملی بهره بردار صحیح نیست' ; 
             ...
             <form id="form" name="form1" action="" method="post" >
               <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    ...
                                    <td width="37%"><div align="right" class="style8"><?php echo $v_no_kesht?> 
 ...
 <?php if ($nah_kesh <>'3') {?>
                 ...
                 <tr>
                   <td height="107"  colspan="3">
                     <input name="action" type="submit" class="style8" id="sub" value="ادامه"  />
                     <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
                     <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
                     <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
                     <input type="hidden" name="id" value="<?php echo $id ;?>" />
