...
<body>
 ...
 if (isset($_POST['id'])) 
 {  
$query = "SELECT id,id_ostan,id_city,add_abadi,add_city,no_mtol,m_zamin,bah_cod_m,unit_name,no_mal,num_bah from Greenhousn where  id = $id "; 
...
$bah_cod_m = $row['bah_cod_m'] ; 
  ?>
          ...
          <td class="normalTextSmall" ><?php echo $v_no_mtol ?></td>
...
<form id="form_name" name="form_name" action="Greenhous_prod.php" method="post">
...
<input type="hidden"  name="no_moj" value="<?php echo $no_moj ?>" />
    ...
    <?php 
      ...
      <p><a href="liste_Greenhousn.php"    title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p></td>
  </tr>
  <tr>
