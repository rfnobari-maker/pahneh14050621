...
$query = "SELECT * from Garden where bah_cod_m = '$bah_cod_m' and sh_gat = '$sh_gat' and z_sal = '$z_sal' "; 
...
$num2_t_mah = $t_mah ;
include_once('../../login/config.php');
$query = "SELECT * from Garden_prod where bah_cod_m = :bah_cod_m and sh_gat=:sh_gat and z_sal = :z_sal "; 
$stmt = $dbh->prepare($query);
...
while ($xx > 0)
{
$query = "INSERT INTO Garden_prod (bah_cod_m,sh_gat,z_sal)              
...
$sql = "DELETE FROM Garden_prod where bah_cod_m = :bah_cod_m and sh_gat=:sh_gat and z_sal = :z_sal ORDER BY id DESC LIMIT $xx ";
