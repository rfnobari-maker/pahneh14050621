 ...
 if($no_moj !='4' and $no_moj !='1' ) {?>
             ...
             <?php } if($no_moj !='4' ) {?>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="sal_tas" type="text" class="required number input_text" id="sal_tas" style="width:75px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $pb_no ; ?>"min='1300' max='1405' minlength="4" maxlength="4" xml:lang="fa"/>
                  <br />
                  </div></td>
        ...
        <tr>
          <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><div align="right">
                <select name="m_ab" class="input_text required " id="m_ab"  style="height:40px ; width:120px ; direction:rtl" tabindex="42">
                  <option value="">انتخاب کنید</option>
