  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             ...
             <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="575" border='0' align="center" cellpadding='0' cellspacing='0'>
                 <tr bgcolor='#f1f1f1' >
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
                 ...
                 <tr >
                   <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right"><span class="style2">تن در سال</span>
                     <input name="z_vag2" type="text" class="input_text" id="z_vag2"  style="height:35px ; width:70px " value="<?php echo $z_vag2?>" />
                   </div></td>
                   <td height="50"  align='center' bgcolor="#DDDDDD" class="style1" ><font size="2" class="normalTextSmall">: کوچکتر یا مساوی</font></td>
                   <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right"><span class="style2">تن در سال</span>
                     <input name="z_vag1" type="text" class="input_text" id="z_vag1"  style="height:35px ; width:70px " value="<?php echo $z_vag1?>" />
                   </div></td>
                   <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">ظرفیت واقعی<br />
                     : بزرگتر یا مساوی</font></td>
                 </tr>
                 <tr >
...
<?php 
 ...
 if ($z_vag1 == '')  { $f_z_vag1   = 1  ; }else{ $f_z_vag1 = "z_vag >= $z_vag1" ;}
 if ($z_vag2 == '')  { $f_z_vag2   = 1  ; }else{ $f_z_vag2 = "z_vag <= $z_vag2" ;}
$start=0;
$limit=25;
if(isset($_GET['id']))
{
...
and $f_z_es2 and $f_z_vag1 and $f_z_vag2
...
<form  action="list_Mushroom_xls.php" method="post">
        ...
        <input type="hidden" name="z_vag1" value="<?php echo $z_vag1 ;?>" />
        <input type="hidden" name="z_vag2" value="<?php echo $z_vag2 ;?>" />
