...
<body class="agri1-body agri1-page">
    ...
    $pahneh_crumb = array(
        ...
        array('label' => 'گزارش اطلاعات باغی به تفکیک محصول'),
    );
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="garden-rep13-title">گزارش اطلاعات باغی به تفکیک محصول</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="garden-rep13-title">
...
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah Group by cod_mah ";
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            <div class="agri1-results-toolbar">
                ...
                <div class="agri1-xls">
                    <form action="Garden_rep13_xls.php" method="post">
                    ...
                    <form action="Garden_rep13_doc.php" method="post">
                        <input type="hidden" name="id_ostan1" value="<?php echo agri2_h($id_ostan1); ?>"/>
                        <input type="hidden" name="mah_name" value="<?php echo agri2_h($mah_name); ?>"/>
                        <input type="hidden" name="id_city" value="<?php echo agri2_h($id_city); ?>"/>
                        <input type="hidden" name="id_mar" value="<?php echo agri2_h($id_mar); ?>"/>
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        <col data-col="mah_tol" style="width:12%"/>
                        <col data-col="mah_tolp" style="width:12%"/>
                        <col data-col="treegb" style="width:11%"/>
                        <col data-col="treeb" style="width:11%"/>
                        <col data-col="s_keshtgb" style="width:12%"/>
                        <col data-col="s_keshtb" style="width:12%"/>
                        <col data-col="product" style="width:22%"/>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-col="product" rowspan="2">نام محصول<br />کد محصول</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="agri1-name-col" data-col="product"><?php echo agri2_h(str_replace('&nbsp;', ' ', mah_name_bagh($row['cod_mah']))); ?><br /><?php echo agri2_h($row['cod_mah']); ?></td>
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Garden_rep13_hidden_cols';
            var GROUP = {
