...
<body>
  ...
  <tr>
    <td>
      ...
      <p>
        <?php
$query = "SELECT mor_cod_m,no_bah,last_name,name,co_name,add_city,add_abadi,id_city,id_ostan,num_bah from bah where bah_cod_m = '$bah_cod_m'";
...
?>
	 <form name="myform2" class="myform" method="post" action="Gardendata_edit.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
