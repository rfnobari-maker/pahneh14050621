...
if (isset($_POST['id'])) {
    ...
    if ($stmt->rowCount() == 0) {
        echo '<form name="myform" method="post" action="Garden.php"></form>';
    ...
    $groups = array();
    $qry = "SELECT DISTINCT group_cod, group_name FROM `product_b`";
    ...
    $query = "SELECT cod_qroup, cod_mah, s_kesht_b, s_kesht_gb, tree_b, tree_gb, mah_tol, mah_tolp, mah_bem, mah_kh FROM Garden_prod WHERE Garden_id = :Garden_id";
    $stmt = $dbh->prepare($query);
    $stmt->execute(array(':Garden_id' => $id));
    $products = $stmt->fetchAll(PDO::FETCH_ASSOC);

    $page_title = isset($title) ? $title : 'مشاهده اطلاعات باغی';
?>
<!DOCTYPE html>
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main" id="agri-view">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri-view-title">نمایش اطلاعات باغی و قلمستان</h1>
        </header>
        ...
        <section class="agri1-card" aria-labelledby="agri-view-title">
            ...
            <div class="agri1-grid">
                ...
                <div class="agri1-field" style="margin-top:0">
                    ...
                    <div class="agri1-info"><?php echo city_name1($id_city, $id_ostan1); ?></div>
                </div>
                <div class="agri1-field" style="margin-top:0">
            ...
            <div class="agri1-grid">
                ...
                <div class="agri1-field" style="margin-top:0">
                    <span class="agri1-label">نحوه کشت</span>
                    <div class="agri1-info"><?php echo view_h($v_nah_kesh); ?></div>
                </div>
<?php if ($show_land) { ?>
                <div class="agri1-field" style="margin-top:0">
...
<?php if ($show_land) { ?>
                            <th colspan="2">سطح کاشت<br/>هکتار</th>
<?php } ?>
...
<?php } ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo ($row_prod['tree_gb'] * 1); ?></td>
                            <td><?php echo ($row_prod['tree_b'] * 1); ?></td>
<?php if ($show_land) { ?>
                            <td><?php echo ($row_prod['s_kesht_gb'] * 1); ?></td>
                            <td><?php echo ($row_prod['s_kesht_b'] * 1); ?></td>
<?php } ?>
                            <td><?php echo mah_name_bagh($row_prod['cod_mah']); ?></td>
            ...
            <p class="agri1-note" style="margin-top:16px">تعداد درخت برای محصولات توت فرنگی، چای، زرشک، گل محمدی، گیاهان دارویی و گیاهان دایمی تزئینی تکمیل نمی‌گردد.</p>

            <form action="liste_Garden.php?id=<?php echo $id_page . '#1'; ?>" method="post" id="form1" name="form1" class="agri1-form">
