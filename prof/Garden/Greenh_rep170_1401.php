  ...
  <select name="date_2_kesh" class="date date_2_kesh input_text  " id="date_2_kesh"  style="height:40px ; width:70px ; direction:rtl" tabindex="61">
    ...
    <option value="12"<?php if($date_2_kesh == '12') echo 'selected=selected'?>>اسفند</option>
               ...
               <tr >
                 ...
                 <td height="50"  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">:پایان برداشت</font></td>
                 <td height="50" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
                 ...
                 <td  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="normalTextSmall">: شروع برداشت</font></td>
               </tr>
               <tr >
