...
$no_kesh = $_SESSION['page_date']['p_no_kesh'] ;
$nah_kesh = $_SESSION['page_date']['p_nah_kesh'] ;
$no_mal = $_SESSION['page_date']['p_no_mal'] ;
$bah_cod_m = $_SESSION['page_date']['p_bah_cod_m'] ;
...
//session_destroy();
 ...
 if ($nah_kesh == '')  { $f_nah_kesh  = 1  ; }else{ $f_nah_kesh = "nah_kesh = '$nah_kesh'" ;}
