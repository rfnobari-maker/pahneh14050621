...
$query = "SELECT mor_cod_m,no_bah,num_bah,last_name,name,add_abadi,add_city,id_city,id_ostan from bah where bah_cod_m = $bah_cod_m";
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_codm = $stmt -> rowCount();
?>
</p>
	 <form name="myform2" class="myform" method="post" action="Mushdata_edit.php">
...
?>
           ...
           <input type="button" name="cancel" value="انصراف" style="width:150px ; height:45px" tabindex="30" id="btn1" onClick="window.location='Mushroom.php';"/>
          </form>
      <p>
        <?php 
}
