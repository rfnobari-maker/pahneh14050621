...
if(isset($_GET['id']))
{
 ...
 $query = "SELECT  mah_kh,id,Garden_id,z_sal,bah_cod_m,sh_gat,no_kesh,cod_mah,mah_tolp,mah_tol,add_abadi,s_kesht_b,s_kesht_gb,tree_b,tree_gb from Garden_prod 
...
?>
            ...
            <br />
            <table width="99%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
              <tr class="text1">
          <td width="7%" rowspan="2" bgcolor="#006699">عملیات</td>
          <td width="6%" rowspan="2" bgcolor="#006699">خسارت</td>
          ...
          <td colspan="2" bgcolor="#006699">سطح زیر کشت
        ...
        <tr class="text1">
          ...
          <td width="10%" bgcolor="#006699" class="text1">کد ملی</td>
...
$t_r = $r ; 
  ?>
			...
			<?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
 ...
 <input type="hidden" id="sh_gat<?php echo $t_r ?>" name="sh_gat" value="<?php echo $row['sh_gat'] ;?>" />
  ...
  <div class="column" >
    ...
    <div class="column" >
       <select name="mah_kh" class="required input_text  required" id="mah_kh<?php echo $t_r ;?>"  style="height:40px ; direction:rtl" tabindex="<?php echo $r.'1'?>">
    ...
    <div class="column" >
       ...
       <input name="mah_tol" type="text" onpaste="return false" class="mah_tol<?php echo $t_r ;?> 
       required number input_text" id="mah_tol<?php echo $t_r ;?>" style="width:50px; height:30px ; "
        tabindex="<?php echo $r.'4'?>" dir="rtl" lang="fa" value="<?php  echo $mah_tol*1 ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
      
       </div>
    <div class="column" >
      
     <input name="mah_tolp" type="text" onpaste="return false" class="mah_tolp<?php echo $t_r ;?> 
     required number input_text" id="mah_tolp<?php echo $t_r ;?>" style="width:50px; height:30px ; " 
     tabindex="<?php echo $r.'3'?>" dir="rtl" lang="fa" value="<?php echo  $mah_tolp*1 ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
     
      </div>
    <div class="column" >
      <input name="tree_gb" type="text" onpaste="return false" class="tree_gb required digits input_text" id="tree_gb<?php echo $t_r ;?>" style="width:50px; height:30px ; " 
      tabindex="<?php echo $r.'2'?>" dir="rtl" lang="fa" value="<?php echo $tree_gb ; ?>" maxlength="10"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
    
      <input name="tree_b" type="text" onpaste="return false" class="tree_b<?php echo $t_r ?> required digits input_text" id="tree_b<?php echo $t_r ;?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>" dir="rtl" lang="fa" value="<?php echo $tree_b ; ?>" maxlength="10"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
    
      <input name="s_kesht_gb"  type="text" class="s_kesht_gb<?php echo $t_r ?> required digits input_text" id="s_kesht_gb<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_kesht_gb']*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
      <input name="s_kesht_b"  type="text" class="s_kesht_b<?php echo $t_r ?> required digits input_text" id="s_kesht_b<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_kesht_b']*1 ; ?>" maxlength="6" readonly="readonly"  align="baseline" xml:lang="fa" /></div>
       </div>
       </form>
                </td>
...
?>
    ...
    <script>
        $('.mah_tol<?php echo $no ?>').keyup(function () {
            // کد محصول
           var mcod   = $("#cod_mah<?php echo $no ?>").val();
//
            var skb = document.getElementById("s_kesht_b<?php echo $no ?>").value;
            var mtol = document.getElementById("mah_tol<?php echo $no ?>").value;
			var no_kesh = <?php echo $no_kesh; ?> ;
...
var dataString = 'tree_gb='+ tree_gb + '&tree_b=' + tree_b + '&mah_tol=' + mah_tol + '&mah_tolp=' + mah_tolp + '&id=' + id + '&bah_cod_m=' + bah_cod_m +  '&add_abadi=' + add_abadi + '&z_sal=' + z_sal +  '&sh_gat=' + sh_gat + '&mah_kh=' + mah_kh
+ '&s_kesht_b=' + s_kesht_b + '&s_kesht_gb=' + s_kesht_gb;

if(mah_kh =='' ||  (parseFloat(s_kesht_b) > 0   && mah_kh =='2' &&  ( parseFloat(mah_tol)  <= 0 || parseFloat(mah_tolp)  <= 0)))
//if( 1 == 2 )
{
