...
<body>
 ...
 ?>
<p align="center" >&nbsp;</p>
<p align="center" ><span class="style8">مدیریت اطلاعات واحد های گلخانه</span><br />
...
?>
  ...
  <table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
        <tr class="text1">
          ...
          <td width="5%" rowspan="2" bgcolor="#006699">مساحت گلخانه<br />
         <span class="style2">متر مربع</span></td>
          <td width="5%" rowspan="2" bgcolor="#006699">نوع گلخانه</td>
          <td width="13%" rowspan="2" bgcolor="#006699">نوع سازه</td>
          <td width="5%" rowspan="2" bgcolor="#006699">سیستم کشت</td>
          <td width="11%" rowspan="2" bgcolor="#006699">نوع و کلاس محصول تولیدی</td>
          <td height="35" rowspan="2" bgcolor="#006699">سال</td>
...
if ($row['sys_kesh']=='2') $v_sys_kesh='هیدروپونیک' ;	 
  ?>
  <?php if(($row['mor_cod_m'] == $login_session) and ($row['sal']!='1395'))  {?>

          <td width="6%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php if($row['sal']=='1398')  {?>
            <form  action="del_Greenhous.php" method="post">
              <input type="hidden" name="m_page" value="manager_Greenhous.php" />
...
<td >
<img src="../../files/lock.gif" title="امکان ویرایش و حذف اطلاعات مقدور نمیباشد " width="33" height="26" alt=""/>
<?php 
}
?>
