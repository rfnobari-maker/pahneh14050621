...
function greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m)
{
...
$no_saz = isset($_POST['no_saz']) ? $_POST['no_saz'] : '0';
$no_gol = isset($_POST['no_gol']) ? $_POST['no_gol'] : '0';
$sys_kesh = isset($_POST['sys_kesh']) ? $_POST['sys_kesh'] : '0';
$sys_hot = isset($_POST['sys_hot']) ? $_POST['sys_hot'] : '0';
$no_mal = isset($_POST['no_mal']) ? $_POST['no_mal'] : '0';
...
<body class="agri1-body agri1-page">
    ...
    $pahneh_crumb = array(
        ...
        array('label' => 'لیست گلخانه داران'),
    );
    include(__DIR__ . '/../../chrome.php');
    ?>
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="greenh-old-title">لیست گلخانه داران</h1>
        </header>
        <section class="agri1-card agri1-card-search" aria-labelledby="greenh-old-title">
            <form id="reg-form" class="agri1-form" method="post" action="#1" novalidate>
                ...
                <div class="agri1-grid">
                    <div class="agri1-field">
                        <label class="agri1-label" for="no_kesht">نوع کشت</label>
                        <select name="no_kesht" class="input_text required" id="no_kesht">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="id_ostan" disabled="disabled" class="style8" id="id_ostan" dir="rtl">
                            ...
                            <?php
                            $stmt = $dbh->prepare('SELECT id_ostan,ostan FROM ostanname ORDER BY BINARY ostan');
                            $stmt->execute();
                            foreach ($stmt as $row) {
                    ...
                    <div class="agri1-field">
                        <label class="agri1-label" for="bakh">مرکز خدمات</label>
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="id_city5" disabled="disabled" class="style8" id="id_city" dir="rtl">
                            ...
                            <?php
                            $stmt = $dbh->prepare('SELECT DISTINCT id_city,city FROM list_abadi WHERE id_ostan = :id_ostan ORDER BY BINARY city');
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="sys_kesh" class="input_text required" id="sys_kesh">
                            <option value="0">انتخاب کنید</option>
                            <?php greenh_opt('1', $sys_kesh, 'خاکی'); ?>
                            <?php greenh_opt('2', $sys_kesh, 'هیدروپونیک'); ?>
                            <?php greenh_opt('3', $sys_kesh, 'اکوآپونیک'); ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="no_saz">نوع سازه</label>
                        <select name="no_saz" class="input_text required" id="no_saz">
                            <option value="0">انتخاب کنید</option>
                            <?php greenh_opt('1', $no_saz, 'فلزی با پوشش پلاستیکی'); ?>
                            <?php greenh_opt('2', $no_saz, 'فلزی با پوشش پلی کربنات'); ?>
                            <?php greenh_opt('3', $no_saz, 'فلزی با پوشش شیشه ای'); ?>
                            <?php greenh_opt('4', $no_saz, 'چوبی پلاستیکی'); ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="no_gol">نوع گلخانه</label>
                        <select name="no_gol" class="input_text required" id="no_gol">
                            <option value="0">انتخاب کنید</option>
                            <?php greenh_opt('1', $no_gol, 'تونلی تک قلو'); ?>
                            <?php greenh_opt('2', $no_gol, 'تونلی بهم پیوسته'); ?>
                            <?php greenh_opt('3', $no_gol, 'یک طرفه'); ?>
                            <?php greenh_opt('4', $no_gol, 'شیشه ای سقف شیروانی'); ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                        ...
                        <select name="no_mal" class="input_text required" id="no_mal">
                            <option value="0">انتخاب کنید</option>
                            <?php greenh_opt('1', $no_mal, 'سند ششدانگ'); ?>
                            <?php greenh_opt('2', $no_mal, 'سند مشاعی'); ?>
                            <?php greenh_opt('3', $no_mal, 'اصلاحات اراضی'); ?>
                            <?php greenh_opt('4', $no_mal, 'موقوفه'); ?>
                            <?php greenh_opt('5', $no_mal, 'واگذاری'); ?>
                            <?php greenh_opt('6', $no_mal, 'قولنامه'); ?>
                            <?php greenh_opt('7', $no_mal, 'اجاره'); ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="sys_hot">سیستم گرمایشی</label>
                        <select name="sys_hot" class="input_text required" id="sys_hot">
                            <option value="0">انتخاب کنید</option>
                            <?php greenh_opt('1', $sys_hot, 'حرارت مرکزی'); ?>
                            <?php greenh_opt('2', $sys_hot, 'هیتر یا بخاری'); ?>
                            <?php greenh_opt('3', $sys_hot, 'تشعشعی'); ?>
                        </select>
                    </div>
                    <div class="agri1-field">
...
if (isset($_POST['action'])) {
    $_SESSION['id_ostan1'] = $id_ostan1;
    $_SESSION['id_city'] = $id_city;
    $_SESSION['id_mar'] = $id_mar;
    $_SESSION['no_kesht'] = $no_kesht;
    $_SESSION['no_saz'] = $no_saz;
    $_SESSION['no_gol'] = $no_gol;
    $_SESSION['sys_kesh'] = $sys_kesh;
    $_SESSION['sys_hot'] = $sys_hot;
    $_SESSION['no_mal'] = $no_mal;
    $_SESSION['mor_cod_m'] = $mor_cod_m;
    $_SESSION['bah_cod_m'] = $bah_cod_m;

    $where = array();
    $params = array();
    $empty0 = array('0', '-1');
    greenh_eq($where, $params, 'G.id_ostan', $id_ostan1, $empty0);
    greenh_eq($where, $params, 'G.id_city', $id_city, $empty0);
    greenh_eq($where, $params, 'G.id_mar', $id_mar, $empty0);
    greenh_eq($where, $params, 'G.no_kesht', $no_kesht, $empty0);
    greenh_eq($where, $params, 'G.no_saz', $no_saz, $empty0);
    greenh_eq($where, $params, 'G.no_gol', $no_gol, $empty0);
    greenh_eq($where, $params, 'G.sys_kesh', $sys_kesh, $empty0);
    greenh_eq($where, $params, 'G.sys_hot', $sys_hot, $empty0);
    greenh_eq($where, $params, 'G.no_mal', $no_mal, $empty0);
    if ($mor_cod_m !== '') {
        $where[] = 'G.mor_cod_m = :mor_cod_m';
        $params[':mor_cod_m'] = $mor_cod_m;
    }
    if ($bah_cod_m !== '') {
        $where[] = 'G.bah_cod_m = :bah_cod_m';
        $params[':bah_cod_m'] = $bah_cod_m;
    }
    $sqlWhere = $where ? implode(' AND ', $where) : '1=1';
    $query = "SELECT G.id, G.id_ostan, G.id_city, G.id_mar, G.no_kesht, G.no_saz, G.no_gol, G.sys_kesh,
                     G.mor_cod_m, G.bah_cod_m, G.no_mal, G.m_zamin, G.m_zamin_gol, G.add_abadi, G.add_city,
                     G.num_bah, G.no_moj, G.m_poul,
                     bah.name, bah.Last_name AS last_name,
                     list_abadi.abadi, list_city.shahr
              FROM Greenhous G
              LEFT JOIN bah ON G.bah_cod_m = bah.bah_cod_m AND G.num_bah = bah.num_bah
              LEFT JOIN list_abadi ON G.add_abadi <> '' AND G.add_abadi = list_abadi.add_abadi AND list_abadi.mor_cod_m = G.mor_cod_m
              LEFT JOIN list_city ON G.add_city <> '' AND G.add_city = list_city.add_city AND list_city.mor_cod_m = G.mor_cod_m
              WHERE $sqlWhere
              ORDER BY G.mor_cod_m ASC
              LIMIT $start, $limit";
    $query1 = "SELECT COUNT(*) FROM Greenhous G WHERE $sqlWhere";
...
?>
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            <div class="agri1-results-toolbar">
                <div class="agri1-col-picker" id="agri1-col-picker">
                    ...
                    <div id="agri1-col-panel" class="agri1-col-panel" role="group" aria-labelledby="agri1-col-panel-title">
                        ...
                        <ul class="agri1-col-list">
                            ...
                            <li><label><input type="checkbox" data-col-toggle="m_zamin_gol" checked/> مساحت مفید گلخانه</label></li>
                            <li><label><input type="checkbox" data-col-toggle="m_zamin" checked/> مساحت گلخانه</label></li>
                            <li><label><input type="checkbox" data-col-toggle="no_gol" checked/> نوع گلخانه</label></li>
                            <li><label><input type="checkbox" data-col-toggle="no_saz" checked/> نوع سازه</label></li>
                            <li><label><input type="checkbox" data-col-toggle="sys_kesh" checked/> سیستم کشت</label></li>
                            <li><label><input type="checkbox" data-col-toggle="no_kesht" checked/> نوع کشت</label></li>
                ...
                <form action="Greenhous_xls.php" method="post" class="agri1-xls">
                    <?php
                    greenh_hiddens(array(
                        'id_ostan' => $id_ostan1,
                        'id_city' => $id_city,
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        ...
                        <col data-col="m_zamin_gol" style="width:8%"/>
                        <col data-col="m_zamin" style="width:8%"/>
                        <col data-col="no_gol" style="width:8%"/>
                        <col data-col="no_saz" style="width:9%"/>
                        <col data-col="sys_kesh" style="width:8%"/>
                        <col data-col="no_kesht" style="width:7%"/>
                        <col data-col="bah_cod_m" style="width:10%"/>
                        <col data-col="name" style="width:14%"/>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-col="m_zamin_gol" rowspan="2">مساحت مفید گلخانه<br/>مترمربع</th>
                            <th data-col="m_zamin" rowspan="2">مساحت گلخانه<br/>مترمربع</th>
                            <th data-col="no_gol" rowspan="2">نوع گلخانه</th>
                            <th data-col="no_saz" rowspan="2">نوع سازه</th>
                            <th data-col="sys_kesh" rowspan="2">سیستم کشت</th>
                            <th data-col="no_kesht" rowspan="2">نوع کشت</th>
                            <th data-col-group="bah" colspan="2">مشخصات بهره‌بردار</th>
                            <th data-col="abadi" rowspan="2">شهر/آبادی</th>
                        ...
                        <tr>
                            <td class="agri1-ops" data-col="ops">
                                <div class="agri1-ops-bar">
                                    <form action="del_list_Greenhous.php" method="post" onsubmit="target_po2(this)">
                                        ...
                                        <button type="submit" class="agri1-ops-btn agri1-ops-btn-del" title="حذف اطلاعات واحد" aria-label="حذف اطلاعات واحد" onclick="return confirm('از حذف اطلاعات این واحد گلخانه مطمئن هستید ؟ ')"><?php echo greenh_ops_svg('del'); ?></button>
                                    </form>
                                    <form action="liste_Greenhous_prod.php" method="post" onsubmit="target_po3(this)">
                                        <input type="hidden" name="id" value="<?php echo agri2_h($row['id']); ?>"/>
                                        <input type="hidden" name="bah_cod_m" value="<?php echo agri2_h($row['bah_cod_m']); ?>"/>
                                        <input type="hidden" name="no_moj" value="<?php echo agri2_h($row['no_moj']); ?>"/>
                                        <button type="submit" class="agri1-ops-btn" title="نمایش اطلاعات عملکرد واحد" aria-label="نمایش اطلاعات عملکرد واحد"><?php echo greenh_ops_svg('crop'); ?></button>
                                    </form>
                                    <form action="Greenhous_editn.php" method="post" onsubmit="target_po3(this)">
                                        <input type="hidden" name="h_add_abadi" value=""/>
                                        <input type="hidden" name="h_add_city" value=""/>
                                        <input type="hidden" name="no_kesht" value="<?php echo agri2_h($row['no_kesht']); ?>"/>
                                        <input type="hidden" name="h_no_mal" value="<?php echo agri2_h($no_mal); ?>"/>
                                        <input type="hidden" name="m_page" value="liste_Greenhousn.php"/>
                                        <input type="hidden" name="bah_cod_m" value="<?php echo agri2_h($row['bah_cod_m']); ?>"/>
                                        <input type="hidden" name="m_poul" value="<?php echo agri2_h(isset($row['m_poul']) ? $row['m_poul'] : ''); ?>"/>
                                        <input type="hidden" name="add_abadi" value="<?php echo agri2_h($row['add_abadi']); ?>"/>
                                        <input type="hidden" name="add_city" value="<?php echo agri2_h($row['add_city']); ?>"/>
                                        ...
                                        <button type="submit" class="agri1-ops-btn" title="ویرایش اطلاعات بهره برداری" aria-label="ویرایش اطلاعات بهره برداری"><?php echo greenh_ops_svg('land'); ?></button>
                                    </form>
                            ...
                            <td data-col="m_zamin_gol"><?php echo agri2_h($row['m_zamin_gol'] * 1); ?></td>
                            <td data-col="m_zamin"><?php echo agri2_h($row['m_zamin'] * 1); ?></td>
                            <td data-col="no_gol"><?php echo agri2_h(greenh_label_no_gol($row['no_gol'])); ?></td>
                            <td data-col="no_saz"><?php echo agri2_h(greenh_label_no_saz($row['no_saz'])); ?></td>
                            <td data-col="sys_kesh"><?php echo agri2_h(greenh_label_sys_kesh($row['sys_kesh'])); ?></td>
...
<?php
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                <?php if ($id > 1) { ?>
                <li>
                    <form action="liste_Greenhousn_old.php?id=<?php echo (int) $id - 1; ?>#1" method="post">
                        <?php greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m); ?>
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="liste_Greenhousn_old.php?id=1#1" method="post">
                        <?php greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="liste_Greenhousn_old.php?id=<?php echo (int) $i; ?>#1" method="post">
                        <?php greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="liste_Greenhousn_old.php?id=<?php echo (int) $total; ?>#1" method="post">
                        <?php greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="liste_Greenhousn_old.php" method="post">
                    <?php greenh_old_hiddens($id_ostan1, $id_city, $id_mar, $no_kesht, $no_saz, $no_gol, $sys_kesh, $sys_hot, $no_mal, $mor_cod_m, $bah_cod_m); ?>
                    <span>به صفحه</span>
        ...
        (function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!isNaN(pageId) && pageId >= 1 && pageId <= <?php echo (int) $total; ?>) {
                    this.action = 'liste_Greenhousn_old.php?id=' + pageId + '#1';
                } else {
                    e.preventDefault();
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'liste_Greenhousn_old_hidden_cols';
            var GROUP = { bah: ['bah_cod_m', 'name'] };
