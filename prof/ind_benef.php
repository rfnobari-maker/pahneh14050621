...
{
?>
	      <form name="myform1" class="myform" method="post" action="benef_data2.php">
    ...
    <td width="840" >
          ...
          <div id="div">
             ...
             <table width="100%" height="180" border="0">
               <tr>
                 <td height="48">&nbsp;</td>
                 <td colspan="2"><div align="right"><select  name="id_city5" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
   ...
   <?php if ($row['id_city']==$id_city5) echo 'selected=selected'?>> <?php echo $row['city'] ;?></option>
                     <?php }?>
                     </select>
                   <?php 
...
?></div></td>
                 <td class="normalTextSmall">: شهرستان</td>
               </tr>
               <tr>
                 ...
                 <td width="38%" height="93">
                   <p style="text-align: right">
                     ...
                     <select  name="add_city"  style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()" >
                       ...
                       <?php
$query = "SELECT  add_city,shahr FROM `list_city` WHERE  `id_ostan` = '$id_ostan' and  `id_city` = $id_city5 ORDER BY BINARY city ASC"  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
foreach($stmt as $row){
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
                     ...
                     <select dir="rtl"  name="add_abadi"  class="required" style="width:170px ; height:40px"  onchange="this.form.submit()" >
                       ...
                       <?php
$query = "SELECT  add_abadi,abadi FROM `list_abadi` WHERE `id_ostan` = '$id_ostan' and `id_city` = $id_city5 ORDER BY BINARY abadi ASC"   ;
$stmt = $dbh->prepare($query);
$stmt->execute();
foreach($stmt as $row){
?>
