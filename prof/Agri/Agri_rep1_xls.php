...
header("Content-Disposition: attachment;Filename=Agri_rep1.xls");
include('../../lock_p1.php');
include('../../event.php');
...
<body>
<p align="center"  class="style8">گزارش اطلاعات زراعی به تفکیک بهره بردار - سال زراعی <?php echo $z_sal?>
        <?php
...
<table width="85%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#bbbbbb">
          ...
          <td align="center" colspan="4">مساحت /  مترمربع </td>
          <td align="center" width="6%" rowspan="2"> تعداد<br />
            قطعه<br /></td>
          <td align="center" height="24" colspan="3">مشخصات بهره بردار</td>
        ...
        <tr class="text1">
          ...
          <td width="15%" align="center" bgcolor="#999999" class="text_r">نام خانوادگی</td>
          <td width="15%" align="center" bgcolor="#999999" class="text_r">نام</td>
  </tr>
        <tr>
          <?php 
$r = 1 ;
foreach($stmt as $row){ 
  ?>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mah_tol($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mah_tolp($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo s_bar($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo zer_kesht($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo s_ayesh($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo m_zamin($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo Agri_gat($row['bah_cod_m'],$v_id_ostan,$v_id_city,$v_id_mar,$f_add_abadi,$f_no_kesh,$z_sal,$v_mor_cod_m) ; ?></td>
