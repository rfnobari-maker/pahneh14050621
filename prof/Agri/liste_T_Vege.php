...
function liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2)
{
    $pairs = array(
        'action_lise' => '1',
        'add_abadi' => $add_abadi,
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .agri1-card-search .agri1-hint { margin: 0; }
        .agri1-card-results .agri1-note { margin-top: 12px; }
        .agri1-export {
            display: flex;
            justify-content: center;
            margin: 0 0 12px;
        ...
        .agri1-ops form { margin: 0; display: inline; }
        .agri1-ops button {
            border: 0;
            background: transparent;
            padding: 0;
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="liste-t-vege-title">ثبت اطلاعات تکمیلی بهره‌برداری‌های صیفی</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="liste-t-vege-title">
            <form id="reg-form" class="agri1-form" method="post" action="#1" novalidate>
                ...
                <div class="agri1-grid">
                    ...
                    <div class="agri1-field">
                        <p class="agri1-hint">برای مشاهده همه، جستجو را بدون فیلتر بزنید.</p>
                    </div>
                    <div class="agri1-field">
  ...
  GROUP BY Vege.id) AS sub ";
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <thead>
                        <tr>
                            <th class="agri1-ops-col" colspan="2">عملیات</th>
                            <th>تاییدیه تکمیلی</th>
                            <th>میزان تولید</th>
                            <th>سطح برداشت</th>
                            <th>تاریخ ارسال به بازار</th>
                            <th>پیش بینی تولید</th>
                            <th>تاریخ اولین آبیاری</th>
                            <th>قطعه</th>
                            <th>سال زراعی</th>
                            <th>کد ملی</th>
                            <th>نام</th>
                        ...
                        <tr>
                            <td class="agri1-ops">
                                ...
                                <form action="Vegedata_T_edit.php" method="post" onsubmit="target_po3(this)">
                                    ...
                                    <button type="submit"><img src="../../files/edit.png" title="ویرایش اطلاعات " width="33" height="26" alt=""/></button>
                                </form>
                                <?php } ?>
                            </td>
                            <td class="agri1-ops">
            ...
            <p class="agri1-note">لیست بهره‌برداری‌های تاییدشده که از تاریخ اولین آبیاری آن‌ها ۴۵ روز گذشته — تاریخ اولین آبیاری قبل از: <?php echo agri2_h($date_check); ?></p>
        </section>
        <?php
            } else {
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                ...
                <li>
                    <form action="liste_T_Vege.php?id=<?php echo (int)$id - 1; ?>#1" method="post">
                        <?php liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2); ?>
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="liste_T_Vege.php?id=1#1" method="post">
                        <?php liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="liste_T_Vege.php?id=<?php echo (int)$i; ?>#1" method="post">
                        <?php liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="liste_T_Vege.php?id=<?php echo (int)$total; ?>#1" method="post">
                        <?php liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="liste_T_Vege.php" method="post">
                    <?php liste_t_vege_filter_hiddens($add_abadi, $add_city, $bah_cod_m, $z_sal, $b_time, $m_ab, $confi2); ?>
                    <span>به صفحه</span>
        ...
        (function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!isNaN(pageId) && pageId >= 1 && pageId <= <?php echo (int)$total; ?>) {
                    this.action = 'liste_T_Vege.php?id=' + pageId + '#1';
                } else {
                    e.preventDefault();
