...
function agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal)
{
    $pairs = array(
        'action' => '1',
        'id_ostan' => $id_ostan1,
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri-rep1-title">گزارش اطلاعات زراعی به تفکیک بهره بردار</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="agri-rep1-title">
            <form id="reg-form" class="agri1-form" method="post" action="#1" novalidate>
                ...
                <div class="agri1-grid">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="id_ostan" class="style8" disabled="disabled" id="id_ostan" dir="rtl">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="id_city5" class="style8" id="id_city" disabled="disabled" dir="rtl">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="add_abadi" class="input_text" id="add_abadi" tabindex="3" dir="rtl">
                            <option value="0">انتخاب کنید</option>
                            <?php
                            $query = "SELECT  add_abadi,abadi FROM `list_abadi` WHERE  `id_mar` = '$id_mar'  and mor_cod_m = '$login_session' ORDER BY BINARY abadi ";
                            $stmt = $dbh->prepare($query);
                            $stmt->execute();
                            foreach ($stmt as $row) {
                            ?>
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="id_mar" class="style8" id="bakh" dir="rtl" disabled="disabled">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="add_city" class="input_text" id="add_city" tabindex="4" dir="rtl">
                            <option value="0">انتخاب کنید</option>
                            <?php
                    ...
                    <div class="agri1-field">
                        ...
                        <input name="bah_cod_m" type="text" class="input_text" id="bah_cod_m" dir="ltr" inputmode="numeric" tabindex="5" value="<?php echo agri2_h($bah_cod_m); ?>"/>
                    </div>
                    <div class="agri1-field">
                ...
                <div class="agri1-actions">
                    <button type="submit" name="action" id="action" value="جستجو" class="agri1-btn agri1-btn-primary" tabindex="6">جستجو</button>
                </div>
            </form>
        </section>
        ...
        if (isset($_POST['action'])) {
            ...
            $start = ($id - 1) * $limit;
            $query  = "SELECT DISTINCT bah_cod_m from `$Agri_table` where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m   ORDER BY bah_cod_m ASC LIMIT $start, $limit ";
            $query1 = "SELECT COUNT(DISTINCT bah_cod_m) from `$Agri_table` where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m   ";
            $stmt = $dbh->prepare($query);
            $stmt->execute();
            $t_row = $stmt->rowCount();
            if ($t_row > 0) {
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            ...
            <div class="agri1-col-picker" id="agri1-col-picker">
                ...
                <div id="agri1-col-panel" class="agri1-col-panel" role="group" aria-labelledby="agri1-col-panel-title">
                    ...
                    <ul class="agri1-col-list">
                        <li><label><input type="checkbox" data-col-toggle="mah_tol" checked/> قطعی</label></li>
                        <li><label><input type="checkbox" data-col-toggle="mah_tolp" checked/> پیش‌بینی</label></li>
                        <li><label><input type="checkbox" data-col-toggle="s_bar" checked/> سطح برداشت</label></li>
                        <li><label><input type="checkbox" data-col-toggle="zer_kesht" checked/> سطح زیر کشت</label></li>
                        <li><label><input type="checkbox" data-col-toggle="s_ayesh" checked/> اراضی آیش</label></li>
                        <li><label><input type="checkbox" data-col-toggle="m_zamin" checked/> اراضی زراعی</label></li>
                        <li><label><input type="checkbox" data-col-toggle="gat" checked/> تعداد قطعه</label></li>
            ...
            <form action="Agri_rep1_xls.php" method="post" class="agri1-xls">
                <input type="hidden" name="id_ostan" value="<?php echo agri2_h($id_ostan1); ?>"/>
                <input type="hidden" name="id_city5" value="<?php echo agri2_h($id_city); ?>"/>
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        <col data-col="mah_tol" style="width:10%"/>
                        <col data-col="mah_tolp" style="width:10%"/>
                        <col data-col="s_bar" style="width:10%"/>
                        <col data-col="zer_kesht" style="width:10%"/>
                        <col data-col="s_ayesh" style="width:9%"/>
                        <col data-col="m_zamin" style="width:9%"/>
                        <col data-col="gat" style="width:7%"/>
                        <col data-col="bah_cod_m" style="width:12%"/>
                        <col data-col="name" style="width:16%"/>
                        <col data-col="rownum" style="width:7%"/>
                    </colgroup>
                    <thead>
                        <tr>
                            <th data-col-group="mah" colspan="2">میزان محصول<br />تن</th>
                            <th data-col-group="masahat" colspan="4">مساحت<br />مترمربع</th>
                            <th data-col="gat" rowspan="2">تعداد قطعه</th>
                            <th data-col-group="spec" colspan="2">مشخصات</th>
                            <th data-col="rownum" rowspan="2">ردیف</th>
                        </tr>
                        <tr>
                            <th data-col="mah_tol">قطعی</th>
                            <th data-col="mah_tolp">پیش‌بینی</th>
                            <th data-col="s_bar">سطح برداشت</th>
                            <th data-col="zer_kesht">سطح زیر کشت</th>
                            <th data-col="s_ayesh">اراضی آیش</th>
                            <th data-col="m_zamin">اراضی زراعی</th>
                    ...
                    ?>
                        <tr>
                            <td data-col="mah_tol"><?php echo agri2_h(mah_tol($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="mah_tolp"><?php echo agri2_h(mah_tolp($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="s_bar"><?php echo agri2_h(s_bar($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="zer_kesht"><?php echo agri2_h(zer_kesht($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="s_ayesh"><?php echo agri2_h(s_ayesh($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="m_zamin"><?php echo agri2_h(m_zamin($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
                            <td data-col="gat"><?php echo agri2_h(Agri_gat($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_mor_cod_m)); ?></td>
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                ...
                <li>
                    <form action="Agri_rep1.php?id=<?php echo (int)$id - 1; ?>#1" method="post">
                        <?php agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal); ?>
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="Agri_rep1.php?id=1#1" method="post">
                        <?php agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="Agri_rep1.php?id=<?php echo (int)$i; ?>#1" method="post">
                        <?php agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="Agri_rep1.php?id=<?php echo (int)$total; ?>#1" method="post">
                        <?php agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="Agri_rep1.php" method="post">
                    <?php agri_rep1_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal); ?>
                    <span>به صفحه</span>
        ...
        (function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!isNaN(pageId) && pageId >= 1 && pageId <= <?php echo (int)$total; ?>) {
                    this.action = 'Agri_rep1.php?id=' + pageId + '#1';
                } else {
                    e.preventDefault();
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Agri_rep1_hidden_cols';
            var GROUP = {
                mah: ['mah_tol', 'mah_tolp'],
                masahat: ['s_bar', 'zer_kesht', 's_ayesh', 'm_zamin'],
                spec: ['bah_cod_m', 'name']
            };
