...
function agri2_validate_step2($post, $no_kesh)
{
    $errors = array();
    ...
    $s_ayesh = agri2_num(isset($post['s_ayesh']) ? $post['s_ayesh'] : '');
    ...
    if ($s_ayesh === null) $errors['s_ayesh'] = 'سطح آیش را وارد کنید (اگر آیش ندارید صفر بزنید)';
    elseif ($s_ayesh === false) $errors['s_ayesh'] = 'سطح آیش باید عدد باشد';
    elseif ($s_ayesh < 0) $errors['s_ayesh'] = 'سطح آیش نمی‌تواند منفی باشد';
    elseif ($m_zamin !== null && $m_zamin !== false && $s_ayesh > $m_zamin) {
        $errors['s_ayesh'] = 'سطح آیش نمی‌تواند از مساحت زمین بیشتر باشد';
    }

    if ($z_sal == '') $errors['z_sal'] = 'سال زراعی را انتخاب کنید';
    elseif ($z_sal != '1405-1406' && $z_sal != '1404-1405') $errors['z_sal'] = 'سال زراعی نامعتبر است';
...
if ($is_save) {
    ...
    if (!$place['ok']) {
        ...
        $field_errors = agri2_validate_step2($_POST, $no_kesh);
        ...
        $s_ayesh = agri2_num($_POST['s_ayesh']);
...
if ($show_step2) {
    ...
    if (isset($_POST['s_ayesh'])) $s_ayesh = $_POST['s_ayesh'];
    $v_no_kesh = '';
    $v_no_mal = '';
...
$agri_ro = ($show_step2 && $no_mal <> 7) ? ' readonly="readonly"' : '';
$agri_ro_class = ($show_step2 && $no_mal <> 7) ? ' agri-lock' : '';
?>
<!DOCTYPE html>
...
<body class="agri1-body agri1-page">
    ...
    <img src="../../files/images/header.jpg" width="1200" height="149" alt="" class="agri1-header-image"/>
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri2-title"><?php echo $show_step2 ? 'ثبت قطعه زراعی جدید' : 'ثبت اطلاعات بهره‌برداری زراعی جدید'; ?></h1>
        ...
        <section class="agri1-card" aria-labelledby="agri2-title">
            <?php if ($show_step2) { ?>
                <form id="agri2-back" method="post" action="Agri2.php" class="is-hidden" aria-hidden="true">
                ...
                <form action="Agri2.php" method="post" id="form1" name="form1" class="agri1-form" novalidate>
                    ...
                    <div class="agri1-grid">
                        ...
                        <div class="agri1-field" style="margin-top:0" id="field-m_zamin">
                            ...
                            <input name="m_zamin" type="text" id="m_zamin" dir="ltr" lang="fa" inputmode="decimal" value="<?php if (isset($m_zamin)) echo agri2_h($m_zamin); ?>" maxlength="11"
                    ...
                    <div class="agri1-grid" style="margin-top:24px">
                        ...
                        <div class="agri1-field" style="margin-top:0" id="field-s_ayesh">
                            ...
                            <input name="s_ayesh" type="text" id="s_ayesh" dir="ltr" inputmode="decimal" value="<?php if (isset($s_ayesh)) echo agri2_h($s_ayesh); ?>" maxlength="70"
                                   aria-invalid="<?php echo isset($field_errors['s_ayesh']) ? 'true' : 'false'; ?>"
                                   aria-describedby="hint-s_ayesh<?php echo isset($field_errors['s_ayesh']) ? ' error-s_ayesh' : ''; ?>"/>
                            <p class="agri1-hint" id="hint-s_ayesh">اگر آیش ندارید صفر وارد کنید. نمی‌تواند از مساحت زمین بیشتر باشد.</p>
                            <p class="agri1-error<?php echo isset($field_errors['s_ayesh']) ? '' : ' is-hidden'; ?>" id="error-s_ayesh"><?php echo isset($field_errors['s_ayesh']) ? agri2_h($field_errors['s_ayesh']) : ''; ?></p>
                        </div>
                    </div>
                ...
                <div class="agri1-alert" id="agri1-error-summary" role="alert" tabindex="-1" aria-labelledby="agri1-error-title">
                    ...
                    <div>
                        ...
                        <?php if (isset($not_found_bah)) { ?>
                            <p>برای ثبت اطلاعات بهره‌برداری زراعی، ابتدا اطلاعات بهره‌بردار را ثبت کنید.</p>
            ...
            <form id="agri2-form" class="agri1-form" method="post" action="Agri2.php" novalidate>
