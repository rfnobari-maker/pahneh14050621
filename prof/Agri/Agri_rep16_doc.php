...
header("Content-Disposition: attachment;Filename=محصولات زراعی.docx");
include('../../lock_p1.php');
include('../../event.php');
...
<body>
      <p align="center" >گزارش محصولات زراعی 
        <?php
...
FROM Agri_prod
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah and cod_mah !='' Group by cod_mah "  ;
...
?>
      ...
      <table width="85%" height="128" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
        <tr align="center" class="text1">
               ...
               <td colspan="3" bgcolor="#999999">سطح زیر کشت <br />
                <span class="style2">هکتار</span></td>
               <td valign="middle" width="12%" rowspan="2" bgcolor="#999999">نام محصول</td>
...
?>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="11%" height="40" ><?php echo $mahtol ;?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="13%" ><?php echo $mahtolp ;?></td>
               ...
               <td align="center" width="9%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $zer_keshtkol ;?></td>
