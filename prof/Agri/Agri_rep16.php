...
$Agri_prod_table = isset($_POST['z_sal']) ? 'Agri_prod' . str_replace('-', '_', $z_sal) : '';
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri-rep16-title">گزارش محصولات زراعی</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="agri-rep16-title">
                ...
                <div class="agri1-grid">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="no_kesh" class="input_text required" id="no_bah2" tabindex="2">
                            ...
                            <option value="1" <?php if (isset($_POST['no_kesh']) && $no_kesh == "1") echo "selected='selected'"; ?>>آبی</option>
                            <option value="2" <?php if (isset($_POST['no_kesh']) && $no_kesh == "2") echo "selected='selected'"; ?>>دیم</option>
                        </select>
                    </div>
                    <div class="agri1-field">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="add_abadi" class="input_text" id="add_abadi" tabindex="5" dir="rtl">
                            ...
                            <option value="<?php echo agri2_h($row['add_abadi']); ?>"
                                <?php if (isset($_POST['add_abadi']) && $row['add_abadi'] == $add_abadi) echo 'selected="selected"'; ?>> <?php echo agri2_h($row['abadi']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="add_city" class="input_text" id="add_city" tabindex="6" dir="rtl">
                            ...
                            <option value="<?php echo agri2_h($row['add_city']); ?>"
                                <?php if (isset($_POST['add_city']) && $row['add_city'] == $add_city) echo 'selected="selected"'; ?>> <?php echo agri2_h($row['shahr']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="agri1-field">
...
where $v_id_ostan and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh 
 and $v_mor_cod_m and $v_bah_cod_m  and  $v_cod_mah and cod_mah !='' Group by cod_mah ";
            $stmt = $dbh->prepare($query);
            $stmt->execute();
            $t_row = $stmt->rowCount();
            if ($t_row > 0) {
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            ...
            <div class="agri1-col-picker" id="agri1-col-picker">
                ...
                <div id="agri1-col-panel" class="agri1-col-panel" role="group" aria-labelledby="agri1-col-panel-title">
                    ...
                    <ul class="agri1-col-list">
                        ...
                        <li><label><input type="checkbox" data-col-toggle="s_bar_kol" checked/> کل برداشت</label></li>
                        <li><label><input type="checkbox" data-col-toggle="s_bar_b" checked/> کشت مجدد برداشت</label></li>
                        <li><label><input type="checkbox" data-col-toggle="s_bar_a" checked/> کشت اول برداشت</label></li>
                        <li><label><input type="checkbox" data-col-toggle="zer_kol" checked/> کل</label></li>
                        <li><label><input type="checkbox" data-col-toggle="zer_b" checked/> کشت مجدد</label></li>
                        <li><label><input type="checkbox" data-col-toggle="zer_a" checked/> کشت اول</label></li>
            ...
            <div class="agri1-xls">
                <form action="Agri_rep16_xls.php" method="post">
                    <input type="hidden" name="id_ostan" value="<?php echo agri2_h($id_ostan1); ?>"/>
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        ...
                        <col data-col="s_bar_b" style="width:10%"/>
                        <col data-col="s_bar_a" style="width:9%"/>
                        <col data-col="zer_kol" style="width:9%"/>
                        <col data-col="zer_b" style="width:10%"/>
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th data-col="s_bar_b">کشت مجدد</th>
                            <th data-col="s_bar_a">کشت اول</th>
                            <th data-col="zer_b">کشت مجدد</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="agri1-name-col" data-col="product"><?php echo agri2_h(mah_name($row['cod_mah'])); ?><br /><?php echo agri2_h($row['cod_mah']); ?></td>
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Agri_rep16_hidden_cols';
            var GROUP = {
