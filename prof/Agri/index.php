            ...
            <section class="agri1-card" aria-labelledby="agri1-card-farm">
                <h2 class="agri1-card-title" id="agri1-card-farm">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M2 22L16 8"></path>
                        <path d="M3.47 12.53L5 11l1.53 1.53a3.5 3.5 0 0 1 0 4.94L3 20l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path>
                        <path d="M7.47 8.53L9 7l1.53 1.53a3.5 3.5 0 0 1 0 4.94L7 16l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path>
                        <path d="M11.47 4.53L13 3l1.53 1.53a3.5 3.5 0 0 1 0 4.94L11 12l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path>
                        <path d="M20 2h2v2a4 4 0 0 1-4 4h-2V6a4 4 0 0 1 4-4Z"></path>
                        <path d="M11.47 17.47L13 19l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L5 19l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path>
                        <path d="M15.47 13.47L17 15l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L9 15l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path>
                        <path d="M19.47 9.47L21 11l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L13 11l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path>
                    </svg>
                    بهره‌برداری زراعی
                </h2>
