...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        ...
        <section class="agri1-card" aria-labelledby="agri2-title">
            <?php if ($show_step2) { ?>
                <form id="agri2-back" method="post" action="Agri1.php" class="is-hidden" aria-hidden="true">
                ...
                <form action="Agri1.php" method="post" id="form1" name="form1" class="agri1-form" novalidate>
            ...
            <form id="agri2-form" class="agri1-form" method="post" action="Agri1.php" novalidate>
