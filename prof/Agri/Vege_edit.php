...
// ✅ تعریف متغیرهای پیش‌فرض برای جلوگیری از Notice
$mess = '';
$mah1 = '';
$mah2 = '';
$mah3 = '';
...
// ✅ بررسی وجود POST قبل از استفاده
...
if ($id != '') {
    $query = "SELECT cod_mah from Vege_prod where Vege_id = '$id' ";
    $stmt = $dbh->prepare($query);
    $stmt->execute();
    foreach($stmt as $row){
        if ($row['cod_mah']=='174') $mah1='1'; 
        if ($row['cod_mah']=='172') $mah2='1'; 
        if ($row['cod_mah']=='170') { $mah3='1'; $t_kind_m++; }
    }
}

if (isset($_POST['cod'])) { 
    $t_kind = isset($_POST['t_kind']) ? $_POST['t_kind'] : 0;
...
// ✅ این بخش تکراری بود - حذف شد (قبلاً بالاتر تعریف شد)
...
{  
    ...
    $b_time = isset($_POST['b_time']) ? $_POST['b_time'] : '';
    if ($b_time=='') $mess.='کشت بر اساس زمان برداشت را انتخاب کنید'.'<p>';
    ...
    if ((isset($_POST['action'])) and ($mess==''))
    {
        ...
        $row = $stmt->fetch(PDO::FETCH_ASSOC);
        $no_bah = isset($row['no_bah']) ? $row['no_bah'] : '';
        
        if ($count_codm>1) {
            ?>
            <form name="myform1" class="myform" method="post" action="VbahEdit_history.php">
        ...
        {
            ?>
            <form name="myform1" class="myform" method="post" action="Vegedata_edit.php">
                <input type="hidden" name="id" value="<?php echo $id; ?>" />
                <input type="hidden" name="no_bah" value="<?php echo $no_bah; ?>" />
                <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m; ?>" />
                <input type="hidden" name="m_poul" value="<?php echo $m_poul; ?>" />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
            <td>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        <td width="11"><p>&nbsp;</p><p>&nbsp;</p></td>
                        <?php include('top.php'); ?>
                        <td width="996">
                            <p class="style8">ویرایش اطلاعات محصولات عمده صیفی</p>
                            <a name="1" id="1"></a>
                                                    ...
                                                    <?php if ($m_poul == 'shahr') { ?>
                                                        <select name="add_city" class="input_text" id="add_city" style="width:170px; height:40px" dir="rtl" onchange="this.form.submit()">
                                                            ...
                                                            <option value="<?php echo $row['add_city']; ?>"
                                                                <?php if (isset($add_city) && $row['add_city']==$add_city) echo 'selected=selected'?>> 
                                                                <?php echo $row['shahr']; ?>
                                                            </option>
                                                            <?php }?>
                                                        </select>
                                                    ...
                                                    <?php if ($m_poul == 'abadi') { ?>
                                                        <select name="add_abadi" class="input_text" id="add_abadi" style="width:170px; height:40px" dir="rtl" onchange="this.form.submit()">
                                                            ...
                                                            <option value="<?php echo $row['add_abadi']; ?>"
                                                                <?php if (isset($add_abadi) && $row['add_abadi']==$add_abadi) echo 'selected=selected'?>> 
                                                                <?php echo $row['abadi']; ?>
                                                            </option>
                                                            <?php }?>
                                                        </select>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td height="50" colspan="3" align="right">
                                                <div align="right">
                                                    <input name="bah_cod_m" type="text" class="required" value="<?php echo $bah_cod_m; ?>" maxlength="12" readonly/>
                                                </div>
                                            </td>
                                            ...
                                            <td height="47" colspan="3">
                                                <div align="right">
                                                    <select name="b_time" class="input_text required" id="b_time" style="height:40px; width:170px; direction:rtl" tabindex="4">
                                                        <option value="">انتخاب کنید</option>
                                                        <option value="1" <?php if (isset($b_time) && $b_time=='1') { echo 'selected="selected"'; } ?>>زمستانه/استمرار</option>
                                                        <option value="2" <?php if (isset($b_time) && $b_time=='2') { echo 'selected="selected"'; } ?>>بهاره</option>
                                                        <option value="3" <?php if (isset($b_time) && $b_time=='3') { echo 'selected="selected"'; } ?>>تابستانه</option>
                                                        <option value="4" <?php if (isset($b_time) && $b_time=='4') { echo 'selected="selected"'; } ?>>پاییزه</option>
                                                    </select>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="22%" height="40">
                                                <div align="right">
                                                    <span style="text-align: right">گوجه فرنگی
                                                        <input name="mah1" type="checkbox" class="green" id="mah1" value="1" <?php if (isset($mah1) && $mah1 == '1') { ?>checked='checked' <?php } ?> />
                                                    </span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td height="37" align="center">
                                                <div align="right">
                                                    <span style="text-align: right">پیاز
                                                        <input name="mah2" type="checkbox" class="green" id="mah2" value="1" <?php if (isset($mah2) && $mah2 == '1') { ?>checked='checked' <?php } ?> />
                                                    </span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <?php if (isset($mah3) && $mah3==1) {?>
                                                <td width="22%">
                                                    <div align="right">
                                                        <input name="t_kind" type="text" class="required" id="t_mah" maxlength="2" style="width:50px; text-align:center" value="<?php echo $t_kind_m; ?>"/>
                                                    </div>
                                                </td>
                                                <td width="15%"><div align="right">: تعداد ارقام</div></td>
                                            <?php } else {?>
                                                <td width="22%"><div align="right"></div></td>
                                                <td width="12%"></td>
                                            <?php } ?>
                                            <td width="7%" height="55" align="center">
                                                <div align="right">
                                                    <span style="text-align: right">سیب زمینی 
                                                        <input name="mah3" type="checkbox" class="green" id="mah3" onChange="this.form.submit()" value="1" <?php if (isset($mah3) && $mah3 == '1') { ?>checked='checked' <?php } ?> />
                                                    </span>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td height="55" colspan="3" align="center">
                                                <div align="right">
                                                    <select name="m_ab" class="input_text required" id="m_ab" style="height:40px; width:120px; direction:rtl" tabindex="14">
                                                        <option value="">انتخاب کنید</option>
                                                        <option value="1" <?php if (isset($m_ab) && $m_ab=='1') { echo 'selected="selected"'; } ?>>چشمه</option>
                                                        <option value="2" <?php if (isset($m_ab) && $m_ab=='2') { echo 'selected="selected"'; } ?>>قنات</option>
                                                        <option value="3" <?php if (isset($m_ab) && $m_ab=='3') { echo 'selected="selected"'; } ?>>رودخانه</option>
                                                        <option value="4" <?php if (isset($m_ab) && $m_ab=='4') { echo 'selected="selected"'; } ?>>سد</option>
                                                        <option value="5" <?php if (isset($m_ab) && $m_ab=='5') { echo 'selected="selected"'; } ?>>چاه سطحی</option>
                                                        <option value="6" <?php if (isset($m_ab) && $m_ab=='6') { echo 'selected="selected"'; } ?>>چاه عمیق</option>
                                                        <option value="7" <?php if (isset($m_ab) && $m_ab=='7') { echo 'selected="selected"'; } ?>>چاه نیمه عمیق</option>
                                                        <option value="8" <?php if (isset($m_ab) && $m_ab=='8') { echo 'selected="selected"'; } ?>>زهکش</option>
                                                        <option value="9" <?php if (isset($m_ab) && $m_ab=='9') { echo 'selected="selected"'; } ?>>پساب</option>
                                                        <option value="10" <?php if (isset($m_ab) && $m_ab=='10') { echo 'selected="selected"'; } ?>>آب بندان</option>
                                                        <option value="11" <?php if (isset($m_ab) && $m_ab=='11') { echo 'selected="selected"'; } ?>>سایر</option>
                                                    </select>
                                                </div>
                                            </td>
