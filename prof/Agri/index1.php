...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        ...
        <div class="agri1-grid">
            <section class="agri1-card" aria-labelledby="agri1-btn-benefic">
                <div class="agri1-sticker" aria-hidden="true">
                ...
                <nav class="agri1-nav">
                    <a href="benefic.php" id="agri1-btn-benefic" class="agri1-btn agri1-btn-primary">بهره برداران کشاورزی</a>
                </nav>
            </section>

            <section class="agri1-card" aria-labelledby="agri1-btn-agri">
                <div class="agri1-sticker" aria-hidden="true">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24">
                ...
                <nav class="agri1-nav">
                    <a href="Agri/" id="agri1-btn-agri" class="agri1-btn agri1-btn-primary">زراعت</a>
                </nav>
            </section>

            <section class="agri1-card" aria-labelledby="agri1-btn-garden">
                <div class="agri1-sticker" aria-hidden="true">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24">
                ...
                <nav class="agri1-nav">
                    <a href="./Garden/" id="agri1-btn-garden" class="agri1-btn agri1-btn-primary">باغبانی</a>
                </nav>
            </section>

            <section class="agri1-card" aria-labelledby="agri1-btn-poultry">
                <div class="agri1-sticker" aria-hidden="true">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24">
                ...
                <nav class="agri1-nav">
                    <a href="Poultry/" id="agri1-btn-poultry" class="agri1-btn agri1-btn-primary">زنبور عسل</a>
                </nav>
            </section>

            <section class="agri1-card" aria-labelledby="agri1-btn-aquatic">
                <div class="agri1-sticker" aria-hidden="true">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24">
                ...
                <nav class="agri1-nav">
                    <a href="Aquatic/" id="agri1-btn-aquatic" class="agri1-btn agri1-btn-primary">آبزی پروری</a>
                </nav>
            </section>

            <section class="agri1-card" aria-labelledby="agri1-btn-animal">
                <div class="agri1-sticker" aria-hidden="true">
                    <svg class="agri1-icon" width="24" height="24" viewBox="0 0 24 24">
                ...
                <nav class="agri1-nav">
                    <a href="Animal/" id="agri1-btn-animal" class="agri1-btn agri1-btn-primary">دام</a>
                </nav>
            </section>
        </div>
