...
header("Content-Disposition: attachment;Filename=Agri_noon_edit.xls");
include('../../lock_p1.php');
include('../../event.php') ;
...
$query = "SELECT s_ayesh,num_bah,id,mor_cod_m,no_mal,bah_cod_m,add_abadi,add_city,sh_gat,z_sal,no_kesh,m_zamin,id_ostan,id_city,t_mah from `$Agri_table` where  mor_cod_m = :mor_cod_m and $v_add_abadi and $v_add_city and $v_no_mal and $v_no_kesh and $v_bah_cod_m and $v_m_cod_m and $v_z_sal  and  date_s not like '%/%' ORDER BY mor_cod_m ASC  "; 
