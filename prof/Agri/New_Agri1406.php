...
id_city,t_mah,check_cod from `Agri1404_1405` where  bah_cod_m = :bah_cod_m  and mor_cod_m = :mor_cod_m";
...
<body class="agri1-body agri1-page">
    ...
    <div id="agri1-confirm" class="agri1-overlay" role="dialog" aria-modal="true" aria-labelledby="agri1-confirm-title" hidden>
        <div class="agri1-overlay-panel">
            <p id="agri1-confirm-title">از آماده‌سازی قطعه / قطعات انتخاب شده برای سال زراعی 1406-1405 مطمئن هستید؟</p>
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="new-agri-title">آماده‌سازی اطلاعات پایه، سال زراعی 1406-1405</h1>
        </header>
...
<?php if ($searched) { ?>
        <section class="agri1-card" aria-labelledby="result" id="result-card">
            <h2 class="agri1-card-title" id="result">قطعات سال زراعی 1405-1404</h2>
<?php if ($found > 0) { ?>
            ...
            <form id="bulk_action_form" class="agri1-form" name="bulk_action_form" action="send_data1406.php" method="post" novalidate>
...
?>
                ...
                <input type="hidden" name="Go_send_data" value="مایل به ایجاد اطلاعات فوق در سال زراعی 1406-1405 هستم"/>
                <div class="agri1-actions">
                    <button type="submit" id="send_data" class="agri1-btn agri1-btn-accent">
                        مایل به ایجاد اطلاعات فوق در سال زراعی 1406-1405 هستم
                    </button>
                </div>
            </form>
<?php } else { ?>
            <div class="agri1-alert" role="alert">
                ...
                <p>اطلاعات زراعی بهره‌بردار در سال 1405-1404 یافت نشد.</p>
            </div>
<?php } ?>
        </section>
<?php } ?>
