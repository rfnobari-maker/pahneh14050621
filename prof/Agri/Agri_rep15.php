...
function agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name)
{
    $pairs = array(
        'action' => '1',
        'id_ostan' => $id_ostan1,
...
$Agri_prod_table = !empty($z_sal) ? 'Agri_prod' . str_replace('-', '_', $z_sal) : '';
...
<head>
    ...
    <script type="text/javascript">
        function agri1RebuildMahName() {
            var sel = document.querySelector("select.mar") || document.getElementById("mah_name");
        ...
        $(document).ready(function () {
            $(".country").change(function () {
                ...
                $.ajax({
                    ...
                    cache: false,
                    success: function (html) {
                        $(".mar<?php if (isset($num_t_mah)) echo $num_t_mah; ?>").html(html);
                        agri1RebuildMahName();
                    }
                });
            });
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri15-title">گزارش اطلاعات زراعی به تفکیک محصول / بهره بردار</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="agri15-title">
            <form id="reg-form" class="agri1-form" method="post" action="#1" novalidate>
                    ...
                    <div class="agri1-field">
                        ...
                        <select name="add_abadi" class="input_text" id="add_abadi" tabindex="5" dir="rtl">
                            ...
                            <option value="<?php echo agri2_h($row['add_abadi']); ?>"
                                <?php if (isset($add_abadi) and $row['add_abadi'] == $add_abadi) echo 'selected="selected"'; ?>> <?php echo agri2_h($row['abadi']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                        ...
                        <select name="add_city" class="input_text" id="add_city" tabindex="6" dir="rtl">
                            ...
                            <option value="<?php echo agri2_h($row['add_city']); ?>"
                                <?php if (isset($add_city) and $row['add_city'] == $add_city) echo 'selected="selected"'; ?>> <?php echo agri2_h($row['shahr']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="agri1-field">
                ...
                <div class="agri1-actions">
                    <button type="submit" name="action" id="action" value="جستجو" class="agri1-btn agri1-btn-primary" tabindex="8">جستجو</button>
                </div>
            </form>
        </section>
        ...
        if (isset($_POST['action'])) {
            ...
            $query1 = "SELECT count(*) bah_cod_m from `$Agri_prod_table` where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_cod_mah   ";
            $stmt = $dbh->prepare($query);
            $stmt->execute();
            $t_row = $stmt->rowCount();
            if ($t_row > 0) {
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            <div class="agri1-results-toolbar">
                <div class="agri1-col-picker" id="agri1-col-picker">
                    ...
                    <div id="agri1-col-panel" class="agri1-col-panel" role="group" aria-labelledby="agri1-col-panel-title">
                        ...
                        <ul class="agri1-col-list">
                            ...
                            <li><label><input type="checkbox" data-col-toggle="mah_tol" checked/> محصول قطعی</label></li>
                            <li><label><input type="checkbox" data-col-toggle="mah_tolp" checked/> محصول پیش‌بینی</label></li>
                ...
                <div class="agri1-xls">
                    <form action="Agri_rep15_xls.php" method="post">
                        <input type="hidden" name="id_ostan" value="<?php echo agri2_h($id_ostan1); ?>"/>
                    ...
                    <form action="Agri_rep15_doc.php" method="post">
                        <input type="hidden" name="id_ostan" value="<?php echo agri2_h($id_ostan1); ?>"/>
                        <input type="hidden" name="id_city" value="<?php echo agri2_h($id_city); ?>"/>
                        <input type="hidden" name="id_mar" value="<?php echo agri2_h($id_mar); ?>"/>
                        <input type="hidden" name="add_abadi" value="<?php echo agri2_h($add_abadi); ?>"/>
            ...
            <p class="agri1-note">فقط قطعات دارای محصول در محاسبه شرکت داده شده / قطعات دارای تنوع محصول 0 یا به عبارت دیگر قطعه‌ای که کلاً آیش ثبت شده محاسبه نگردیده</p>
                    ...
                    ?>
                        <tr>
                            <td class="agri1-ops" data-col="ops">
                                <form action="manager_Agri3.php" method="post" onsubmit="target_Agri15(this)">
                            ...
                            <td data-col="mah_tol"><?php echo agri2_h(mah_tol($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_cod_mah, $mor_cod_m)); ?></td>
                            <td data-col="mah_tolp"><?php echo agri2_h(mah_tolp($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_cod_mah, $mor_cod_m)); ?></td>
                            <td data-col="s_bar"><?php echo agri2_h(s_bar($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_cod_mah, $mor_cod_m)); ?></td>
                            <td data-col="zer_kesht"><?php echo agri2_h(zer_kesht($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_cod_mah, $mor_cod_m)); ?></td>
                            <td data-col="gat"><?php echo agri2_h(Agri_gat($row['bah_cod_m'], $v_id_ostan, $v_id_city, $v_id_mar, $f_add_abadi, $f_no_kesh, $z_sal, $v_cod_mah, $mor_cod_m)); ?></td>
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                ...
                <li>
                    <form action="Agri_rep15.php?id=<?php echo (int)$id - 1; ?>#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="Agri_rep15.php?id=1#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="Agri_rep15.php?id=<?php echo (int)$i; ?>#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="Agri_rep15.php?id=<?php echo (int)$total; ?>#1" method="post">
                        <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="Agri_rep15.php" method="post">
                    <?php agri15_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $z_sal, $mah_qroup, $mah_name); ?>
                    <span>به صفحه</span>
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Agri_rep15_hidden_cols';
            var GROUP = {
                mah: ['mah_tol', 'mah_tolp'],
                masahat: ['s_bar', 'zer_kesht'],
                spec: ['bah_cod_m', 'name']
            };
