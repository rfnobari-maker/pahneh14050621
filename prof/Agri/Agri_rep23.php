...
function agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah)
{
    $pairs = array(
        'action' => '1',
        'id_ostan' => $id_ostan1,
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .agri1-table .agri1-ostan-col,
        .agri1-table .agri1-loc-col {
            white-space: nowrap;
            overflow: hidden;
            text-overflow: ellipsis;
        }
        .agri1-table th.agri1-row-col,
        .agri1-table td.agri1-row-col {
            width: 40px;
            min-width: 40px;
            overflow: hidden;
        }
...
<body class="agri1-body agri1-page">
    ...
    <main class="agri1-main">
        <header class="agri1-hero">
            <h1 class="agri1-title" id="agri23-title">گزارش اختصاصی اطلاعات زراعی</h1>
        </header>

        <section class="agri1-card agri1-card-search" aria-labelledby="agri23-title">
            <form id="reg-form" class="agri1-form" method="post" action="#1" novalidate>
                ...
                <div class="agri1-grid">
                    ...
                    <div class="agri1-field">
                        ...
                        <input name="mor_cod_m" type="text" readonly="readonly" class="input_text" id="mor_cod_m" dir="ltr" inputmode="numeric" value="<?php echo agri2_h($login_session); ?>"/>
                    </div>
                    <div class="agri1-field">
                    ...
                    <div class="agri1-field">
                        <label class="agri1-label" for="m_zamin2">مساحت زمین — کوچکتر یا مساوی</label>
                        <p class="agri1-hint">هکتار</p>
                        <input name="m_zamin2" type="text" class="input_text" id="m_zamin2" dir="ltr" inputmode="decimal" value="<?php echo agri2_h($m_zamin2); ?>"/>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="m_zamin1">مساحت زمین — بزرگتر یا مساوی</label>
                        <p class="agri1-hint">هکتار</p>
                        <input name="m_zamin1" type="text" class="input_text" id="m_zamin1" dir="ltr" inputmode="decimal" value="<?php echo agri2_h($m_zamin1); ?>"/>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="t_mah">تنوع محصول</label>
                        <input name="t_mah" type="text" class="input_text" id="t_mah" dir="ltr" inputmode="numeric" value="<?php echo agri2_h($t_mah); ?>"/>
                    </div>
                    <div class="agri1-field">
                        <label class="agri1-label" for="s_ayesh">سطح آیش</label>
                        <p class="agri1-hint">هکتار</p>
                        <input name="s_ayesh" type="text" class="input_text" id="s_ayesh" dir="ltr" inputmode="decimal" value="<?php echo agri2_h($s_ayesh); ?>"/>
                    </div>
                </div>
        ...
        <section class="agri1-card agri1-card-results" aria-label="نتایج جستجو">
            <div class="agri1-results-toolbar">
                ...
                <div class="agri1-xls">
                <form action="Agri_rep23_xls.php" method="post">
                    <input type="hidden" name="id_ostan"  value="<?php echo agri2_h($id_ostan1); ?>"/>
                    <input type="hidden" name="id_city"   value="<?php echo agri2_h($id_city); ?>"/>
                    <input type="hidden" name="id_mar"    value="<?php echo agri2_h($id_mar); ?>"/>
                    ...
                    <input type="hidden" name="m_zamin1"  value="<?php echo agri2_h($m_zamin1); ?>"/>
                    <input type="hidden" name="m_zamin2"  value="<?php echo agri2_h($m_zamin2); ?>"/>
                    <input type="hidden" name="s_ayesh"  value="<?php echo agri2_h($s_ayesh); ?>"/>
                ...
                <form action="Agri_rep23_doc.php" method="post">
                    <input type="hidden" name="id_ostan"  value="<?php echo agri2_h($id_ostan1); ?>"/>
                    <input type="hidden" name="id_city"   value="<?php echo agri2_h($id_city); ?>"/>
                    <input type="hidden" name="id_mar"    value="<?php echo agri2_h($id_mar); ?>"/>
                    <input type="hidden" name="add_abadi" value="<?php echo agri2_h($add_abadi); ?>"/>
            ...
            <div class="agri1-table-wrap">
                <table class="agri1-table">
                    <colgroup>
                        ...
                        <col data-col="ostan" style="width:10%"/>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="agri1-row-col" data-col="rownum" rowspan="2">ردیف</th>
                        </tr>
                        <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="agri1-loc-col" data-col="abadi"><?php echo agri2_h(abadi_name($row['add_abadi'])); ?><?php echo agri2_h(shahr_name($row['add_city'])); ?></td>
                            <td class="agri1-loc-col" data-col="city"><?php echo agri2_h(city_name1($row['id_city'],$row['id_ostan'])); ?></td>
                            <td class="agri1-ostan-col" data-col="ostan"><?php echo agri2_h(ostan_name($row['id_ostan'])); ?></td>
                            <td class="agri1-row-col" data-col="rownum"><?php echo (int)$r; ?></td>
                        </tr>
                    <?php
                    $r++;
                    }
        ...
        <?php
        if (isset($query1) && isset($limit) && $limit > 0) {
        ...
        <nav class="agri1-pager" aria-label="صفحه‌بندی">
            <ul class="agri1-pager-list">
                ...
                <li>
                    <form action="Agri_rep23.php?id=<?php echo (int)$id - 1; ?>#1" method="post">
                        <?php agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah); ?>
                ...
                <?php if ($show_first) { ?>
                <li>
                    <form action="Agri_rep23.php?id=1#1" method="post">
                        <?php agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah); ?>
                ...
                <li>
                    ...
                    <?php } else { ?>
                    <form action="Agri_rep23.php?id=<?php echo (int)$i; ?>#1" method="post">
                        <?php agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah); ?>
                ...
                <li><span class="agri1-pager-ellipsis">...</span></li>
                    <?php } ?>
                <li>
                    <form action="Agri_rep23.php?id=<?php echo (int)$total; ?>#1" method="post">
                        <?php agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah); ?>
            ...
            <div class="agri1-pager-jump">
                <form id="pageJumpForm" action="Agri_rep23.php" method="post">
                    <?php agri23_filter_hiddens($id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah); ?>
                    <span>به صفحه</span>
        ...
        (function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!isNaN(pageId) && pageId >= 1 && pageId <= <?php echo (int)$total; ?>) {
                    this.action = 'Agri_rep23.php?id=' + pageId + '#1';
                } else {
                    e.preventDefault();
    ...
    <script>
        ...
        (function () {
            ...
            var KEY = 'Agri_rep23_hidden_cols';
            var GROUPS = {
                bah: ['bah_cod_m', 'name'],
                loc: ['abadi', 'city', 'ostan']
            };
