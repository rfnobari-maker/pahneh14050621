...
//sms($tel_m,$text) ;
 // ثبت در بانک پیگیری
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'ثبت اطلاعات زنبورستان نا شناس ') ; 
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <? echo $row['abadi'] ;?></option>
                 ...
                 <tr>
                   <td height="39" colspan="3" style="text-align: right"><table width="100%" border="1" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <td width="22%"><span class="normalTextSmall"> : نوع اراضی </span></td>
                       <td width="15%">
                     ...
                     <tr>
                       ...
                       <td colspan="2"><span class="normalTextSmall">: مختصات زمین</span></td>
                       </tr>
                     <tr>
                       <td height="105" colspan="4"><textarea class="input_text" name="comment2" id="comment2" cols="60" rows="8"><?php echo $comment ;?></textarea></td>
                     ...
                     <tr>
                       <td height="40" colspan="6"><table width="100%" border="1" cellpadding="0" cellspacing="0">
                         <tr>
                           <td><textarea class="input_text" name="comment" id="comment" cols="60" rows="8"><?php echo $comment ;?></textarea></td>
                           <td>: سایر موارد با ذکر توضیح</td>
                           </tr>
                         </table></td>
                     </tr>
                    </table>                     
                    <table width="850px" border="1" align="center" cellpadding="0" cellspacing="0" >
                      <tr>
                        <td width="91" height="55" align="center" bgcolor="#CCCCCC"><input type="submit" name="del_sh"  value="حذف فایل"   style="width:70px; height:33px ; font-family:Tahoma, Geneva, sans-serif "
		<?php 
		$pic1 = '../files/ok.png' ;
		 if ($row['sh']=="")
		{
		...
		?>
		 ...
		 /></td>
                        <td width="103" align="center" bgcolor="#CCCCCC"><img src="<?php echo $pic1 ;?>" width="39" height="39"  alt=""/></td>
                        <td width="70" height="55" align="center" bgcolor="#CCCCCC"><span class="up_row">
                          <?php if($row['sh']<>""){?>
                        ...
                        <td width="415" height="55" bgcolor="#CCCCCC"><input type="submit" value="ارسال فايل" name="action4"  <?php if($row['sh']<>"") { echo ' disabled="disabled"';}?>/>
                        ...
                        <td width="159" align="center" bgcolor="#CCCCCC">تصویر محل </td>
                      </tr>
                    </table></td>
                 </tr>
                 <tr>
