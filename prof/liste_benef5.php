...
$query = "SELECT add_abadi,add_city,bah_cod_m,cod_p,tel_m,last_name,name,confi,num_bah,date_t from bah where  mor_cod_m = $login_session and $v_add_abadi and $v_add_city and $v_no_fa and $v_confi ORDER BY BINARY last_name ASC LIMIT $start, $limit "; 
$query1 = "SELECT id from bah where  mor_cod_m = $login_session and $v_add_abadi and $v_add_city and $v_no_fa and $v_confi ORDER BY BINARY last_name ASC  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
         <p class="style1"><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
