 ...
 <?php  if ($no_bah=='1') { ?>
  <td height="38" colspan="5" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقیقی <span class="style8"><?php echo $notfound,$live?></span></strong></div></td>
   ...
   <tr>
     ...
     <td><div align="right">
       <input name="cod_p2" type="text" class="required digits" id="cod_p2" style="width:150px; height:30px ; " tabindex="12" dir="rtl" lang="fa" value="<?php echo $cod_p ; ?>" maxlength="10" xml:lang="fa"/>
     </div></td>
...
,m_sod=?,fname=?,m_tah=?,er_mtah=?,tel_s=?,tel_m=?,ostan_s=?,shahr_s=?,city_s=?,rosta_s=?,co_name=?,no_co=?,sh_meli=?,co_sabt=?,fa_1=?,fa_2=?,fa_3=?,fa_45=?,fa_67=?,fa_8=?,fa_9=?,fa_10=?,fa_11=?,fa_12=?,fa_13=?,add_abadi=?,add_city=?,ok=?	
 WHERE bah_cod_m=? and no_bah=?";
$q = $dbh->prepare($query);
$q->execute(array($date_edit,$add_abadi,$add_city,$s_bah,$no_bah,$bah_cod_m,$cod_p,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,$fname,$m_tah,$er_mtah,$tel_s,$tel_m,$ostan_s,$shahr_s,$city_s,$rosta_s,$co_name,$no_co,$sh_meli,$co_sabt,$fa_1,$fa_2,$fa_3,$fa_45,$fa_67,$fa_8,$fa_9,$fa_10,$fa_11,$fa_12,$fa_13,$add_abadi,$add_city,'1',$bah_cod_m,$no_bah));
// ارسال اس ام اس 
