...
{
	var result = confirm(" از آماده سازی قطعه / قطعات انتخاب شده برای سال  97 مطمئن هستید ؟");
	if(result){
		return true;
	}else{
		return false;
...
<body>
 ...
 $bah_cod_m=$_POST['bah_cod_m'];
  ?>
<p align="center" >&nbsp;</p>
<p align="center" dir="rtl" ><span class="style8">آماده سازی اطلاعات  پایه ، سال  97 </span></p>
...
?>
 ...
 <form name="bulk_action_form" action="send_data97.php" method="post" onSubmit="return delete_confirm();"/>
...
?>
        ...
        <input type="submit" name="Go_send_data" id="send_data" style="height:45px ; width:350px" value="مایل به ایجاد اطلاعات فوق در سال 97 هستم" />
      </form>
<?php
 }
 else 
