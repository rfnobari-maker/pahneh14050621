...
$query = "SELECT group_cod,group_name FROM product_b "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
foreach($stmt as $row){
?>
...
?>
 ...
 if ($dis == '1')  { $v_dis  = 1  ; }else{ $v_dis = "mah_tol = 0 " ;}
 ...
 $t_r = $r ; 
  ?>
          <td class="normalTextSmall" >
            <form  action="Gardendata_edit98.php" method="post" onsubmit="target_Gar15(this)">
