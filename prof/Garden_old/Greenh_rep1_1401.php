...
<body>
  ...
  <tr>
    ...
    <td width="840" >
      <?php include('top.php');?>
      <span class="style8">عملکرد سالانه واحد های گلخانه</span><br />
      </p>
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                 ...
                 <td rowspan="2" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_mar" disabled="disabled" class="input_text" id="id_mar" style="width:170px ; height:40px" tabindex="4" dir="rtl" onchange="this.form.submit()">
...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
               ...
               <tr >
                 ...
                 <td height="54" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <input name="mor_cod_m" type="text" class="input_text" id="mor_cod_m"  style="height:35px ; width:170px " tabindex="7" value="<?php echo $login_session?>" readonly="readonly" />
                   </div></td>
...
where  $v_id_ostan  and $v_id_city and $f_no_kesht and  $v_id_mar and $f_add_abadi and $f_add_city and y_prod = '$y_prod'
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td><form  action="Greenh_prod_xls.php" method="post">
            ...
            <table width="99%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
              <tr class="text1">
                ...
                <td width="3%" rowspan="2" bgcolor="#006699">تعداد شاغل<br />
                <span class="style2">نفر</span></td>
          <td width="7%" rowspan="2" bgcolor="#006699">مسئول فنی</td>
          <td width="9%" rowspan="2" bgcolor="#006699">نوع محصول تولیدی</td>
          <td width="8%" rowspan="2" bgcolor="#006699">نوع کشت</td>
          <td width="7%" rowspan="2" bgcolor="#006699">وضعیت واحد</td>
          <td width="9%" rowspan="2" bgcolor="#006699"><p>عملکرد سال </p></td>
        ...
        <tr class="text1">
          <td width="12%" height="29" bgcolor="#006699" class="style8"><span class="text1"> کد ملی</span></td>
          <td width="10%" bgcolor="#006699">نام و نام خانوادگی</td>
          <td width="5%" bgcolor="#006699">شهر/آبادی</td>
