  ...
  ?>
        ...
        <tr>
          <td height="206" colspan="7" class="normalTextSmall" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr >
                <td height="34" colspan="3" bgcolor="#006699" class="text2">عملیات</td>
                <td width="17%" bgcolor="#006699" class="text2">عملکرد تولید <br />
                  <span class="style2">کیلوگرم / مترمربع</span></td>
                <td width="16%" bgcolor="#006699" class="text2">میزان کل تولید<br />
                  <span class="style2">تن</span></td>
                <td width="16%" bgcolor="#006699" class="text2">سطح زیر کشت سالیانه</td>
                <td width="11%" bgcolor="#006699" class="text2">تعداد دوره پرورش در سال </td>
                <td width="12%" bgcolor="#006699" class="text2">وضعیت واحد </td>
                <td width="11%" bgcolor="#006699" class="text2">عملکرد سال</td>
              </tr>
              <tr>
                <?php
...
{
?>
   <td height="50" colspan="9" class="style8" style="font-size: 14px; font-family: Tahoma;">عملکردی برای این واحد یافت نشد ، هم اکنون با استفاده از آیکون زیر عملکرد واحد را ثبت کنید </td>
<?php
}
else 
{
...
?>
               <td width="5%">
              <?php if($row['y_prod']=='1404') {?>
                  <form  action="del_list_Mush_prod.php" method="post" onsubmit="target_po2(this)">
                  ...
                  <button onclick="return confirm('از حذف اطلاعات عملکرد واحد مطمئن هستید ؟ ')"><img src="../../files/del.png" title="حذف عملکرد واحد " width="20" height="20"  alt=""/></button>
                </form>
                <?php }?>
                </td>
                <td width="6%">
                <?php if($row['y_prod']=='1404') {?>
                <form  action="Mushroom_prod_edit.php" method="post">
                  ...
                  <button><img src="../../files/edit.png" title="ویرایش عملکرد واحد " width="20" height="20"  alt=""/></button>
                </form>
                 <?php }?>
                </td>
              <?php if($row['v_unit']=='1') {?>
                ...
                <?php }?>
                <td height="50"><?php echo $row['tol_avg'] ; ?></td>
                <td><?php echo $row['mah_tol'] ; ?></td>
                <td><?php echo $row['zer_kesh'] ; ?></td>
                <td><?php echo $row['t_dpar'] ; ?></td>
                <td><?php echo $f_v_uint?></td>
                <td><?php echo $row['y_prod'] ; ?></td>
              </tr>
               <?php 
    }
    }
   	?>
            ...
            <p><br />
            <a href="#" onclick="document.form_name.submit(); return false;"><img src="../../files/add_new.png" width="51" height="58"/></a>
...
<input type="hidden"  name="num_bah" value="<?php echo $num_bah ?>" />
    ...
    <?php 
      ...
      <p><a href="liste_Mushroom.php"    title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p></td>
  </tr>
  <tr>
