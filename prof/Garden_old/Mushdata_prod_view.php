...
<body>
  ...
  <tr>
    ...
    <form action="" method="post" id="form1" name="form1"  onSubmit="return checkform()">
      <table width="99%" height="1191" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        <tr>
        ...
        <tr>
          <td height="142" colspan="5"><br /><?php include('Mushroom_spwan_view98.php')?></td>
        </tr>
        <tr>
