...
///
    $query = "update Mushroom_prod set date_s=?,v_unit=?,num_bah=?,bah_cod_m=?,mor_cod_m=?,no_mush=?,
	...
	gazoil_m=?,gazoil_a=?,benz_m=?,benz_a=?,barg_m=?,barg_a=?,gaz_m=?,gaz_a=?,comp=?,nt_comp=?,t_dpar=?,mah_tol=?,zer_kesh=?
	,tol_avg=? where unit_id=? and y_prod=? ";
    $q = $dbh->prepare($query);
    $q->execute(array($date_s,$v_unit,$num_bah,$bah_cod_m,$login_session,$no_mush,$id_ostan,$id_city,$id_mar,$add_abadi
	,$add_city,$z_dep,$dep,$lisan,$t_mar,$t_zan,$m_fani,$gar_j,$gar_ja,$gar_m,$gar_ma,$hash_j,$hash_ja,$hash_m,$hash_ma,
	$zof_j,$zof_ja,$zof_m,$zof_ma,$ab_m,$ab_a,$gazoil_m,$gazoil_a,$benz_m,$benz_a,$barg_m,$barg_a,$gaz_m,$gaz_a,$comp,$nt_comp,$t_dpar
...
// clos conntection 
    ...
    alert ('عملکرد واحد پرورش قارچ با موفقیت ویرایش شد ') ;
?>
...
$row = $stmt->fetch(PDO::FETCH_ASSOC);
 ...
 $gaz_m = $row['gaz_m'] ;
 $gaz_a = $row['gaz_a'] ;
// if(isset($row['barg_m'])){$barg_m = $row['barg_m'];$barg_a=$row['barg_a'];}else{$barg_m=0;$barg_a=0;}
      ...
      <table width="99%" height="1272" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="gar_m" type="text" class="input_text  required  number" id="gar_m" style="width:100px;height:30px" tabindex="9" dir="rtl" lang="fa" value="<?php echo $gar_m ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
                <td bgcolor="#FFFFFF"><div align="right">
                ...
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="gar_j" type="text" class="input_text  required  number" id="gar_j" style="width:100px;height:30px" tabindex="7" dir="rtl" lang="fa" value="<?php echo $gar_j ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
              ...
              <tr>
                ...
                <td><div align="right">
                  <input name="hash_m" type="text" class="input_text  required  number" id="hash_m" style="width:100px; height:30px ; " tabindex="13" dir="rtl" lang="fa" value="<?php echo $hash_m ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
                <td><div align="right">
                ...
                <td><div align="right">
                  <input name="hash_j" type="text" class="input_text  required  number" id="hash_j" style="width:100px; height:30px ; " tabindex="11" dir="rtl" lang="fa" value="<?php echo $hash_j ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
              ...
              <tr>
                ...
                <td height="47"><div align="right">
                  <input name="zof_m" type="text" class="input_text  required  number" id="zof_m" style="width:100px; height:30px ; " tabindex="17" dir="rtl" lang="fa" value="<?php echo $zof_m ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
                <td height="47"><div align="right">
                ...
                <td height="47"><div align="right">
                  <input name="zof_j" type="text" class="input_text  required  number" id="zof_j" style="width:100px; height:30px ; " tabindex="15" dir="rtl" lang="fa" value="<?php echo $zof_j ; ?>" maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
        ...
        <tr>
          <td height="9" colspan="5" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="20%" height="35" ><?php if($gaz=='1') {?>
                <div style="margin-right:30px" align="right" >گاز</div>
                <?php }?></td>
              <td width="16%" ><?php if($barg=='1') {?>
              ...
              <td width="18%" bgcolor="#FFFFFF" ><div style="margin-right:30px" align="right" >آب</div></td>
              <td width="12%">&nbsp;</td>
            </tr>
            <tr>
          ...
          <tr>
            <td height="29" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="47" ><div align="right">
                  <select name="nt_comp" class="input_text required " id="m_fani"  style="height:40px ; width:100px ; direction:rtl" tabindex="30">
                    <option value="">انتخاب کنید</option>
                ...
                <td bgcolor="#FFFFFF" ><div align="right"><span class="style2">تن /سال</span>
                  <input name="comp" type="text" class="input_text  required  number" id="comp" style="width:100px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php echo $comp ; ?>"  maxlength="5"  align="baseline" xml:lang="fa" />
                </div></td>
              ...
              <tr>
                <td width="33%" height="47" ><div align="right"><span class="style2">تن</span>
                    <input name="mah_tol" type="text" class="input_text  required  number" id="mah_tol" style="width:100px; height:30px ; " tabindex="32" dir="rtl" lang="fa" value="<?php echo $mah_tol ; ?>" maxlength="9"  align="baseline" xml:lang="fa" />
                </div></td>
        ...
        <tr>
          ...
          <td height="54" bgcolor="#33CCCC"><div align="right"><span class="style2">مترمربع</span>
              <input name="zer_kesh" type="text" class="input_text  required  number" id="zer_kesh9" style="width:100px; height:30px ; " min="1"  tabindex="33" dir="rtl" lang="fa" value="<?php echo $zer_kesh ; ?>" maxlength="9" readonly  align="baseline" xml:lang="fa" />
          </div></td>
...
$( ".spwan" ).click(function() {
                ...
                var zer_kesh_sal = zer_kesh_salon * t_dpar ;
				 $('#zer_kesh9').val(parseInt(zer_kesh_sal));
