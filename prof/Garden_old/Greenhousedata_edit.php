          ...
          <td height="131" colspan="5"><?php if($no_mtol=='1') { ?>
            <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
              ...
              <tr>
                ...
                <td><div align="center">
                  <input name="no_mtol1_4" type="text" class="required number input_text" id="md_ab9" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $no_mtol1_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
