...
// بانک اطلاعات کشت 
$query = "UPDATE Greenhousn SET
 m_zamin=?,m_zamin_gol=?,no_mal=?,

lng_d=?,lng_m=?,lng_s=?,lng_ds=?,lat_d=?,lat_m=?,lat_s=?,lat_ds=?,
m_cod_m=?,m_vaz_sok=?,no_mtol=?,no_saz=?,no_gol=?,pt_date=?,pt_no=?,num_bah=?,add_abadi=? 
...
$sal = $_POST['sal'];
$num_bah = $_POST['num_bah']; 
$query = "SELECT * from Greenhousn where bah_cod_m = '$bah_cod_m'  and id = '$id' "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$found = $stmt -> rowCount();
...
<body>
    ...
    <form action="" method="post" id="form1" name="form1">
      <table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td colspan="2"><div style="margin-right:30px" align="right"> :مساحت مفید گلخانه</div></td>
          <td><div align="right">
          ...
          <td height="5" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="30%"  bgcolor="#FFFFFF"><div align="right"  >
                <input name="m_cod_m" type="text"  class="input_text required Mcod_m" id="m_cod_m"  style="width:150px; height:30px;  <?php if($no_mal<>7) echo 'background-color:#FFFFCC " readonly="readonly" ' ?> " tabindex="11"   dir="rtl" lang="fa" value="<?php echo $m_cod_m ; ?>" maxlength="10" xml:lang="fa"/>
              </div></td>
              ...
              <td height="53" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="31%" height="57" ><div align="right">
                    <select name="no_moj" disabled="disabled" class="input_text required " id="no_moj"  style="height:40px ; width:200px ; direction:rtl" tabindex="20">
                      <option value="">انتخاب کنید</option>
                  ...
                  <td width="20%" bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:نام مجتمع گلخانه ای</div></td>
                </tr>
                <tr>
                  <?php
 if($no_moj !='4' and $no_moj !='1' ) {?>
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td bgcolor="#FFFFFF"><div align="right">
                    <input name="sal_tas" type="text" class="required number input_text" id="sal_tas" style="width:75px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $sal_tas ; ?>"min='1200' max='1400' minlength="4" maxlength="4" xml:lang="fa"/>
                    <br />
                  </div></td>
              ...
              <td height="47" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="46" colspan="3" class="style2"><div align="right" id="otherFieldDiv8"> تن
                    <input name="z_sard" type="text" class="required number input_text" id="z_sard" style="width:75px; height:30px ; " tabindex="47" dir="rtl" lang="fa"  value="<?php echo $z_sard?>" maxlength="35" xml:lang="fa"/>
                    <br />
                  </div></td>
                ...
                <tr>
                  <td height="42" colspan="3" class="style2"><div align="right" id="otherFieldDiv10"> تن
                    <input name="z_sort" type="text" class="required number input_text" id="z_sort" style="width:75px; height:30px ; " tabindex="50" dir="rtl" lang="fa" value="<?php echo $z_sort?>" maxlength="35" xml:lang="fa"/>
                    <br />
                  </div></td>
     ...
     <input type="submit" name="action" value="تصحیح" style="width:150px ; height:45px" tabindex="39" id="btn1" onClick="setTimeout(disableFunction, 1);"/>
