...
<body>
  ...
  <tr>
    <td>
      ...
      <p>
        <?php
$query = "SELECT num_bah,no_bah,bah_cod_m,mor_cod_m,name,last_name,id_ostan,add_abadi,add_city,id_city,co_name from bah where bah_cod_m = $bah_cod_m";
...
?>
  <tr>
    ...
    <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo ostan_name($row['id_ostan'])?><br/><?php echo $num_bah?> </td>
...
?>
      ...
      <form  name="myform"  method="post" action="Mushroom.php">
      </form>
...
<?php
 ...
 $add_city =$_POST['add_city'] ; 
 $add_abadi =$_POST['add_abadi'] ; 
$query = "SELECT count(*) from Mushroom where bah_cod_m = '$bah_cod_m' and num_bah = '$num_bah' ";
$stmt = $dbh->prepare($query);
$stmt->execute();
...
{
?>
	 <form name="myform2" class="myform" method="post" action="Mushroom_data.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
           <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
