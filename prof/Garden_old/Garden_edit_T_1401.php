...
if ($row['no_kesh']=='2') $v_no_kesh='دیم' ;	 
 $t_r = $r ; 
  ...
  <div class="column" >
    ...
    <div class="column" >
      <input name="mah_tolp"  type="text" class="mah_tolp<?php echo $t_r ?> required digits input_text" id="mah_tolp<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'2'?>"  dir="rtl" lang="fa" value="<?php echo $row['mah_tolp']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
      <input name="tree_gb"  type="text" class="tree_gb<?php echo $t_r ?> required digits input_text" id="tree_gb<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['tree_gb']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
      <input name="tree_b"  type="text" class="tree_b<?php echo $t_r ?> required digits input_text" id="tree_b<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['tree_b']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
      <input name="s_kesht_gb"  type="text" class="s_kesht_gb<?php echo $t_r ?> required digits input_text" id="s_kesht_gb<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_kesht_gb']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
    <div class="column" >
      <input name="s_kesht_b"  type="text" class="s_kesht_b<?php echo $t_r ?> required digits input_text" id="s_kesht_b<?php echo $t_r ?>" style="width:50px; height:30px ; " tabindex="<?php echo $r.'1'?>"  dir="rtl" lang="fa" value="<?php echo $row['s_kesht_b']*1 ; ?>" maxlength="6"  align="baseline" xml:lang="fa" /></div>
       </div>
       </form>
                </td>
