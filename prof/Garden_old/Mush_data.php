...
<body>
  ...
  <tr>
    ...
    <br />
      <table width="90%" height="1226" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        <tr>
  ...
  <?php if($nah_kesh<>'3'){?> 
          ...
          <td height="9" colspan="5" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <tr>
                <td height="53"><div align="right">
                  <select name="no_gol" class="input_text required " id="no_gol"  style="height:40px ; width:150px ; direction:rtl" tabindex="13">
                    <option value="">انتخاب کنید</option>
                    <option value="1">وزارت جهاد</option>
                    <option value="2">نظام مهندسی</option>
                    <option value="3">بسیج سازندگی</option>
                  </select>
                </div></td>
                <td><div align="right">:محل اخذ مجوز</div></td>
                <td>&nbsp;</td>
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="unit_name2" type="text" class="required input_text" id="unit_name2" style="width:150px; height:30px ; " tabindex="12" dir="rtl" lang="fa" value="<?php echo $unit_name ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="pb_no" type="text" class="required  input_text" id="pb_no" style="width:75px; height:30px ; " tabindex="14" dir="rtl" lang="fa" value="<?php echo $pb_no ; ?>" maxlength="20" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td width="37%" height="53"><div align="right">
                  <input name="unit_name" type="text" class="required input_text" id="unit_name" style="width:150px; height:30px ; " tabindex="17" dir="rtl" lang="fa" value="<?php echo $unit_name ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                <td width="17%"><div align="right">:ظرفیت واقعی</div></td>
                <td width="2%">&nbsp;</td>
                <td width="26%" bgcolor="#FFFFFF"><div align="right">
                  <input name="pb_no2" type="text" class="required  input_text" id="pb_no2" style="width:75px; height:30px ; " tabindex="16" dir="rtl" lang="fa" value="<?php echo $pb_no ; ?>" maxlength="20" xml:lang="fa"/>
                  <br />
                </div></td>
        ...
        <tr>
          <td height="298" colspan="5"><table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
            <tr>
                <td height="43" colspan="4" bgcolor="#FFFFCC">مشخصات قفسه بندی سالن ها</td>
                </tr>
              <tr>
                <td width="28%" height="43" bgcolor="#FFFFCC">عرض<br />
                  <span class="style2">متر</span></td>
                <td width="25%" bgcolor="#FFFFCC">طول <br />
                  <span class="style2">متر </span></td>
                <td width="26%" bgcolor="#FFFFCC">تعداد طبقه در هر ردیف<br /></td>
                <td width="21%" bgcolor="#FFFFCC">ردیف تعداد </td>
                </tr>
              <tr>
                <td height="51"><div align="center">
                  <input name="no_mtol1_4" type="text" class="required number input_text" id="md_ab9" style="width:70px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $no_mtol1_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_3" type="text" class="required number input_text" id="md_ab8" style="width:70px; height:30px ; " tabindex="20" dir="rtl" lang="fa" value="<?php echo $no_mtol1_3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_2" type="text" class="required number input_text" id="md_ab7" style="width:70px; height:30px ; " tabindex="19" dir="rtl" lang="fa" value="<?php echo $no_mtol1_2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                <td><div align="center">
                  <input name="no_mtol1_1" type="text" class="required number input_text" id="md_ab6" style="width:70px; height:30px ; " tabindex="18" dir="rtl" lang="fa" value="<?php echo $no_mtol1_1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                </tr>
            </table>
            ...
            <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
              ...
              <tr>
                <td><div align="center">
                  <input name="md_ab2" type="text" class="required number input_text" id="md_ab10" style="width:70px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $no_mtol2_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="md_ab" type="text" class="required number input_text" id="md_ab5" style="width:70px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $no_mtol2_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td height="41"><div align="center">
                  <input name="no_mtol2_4" type="text" class="required number input_text" id="md_ab15" style="width:70px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php echo $no_mtol2_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                <td><div align="center">
                  <input name="no_mtol2_3" type="text" class="required number input_text" id="md_ab14" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $no_mtol2_3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                <td><div align="center">
                  <input name="no_mtol2_2" type="text" class="required number input_text" id="md_ab13" style="width:70px; height:30px ; " tabindex="23" dir="rtl" lang="fa" value="<?php echo $no_mtol2_2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                <td><div align="center">
                  <input name="no_mtol2_1" type="text" class="required number input_text" id="md_ab12" style="width:70px; height:30px ; " tabindex="22" dir="rtl" lang="fa" value="<?php echo $no_mtol2_1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                  </div></td>
                </tr>
          </table></td>
        ...
        <tr>
          ...
          <td height="37" class="style2"><div align="right">
            <select name="m_ab2" class="input_text required " id="m_ab2"  style="height:40px ; width:150px ; direction:rtl" tabindex="28">
              <option value="">انتخاب کنید</option>
     ...
     <input type="submit" name="action" value="ثبت اطلاعات" style="width:150px ; height:45px" tabindex="29" id="btn1" onClick="setTimeout(disableFunction, 1);"/>
        </p>
      </div>
<p align="center" >&nbsp;</p>
</form> 
