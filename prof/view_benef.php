...
<body>
 ...
 <?php  if ($no_bah=='1') { ?>
  <td height="38" colspan="5" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقیقی</strong></div></td>
   ...
   <tr>
     ...
     <td><div align="right">
       <input name="cod_p2" type="text" class="required digits" id="cod_p2" style="width:150px; height:30px ; " tabindex="12" dir="rtl" lang="fa" value="<?php echo $cod_p ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
     </div></td>
 ...
 <table width="95%" height="304" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
   ...
   <tr>
     <td height="53" bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
           <input name="fa_14" type="radio" disabled="disabled"   class="required green" id="fa_1_8" tabindex="27"  value="1"   <?php if($fa_14=="1") echo "checked='checked'"?> />
         </label>
         <br />
         <label> خیر</label>
         <label>
           <input name="fa_14" type="radio" disabled="disabled"   class="required red" id="fa_1_9" value="2"  <?php if($fa_14=="2") echo "checked='checked'"?> />
         </label>
         <br />
       </p>
     </div></td>
 ...
 <p>&nbsp;</p>
    ...
    <p><a href="liste_benef.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p> 
           </td>
  </tr>
  <tr>
