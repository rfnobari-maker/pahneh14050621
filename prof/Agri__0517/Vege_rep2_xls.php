...
?>
      ...
      <table width="85%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#0099FF">
        <tr class="style8">
          ...
          <td align="center" width="4%" bgcolor="#CCCCCC">فصل تولید </td>
          <td align="center" width="6%" bgcolor="#CCCCCC">سطح برداشت / هکتار</td>
          <td align="center" width="5%" bgcolor="#CCCCCC">سطح زیر کشت  / هکتار</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">همراه</td>
          <td align="center" width="10%" bgcolor="#CCCCCC"><span class="style8"> کد ملی بهره بردار</span></td>
          <td width="8%" align="center" bgcolor="#CCCCCC" class="text_r">نام خانوادگی</td>
          <td width="9%" align="center" bgcolor="#CCCCCC" class="text_r">نام</td>
          <td align="center" width="10%" bgcolor="#CCCCCC">شهرستان</td>
