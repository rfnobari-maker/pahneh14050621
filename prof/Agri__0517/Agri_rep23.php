...
function generate_hidden_inputs() {
    global $action, $id_ostan1, $id_city, $id_mar, $add_abadi, $add_city, $bah_cod_m, $mor_cod_m, $no_kesh, $m_ab, $no_ab, $z_sal, $m_zamin1, $m_zamin2, $s_ayesh, $t_mah;
    ?>
    ...
    <ul class="pagination" style="list-style: none; padding: 0; margin: 0; display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
        <?php if($id > 1): ?>
            <li style="display: inline-block;">
                <form action="Agri_rep23.php?id=<?php echo $id-1 ?>#1" method="post" style="display: inline;">
        ...
        <?php for($i = $start_page; $i <= $end_page; $i++): ?>
            <li style="display: inline-block;">
                ...
                <?php else: ?>
                    <form action="Agri_rep23.php?id=<?php echo $i ?>#1" method="post" style="display: inline;">
                        <?php generate_hidden_inputs(); ?>
        ...
        <?php if($end_page < $total): ?>
            ...
            <?php endif; ?>
            <li style="display: inline-block;">
                <form action="Agri_rep23.php?id=<?php echo $total ?>#1" method="post" style="display: inline;">
                    <?php generate_hidden_inputs(); ?>
