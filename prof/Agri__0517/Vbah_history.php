...
$query = "SELECT mor_cod_m,no_bah,last_name,name,add_abadi,add_city,id_city,id_ostan,co_name from bah where bah_cod_m = '$bah_cod_m'";
...
?>
  <tr>
    ...
    <label >
    <input name="no_bah" type="radio"   class="required green"   value="<?php echo $row['no_bah']?>" />
    </label>
      <br /></td>
...
$no_bah = $_POST['no_bah'] ;
 ...
 include('../../login/config.php');
echo $query = "SELECT id from Vege where bah_cod_m = '$bah_cod_m' and no_bah = '$no_bah' ";
$query = "SELECT id from Vege where bah_cod_m = '$bah_cod_m'  ";
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_codm = $stmt -> rowCount();
if ($count_codm>0) {   ; 
...
{
?>
	 <form name="myform2" class="myform" method="post" action="Vege_data.php">
           <input type="hidden" name="no_bah" value="<?php echo $no_bah ;?>" />
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
