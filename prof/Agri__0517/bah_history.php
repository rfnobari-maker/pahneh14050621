...
$add_abadi = isset($_POST["add_abadi"]) ? $_POST["add_abadi"] : '';
    ...
    $t_gat = isset($_POST['t_gat']) ? $_POST['t_gat'] : '';
...
<body>
  ...
  <tr>
    <td>
      ...
      <p>
        <?php
$query = "SELECT mor_cod_m,no_bah,last_name,name,id_ostan,id_city,co_name,add_city,add_abadi,num_bah from bah where bah_cod_m = :bah_cod_m";
...
<?php
 ...
 {  
    ...
    $add_abadi = isset($_POST['add_abadi']) ? $_POST['add_abadi'] : '';
	?>
	 <form name="myform2" class="myform" method="post" action="Agri_data1.php">
     <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
