...
#user_data
{
  float:right; height:160px ; width:100% }
#img
{ 
box-shadow:10px 10px 10px 5px #39C ;
}
	#img:hover
{
box-shadow:10px 10px 10px 5px #FF9 ;	
}
...
<div style="float:right ; margin-right:30px ; margin-left:20px ; margin-top:15px ; padding:10px "  >
 <a  title="ویرایش اطلاعات کاربری" href="../../profile.php"><img src="../../files/users/<?php if(isset($pic)) echo $pic ?>" width="79" height="103" id="img" alt="تصویر کاربر "/></a></div>
         ...
         <p align="right" class="RedTitleSmaller" style="margin-right:30px">ویژه کارشناسان مسئول پهنه ، مراکز جهاد کشاورزی </p>
              <p align="right" class="normalTextSmaller" style="margin-right:30px">محل خدمت :<?php if(isset($ostan)) echo $ostan.'&nbsp; /&nbsp;'.$city.'&nbsp;/&nbsp;'.$markaz ;  ?></p>
<div class="box_pm">
  <p><a href="../../messanger.php" title="سیستم ارسال و دریافت پیام"><img src="../../files/messanger.png" alt="users" width="83" height="83" border="0" class="tricky_image" /></a>
<?php
if ($count_pm > 0)
