...
{
?>
	      <form name="myform1" class="myform" method="post" action="edit_benef4.php">
...
?>
   ...
   <?php } ?>
                 ...
                 <tr>
                   <td height="25" colspan="2" align="right" bgcolor="#CCCCCC"><div align="right" style="margin-right:10px"  class="style2"> فیلد های نوع بهره بردار و کد ملی ، غیر قابل ویرایش هستند <img src="../files/con_info.png" width="16" height="16"  alt=""/></div></td>
                  </tr>
                 <tr>
                   <td height="65"><div align="right">
       بهره بردار / مدیر عامل<? if ($no_bah == '1')  {  ?>
       ...
       <? }?>
      <? if ($no_bah == '2')  {  ?>
               <input name="date_t" type="text"  style="width:100px" class="required digits" id="date_t" value=""  maxlength="8" minlength="8"/>
       <? }?>
                     <br />
                   </div></td>
                   <td>:  تاریخ تولد <br />
