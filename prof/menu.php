...
<table width="100%" border="0" align="center" bgcolor="#0099CC">
      <tr>
        ...
        <td width="30%" style="margin-top:20px ; text-align:right ; color:#FFF"><?php if(isset($v_jen,$PersName)) echo $v_jen.' '.$PersName ; ?><span class="normalTextSmall"> / </span><?php echo $name; ?> </td>
