...
?>
           ...
           <div align="center"><form  action="list_bah_xls.php" method="post">
               ...
               <table width="98%" height="196" border="0" align="center" cellpadding="1" cellspacing="1" >
                 <tr align="center" class="text1">
                   <td height="99" colspan="2" bgcolor="#999999">عملیات</td>
                   <td bgcolor="#999999">وضعیت حیات بهره بردار</td>
...
//echo $row2['User_Name'] ; 
?>
                   <td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="edit_benef.php" method="post">
                     <input type="hidden" name="add_abadi2" value="<?php echo $add_abadi ;?>" />
                     <input type="hidden" name="add_city3" value="<?php echo $add_city ;?>" />
                     <input type="hidden" name="bah_cod_m2" value="<?php echo $row['bah_cod_m'] ;?>" />
                     ...
                     <input type="hidden" name="s_bah2" value="<?php echo $row['s_bah'] ;  ;?>" />
                   ...
                   <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="8%" class="normalTextSmaller"><?php echo $v_ok ;?></td>
                   ...
                   <td class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php if(isset($row2['abadi'])) echo $row2['abadi'];?>
                     <?php if(isset($row2['shahr'])) echo $row2['shahr'];?></td>
                   <?php 
...
{
	?>
    <form  action="list_benef2.php?id=<?php echo $id-1 ?>" method="post">
...
echo "<ul class='page'>";
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="list_benef2.php?id=<?php echo $i?>" method="post">
        <input type="hidden" name="action" value="1" />
        <input type="hidden" name="no_fa" value="<?php echo $no_fa1 ;?>" />
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
