...
<body>
 ...
 <?php }  if ($no_bah == '2') { 
   ...
   <tr>
     <td height="46"><div align="right"  >
       <input name="co_name" type="text" disabled="disabled" class="required" id="co_name" style="width:150px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $co_name ; ?>" maxlength="70"  align="baseline" xml:lang="fa" />
     </div></td>
   ...
   <tr>
     ...
     <td bgcolor="#FFFFFF">&nbsp;</td>
     <td bgcolor="#FFFFFF"><div align="right">
       <input name="sh_meli" type="text" disabled="disabled" class="required digits" id="sh_meli" style="width:150px; height:30px ; " tabindex="4" dir="rtl" lang="fa" value="<?php echo $sh_meli ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
...
sh_meli,tel_m,valid,co_name,id_ostan,id_city,id_mar,sh_sh,m_tah,er_mtah,tel_s,s_bah,jens,co_sabt,cod_p,ok
,no_nation)
...
$(document).ready(function () {
    ...
    $('#tel_m').change(function () {
        checkTelAndCode(); // فراخوانی تابع استعلام
    });
