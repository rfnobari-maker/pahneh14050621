...
$num_bah     = isset($_POST['num_bah']) ? $_POST['num_bah'] : null;$query = "SELECT * from Aquatic2 where bah_cod_m = '$bah_cod_m' and sal = '$sal' and id = '$id' "; 
...
<body>
  ...
  <tr>
    <td>
      <?php include('top.php'); ?>
           <p class="style8">مشاهده اطلاعات واحد </p>
    ...
    <form action="<?php echo $m_page  ?>" method="post" id="form1" name="form1">
      <table width="99%" height="570" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          <td width="36%" height="40"><div align="right"> <?php echo city_name1($id_city2,$id_ostan2) ?></div></td>
          <td width="15%"><div align="right">:شهرستان</div></td>
          <td width="10%">&nbsp;</td>
          <td width="21%"><div align="right"><?php echo ostan_name($id_ostan2) ; ?></div></td>
          ...
          <td height="131" colspan="5"><?PHP if(($no_fa == '1') or ($no_fa == '3')) {?>
            <table align="center"  class="my-table" >
              ...
              <tr>
                ...
                <td><div align="center">
                  <input name="tak1" type="text" readonly="readonly" class="required number input_text" id="tak1" style="width:70px; height:30px ; " tabindex="20" dir="rtl" lang="fa" value="<?php echo $tak1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak2" type="text" readonly="readonly" class="required number input_text" id="tak2" style="width:70px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $tak2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak3" type="text" readonly="readonly" class="required number input_text" id="tak3" style="width:70px; height:30px ; " tabindex="22" dir="rtl" lang="fa" value="<?php echo $tak3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak4" type="text" readonly="readonly" class="required number input_text" id="tak4" style="width:70px; height:30px ; " tabindex="23" dir="rtl" lang="fa" value="<?php echo $tak4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak5" type="text" readonly="readonly" class="required number input_text" id="tak5" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak5 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak6" type="text" readonly="readonly" class="required number input_text" id="tak6" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak6 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak7" type="text" readonly="readonly" class="required number input_text" id="tak7" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak7 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak8" type="text" readonly="readonly" class="required number input_text" id="tak8" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak8 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak9" type="text" readonly="readonly" class="required number input_text" id="tak9" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak9 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51"><span class="style2"> هزار قطعه</span></td>
                <td><div align="center">
                  <input name="tak10" type="text" readonly="readonly" class="required number input_text" id="tak10" style="width:70px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $tak10 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
            ...
            <table align="center"  class="my-table" >
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par1" type="text" readonly="readonly" class="required number input_text" id="par1" style="width:70px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php echo $par1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par2" type="text" readonly="readonly" class="required number input_text" id="par2" style="width:70px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $par2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par3" type="text" readonly="readonly" class="required number input_text" id="par3" style="width:70px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $par3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par4" type="text" readonly="readonly" class="required number input_text" id="par4" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par5" type="text" readonly="readonly" class="required number input_text" id="par5" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par5 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par6" type="text" readonly="readonly" class="required number input_text" id="par6" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par6 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par7" type="text" readonly="readonly" class="required number input_text" id="par7" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par7 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8"><span class="style2">تن</span></td>
                <td><div align="center">
                  <input name="par8" type="text" readonly="readonly" class="required number input_text" id="par8" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par8 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">پرورش میگو آب شور</td>
              </tr>
              <tr>
                <td height="51" class="style8">تن</td>
                <td><div align="center">
                  <input name="par9" type="text" readonly="readonly" class="required number input_text" id="par9" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par9 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8">تن</td>
                <td><div align="center">
                  <input name="par10" type="text" readonly="readonly" class="required number input_text" id="par10" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par10 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">پرورش    در منابع آبی طبیعی و نیمه طبیعی</td>
              </tr>
              <tr>
                <td height="51" class="style8">هزارقطعه</td>
                <td><div align="center">
                  <input name="par11" type="text" readonly="readonly" class="required number input_text" id="par11" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par11 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">ماهیان زینتی</td>
              </tr>
              <tr>
                <td height="51" class="style8">هزار عدد</td>
                <td><div align="center">
                  <input name="par12" type="text" readonly="readonly" class="required number input_text" id="par12" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par12 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">زالوی    طبی </td>
              </tr>
              <tr>
                <td height="51" class="style8">هزار شاخه </td>
                <td><div align="center">
                  <input name="par13" type="text" readonly="readonly" class="required number input_text" id="par13" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par13 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">گیاهان آبزی</td>
              </tr>
              <tr>
                <td height="51" class="style8">سر</td>
                <td><div align="center">
                  <input name="par14" type="text" readonly="readonly" class="required number input_text" id="par14" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par14 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8">تن</td>
                <td><div align="center">
                  <input name="par15" type="text" readonly="readonly" class="required number input_text" id="par15" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par15 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td class="style19">صدف</td>
              </tr>
              <tr>
                <td height="51" class="style8">تن</td>
                <td><div align="center">
                  <input name="par16" type="text" readonly="readonly" class="required number input_text" id="par16" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par16 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              ...
              <tr>
                <td height="51" class="style8">تن</td>
                <td><div align="center">
                  <input name="par17" type="text" readonly="readonly" class="required number input_text" id="par17" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $par17 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
