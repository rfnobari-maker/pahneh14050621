...
include('../cod_m.php') ;
//
if(isset($_POST['no_fa'])) $no_fa =  $_POST['no_fa'] ;  else  $no_fa = '' ;
...
$no_fa = $_POST['no_fa'];
if ($no_fa=='') $mess.='نوع فعالیت مزرعه مورد نظر را انتخاب کنید'.'<p>' ;
$no_mal = $_POST['no_mal'];
...
?>
     ...
     <input type="hidden" name="m_page" value="<?php echo 'Aquatic.php' ;?>" />
...
if ($count_codm==0) 
{
$mess='اطلاعات بهره بردار یافت نشد <p> برای ثبت اطلاعات مزرعه پرورش آبزیان ، ابتدا اطلاعات بهره بردار را ثبت نمایید ' ; 
$not_found_bah= true ;
}
else
{
...
<div id="rasul" style="width: 100%; height: 100%; background: #726d6d; display: none;  opacity: 0.6; position: fixed; z-index: 4;">
  ...
  <?php include('top.php'); ?>
    <td width="840" >
           ...
           <p class="style8">ثبت اطلاعات مزرعه تکثیر و پرورش آبزیان جدید</p><a name="1" id="1"></a>
