...
//    include('../login/config.php');
//    $valid = '600';
//    $query = "UPDATE bah SET date_s=? WHERE id=?";
//    $stmt = $dbh->prepare($query);
//    $stmt->execute(array($date_edit , $id));

//    $query = "UPDATE bah20 SET date_s=? WHERE bah_cod_m=?";
//    $stmt = $dbh->prepare($query);
//    $stmt->execute(array($date_edit, $bah_cod_m));
