...
$query = "SELECT mor_cod_m,no_bah,mor_cod_m,last_name,name,co_name,add_city,add_abadi,id_ostan,id_city,num_bah from bah where bah_cod_m = '$bah_cod_m'";
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
</p>
     <form name="form3" id="form3" method="post" action="bee_data.php">
...
?>
      ...
      <form  name="myform"  method="post" action="bee.php">
      </form>
