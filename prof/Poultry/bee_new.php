...
// $num_bah = $row['num_bah'] ; 
?>
	 <form name="myform1" class="myform" method="post" action="bee_data_new.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="no_bee" value="<?php echo $no_bee ;?>" />
           <input type="hidden" name="m_zan" value="<?php echo $m_zan ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
...
//if ('3' == '3' && !in_array($login_session, array('4132981630','4172127045','4199327983','4073427245','4071200723','4073350228','4073590413','6129595654','4072740225','4072596604','4070720065','4072822060','4072870110'))) 
if ('3'>'3')
//if ( $login_session !='1080007628 ' )
{
