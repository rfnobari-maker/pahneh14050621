...
if  ($m_zan=='shahr') {
 ...
 $id_mar = $row["id_mar"]; 
	...
	$no_zan = $no_bee ;
	$sal = '1398';
	$query = "INSERT INTO unknown_bee (date_s,sal,mor_cod_m,no_zan,id_ostan,id_city,id_mar,tk_mo,tk_bo,comment,add_abadi,add_city) VALUES(:date_s,:sal,:mor_cod_m,:no_zan,:id_ostan,:id_city,:id_mar,:tk_mo,:tk_bo,:comment,:add_abadi,:add_city)";
$q = $dbh->prepare($query);
$q->execute(array(':date_s'=>$date_s,':sal'=>$sal,':mor_cod_m'=>$mor_cod_m,':no_zan'=>$no_zan,':id_ostan'=>$id_ostan,':id_city'=>$id_city,':id_mar'=>$id_mar,':tk_mo'=>$tk_mo,':tk_bo'=>$tk_bo,':comment'=>$comment,':add_abadi'=>$add_abadi,':add_city'=>$add_city));
 // ثبت در بانک پیگیری
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  >
                 <tr>
                   <td colspan="2"><p style="text-align: right"> غیرمهاجر
                     ...
                     <p style="text-align: right"> مهاجر
                       ...
                       <br />
                     <span class="style2">زنبورستان  های که از سایر شهرستان های  استان  یا استان های دیگر  به موقعیت فعلی کوچ کردن</span>                     </p></td>
      ...
      <input type="text" name="tk_bo" id="tk_bo" class=" required input_text" value="<?php echo $tk_bo ;?>" style="width:75px ; height:30px" /></td>
                   <td width="9%" style="text-align: right">: سنتی</td>
   ...
   <input type="text" name="tk_mo" id="tk_mo" class="input_text" value="<?php echo $tk_mo ;?>" style="width:75px ; height:30px" /></td>
                 ...
                 <tr>
                   ...
                   <td height="111" colspan="2"> : توضیحات تکمیلی</td>
                  </tr>
                 <tr>
