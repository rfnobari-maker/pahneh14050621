...
$query = "UPDATE  bee SET no_zan=?,add_abadi=?,add_city=?,bem_zan=? ,bem_kand=?,sh_zan=?,t_sha=?,m_ostan=?,m_city=?,no_mo=?,tm_kh=?,tm_kkh=?,tm_arz=?,tk_mo=?
...
$q = $dbh->prepare($query);
$q->execute(array($no_zan,$add_abadi,$add_city,$bem_zan,$bem_kand,$sh_zan,$t_sha,$m_ostan,$m_city,$no_mo,$tm_kh,$tm_kkh,$tm_arz,$tk_mo,$tk_bo,$to_mo,$to_bo,$t_gar,$t_bar,$t_mom,$t_jel,$oz_tav,$t_zah
...
,$t_mom,$t_jel,$t_zah,$e_ostan,$g_ostan,$vaz_zan,$m_shaker,$t_k_jel,$m_nejad);
?>
