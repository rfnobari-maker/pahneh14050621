...
$query  = "SELECT * from bee where mor_cod_m =:mor_cod_m and  sal='1401' ORDER BY bah_cod_m ASC LIMIT $start, $limit "; 
$query1 = "SELECT * from bee where mor_cod_m =:mor_cod_m and  sal='1401' ORDER BY bah_cod_m ASC "; 
$stmt = $dbh->prepare($query);
