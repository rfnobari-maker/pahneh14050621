    ...
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;" >
      ...
      <tr>
        <td height="55"><div align="right"> <span class="style2">درجه اعشار</span>
          <input name="lat" type="text" class="required number input_text" id="lat" style="width:150px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php if(isset($lat)) echo $lat ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
          <br />
        </div></td>
        <td><div align="right">:Y عرض جغرافیایی</div></td>
        <td>&nbsp;</td>
        <td><div align="right"><span class="style2">درجه اعشار</span>
          <input name="lng" type="text" class="required number input_text" id="lng" style="width:150px; height:30px ; " tabindex="1" dir="rtl" lang="fa" value="<?php if(isset($lng)) echo $lng ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
          <br />
        </div></td>
   ...
   <?php if ($row['id_ostan']==$m_ostan) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
      ...
      <tr>
        <td dir="rtl" height="46" colspan="4"><div style=" margin-left:65px ;  width:85% ; display: flex;  flex-direction: row ; justify-content:space-between ">
          <div>
            <input name="m_nejad1" type="checkbox" disabled="disabled" tabindex="10" value="1" <?php if($m_nejad1=='1') echo "checked='checked'";?>/>
            ایرانی</div>
          <div>
            <input name="m_nejad2" type="checkbox" disabled="disabled" tabindex="11" value="1" <?php if($m_nejad2=='1') echo "checked='checked'";?>/>
            کارنیکا</div>
          <div>
            <input name="m_nejad3" type="checkbox" disabled="disabled" tabindex="12" value="1" <?php if($m_nejad3=='1') echo "checked='checked'";?>/>
            قفقازی</div>
          <div>
            <input name="m_nejad4" type="checkbox" disabled="disabled" tabindex="13" value="1" <?php if($m_nejad4=='1') echo "checked='checked'";?>/>
            ایتالیایی</div>
          <div>
            <input name="m_nejad5" type="checkbox" disabled="disabled" tabindex="14" value="1" <?php if($m_nejad5=='1') echo "checked='checked'";?>/>
            سایر</div>
        </div></td>
      ...
      <tr>
        <td height="50" colspan="4" dir="rtl"><div style=" margin-left:65px ;  width:85% ; display: flex;  flex-direction: row ; justify-content:space-between ">
          <div>
            <input name="mk_nejad1" type="checkbox" disabled="disabled" id="mk_nejad1" tabindex="17" onclick="Fun_nejad1()"  value="1"<?php if($mk_nejad1=='1') echo "checked='checked'";?> />
            ایرانی </div>
          <div>
            <input name="mk_nejad2" type="checkbox" disabled="disabled" id="mk_nejad2" tabindex="19" onclick="Fun_nejad2()"  value="1"<?php if($mk_nejad2=='1') echo "checked='checked'";?> />
            کارنیکا</div>
          <div>
            <input name="mk_nejad3" type="checkbox" disabled="disabled" id="mk_nejad3" tabindex="21" onclick="Fun_nejad3()"  value="1"<?php if($mk_nejad3=='1') echo "checked='checked'";?> />
            قفقازی</div>
          <div>
            <input name="mk_nejad4" type="checkbox" disabled="disabled" id="mk_nejad4" tabindex="23" onclick="Fun_nejad4()"  value="1"<?php if($mk_nejad4=='1') echo "checked='checked'";?> />
            ایتالیایی</div>
          <div>
            <input name="mk_nejad5" type="checkbox" disabled="disabled" id="mk_nejad5" tabindex="25" onclick="Fun_nejad5()"  value="1"<?php if($mk_nejad5=='1') echo "checked='checked'";?> />
            سایر</div>
        </div></td>
      ...
      <tr>
        <td height="47" bgcolor="#FFFFFF"><div align="right"><span class="style2">کیلوگرم</span>
          <input name="t_nan" type="text" class="tonan input_text  required number" id="t_nan" style="width:100px; height:30px ; " tabindex="39" dir="rtl" lang="fa" value="<?php echo $t_nan ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
        </div></td>
        <td height="47" bgcolor="#FFFFFF"><div align="right">: نان زنبور</div></td>
        <td>&nbsp;</td>
        <td><div align="right">
          <input name="t_k_nan" type="text" class="tknan input_text  required digits" id="t_k_nan" style="width:100px; height:30px ; " tabindex="38" dir="rtl" lang="fa" value="<?php echo $t_k_nan ; ?>" maxlength="11" readonly="readonly" xml:lang="fa"/>
        </div></td>
      ...
      <tr>
        <td height="47" bgcolor="#FFFFFF"><div align="right">
          <input name="tal_b_lav" type="text" class="input_text  required digits" id="tal_b_lav" style="width:100px; height:30px ; " tabindex="48" dir="rtl" lang="fa" value="<?php echo $tal_b_lav ; ?>" maxlength="4" readonly="readonly" xml:lang="fa"/>
        </div></td>
...
<form  name="myform" class="myform" method="post" action="list_bee.php">
     ...
     <button  onclick="close_window()" style=" margin-top:25px ; width:150px ; height:45px" tabindex="28" >بستن پنجره </button>
