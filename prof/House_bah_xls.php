...
header("Content-Disposition: attachment;Filename=لیست_سرپرست_بهره_برداران.xls");
include('../lock_p1.php');
include('../event.php') ;
...
,Household.name as sp_name,Household.last_name as sp_last_name,Household.sp_cod_m ,Household.fname as sp_fname ,Household.tel_m as sp_tel_m
 FROM  bah
 ...
 where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city  and $v_mor_cod_m and $v_bah_cod_m  and $v_s_bah and $v_no_fa and $f_ok and no_bah='1' ORDER BY BINARY bah.last_name ASC  "; 
...
?>
      ...
      <table width="98%" height="90" border="1" align="center" cellpadding="1" cellspacing="1" >
        <tr align="center" class="text1">
          ...
          <td width="4%" bgcolor="#FFFFFF" class="style8">نام کارشناس</td>
          <td bgcolor="#FFFFCC" class="style8">نام پدر سرپرست </td>
          <td bgcolor="#FFFFCC" class="style8">شماره همراه سرپرست</td>
          <td bgcolor="#FFFFCC" class="style8">نام خانوادگی </td>
          <td bgcolor="#FFFFCC" class="style8">نام سرپرست</td>
          <td bgcolor="#FFFFCC" class="style8">کد ملی سرپرست</td>
          ...
          <td width="3%" bgcolor="#FFFFFF" class="style8">شماره ثابت</td>
          ...
          <td width="3%" bgcolor="#FFFFFF" class="style8">شماره شناسنامه</td>
          <td width="3%" bgcolor="#FFFFFF" class="style8">تاریخ تولد </td>
          <td width="3%" bgcolor="#FFFFFF" class="style8">نام شرکت </td>
          <td width="3%" bgcolor="#FFFFFF" class="style8">شناسه ملی</td>
          <td width="2%" bgcolor="#FFFFFF" class="style8"> کد ملی<br />
          </td>
          <td width="3%" bgcolor="#FFFFFF" class="style8">جنسیت</td>
          ...
          <td width="7%" bgcolor="#FFFFCC" class="style8">شهرستان </td>
          <td width="6%" bgcolor="#FFFFFF" class="style8">تاریخ ثبت / ویرایش</td>
          <td width="3%" bgcolor="#FFFFFF" class="style8">ردیف</td>
        </tr>
        <tr>
          <?php
$r = 1 ;
...
?>
          <td align="center" width="4%" height="30" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $mor_cod_m?></span></td>
          <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> class="normalTextSmaller"><?php echo user_name($mor_cod_m)?></td>
          <td  width="4%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['sp_fname'];?></td>
          <td  width="4%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['sp_tel_m'];?></td>
          <td  width="4%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['sp_last_name'];?></td>
          <td  width="4%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['sp_name'];?></td>
          <td  width="4%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['sp_cod_m'];?></td>
          <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="4%" class="normalTextSmaller"><?php echo $v_ok;?></td>
          <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="2%" class="normalTextSmaller"><?php echo $row['cod_p'];?></td>
          <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="3%" class="normalTextSmaller"><?php echo $row['tel_m'];?></td>
