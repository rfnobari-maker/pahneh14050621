...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $dbh->prepare("INSERT INTO `$Agri_not_table` (Agri_id, mor_cod_m, description, date_s) VALUES (:Agri_id, :mor_cod_m, :description, :date_s)");
