...
while ($num3_t_mah > 0){
$Vegeprod_id = $_POST['Vegeprod_id'.$num3_t_mah];
 $dah_bazar = $_POST['dah_bazar'.$num3_t_mah] ;
 $mah_bazar = $_POST['mah_bazar'.$num3_t_mah] ;
 $mah_tolp  = $_POST['mah_tolp'.$num3_t_mah] ;

$query = "UPDATE  Vege_prod SET 
date_s=?,dah_bazar=?,mah_bazar=?,mah_tolp=? WHERE id=? " ;
$q = $dbh->prepare($query);
$q->execute(array($date_edit,$dah_bazar,$mah_bazar,$mah_tolp,$Vegeprod_id));
...
?>
                 ...
                 <td <?php if($n%2 == 0)   echo 'bgcolor=#CCCCCC' ?>><div align="center">
                   <select name="mah_bazar<?php echo $num2_t_mah ;?>" class="required input_text  required" id="mah_bazar<?php echo $num2_t_mah ;?>"  style="height:40px ; width:80px ; direction:rtl" tabindex="4">
                 ...
                 <td <?php if($n%2 == 0)   echo 'bgcolor=#CCCCCC' ?>><div align="center">
                   <select name="dah_bazar<?php echo $num2_t_mah ;?>" class="required input_text  required" id="dah_bazar<?php echo $num2_t_mah ;?>"  style="height:40px ; width:80px ; direction:rtl" tabindex="3">
                     <option value="">انتخاب کنید</option>
                 ...
                 <td <?php if($n%2 == 0)  echo 'bgcolor=#CCCCCC' ?>><div align="center">
                <div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="mah_tolp<?php echo $num2_t_mah ;?> required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo  $mah_tolp ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div>
