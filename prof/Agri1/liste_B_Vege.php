...
<body>
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             <p> <span class="style1"> اطلاعات سطح برداشت و تولید قطعی بهره برداری های صیفی </span></p>
...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
               ...
               <tr>
                 ...
                 <td width="23%"><div align="right"><span style="  margin-right:15px;text-align: right">:کد ملی بهره بردار</span></div></td>
...
نام آبادی</span></div></td>
               ...
               <tr>
                 <td height="56"><div align="right">
                   <select name="cod_mah" class="input_text  required" id="cod_mah" style="height:40px ; width:170px ; direction:rtl" tabindex="4">
                     <option value="">انتخاب کنید</option>
                 ...
                 <td height="56"><div align="right"><span style="  margin-right:15px;text-align: right">:نام محصول</span></div></td>
                 <td height="56"><div align="right">
...
where  Vege.confi='2' and $v_cod_mah and  Vege_prod.date_ab <= '$date_check' and Vege.mor_cod_m = '$login_session'  and $v_confi2 and $v_add_abadi and $v_add_city and $f_b_time and $f_m_ab and $v_bah_cod_m and $v_z_sal  group by Vege.id ";
...
<p align="center"><span class="style1"><a name="1" id="1"></a></span>
...
{
	?>
    <form  action="liste_B_Vege.php?id=<?php echo $id-1 ?>" method="post">
...
{
	?>
    <form  action="liste_B_Vege.php?id=<?php echo $id+1 ?>#1" method="post">
        <input type="hidden" name="action_lise" value="1" />
         <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
        <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
        <input type="hidden" name="z_sal" value="<?php echo $z_sal ;?>" />
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="liste_B_Vege.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action_lise" value="1" />
         <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
        <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
        <input type="hidden" name="z_sal" value="<?php echo $z_sal ;?>" />
