...
$dbh = null;
    ...
    unset($actual_link,$add_abadi,$add_city,$Agri_id,$check,$check_cod,$city,$co_name,$cod_m_session,$cod_mah,$cod_qroup,$count_pm,$date_edit,$date_s,$dsn,$dbh,$e,$es,$euser,$found,$h_ab,$id_city,$id_mar,$id_ostan,$jens,$karbar_m,$lat,$lng,$m_ab,$zer_kesht_b,$m_cod_m,$m_fname,$m_jens,$m_last_name,$m_name,$m_poul,$m_tel_m,$m_vaz_sok,$m_zamin,$mah_bem,$mah_kh,$mah_mas,$mah_tol,$mah_tol,$mah_tolp,$markaz,$md_ab,$mor_cod_m,$n,$name,$name,$no,$no_ab,$no_bah,$no_bah,$no_karbar,$no_kesh,$no_mal,$no_sab,$num_bah,$num_bah,$ostan,$password,$PersName,$q,$query,$row,$s_ayesh,$s_bar_a,$s_bar_b,$sh_gat,$stmt,$t_gat,$time,$title,$user,$user_check,$v_co_name,$v_jen,$v_no_kesh,$v_no_mal,$zer_kesht_a,$zer_kesht_b);
    ?>
