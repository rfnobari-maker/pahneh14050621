...
?>
  ...
  <table style="border:3px solid #069;" width="90%" border="1" align="center" cellpadding="1" cellspacing="0">
    <tr>
     <td height="38" colspan="8" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>سوابق بهره بردار در سامانه </strong></div></td>
   </tr>
    <tr>
    ...
    <tr>
      <td width="130" bgcolor="#FFFFCC"><span class="style8">1401</span><br />
1400-1401</td>
      <td width="130" bgcolor="#FFFFCC"><span class="style8">1400</span><br />
        1399-1400</td>
      <td width="126" bgcolor="#FFFFCC"><span class="style8">1399</span><br />
        1398-1399</td>
     <td height="40" bgcolor="#FFFFCC"><span class="style8">1398</span><br />
       1397-1398</td>
     <td bgcolor="#FFFFCC"><span class="style8">1397</span><br />
       1396-1397</td>
     <td width="123" bgcolor="#FFFFCC"><span class="style8">1396</span><br />
       1395-1396</td>
     </tr>
   <tr>
	 ...
	 $valeu = bah_agri_count($bah_cod_m,$num_bah,'Agri1398_1399') ;
      if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
       ...
       <?php }?></td>
     <td width="111" bgcolor="#CCCCCC" class="style8">
     <?php 	 $valeu = bah_agri_count($bah_cod_m,$num_bah,'Agri1397_1398') ;
      if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Agri/bah_liste_Agri.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
     ...
     <?php }?></td>
     <td width="124" bgcolor="#CCCCCC" class="style8">
     <?php
	 $valeu = bah_agri_count($bah_cod_m,$num_bah,'Agri1396_1397') ;
      if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Agri/bah_liste_Agri.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="table" value="Agri1396_1397" />
       <input type="hidden" name="z_sal" value="1397-1396" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu ;?></button>
     </form>
     <?php }?></td>
     <td bgcolor="#CCCCCC">
     <?php
	 $valeu = bah_agri_count($bah_cod_m,$num_bah,'Agri1395_1396') ;
	  if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Agri/bah_liste_Agri.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="table" value="Agri1395_1396" />
       <input type="hidden" name="z_sal" value="1396-1395" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu ;?></button>
     </form>
     <?php }?>
     </td>
     <td width="144" bgcolor="#CCCCCC" class="style8"><div style="margin-right:30px" align="right" >زراعی</div></td>
   ...
   <tr>
     ...
     <td class="style8">
      <?php
     $valeu = bah_vege_count($bah_cod_m,$num_bah,'1396-1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
       <form  action="Agri/bah_liste_Vege.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="z_sal" value="1396-1397" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu ;?></button>
     </form>
     <?php } ?></td>
     <td bgcolor="#FFFFFF">
           <?php
     $valeu = bah_vege_count($bah_cod_m,$num_bah,'1395-1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
       <form  action="Agri/bah_liste_Vege.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="z_sal" value="1395-1396" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu ;?></button>
     </form>
     <?php } ?></td>
   ...
   <tr>
     ...
     <td bgcolor="#CCCCCC" class="style8">
      <?php
     $valeu = bah_garden_count($bah_cod_m,$num_bah,'1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Garden.php" method="post" onsubmit="target_popup3(this)"> 
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
     ...
     <td bgcolor="#CCCCCC">
      <?php
     $valeu = bah_garden_count($bah_cod_m,$num_bah,'1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Garden.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
   ...
   <tr>
     ...
     <td class="style8">        
       <?php
     $valeu = bah_Mushroom_count($bah_cod_m,$num_bah,'1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Mushroom.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
     ...
     <td>
     <?php
     $valeu = bah_Mushroom_count($bah_cod_m,$num_bah,'1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Mushroom.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
   ...
   <tr>
     ...
     <td bgcolor="#CCCCCC" class="style8">
       <?php
     $valeu = bah_Greenhous_count($bah_cod_m,$num_bah,'1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Greenhous.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="y_prod" value="1397" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu;?></button>
     </form>
     <?php }?>
     ...
     <td bgcolor="#CCCCCC">
           <?php
     $valeu = bah_Greenhous_count($bah_cod_m,$num_bah,'1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Garden/bah_liste_Greenhous.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
       <input type="hidden" name="y_prod" value="1396" />
       <input type="hidden" name="action" value="1" />
       <button ><?php echo $valeu;?></button>
     </form>
     <?php }?>
   ...
   <tr>
     ...
     <td class="style8">
             <?php
     $valeu = bah_Aquatic_count($bah_cod_m,$num_bah,'1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Aquatic/bah_liste_Aquatic.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
     ...
     <td bgcolor="#FFFFFF">
              <?php
     $valeu = bah_Aquatic_count($bah_cod_m,$num_bah,'1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Aquatic/bah_liste_Aquatic.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
   ...
   <tr>
     ...
     <td bgcolor="#CCCCCC" class="style8">
         <?php
     $valeu = bah_bee_count($bah_cod_m,$num_bah,'1397') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Poultry/bah_liste_bee.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
     ...
     <td height="50" bgcolor="#CCCCCC">
         <?php
     $valeu = bah_bee_count($bah_cod_m,$num_bah,'1396') ;
	 if($valeu== 0) { 	 echo $valeu ;  } else {  ?> 
     <form  action="Poultry/bah_liste_bee.php" method="post" onsubmit="target_popup3(this)">
       <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
       <input type="hidden" name="num_bah" value="<?php echo $num_bah ;?>" />
