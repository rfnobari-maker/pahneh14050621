...
$number = $_POST['page'] ; 
/////////////////////////////////////////////////// 
 if (isset($_POST['action']) and $_POST['p_number'] =='Garden.php') 
 {  
 ?>
 <script>
{
...
$t_mah = $_POST['t_mah'] ;
//کنترل عدم ثبت اطلاعات تکراری 
$query = "SELECT id FROM `Garden` WHERE  date_s= '$date_s' and mor_cod_m= '$mor_cod_m'  and bah_cod_m= '$bah_cod_m' and num_bah= '$num_bah' and 
check_cod = '$check_cod'  "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
if ($stmt -> rowCount() == 0)
...
<input name="lng" type="text" class="required number input_text" id="lng" style="width:150px; height:30px ; " tabindex="1" dir="rtl" lang="fa" value="<?php echo $lng ; ?>" maxlength="11" xml:lang="fa"/>
        ...
        <tr>
          <td height="49" colspan="4"><div align="right"><span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span><span class="style8">هکتار</span><span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span>
<input name="m_zamin" type="text" class="input_text number required" id="m_zamin" style="width:100px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $m_zamin ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
          </div></td>
  ...
  <?php }?>
        ...
        <tr>
          <td height="40" colspan="4"><div align="right">
            <div align="right">
              <span class="style8">امکان ثبت اطلاعات باغی 1395 مقدور نمی باشد</span>
        ...
        <tr>
          <td height="131" colspan="5"><table width="100%" height="116" border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td width="10%" rowspan="2" bgcolor="#FFFFCC">محصول بیمه شده ؟</td>
              <td width="18%" colspan="2" bgcolor="#FFFFCC">میزان تولید<br />
                <span class="style8"><span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span>تن<span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span></span></td>
              <td height="32" colspan="2" bgcolor="#FFFFCC">تعداد درخت<br /></td>
  <?php if($nah_kesh<>'3'){?> 
              <td colspan="2" bgcolor="#FFFFCC">سطح کاشت<br />
                <span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span><span class="style8">هکتار</span><span class="style2"><img src="../../files/jadid.gif" width="35" height="15"  alt=""/></span></td>
                  <?php }?> 
...
?>
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  $mah_tol.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>2" style="width:75px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  $mah_tolp.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="tree_gb<?php echo $num2_t_mah ;?>" type="text" class="tree_gb required digits input_text" id="tree_gb<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php  $tree_gb.$num2_t_mah ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="tree_b<?php echo $num2_t_mah ;?>" type="text" class="tree_b required digits input_text" id="tree_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php  $tree_b.$num2_t_mah ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
  <?php if($nah_kesh<>'3'){?> 
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_kesht_gb<?php echo $num2_t_mah ;?>" type="text" class="mashat required number input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  $s_kesht_gb.$num2_t_mah ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
    <input name="s_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="mashat required number input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  $s_kesht_b.$num2_t_mah ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
                <?php }?> 
              <td bgcolor="#FFFFFF"><span style="margin:10px"><div align="right">
                <select  name="mah_name<?php echo $num2_t_mah ;?>" class="style2 required mar<?php echo $mah_name.$num2_t_mah ;?>" style="width:150px ; height:40px" tabindex="23" dir="rtl">
                  <option value="" selected="selected">انتخاب نام محصول</option>
                </select>
              </div></td>
              <td bgcolor="#FFFFFF"><div align="right"><span style="margin:10px">
                <select  name="mah_qroup<?php echo $num2_t_mah ;?>" class="required style2 country<?php echo $num2_t_mah ;?>" id="mah_qroup<?php echo $num2_t_mah ;?>" style="width:200px ; height:40px" tabindex="22" dir="rtl"  >
