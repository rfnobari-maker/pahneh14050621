...
$tol_avg      = $mah_tol / $zer_kesh ; 
///
    $query = "update Mushroom_prod set (date_s=?,v_unit=?,num_bah=?,bah_cod_m=?,mor_cod_m=?,no_mush=?,
	id_ostan=?,id_city=?,id_mar=?,add_abadi=?,add_city=?,z_dep=?,dep=?,lisan=?,t_mar=?,t_zan=?,
	gar_j=?,gar_ja=?,gar_m=?,gar_ma=?,hash_j=?,hash_ja=?,hash_m=?,hash_ma=?,zof_j=?,zof_ja=?,zof_m=?,zof_ma=?,
	gazoil_m=?,gazoil_a=?,benz_m=?,benz_a=?,barg_m=?,barg_a=?,gaz_m=?,gaz_a=?,comp=?,t_dpar=?,mah_tol=?,zer_kesh=?,tol_avg=? where unit_id=?,y_prod=?),unit_id=?,y_prod=?
	  VALUES()";
    $q = $dbh->prepare($query);
    $q->execute(array($date_s,$v_unit,$num_bah,$bah_cod_m,$mor_cod_m,$no_mush,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$z_dep,$dep,$lisan,$t_mar,$t_zan,
	  $gar_j,$gar_ja,$gar_m,$gar_ma,$hash_j,$hash_ja,$hash_m,$hash_ma,$zof_j,$zof_ja,$zof_m,$zof_ma,$gazoil_m,$gazoil_a,$benz_m,$benz_a,$barg_m,$barg_a,$gaz_m,$gaz_a,$comp,$t_dpar,$mah_tol,$zer_kesh,$tol_avg,$unit_id,$y_prod));
...
<?php
	...
	,$z_dep,$dep,$lisan,$t_mar,$t_zan,$gar_j,$gar_ja,$gar_m,$gar_ma,$hash_j,$hash_ja,$hash_m,$hash_ma,$zof_j,
	$zof_ja,$zof_m,$zof_ma,$gazoil_m,$gazoil_a,$benz_m,$benz_a,$barg_m,$barg_a,$gaz_m,$gaz_a,$comp,$t_dpar,
...
$y_prod = $_POST['y_prod'];
$num_bah = $_POST['num_bah'];
$query = "SELECT bah_cod_m,add_abadi,add_city,id_ostan,id_city,id_mar,unit_name,no_mush,gaz from Mushroom where id = :id"; 
$stmt = $dbh->prepare($query);
  ...
  <tr>
    ...
    <form action="" method="post" id="form1" name="form1"  onSubmit="return checkform()">
      <table width="99%" height="1272" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
          ...
          <td height="9" colspan="5" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><div align="right"><span class="style2">لیتر</span>
                <input name="gazoil_m" type="text" class="input_text  required  number" id="gazoil_m" style="width:100px; height:30px ; " tabindex="22" dir="rtl" lang="fa" value="<?php echo $gazoil_m ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
                </div></td>
              <td><div align="right">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="right">
                <input name="barg_a" type="text" class="input_text  required  number" id="barg_a" style="width:100px; height:30px ; " tabindex="19" dir="rtl" lang="fa" value="<?php echo $barg_a ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
                </div></td>
        ...
        <tr>
          <td height="197" colspan="5"><br /><?php include('Mushroom_prod_data.php')?></td>
        </tr>
        <tr>
    ...
    <input type="submit" name="action" value="ثبت اطلاعات" style="width:150px ; height:45px" tabindex="31" id="submit" />
  <a href="Mushroom_prod.php">
    <input type="button" name="btn1" value="انصراف" style="width:150px ; height:45px" tabindex="32" /></a>
        </p>
      </div>
</form> 
<script>
...
$( ".spwan" ).click(function() {
                ...
                var mah_tol = document.getElementById("mah_tol").value;
                var zer_kesh_salon = data ;
                var zer_kesh_sal = zer_kesh_salon * t_dpar ;
				 $('#zer_kesh9').val(parseFloat(zer_kesh_sal));
