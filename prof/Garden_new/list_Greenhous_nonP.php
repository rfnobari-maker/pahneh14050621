             ...
             <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="528" border='0' align="center" cellpadding='0' cellspacing='0'>
                 ...
                 <tr bgcolor='#f1f1f1' >
                   ...
                   <td width="232" height="52" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                 ...
                 <tr bgcolor='#f1f1f1' >
                   <td width="200" height="46" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_city5" disabled="disabled" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?></td>
                   <td width="133"  align='center' bgcolor="#DDDDDD" class="normalTextSmall"><span class="style1"><font size="2" class="normalTextSmall">:شهرستان</font></span></td>
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                   ...
                   <td rowspan="2" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_mar" disabled="disabled" class="input_text" id="id_mar" style="width:170px ; height:40px" dir="rtl" onchange="this.form.submit()">
...
left join Greenhous_prod On Greenhous_prod.unit_id = Greenhous.id and Greenhous_prod.y_prod='$y_prod'
 ...
 $v_add_city and 
  ...
  $f_sys_kesh  and
   $f_sys_hot  and 
    Greenhous_prod.unit_id is null 
 ORDER BY Greenhous.bah_cod_m ASC LIMIT $start, $limit  "; 
$query1 = "SELECT Greenhous.* from Greenhous
left join Greenhous_prod On Greenhous_prod.unit_id = Greenhous.id and Greenhous_prod.y_prod='$y_prod'
 where  $v_mor_cod_m and 
 $v_id_ostan and 
 $v_id_city and  
...
<form  action="Greenhous_nonP_xls.php" method="post">
...
{
	?>
    <form  action="list_Greenhous_nonP.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="list_Greenhous_nonP.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
        <input type="hidden" name="y_prod" value="<?php echo $y_prod ?>" />
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ?>" />
        <input type="hidden" name="id_city5" value="<?php echo $id_city ?>" />
