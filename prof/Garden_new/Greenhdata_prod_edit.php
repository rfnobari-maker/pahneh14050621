...
// شروع حلقه تنوع محصول 
    while ($num3_t_mah > 0 and $unit_id > 0){
		...
		if($no_mtol != '211100') { $date_1_kesh= '' ; $date_2_kesh='' ; $date_1_bar='' ; $date_2_bar = '' ; }
...
///
    if($no_kesht == '2') { $b_coco = 0 ; $b_mas = 0 ;$b_per=0 ; $b_pet=0 ;$b_say=0 ;}
         
    $query = "update Greenhous_prod set t_mah=?,date_s=?,v_unit=?,num_bah=?,bah_cod_m=?,mor_cod_m=?,no_mtol=?,
	id_ostan=?,id_city=?,id_mar=?,add_abadi=?,add_city=?,z_dep=?,dep=?,lisan=?,t_mar=?,t_zan=?,m_fani=?,
	gar_j=?,gar_ja=?,gar_m=?,gar_ma=?,hash_j=?,hash_ja=?,hash_m=?,hash_ma=?,zof_j=?,zof_ja=?,zof_m=?,zof_ma=?,ab_m=?,ab_a=?,
	gazoil_m=?,gazoil_a=?,benz_m=?,benz_a=?,barg_m=?,barg_a=?,gaz_m=?,gaz_a=?
	,kod_h1_m=?,kod_h1_a=?,kod_h2_m=?,kod_h2_a=?,kod_h3_m=?,kod_h3_a=?,kod_sh1_m=?,kod_sh1_a=?,kod_sh2_m=?,
     kod_sh2_a=?,kod_sh3_m=?,kod_sh3_a=?,kod_bio1_m=?,kod_bio1_a=?,kod_bio2_m=?,kod_bio2_a=?,
     kod_bio3_m=?,kod_bio3_a=?,bazr_m=?,bazr_a=?,nesha_m=?,nesha_a=?,t_hshekar=?,t_zgard=?
	 ,b_coco=?,b_mas=?,b_per=?,b_pet=?,b_say=? where unit_id=? and y_prod=? ";
    $q = $dbh->prepare($query);
    $q->execute(array($t_mah,$date_s,$v_unit,$num_bah,$bah_cod_m,$login_session,$no_mtol,$id_ostan,$id_city,$id_mar,$add_abadi
	,$add_city,$z_dep,$dep,$lisan,$t_mar,$t_zan,$m_fani,$gar_j,$gar_ja,$gar_m,$gar_ma,$hash_j,$hash_ja,$hash_m,$hash_ma,
	$zof_j,$zof_ja,$zof_m,$zof_ma,$ab_m,$ab_a,$gazoil_m,$gazoil_a,$benz_m,$benz_a,$barg_m,$barg_a,$gaz_m,$gaz_a,
     $kod_h1_m,$kod_h1_a,$kod_h2_m,$kod_h2_a,$kod_h3_m,$kod_h3_a,$kod_sh1_m,$kod_sh1_a,$kod_sh2_m,$kod_sh2_a
	 ,$kod_sh3_m,$kod_sh3_a,$kod_bio1_m,$kod_bio1_a,$kod_bio2_m,$kod_bio2_a,$kod_bio3_m,$kod_bio3_a,
	 $bazr_m,$bazr_a,$nesha_m,$nesha_a,$t_hshekar,$t_zgard
	 ,$b_coco,$b_mas,$b_per,$b_pet,$b_say,$unit_id,$y_prod));
    sabt_event($login_session,getUserIP_1(),$date_edit,$time,'',',ویرایش عملکرد واحد پرورش قارچ-'.$bah_cod_m,$id_ostan) ;
    alert ('عملکرد واحد گلخانه با موفقیت ویرایش شد ') ;
// clos conntection 
...
<?php
    unset($date_s,$v_unit,$num_bah,$bah_cod_m,$mor_cod_m,$no_mush,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city
	,$z_dep,$dep,$lisan,$t_mar,$t_zan,$m_fani,$gar_j,$gar_ja,$gar_m,$gar_ma,$hash_j,$hash_ja,$hash_m,$hash_ma,$zof_j,
	$zof_ja,$zof_m,$zof_ma,$gazoil_m,$gazoil_a,$benz_m,$benz_a,$ab_a,$ab_m,$barg_m,$barg_a,$gaz_m,$gaz_a,$comp,$nt_comp,$t_dpar,
	$mah_tol,$zer_kesh,$tol_avg,$unit_id,$y_prod);}
?>
<?php
...
<body>
  ...
  <tr>
    <td>
      ...
      <p class="style8"> ویرایش  عملکرد سال <?php echo $y_prod?> گلخانه </p>
    ...
    <form action="" method="post" id="form1" name="form1"  onSubmit="return checkform()">
      <table width="90%" height="642" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td><div align="right"><span class="style2">نفر</span>
            <input name="dep" type="text" class="dep input_text  required  digits" id="dep" style="width:50px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $dep ; ?>" maxlength="3"  align="baseline" xml:lang="fa" />
          </div></td>
        ...
        <tr>
          ...
          <td><div align="right"><span class="style2">نفر</span>
            <input name="lisan" type="text" class="lisan input_text  required  digits" id="lisan" style="width:50px; height:30px ; " tabindex="3" dir="rtl" lang="fa" value="<?php echo $lisan ; ?>" maxlength="3"  align="baseline" xml:lang="fa" />
          </div></td>
        ...
        <tr>
          <td height="29" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="3%" >&nbsp;</td>
              <td width="20%" bgcolor="#FFFFFF" ><div align="right"><span class="style2">عدد</span>
...
$n = 1;
$num2_t_mah = $t_mah ;
$query ="CREATE TEMPORARY TABLE Gtmp_$id SELECT * FROM `Greenprod_annual` WHERE unit_id=:unit_id and y_prod = :y_prod "; 
$stmt = $dbh->prepare($query);
$stmt->execute(array(':unit_id'=>$unit_id,':y_prod'=>$y_prod));
...
?>
                <tr>
                  <td height="62" bgcolor="#FFFFFF"><div align="center">
                    <input name="m_tol<?php echo $num2_t_mah ;?>" type="text" onpaste="return false" class="m_tol<?php echo $num2_t_mah ;?> required number input_text" id="m_tol<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="65" dir="rtl" lang="fa" value="<?php echo $m_tol * 1 ;?>" maxlength="10"  align="baseline" xml:lang="fa" />
                  </div></td>
                  <?php if($no_mtol == '211100') {?>
                  <td bgcolor="#FFFFFF"><div align="center">
                    <select name="date_2_bar<?php echo $num2_t_mah ;?>" class=" date_2_bar<?php echo $num2_t_mah ;?> input_text  " id="date_2_bar<?php echo $num2_t_mah ;?>"  style="height:40px ; width:70px ; direction:rtl" tabindex="64">
                  ...
                  <td bgcolor="#FFFFFF"><div align="center">
                    <select name="date_1_bar<?php echo $num2_t_mah ;?>" class=" date_1_bar<?php echo $num2_t_mah ;?> input_text  " id="date_1_bar<?php echo $num2_t_mah ;?>"  style="height:40px ; width:70px ; direction:rtl" tabindex="63">
                      <option value="">انتخاب</option>
                  ...
                  <?php }?>
                  <td bgcolor="#FFFFFF"><div align="center">
                    <input name="s_kesh<?php echo $num2_t_mah ;?>" type="text" onpaste="return false" class="mah_tolp required number input_text" id="s_kesh<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="62" dir="rtl" lang="fa" value="<?php echo $s_kesh * 1?>" maxlength="10"  align="baseline" xml:lang="fa" />
                  </div></td>
                  <?php if($no_mtol == '211100') {?>
                  <td bgcolor="#FFFFFF"><div align="center">
                    <select name="date_2_kesh<?php echo $num2_t_mah ;?>" class=" date_2_kesh<?php echo $num2_t_mah ;?> input_text  " id="date_2_kesh<?php echo $num2_t_mah ;?>"  style="height:40px ; width:70px ; direction:rtl" tabindex="61">
                      <option value="">انتخاب</option>
                  ...
                  <td bgcolor="#FFFFFF"><div align="center">
                    <select name="date_1_kesh<?php echo $num2_t_mah ;?>" class=" date_1_kesh<?php echo $num2_t_mah ;?> input_text  " id="date_1_kesh<?php echo $num2_t_mah ;?>"  style="height:40px ; width:70px ; direction:rtl" tabindex="60">
                      <option value="">انتخاب</option>
...
?>
    ...
    <input type="submit" name="action" value="تصحیح اطلاعات" style="width:150px ; height:45px" tabindex="76" id="submit" />
</form> 
