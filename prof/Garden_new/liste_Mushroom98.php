...
$query1 = "SELECT id from Mushroom where  mor_cod_m = $login_session and $v_add_abadi and $v_add_city and $f_no_mush and $v_bah_cod_m and $f_gaz and $f_no_moj ORDER BY mor_cod_m "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
...
if ($row['no_mush']=='3')  $v_no_mush='سایر قارچ های پرورشی خاص';
  ?>
          <td width="5%" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php if ($row['confi']!='2') {?>
...
<p>&nbsp;</p>
     <p>&nbsp;</p>
           <p><a href="Mushroom.php" title="ثبت واحد جدید"><img src="../../files/add_new.png" width="51" height="58"  alt=""/></a> 
             <br />
             <br />
