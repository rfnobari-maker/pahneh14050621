...
if ($no_kesht<1) $mess.='نوع کشت را انتخاب کنید'.'<br>' ;
$no_moj = $_POST['no_moj'];
...
?>
	 <form name="mf1" class="mf1" method="post" action="Greenhous_data.php">
           <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
           <input type="hidden" name="m_poul" value="<?php echo $m_poul ;?>" />
           <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
           <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
    ...
    <script type="text/javascript">document.mf1.submit();</script>
<?php
}
}
}
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
                 ...
                 <td width="18%"><p style="text-align: right">شهر
                   <input type="radio" id="city_select"  class="red" name="m_poul" <?php if ($m_poul == 'shahr') { ?>checked='checked' <?php } ?> value="shahr" onClick="Fun_city()" />
                 </p>
                   <p style="text-align: right"> آبادی
                     <input type="radio" id="abadi_select" class="red" name="m_poul" <?php if ($m_poul == 'abadi') { ?>checked='checked' <?php } ?> value="abadi" onClick="Fun_abadi()" />
                  </p></td>
