...
// بانک اطلاعات کشت 
$query = "UPDATE Greenhous SET m_zamin=?,m_zamin_baz=?,no_mal=?,lng=?,lat=?,
m_cod_m=?,m_vaz_sok=?,no_mtol=?,m_ab=?,no_saz=?,no_gol=?,pt_date=?,pt_no=?,sal=?,num_bah=?,add_abadi=? ,add_city=?,pb_date=?,pb_no=?,unit_name=?,sys_kesh=?,no_sokh=?,sys_hot=?,sys_cool=?,no_mtol1_1=?,no_mtol1_2=?,no_mtol1_3=?,no_mtol1_4=?,no_mtol1_5=?,no_mtol1_6=?,no_mtol2_1=?,no_mtol2_2=?,no_mtol2_3=?,no_mtol2_4=?,no_mtol3_1=?,no_mtol3_2=?,no_mtol3_3=?,no_mtol3_4=?,no_mtol4_1=?,no_mtol4_2=?,no_mtol4_3=?,no_mtol4_4=? WHERE bah_cod_m=? and id=? " ;
$q = $dbh->prepare($query);
          $q->execute(array($m_zamin,$m_zamin_baz,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_mtol,$m_ab,$no_saz,$no_gol,$pt_date,$pt_no,$sal,$num_bah,$add_abadi,$add_city,$pb_date,$pb_no,$unit_name,$sys_kesh,$no_sokh,$sys_hot,$sys_cool,$no_mtol1_1,$no_mtol1_2,$no_mtol1_3,$no_mtol1_4,$no_mtol1_5,$no_mtol1_6,$no_mtol2_1,$no_mtol2_2,$no_mtol2_3,$no_mtol2_4,$no_mtol3_1,$no_mtol3_2,$no_mtol3_3,$no_mtol3_4,$no_mtol4_1,$no_mtol4_2,$no_mtol4_3,$no_mtol4_4,$bah_cod_m,$id ));
...
unset($date_s,$mor_cod_m,$num_bah,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$m_zamin,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_mtol,$no_saz,$no_gol,$pt_no,$pt_date,$pb_no,$pb_date,$m_ab,$unit_name,$sys_kesh,$no_sokh,$sys_hot,$sys_cool,$sal,$no_mtol1_1,$no_mtol1_2,$no_mtol1_3,$no_mtol1_4,$no_mtol1_5,$no_mtol1_6,$no_mtol2_1,$no_mtol2_2,$no_mtol2_3,$no_mtol2_4,$no_mtol3_1,$no_mtol3_2,$no_mtol3_3,$no_mtol3_4);
alert ('انصراف از ویرایش اطلاعات گلخانه ') ;
?>
<form  name="myform" class="myform" method="post" action="<?php echo $m_page ?>">
<input type="hidden" name="bah_cod_m" value=<?php echo $bah_cod_m; ?> />
<input type="hidden" name="add_abadi" value="<?php echo $h_add_abadi?>" />
...
<body>
  ...
  <tr>
    <td>
      <?php include('top.php'); ?>
           <p class="style8">ویرایش اطلاعات  گلخانه </p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="right">
                  <input name="m_name" type="text" class="input_text required" id="m_name" style="width:150px; height:30px;  <?php if($no_mal<>7) echo 'background-color:#FFFFCC " readonly="readonly" ' ?> " tabindex="6" dir="rtl" lang="fa" value="<?php echo $m_name ; ?>" maxlength="11" xml:lang="fa"/>
                  </div></td>
                <td bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">: نام</div></td>
                </tr>
              <tr>
                <td height="51"><div align="right">
                  <input name="m_tel_m" type="text" class="digits input_text required" id="m_tel_m" style="width:100px; height:30px;  <?php if($no_mal<>7) echo 'background-color:#FFFFCC " readonly="readonly" ' ?> " tabindex="9" dir="rtl" lang="fa" value="<?php echo $m_tel_m ; ?>" minlength="11" maxlength="11"  align="baseline" xml:lang="fa" />
                  </div></td>
                <td><div align="right">:تلفن همراه</div></td>
                <td>&nbsp;</td>
                <td><div align="right">
                  <input name="m_fname" type="text" class="required input_text" id="m_fname" style="width:150px; height:30px;  <?php if($no_mal<>7) echo 'background-color:#FFFFCC " readonly="readonly" ' ?> " tabindex="8" dir="rtl" lang="fa" value="<?php echo $m_fname ; ?>" maxlength="35" xml:lang="fa"/>
                  </div></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="53"><div align="right">
                  <select name="no_gol" class="input_text required " id="no_gol"  style="height:40px ; width:150px ; direction:rtl" tabindex="13">
                    <option value="">انتخاب کنید</option>
...
شماره <br />
              ...
              <tr>
                ...
                <td width="26%" bgcolor="#FFFFFF"><div align="right">
                  <select name="m_ab" class="input_text required " id="m_ab"  style="height:40px ; width:150px ; direction:rtl" tabindex="18">
                    <option value="">انتخاب کنید</option>
              ...
              <tr>
                ...
                <select name="no_sokh" class="input_text required " id="no_sokh"  style="height:40px ; width:120px ; direction:rtl" tabindex="21">
                    <option value="">انتخاب کنید</option>
                ...
                <td>&nbsp;</td>
                <td><div align="right">
                  <select name="sys_kesh" class="input_text  required" id="sys_kesh"  style="height:40px ; width:120px ; direction:rtl" tabindex="20">
                    <option value="">انتخاب کنید</option>
              ...
              <tr>
                <td height="47"><div align="right">
                  <select name="sys_cool" class="input_text  required" id="sys_kol"  style="height:40px ; width:120px ; direction:rtl" tabindex="23">
                    <option value="">انتخاب کنید</option>
                ...
                <td>&nbsp;</td>
                <td><div align="right">
                  <select name="sys_hot" class="input_text  required" id="sys_hot"  style="height:40px ; width:120px ; direction:rtl" tabindex="22">
                    <option value="">انتخاب کنید</option>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="right">
            <select name="sal" class="input_text  required" id="sal"  style="height:40px ; width:120px ; direction:rtl" tabindex="24">
   <option value="">انتخاب کنید</option>
            ...
            <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
              ...
              <tr>
                <td height="51"><div align="center">
                  <input name="no_mtol1_6" type="text" class="required number input_text" id="md_ab11" style="width:70px; height:30px ; " tabindex="30" dir="rtl" lang="fa" value="<?php echo $no_mtol1_6 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_5" type="text" class="required number input_text" id="md_ab10" style="width:70px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php echo $no_mtol1_5 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_4" type="text" class="required number input_text" id="md_ab9" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $no_mtol1_5 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_3" type="text" class="required number input_text" id="md_ab8" style="width:70px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $no_mtol1_3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_2" type="text" class="required number input_text" id="md_ab7" style="width:70px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $no_mtol1_2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol1_1" type="text" class="required number input_text" id="md_ab6" style="width:70px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php echo $no_mtol1_1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              </tr>
            </table>
...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
              ...
              <tr>
                <td height="42"><div align="center">
                  <input name="no_mtol3_4" type="text" class="required number input_text" id="md_ab19" style="width:70px; height:30px ; " tabindex="38" dir="rtl" lang="fa" value="<?php echo $no_mtol3_4 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol3_3" type="text" class="required number input_text" id="md_ab18" style="width:70px; height:30px ; " tabindex="37" dir="rtl" lang="fa" value="<?php echo $no_mtol3_3 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol3_2" type="text" class="required number input_text" id="md_ab17" style="width:70px; height:30px ; " tabindex="36" dir="rtl" lang="fa" value="<?php echo $no_mtol3_2 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
                <td><div align="center">
                  <input name="no_mtol3_1" type="text" class="required number input_text" id="md_ab16" style="width:70px; height:30px ; " tabindex="35" dir="rtl" lang="fa" value="<?php echo $no_mtol3_1 ; ?>" maxlength="35" xml:lang="fa"/>
                  <br />
                </div></td>
              </tr>
            </table>
