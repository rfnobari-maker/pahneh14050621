...
header("Content-Disposition: attachment;Filename=Garden_rep.xls");
include("../../lock_p1.php");
include("../../event.php");
...
<table width="98%" height="72" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td width="9%" bgcolor="#999999">میزان تولید پیش بینی / تن </td>
               ...
               <td width="6%" bgcolor="#999999">سطح زیر کشت بارور / هکتار</td>
               <td width="7%" bgcolor="#999999">همراه بهره بردار</td>
               <td width="7%" bgcolor="#999999">کد ملی بهره بردار </td>
               <td width="12%" bgcolor="#999999" class="text_r">نام خانوادگی</td>
               <td width="13%" bgcolor="#999999" class="text_r">نام</td>
               <td width="5%" bgcolor="#999999">ردیف</td>
             </tr>
             <tr>
               <?php
 $query = "SELECT  Garden_prod.bah_cod_m , bah.name , bah.last_name ,  Garden_prod.mor_cod_m ,
...
where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah Group by bah_cod_m  ORDER BY BINARY trim(last_name) , bah_cod_m ASC  "; 
...
?>
        ...
        <td align="center" height="39"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $mahtol ;?></td>
               ...
               <td align="center" width="7%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $treegb ;?></td>
               <td align="center"  width="7%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $treeb ;?></td>
               <td align="center" width="7%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $s_keshtgb ;?></td>
               <td align="center"    <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $s_keshtb ;?></td>
               <td align="center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo bah_tel_m($row['bah_cod_m']) ?></td>
