...
,m_zamin,no_mal,lng_d,lng_m,lng_s,lng_ds,lat_d,lat_m,lat_s,lat_ds
,m_cod_m,m_vaz_sok
...
':m_zamin'=>$m_zamin,':no_mal'=>$no_mal,':lng_d'=>$lng_d,
...
unset($date_s,$mor_cod_m,$bah_cod_m,$add_city,$add_abadi,$id_ostan,$id_city,$id_mar,$no_kesht,$no_moj,$m_zamin,
...
<td height="42" colspan="3" class="style2"><div align="right" id="otherFieldDiv10"> تن
    <input name="z_sort" type="text" class="required number input_text" id="z_sort" style="width:75px; height:30px ; " tabindex="50" dir="rtl" lang="fa" value="0" maxlength="35" xml:lang="fa"/>
     ...
     <input type="submit" name="action" value="ثبت اطلاعات" style="width:150px ; height:45px" tabindex="54" id="btn1" onClick="setTimeout(disableFunction, 1);"/>
 <a href="Greenhous99.php">
          <input type="button" name="btn1" value="انصراف" style="width:150px ; height:45px" tabindex="55" /></a>
