...
<body>
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             ...
             <table width="100%" height="333" border='0' align="center" cellpadding='0' cellspacing='0'>
               <tr bgcolor='#f1f1f1' >
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <td height="46" align="right" bgcolor="#DDDDDD" class="input_text" ><select  name="id_ostan" disabled="disabled" class="style8" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
                   ...
                   <?php
$query = "SELECT DISTINCT id_ostan,ostan FROM public_abadi "  ;
...
?>
   ...
   <?php if ($row['id_mar']==$id_mar) echo 'selected=selected'?>> <?php echo $row['mar'] ;?></option>
                 ...
                 <td width="197" align="right" bgcolor="#FFFFFF" class="input_text" ><select  name="id_city5" class="input_text" id="id_city" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?></td>
 ...
 $query = "SELECT * from Garden where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_no_kesh and $f_no_mal and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal  ORDER BY mor_cod_m ASC  "; 
 $stmt = $dbh->prepare($query);
 $stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
...
if ($row['no_kesh']=='2') $v_no_kesh='دیم' ;	 
  ?>
          <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="Agridata_view.php" method="post">
          ...
          <td bordercolor="#CCCCCC" class="normalTextSmaller" <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><p><img id="img1" src="../../files/users/<? echo $pic ?>" width="37" height="43"  alt=""/><br />
