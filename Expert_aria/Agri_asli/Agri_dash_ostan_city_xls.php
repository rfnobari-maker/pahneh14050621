...
<body>
<div align="center" dir="rtl">اطلاعات محصولات زراعی سال 1400-1399 به تفکیک استان و شهرستان براساس گروه بندی آمارنامه </div> 
<?php
 $query = "SELECT z_sal,id_ostan,id_city,cod_mah_amar,cod_qroup_amar,no_kesh,sum(s_bar_a+s_bar_b)
 as sb , sum(mah_tol) as mah_tol FROM Agriprod1399_1400 WHERE mah_tol>0  and id_ostan = '$id_ostan' group by id_ostan , id_city
