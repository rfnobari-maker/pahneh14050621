...
<body>
      <p align="center"  class="style8" dir="rtl">گزارش تولید محصول <?php echo $v_cod_mah ?> استان  به تفکیک شهرستان
        <?php
...
?>
      ...
      <table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#00CCFF" >
        <tr class="text1" >
          <td dir="rtl" align="center" width="18%" height="38"> مجموع تولید قطعی /<span class="style3">تن </span></td>
          <td dir="rtl" align="center" width="19%"> مجموع  پیش بینی تولید /<span class="style3">تن</span></td>
          <td dir="rtl" align="center" width="19%"> مجموع  سطح برداشت /<span class="style3">هکتار</span></td>
          <td dir="rtl" align="center" width="20%">مجموع  سطح زیر کشت / 
...
$stmt->execute();
	?>
        <tr>
          <td dir="rtl" height="38" align="center" class="text1"> مجموع تولید قطعی /<span class="style3">تن </span></td>
          <td dir="rtl" align="center" class="text1"> مجموع  پیش بینی تولید /<span class="style3">تن</span></td>
          <td dir="rtl" align="center" class="text1"> مجموع  سطح برداشت /<span class="style3">هکتار</span></td>
          <td dir="rtl" align="center" class="text1">مجموع  سطح زیر کشت / <span class="style3">هکتار</span></td>
          <td dir="rtl" align="center" class="text1"  >کل استان </td>
          <td class="text1"  >&nbsp;</td>
        </tr>
        <?php 
foreach($stmt as $row){ 
