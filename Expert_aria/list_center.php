...
?>
  ...
  <table width="395" border="0" align="center" cellpadding="2" cellspacing="2">
    <tr>
      <td width="100"><form  action="Promotion/Centers/list_organiz.php" method="post">
      ...
      <td width="89" height="123" ><form  action="Promotion/Centers/list_supplies.php" method="post">
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ;?>" />
        <input type="hidden" name="id_city" value="<?php echo $id_city1 ;?>" />
        <input type="hidden" name="id_select_city" value="<?php echo $id_select_city ;?>" />
      ...
      <td width="95" height="123" ><form  action="Promotion/Centers/list_build.php" method="post">
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ;?>" />
        <input type="hidden" name="id_city" value="<?php echo $id_city1 ;?>" />
        <input type="hidden" name="id_select_city" value="<?php echo $id_select_city ;?>" />
      ...
      <td width="85"><form  action="Promotion/Centers/list_public.php" method="post">
        <input type="hidden" name="id_ostan" value="<?php echo $id_ostan1 ;?>" />
        <input type="hidden" name="id_city" value="<?php echo $id_city1 ;?>" />
         <input type="hidden" name="id_select_city" value="<?php echo $id_select_city ;?>" />
