...
$r = 1 ;
 foreach($stmt as $row){
?>
<td height="58" class="normalTextSmaller"><form  action="send_sms.php" method="post" onsubmit="target_popup(this)">
    ...
    <td class="normalTextSmaller"><form  action="send_pm.php#1" method="post">
      <input type="hidden" name="username" value="<?php echo $row['username'] ;?>" />
...
<td width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="mor_list_bah.php" method="post">
  <input type="hidden" name="mor_cod_m" value="<?php echo $row['cod_m'] ;?>" />
...
<?php } else { echo '<p style="color:red">'.'مجوز دسترسی به این صفحه را ندارید '.'</p>';}?>
           ...
           <p>&nbsp;</p>
           <p> 
        	 <form name="myform1" class="myform" method="post" action="centers.php">
             <input type="hidden" name="id_city" value="<?php echo $id_city ;?>" />
             <input type="submit" name="action" value="برگشت" style="width:120px ; height:40px"  />
           </form>
    </p>
           <p>&nbsp;</p>
