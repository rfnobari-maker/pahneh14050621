...
<p align="center" dir="rtl"  class="style8">گزارش اطلاعات زراعی به تفکیک بهره بردار - سال زراعی <?php echo $z_sal?>
 ...
 $query = "SELECT DISTINCT bah_cod_m,mor_cod_m from $Agri_table where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m  ORDER BY bah_cod_m ASC "; 
