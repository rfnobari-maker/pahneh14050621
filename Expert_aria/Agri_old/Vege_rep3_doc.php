...
?>
      ...
      <table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#00CCFF" >
        <tr class="text1" >
          ...
          <td dir="rtl" align="center" width="19%"> مجموع  پیش بینی تولید / 
            <span class="style3">هکتار</span></td>
          <td dir="rtl" align="center" width="19%"> مجموع  سطح برداشت /<span class="style3"> تن</span></td>
...
$stmt->execute();
	?>
        <tr>
          ...
          <td dir="rtl" align="center" class="text1"> مجموع  پیش بینی تولید / <span class="style3">هکتار</span></td>
          <td dir="rtl" align="center" class="text1"> مجموع  سطح برداشت /<span class="style3"> تن</span></td>
