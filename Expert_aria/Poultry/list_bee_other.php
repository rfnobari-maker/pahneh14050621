...
?>
   ...
   <?php if ($row['id_ostan']==$mab_ostan) echo 'selected=selected'?>> <?php echo $row['ostan'] ;?></option>
        ...
        <td height="54"  align='center' bgcolor="#DDDDDD" class="style1"><span class="style8">: استان مبدا</span></td>
...
?>
  ...
  $id_city = $_POST['id_city5'] ; 
?></td>
        <td  align='center' bgcolor="#FFFFFF" class="style1"><font size="2" class="style8"> :شهرستان محل سرشماری</font></td>
...
?>
  ...
  $id_ostan1= $id_ostan ; 
?></td>
        <td  align='center' bgcolor="#FFFFFF" class="style8">: استان محل سرشماری<span class="style1"><a name="1" id="12"></a></span></td>
        </tr>
      <tr >
...
?>
   ...
   <?php if ($row['add_abadi']==$add_abadi) echo 'selected=selected'?>> <?php echo $row['abadi'] ;?></option>
        ...
        <td height="42"  align='center' bgcolor="#DDDDDD" class="style8">نام آبادی <font size="2" class="style8">محل سرشماری</font></td>
...
?>
  ...
  $id_mar = $_POST['id_mar'] ; 
        ...
        <td rowspan="2"  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="style8"> :مرکز جهاد کشاورزی محل سرشماری</font></td>
      </tr>
      <tr >
...
?>
   ...
   <?php if ($row['add_city']==$add_city) echo 'selected=selected'?>> <?php echo $row['shahr'] ;?></option>
        ...
        <td height="42"  align='center' bgcolor="#DDDDDD" class="style8">:نام شهر <font size="2" class="style8">محل سرشماری</font></td>
      </tr>
      <tr >
        <td height="54" align="right" bgcolor="#FFFFFF" class="input_text" >&nbsp;</td>
        <td height="54"  align='center' bgcolor="#FFFFFF" class="style1">&nbsp;</td>
      ...
      <tr >
        ...
        <td height="54"  align='center' bgcolor="#DDDDDD" class="style1"><font size="2" class="style8">: کد ملی کارشناس ثبت کننده اطلاعات</font></td>
      </tr>
      <tr >
...
{
 if ($id_ostan1 == '-1')    { $v_id_ostan   = "id_ostan <> '$m_ostan'" ;}else{ $v_id_ostan  = "id_ostan='$id_ostan1'" ;}
...
echo $query = "SELECT * FROM  bee where  $v_id_ostan  and $v_m_ostan  and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  ORDER BY date_s ASC LIMIT $start, $limit ";
 $query1 = "SELECT id FROM  bee where  $v_id_ostan and $v_m_ostan and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  ORDER BY date_s ASC"  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
...
$r = $start+1 ;
 ...
 if ($row['no_zan']=='1') $v_no_zan = 'بومی '; else $v_no_zan = 'مهاجر' ;
  ?>
      ...
      <td width="6%" height="67" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><img id="img1" src="../../files/users/<?php echo $pic ?>" width="37" height="43"  alt=""/><br />
...
$query = "SELECT SUM(tk_bo) AS kol_k_bo ,SUM(tk_mo) AS kol_k_mo,SUM(to_bo) AS kol_t_bo,SUM(to_mo) AS kol_t_mo from bee where  $v_id_ostan  and $v_m_ostan  and  $v_id_city and $v_id_mar and $v_sal and $f_add_abadi  and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m" ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
?>
 <tr>
      ...
      <td height="43" colspan="7" bgcolor="#FFFFFF" class="style1">جمع کل</td>
      </tr>
  </table>
