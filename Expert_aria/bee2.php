...
$query = "SELECT  DISTINCT id_city,city FROM list_abadi WHERE  id_ostan = '$id_ostan' order by binary city "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
<p class="style1">آمار زنبورستان های استان در سال 1396</p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <table width="98%" height="173" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td height="34" colspan="6" bgcolor="#999999"> Kg میزان تولیدات</td>
               ...
               <td width="7%" height="100" rowspan="3" bgcolor="#999999">آخرین وضعیت سرشماری شهرستان</td>
...
?>
    ...
    <td height="40"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
    ...
    <form  action="Poultry/city_list_bee.php" method="post">
