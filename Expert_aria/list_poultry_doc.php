...
$query = "SELECT spoultry.id_city, spoultry.add_abadi,spoultry.add_city,spoultry.no_bah,spoultry.bah_cod_m,spoultry.no_moj,spoultry.z_unit,spoultry.mor_cod_m
FROM spoultry
...
?>
      ...
      <p align="center">لیست مرغداری های صنعتی منطقه <?php echo $id_aria ?> استان </p>
...
<td class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo user_name($row['mor_cod_m'])?></td>
  <td height="51"  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo $row['z_unit']; ?></span></td>
    ...
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo $v_no_bah?></span></td>
    <td  class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['poul_cod'];?></td>
...
if ($pic == '') $pic = 'no_pic.png'
 ...
 ?>
    <td style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><span class="normalTextSmall"><?php echo city_name($row['id_city']); ?></span></td>
