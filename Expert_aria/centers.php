...
$stmt->execute();
?>
<p class="style1">داشبورد مدیریتی/شهرستان های منطقه <?php echo $id_aria?></p>
           <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <table width="98%" height="157" border="1" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr align="center" class="text1">
    ...
    <td width="10%" height="44" bgcolor="#999999">نام خانوادگی</td>
...
$r = 1 ;
 foreach($stmt as $row){
	 $id_city = $row['id_city'] ;
$query2 = "SELECT * FROM  users WHERE  id_ostan = '$id_ostan' and id_city = '$id_city' and  S_access = '3'"  ;
...
if ($pic == '') $pic = 'no_pic.png'
 ...
 ?>
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> >  
      ...
      <input type="hidden" name="username" value="<?php echo $row2['username'] ;?>" />
      <button><img id="img1" src="../files/users/<?php echo $pic ?>" width="37" height="43"  alt=""/></button>
      </form>  
    </td>
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['city'];?><br />
      <a href="#" title="درصد بروز رسانی اطلاعات عمومی آبادی ها"><?php echo abadi_update_per($row['id_city']);?></a></td>
