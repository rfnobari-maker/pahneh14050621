...
<p>
    ...
    سوابق اطلاعات بررسی شده شهرستان : 
    <strong><?php echo htmlspecialchars(city_name1($id_city,$id_ostan), ENT_QUOTES, 'UTF-8'); ?></strong>
 ...
 where $v_id_ostan and $v_id_city and z_sal = '$z_sal' and app_level = '3' "  ;
