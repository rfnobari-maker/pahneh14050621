...
?>
<div align="center">  برنامه الگوی کشت ابلاغی محصولات زراعی شهرستان <?php echo city_name1($id_city,$id_ostan) ?> در سال زراعی <?php echo($z_sal)?></div><br />
              <?php
 if (isset($_POST['z_sal'])) 
 {  
include('../../login/config.php') ;
  $query = "SELECT  * from Agri_ab_city where z_sal = '$z_sal' and id_ostan = '$id_ostan' and id_city = '$id_city' and ((s_abi > 0) or (s_dem > 0)) group by group_cod,product_cod ASC "; 
