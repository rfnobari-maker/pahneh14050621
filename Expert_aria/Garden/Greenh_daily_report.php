...
<p class="style8">گزارش خلاصه روزانه واحدهای گلخانه </p>
        ...
        <div style="width: 300px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 ...
                 <select  name="Base" disabled="disabled" class="style8" id="Base" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
