...
<table width="99%" height="160" border="1" bordercolor="#00CCFF" align="center" cellpadding="0" cellspacing="0" >
  <tr align="center" class="text1">
    ...
    <td width="15%" bgcolor="#999999"><?php if($id_ostan1=='') echo 'استان' ;  else echo 'شهرستان'  ; ?>
      <br /></td>
...
$r = 1 ;
 ...
 ?>
    ...
    <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php if($id_ostan1=='') echo ostan_name($row['id_ostan']) ;  else echo city_name1($row['id_city'],$id_ostan1)  ; ?></td>
...
?>
  <tr>
    ...
    <td colspan="2" align="center"  <?php  echo 'bgcolor=#ffcc99' ?>>مجموع کل</td>
  </tr>
</table>
<?php }?>
</body>
