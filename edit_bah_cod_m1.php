...
$query = "SELECT  Agri1399_1400.bah_cod_m , Agri1399_1400.mor_cod_m , Agri1399_1400.num_bah
FROM Agri1399_1400
LEFT OUTER JOIN bah ON Agri1399_1400.bah_cod_m = bah.bah_cod_m 
WHERE bah.bah_cod_m IS NULL  and  length(Agri1399_1400.bah_cod_m ) < 10 
GROUP BY Agri1399_1400.bah_cod_m , Agri1399_1400.num_bah ";
$q = $dbh->prepare($query);
$q->execute();
