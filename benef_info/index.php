...
<body>
 ...
 ?>
<p align="center" >&nbsp;</p>
<p align="center" class="style8" > اطلاعات بهره بردار </p>
...
$query = "SELECT name,last_name,bah_cod_m,fname,mor_cod_m,add_abadi,add_city,no_bah,co_name,id_ostan,id_city from bah where  bah_cod_m = :bah_cod_m"; 
...
?>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr class="text1">
    <td width="12%" height="54" bgcolor="#006699">کارشناس مروج</td>
    ...
    <td width="10%" bgcolor="#006699">مرکز جهاد کشاورزی</td>
...
<td height="61" class="normalTextSmaller"><img id="img1" src="../files/users/<?php echo $pic ?>" width="37" height="43"  alt=""/><br />      
  <?php echo user_name($mor_cod_m)?><br/>  <br /></td>
    <td class="normalTextSmaller"><?php echo $v_no_bah ; ?><br />
      <?php echo $row['co_name'] ; ?></td>
    <td height="61" class="normalTextSmaller"><?php echo $bah_cod_m ?></td>
    <td class="normalTextSmaller"><?php echo $last_name ?></td>
    <td class="normalTextSmaller"><?php echo $name ?></td>
    <td class="normalTextSmaller"><?php if(isset($abadi)) echo $abadi ?>
      <?php if(isset($shahr)) echo $shahr ?></td>
    <td class="normalTextSmaller"><?php echo $mar?></td>
    <td class="normalTextSmaller"><?php echo $city?></td>
    <td class="normalTextSmaller"><?php echo $ostan ?></td>
    </tr>
        <?php }?>
</table>
<?php
...
?>
   <p><a href="http://eaj.ir/index_a.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p> 
  </td>
  </tr>
  <tr>
