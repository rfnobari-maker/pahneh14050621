...
include('../login/config.php');
 $query = "SELECT Agri_prod.`date_s`,Agri_prod.`id_ostan` , Agri_prod.`id_city` , Agri_prod.`id_mar` , Agri_prod.`add_abadi` , Agri_prod.`add_city` , Agri_prod.`mor_cod_m` , bah.`bah_cod_m` , Agri_prod.`num_bah` , bah.`jens` , bah.`name` , bah.`last_name` , bah.`date_t` , bah.`sh_sh` , bah.`m_sod` , bah.`fname` , bah.`tel_s` , bah.`tel_m` ,bah.bank_account,bah.sh_meli,bah.co_name,bah.no_bah
...
AND bah.num_bah = Agri_prod.num_bah
...
?>
      ...
      <table width="98%" height="90" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor='#0066CC'>
        <tr align="center" class="text1">
          ...
          <td  bgcolor="#FFFFCC"><span class="style8"> کل پیش بینی  /
          تن</span></td>
          <td  bgcolor="#FFFFCC"><span class="style8"> کل سطح زیر کشت 
          / هکتار </span></td>
          ...
          <td width="3%" bgcolor="#CCCCCC" class="style8">کد / شناسه ملی </td>
...
?>
     <?php 
	 if($row['no_bah'] == '2')  $meli = $row['sh_meli'] ;
     if($row['no_bah'] == '1')  $meli = $row['bah_cod_m'] ;
?>
          ...
          <td width="5%" align="center" bgcolor="#FFFFCC" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo kol_pt_108($row['bah_cod_m'],$row['id_ostan'],$row['num_bah']) ; ?></span></td>
          <td width="5%" align="center" bgcolor="#FFFFCC" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmall"><?php echo kol_zk_108($row['bah_cod_m'],$row['id_ostan'],$row['num_bah']) ; ?></span></td>
   ...
   <td align="center"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $meli ;?></td>
