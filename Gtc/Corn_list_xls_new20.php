...
include('../login/config.php');
 $query = "SELECT bah.`date_s`,Agri_prod.`id_ostan` , Agri_prod.`id_city` , Agri_prod.`id_mar` , Agri_prod.`add_abadi` , Agri_prod.`add_city` , Agri_prod.`mor_cod_m` , bah.`bah_cod_m` , Agri_prod.`num_bah` , bah.`jens` , bah.`name` , bah.`last_name` , bah.`date_t` , bah.`sh_sh` , bah.`m_sod` , bah.`fname` , bah.`tel_s` , bah.`tel_m` ,bah.bank_account,bah.sh_meli,bah.co_name,bah.no_bah
