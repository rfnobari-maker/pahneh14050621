 ...
 <p align="center" style="color:#900 ; font-family:Tahoma; font-size:12px" ><?php echo $mess ?><span class="style21"><a name="1" id="1"></a></span></p>
       ...
       <div id="box">
        <table width="491" border="0" align="center">
          <tr>
            <td width="129" height="66">&nbsp;</td>
            <td width="250"><div align="right" dir="rtl">
                            <p>
                <select name="s_access" class="input_text" id="s_access" style="width:200px; height:30px  ">
                  <option value="1">کارشناسان مسئول پهنه</option>
                  <option value="2">روسای مراکز جهاد کشاورزی</option>
                  <option value="3">مدیران شهرستان جهاد کشاورزی</option>
                  <option value="4">روسای سازمان جهاد کشاورزی</option>
                  <option value="5">مدیران کشوری سامانه </option>
                  <option value="98">کاربران admin استان </option>
...
$query = "SELECT username from users where S_access = $s_access  ";
