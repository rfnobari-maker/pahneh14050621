...
?>
  ...
  <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1 ; border-radius:10px" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="40" align='center' bgcolor="#F1F1F1"><span class="style1">گزارش گندمکاران 1397-1396</span></td>
      </tr>
      <tr bgcolor='#f1f1f1' >
        <td height="40" align='center' bgcolor="#FFFFFF" class="style8">ثبت یا ویرایش شده </td>
      </tr>
      <tr >
...
{
?>
<form  name="myform" class="myform" method="post" action="Wheat_list_xls.php">
