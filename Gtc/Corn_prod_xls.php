...
<body>
<p align="center"  class="style8">گزارش لیست بهره برداران تولید کننده ذرت دانه ای در سال زراعی 1396-1395 </p>
        <?php
 include('../login/config.php');
  $query = "SELECT `zer_kesht_a`+`zer_kesht_b` as zer_kesht,`date_s`,`mor_cod_m`,`id_ostan`,`id_city`,`id_mar`,`add_abadi`,`add_city`,`bah_cod_m`,`num_bah`,`mah_tolp` from Agri_prod  WHERE `date_s` >'$date_s' and `z_sal` ='1395-1396' and `cod_mah` = '108' and `cod_qroup` = '1' and `zer_kesht_a`+`zer_kesht_b` > 0 and `mah_tolp` > 0 "; 
