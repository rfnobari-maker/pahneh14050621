...
?>
  ...
  <div style=" width: 500px; padding: 0px;border: 3px solid navy; margin:auto ; background-color:#f1f1f1 ; border-radius:10px" >
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="40" colspan='2' align='center' bgcolor="#F1F1F1"><span class="style1">گزارش  بهره برداران تولید کننده ذرت دانه ای </span></td>
      </tr>
      <tr >
        ...
        <td width="163" valign="top" height="36"  align='center' bgcolor="#FFFFFF" class="style8"><p>&nbsp;</p>
