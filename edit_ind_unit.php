...
$NationalCode = $_POST['NationalCode'];
if ($NationalCode=='') $mess.='کد ملی را وارد کنید'.'<p>' ;
...
<script type="text/javascript" src="jquery-1.11.3-./assets/js/jquery-3.6.0.min.js"></script>
...
?>
   ...
   <td width="78%" align="right" bgcolor="#CCCCCC">   <div align="right">
      <input name="NationalCode" type="text"  class="required" value="<?php echo $NationalCode ;?>" readonly/>
                       <input type="hidden" name="m_bah" value="<?php echo $m_bah ;?>" />
                       <input type="hidden" name="add_city" value="<?php echo $add_city ;?>" />
                       <input type="hidden" name="add_abadi" value="<?php echo $add_abadi ;?>" />
