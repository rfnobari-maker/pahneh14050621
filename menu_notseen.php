...
<table width="100%" border="0" align="center" bgcolor="#0099CC">
      <tr>
        ...
        <td width="14%" align="right"><a href="indexbenef.php" title="Home Page" class="LinkTitleNews">صفحه اصلي <img src="files/Home-icon.png" width="30" height="30" border="0" /></a></td>
     </tr>
 </table>