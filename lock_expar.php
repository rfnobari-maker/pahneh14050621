...
//
$query = "SELECT date_pas,username,Last_name,ostan,id_ostan,city,id_city,markaz,name,id_mar,pic,jens,id_aria,expert_unit from users  WHERE username='".$user_check."' and S_access='5'";
