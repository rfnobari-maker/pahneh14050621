...
$row = $stmt->fetch(PDO::FETCH_ASSOC);
 ?>
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                <tr>
                      <td width="282" height="235" align="center"><p align="justify" class="normalTextSmall"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >تصویر کاربر </p>
                        <p align="justify" class="normalTextSmall"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >- حجم فایل ارسالی نباید از 3 کیلوبایت کمتر و از 30 کیلوبایت بیشتر باشد</p>
   ...
   <tr>
     ...
     <td rowspan="8">&nbsp;</td>
     <td><div align="right">
   <input name="name" type="text" class="required" style="width:150px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $name_m ; ?>" maxlength="50" xml:lang="fa" />
       </div></td>
