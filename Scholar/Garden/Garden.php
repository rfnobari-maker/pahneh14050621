...
<tr>
  ...
  <?php include('top.php'); ?>
    ...
    <?php  if(strstr($perm,'d3')) { ?>
           ...
           <div class="box" align="center">
             <p><a href="Garden_rep3.php"><img src="../../files/reports.png" alt="bee" width="86" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="Garden_rep3.php" class="btn">نمودار اطلاعات باغی استان</a></p>
           </div>
           <div class="box" align="center">
            ...
            <div class="box" align="center">
              <p><a href="Garden_rep170.php"><img src="../../files/filter_data.png" alt="گزارش ویژه زراعت" width="83" height="83" border="0" class="tricky_image" /></a></p>
