...
<img src="../../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/>
           ...
           <table width="98%" height="45" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
...
?>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>> <form  action="manager_Garden2.php" method="post" onsubmit="target_rep15(this)">
