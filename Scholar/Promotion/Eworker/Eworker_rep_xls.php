...
header("Content-Disposition: attachment;Filename=Eworker.xls");
...
<tr>
  <td width="840" >
    <p align="center"  class="style8">گزارش اطلاعات مددکاران ترویجی 
      <?php
 ...
 $query = "SELECT * from Eworker where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $v_cod_m and  $v_sal_z  and $v_jens and $v_v_tah and $v_g_tah and $v_z_fa1 and $v_z_fa2 and $v_no_oz and $v_oz_ta ORDER BY cod_m ASC "; 
