...
<p class="style1">لیست سربازان سازندگی ، مرکز</p>
           ...
           <table width="93%" height="115" border="0" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               ...
               <td width="12%" bgcolor="#999999">تاریخ خاتمه خدمت</td>
               <td width="13%" bgcolor="#999999">رشته تحصیلی</td>
               <td width="15%" bgcolor="#999999">کد ملی</td>
               <td width="17%" bgcolor="#999999">نام خانوادگی</td>
               <td width="13%" bgcolor="#999999">نام</td>
...
$r = 1 ;
 foreach($stmt as $row){
?>
               <td width="7%" height="57" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="../../send_sms.php" method="post" onsubmit="target_popup(this)">
               ...
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="6%" class="normalTextSmaller"><form  action="view_sold.php" method="post">
               ...
               <td class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['date_kh'];?></td>
               <td class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['r_tah'];?></td>
