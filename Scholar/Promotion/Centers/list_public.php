...
if ($id_city1 == 0) { $v_id_city = 'id_city=id_city' ;} else { $v_id_city = "id_city='$id_city1'" ;}
 $query = "SELECT id_ostan,id_mar,id_city,to_d1,to_b1,to_z1,zf_g,rating,m_name FROM  promo_cent_public where  $v_id_ostan and  $v_id_city order by id_ostan,id_city "  ;
