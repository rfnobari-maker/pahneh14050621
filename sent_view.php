 ...
 <p align="center" ><img src="files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
   <form action="" method="post"  id="form1" name="form1" >
       <div id="box">
         <table width="491" border="0" align="center">
           <tr>
             <td height="88"><span class="normalTextSmaller"><img id="img1" src="../files/users/<? echo user_pic($s_user) ?>" width="57" height="64"  alt=""/></span></td>
             <td><div align="right">
   ...
   <tr>
     <td height="92" colspan="2"><div align="right">
       <textarea name="message" cols="55" rows="10" readonly="readonly" class="input_text" id="textarea" dir="rtl"><?php echo $message ?></textarea>
     </div></td>
   ...
   <tr>
     ...
     <?php if ($file<>'') { ?>
     <a href="../pm_files/<?php echo $file ?>"  target="_blank"  title="مشاهده پیوست" style="text-align: right"><img src="files/reports.png" width="64" height="59"  alt=""/></a>
     <?php }?>
     </div></td>
...
else 
{
  ...
  ?>  
 <p>&nbsp;</p><p><a href="sent_message.php" title="برگشت به صفحه قبل"><img src="files/goback.jpg" width="118" height="47"  alt=""/> </a></p>  
 <p align="center" >&nbsp;</p>
         </td>
  </tr>
  <tr>
