...
$query = "SELECT pic,username,ostan,city,markaz,cod_m,name,Last_name,jens,sh_sh,date_t,m_sodor,fname,m_tah,r_tah,univer,m_date,avre,v_tahol,cod_p,tel_s,tel_m,addres,shaba FROM users WHERE  username='".$user_check."'";
...
list($name,$result) = upload('pic','files/users','jpg,JPG,jpeg,gif,png');
if ($result==1) {
$pic =  $name ;
 ...
 ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                <tr>
                      <td width="282" height="239" align="center" bgcolor="#FFFFFF"><p align="justify" class="normalTextSmall"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >تصویر کاربر </p>
            ...
            <img style="border:1px solid #021a40;" src="<?php echo '../files/users/'.$row['pic'];?>?m=<?php echo  filemtime($_SERVER['DOCUMENT_ROOT'].'/files/users/'.$row['pic']) ?>"  width="87" height="107"/>    
                  ...
                  <input name="pic" type="file" id="pic"  accept=".jpg,.JPG,.jpeg,.gif,.png" /></td>
                    </tr>
                  </table>
                            </form></td>
        </tr>
          ...
          <table style="border:3px solid #069;" width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="38"><div align="right">
                <input name="last_name" type="text" class="required" style="width:200px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $last_name ; ?>" maxlength="50" readonly="readonly" xml:lang="fa" />
              </div></td>
              <td><div align="right">:نام خانوادگی</div></td>
              <td rowspan="8">&nbsp;</td>
              <td><div align="right">
                <input name="name" type="text" class="required" style="width:150px; height:30px ; " tabindex="1" dir="rtl" lang="fa" value="<?php echo $name_m ; ?>" maxlength="50" readonly="readonly" xml:lang="fa" />
              </div></td>
...
?>
              <td height="38"><div align="right"><span class="style2"><img src="files/sms.png" width="28" height="32" /></span>
                <input name="tel_m_x" type="text" class="required digits" id="tel_m" style="width:150px; height:30px ; " tabindex="16" dir="rtl" lang="fa"  value="11111111111" maxlength="11" xml:lang="fa" />
...
<?php }?>              
            ...
            <tr>
              ...
              <td colspan="3" align="center"><span class="row">
               <div align="right">
...
include('login/config.php');
$query = "UPDATE users 
        SET  name=?,Last_name=?,jens=?,sh_sh=?,date_t=?,m_sodor=?,fname=?,m_tah=?,r_tah=?,univer=?,m_date=?,avre=?,v_tahol=?,cod_p=?,tel_s=?,tel_m=?,addres=?,shaba=?
		WHERE username=?";
$q = $dbh->prepare($query);
$q->execute(array($name,$last_name,$jens,$sh_sh,$date_t,$m_sodor,$fname,$m_tah,$r_tah,$univer,$m_date,$avre,$v_tahol,$cod_p,$tel_s,$tel_m,$addres,$shaba,$username
));
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,'','ویرایش اطلاعات کاربر',$id_ostan) ; 
