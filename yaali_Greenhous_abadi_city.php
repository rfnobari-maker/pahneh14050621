...
include ('event.php');
$query = "SELECT id_mar,id_city,bah_cod_m from Greenprod_annual WHERE add_abadi <1 and add_city <1    "; 
...
//alert($add_abadi);
$query = "UPDATE Greenprod_annual SET add_abadi=? , add_city=?  where id_city = ? and 
id_mar = ? and bah_cod_m = ? and add_abadi < 1 and add_city < 1  ";
$q = $dbh->prepare($query);
