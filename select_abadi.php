...
$table = 's_abadi';
$ar_cols = array('ostan', 'city', 'bakh', 'deh','rosta','id_rosta');
...
if ($col=='rosta') { $v_col = 'آبادی' ;}
  ...
  while($row = $result->fetch_assoc()) {
    ...
    $z = $row['id_rosta'] ;
?>
<p align="center"><a href="reza.php?z=<?php echo $z ;?>" target="frame"><input type="button" name="sub1352" value="جستجو" style="width:150px ; height:50px ; color:#03C ; font-size:18px" ></a></p>
<?php
    // نمایش کد آبادی 
	//$re_html .= '<br/>'. $row[$col];
	}
