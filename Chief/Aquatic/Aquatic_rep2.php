...
require_once('../../login/config.php'); // اطمینان حاصل کنید که فایل config.php برای اتصال به پایگاه داده موجود است.

if(isset($_POST['id_ostan'])) $id_ostan1 = $_POST['id_ostan'];
else $id_ostan1 = ''; // مقدار پیش فرض
if(isset($_POST['sal'])) $sal = $_POST['sal'];
else $sal = date("Y"); // مقدار پیش فرض سال جاری، یا می توانید 1402 را قرار دهید
...
.style2 { /* اضافه شده - بر اساس حدس برای فونت کوچکتر */
    font-size: 10px;
}
.style8 { /* اضافه شده - از Aquatic_rep1.php */
    font-size: 14px;
    font-family: Tahoma;
}
.style19 { /* اضافه شده - از Aquatic_rep1.php */
    font-size: 16px;
    font-family: Tahoma;
    font-weight: bold;
    color: white;
}
.normalTextSmall { /* اضافه شده - از Aquatic_rep1.php */
    font-size: 12px;
    font-family: Tahoma;
    text-align: center;
}
.style21 { /* اضافه شده - placeholder برای جلوگیری از خطا */
    /* اگر این کلاس در FA.css تعریف نشده، ممکن است لازم باشد تعریف واقعی آن را اضافه کنید */
    color: blue;
...
$query_ostan = "SELECT id_ostan,ostan FROM ostanname ORDER BY BINARY ostan";
