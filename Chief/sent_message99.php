...
$query = "SELECT * FROM  pm WHERE   s_user = '$login_session' and $v_ru_read ORDER BY id DESC LIMIT $start, $limit" ;
$query1 = "SELECT * FROM  pm WHERE   s_user = '$login_session' and $v_ru_read ORDER BY id DESC  "  ;
