...
<body>
 ...
 include_once('../login/config.php');
  $query = "SELECT date_s,mor_cod_m,id_ostan,id_city,id_mar,add_abadi,add_city,bah_cod_m,num_bah,zer_kesht_a,zer_kesht_b,mah_tolp FROM Agri_prod WHERE z_sal ='1395-1396' and cod_mah = '108' and cod_qroup = '1' "; 
