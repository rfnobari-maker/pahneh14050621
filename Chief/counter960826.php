...
$z_sal = $sal1.'-'.$sal ;
include_once('../login/config.php');
$query = "SELECT distinct bah_cod_m ,add_abadi,add_city   FROM Agri where id_ostan= '$id_ostan' and z_sal = '$z_sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Agri = $stmt -> rowCount();
return $count_ostan_Agri ; 	
...
{
include_once('../login/config.php');
$query = "SELECT distinct bah_cod_m ,add_abadi,add_city   FROM Garden where id_ostan= '$id_ostan' and z_sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Garden = $stmt -> rowCount();
return $count_ostan_Garden ; 	
...
{
include_once('../login/config.php');
$query = "SELECT distinct bah_cod_m ,add_abadi,add_city   FROM Greenhous where id_ostan= '$id_ostan' and sal = '$sal' "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
$count_ostan_Greenhous = $stmt -> rowCount();
return $count_ostan_Greenhous ; 	
