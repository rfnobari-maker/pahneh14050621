    ...
    <td  colspan="3" valign="middle" >
      ...
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 500px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="262" border='0' align="center" cellpadding='0' cellspacing='0'>
               <tr bgcolor='#f1f1f1' >
                 <td height="22" colspan='2' align='center' bgcolor="#FFFFFF">&nbsp;</td>
               </tr>
               <tr bgcolor='#f1f1f1' >
                 <td width="65%" height="64" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <span class="style2">حداقل باید 3 کارکتر وارد شود </span>
                   <input name="last_name" type="text" class="input_text" id="last_name"  style="height:35px ; width:170px " value="<?php echo $last_name?>" />
                 </div></td>
                 <td width="35%"  align='center' bgcolor="#FFFFFF" class="style8"><span class="style1"><font size="2" class="style8">: </font></span><span style="font-family: Tahoma; color: #003366;"><font size="2" style="text-decoration: none; font-family: Tahoma; color: #990000;">نام خانوادگی شامل</font></span></td>
                 </tr>
               <tr bgcolor='#f1f1f1' >
                 <td height="57" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <input name="name1" type="text" class="input_text" id="name1"  style="height:35px ; width:170px " value="<?php echo $name1?>" />
                 </div></td>
                 <td height="57" align="right" bgcolor="#FFFFFF" class="style1" ><font size="2" class="style8">:نام شامل</font></td>
               </tr>
               <tr bgcolor='#f1f1f1' >
                 <td height="59" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <input name="fname" type="text" class="input_text" id="fname"  style="height:35px ; width:170px " value="<?php echo $fname?>" />
                 </div></td>
                 <td height="59" align="right" bgcolor="#FFFFFF" class="style1" ><font size="2" class="style8">:نام پدر شامل</font></td>
                 </tr>
               <tr >
...
if(isset($_GET['id']))
{
  ...
  $query = "SELECT bah.no_bah,bah.date_s,bah.tel_m,bah.name,bah.last_name,bah.fname,bah.co_name,bah.sh_meli,bah.bah_cod_m,bah.mor_cod_m
...
,list_city.ostan as ostan2,list_city.city as city2,list_city.shahr,list_city.mar
 ...
 where name like '$name1%'  and last_name like '$last_name%' and fname like '$fname%' ORDER BY BINARY last_name ASC LIMIT $start, $limit "; 
$query1 = "SELECT bah.id
 FROM  bah
 left join list_abadi on list_abadi.add_abadi = bah.add_abadi
 left join list_city  on list_city.add_city   = bah.add_city
 where name like '$name1%'  and last_name like '$last_name%' and fname like '$fname%'  ORDER BY BINARY last_name  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
      <p><img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/></p>
           <table width="85%" height="132" border="0" align="center" cellpadding="1" cellspacing="1" >
...
?>
      <td width="6%" height="72" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="view_benef1.php#1" method="post" onsubmit="target_popup2(this)">
        ...
        <button style="border-color:#FFF"><img src="../files/view.png" title="نمایش اطلاعات بهره بردار"  width="33" height="26"  alt=""/></button>
      </form></td>
...
<?php }?>
<div   style=" text-align:right;height:100px; margin:auto;width:80%;overflow:auto;background-color:#ffffff;color:#06C;scrollbar-base-color:gold;font-family:tahoma;font-size:11px;padding:10px;; border-radius: 15px">
<?php 
