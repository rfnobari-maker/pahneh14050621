...
<p class="style8">گزارش  بهره برداران کشاورزی استان <?php echo ostan_name($id_ostan_t);?> به تفکیک زمینه فعالیت </p>
           ...
           <table width="98%" height="250" border="1" bordercolor="#0099FF" align="center" cellpadding="0" cellspacing="0" >
...
?>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['jam'];?></td>
           ...
           <p>&nbsp;</p><p><a href="bah_rep2.php" title="برگشت به صفحه قبل"><img src="../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p>
           <p>&nbsp;</p>
