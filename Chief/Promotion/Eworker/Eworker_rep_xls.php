...
?>
    ...
    <table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
              <tr class="text1">
                <td width="16%" bordercolor="#0099CC" bgcolor="#CCCCCC">تاریخ ثبت / ویرایش</td>
          ...
          <td width="5%" bgcolor="#CCCCCC">نام </td>
          <td width="3%" bordercolor="#0099CC" bgcolor="#CCCCCC">آدرس آماری آبادی</td>
          <td width="3%" bordercolor="#0099CC" bgcolor="#CCCCCC">آدرس آماری شهر </td>
          <td width="3%" bordercolor="#0099CC" bgcolor="#CCCCCC">آبادی</td>
          <td width="3%" bordercolor="#0099CC" bgcolor="#CCCCCC">شهر </td>
          <td width="5%" bordercolor="#0099CC" bgcolor="#CCCCCC">کد مرکز جهاد کشاورزی</td>
...
if( bah_m_tah($row['cod_m'])== 1) $v_m_tah = 'بیسواد' ; 
if( bah_m_tah($row['cod_m'])== 2) $v_m_tah = 'خواندن و نوشتن' ; 
if( bah_m_tah($row['cod_m'])== 3) $v_m_tah = 'سیکل' ; 
if( bah_m_tah($row['cod_m'])== 4) $v_m_tah = 'دیپلم' ; 
if( bah_m_tah($row['cod_m'])== 5) $v_m_tah = 'فوق دیپلم' ; 
if( bah_m_tah($row['cod_m'])== 6) $v_m_tah = 'لیسانس' ; 
if( bah_m_tah($row['cod_m'])== 7) $v_m_tah = 'فوق لیسانس' ; 
if( bah_m_tah($row['cod_m'])== 8) $v_m_tah = 'دکتری' ; 
if( bah_m_tah($row['cod_m'])== 9) $v_m_tah = 'تحصیلات حوزوی' ; 

  ?>
        <tr>
          <td bordercolor="#0099CC" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['date_s']; ?></td>
          ...
          <td class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><div align="right"><?php echo $v_m_tah?></div></td>
          ...
          <td  class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><div align="right"><?php echo bah_last_name($row['cod_m'])?></div></td>
          <td  class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><div align="right"><?php echo bah_first_name($row['cod_m'])?></div></td>
          <td bordercolor="#0099CC" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo  '&nbsp;'.$row['add_abadi'] ;  ?></td>
          <td bordercolor="#0099CC" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['add_city'] ?></td>
          ...
          <td bordercolor="#0099CC" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['id_mar']?></td>
