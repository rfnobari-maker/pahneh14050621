...
?>
    ...
    <table width="2000" height="82" border="0" align="center" cellpadding="1" cellspacing="1" >
...
$r = 1 ;
 foreach($stmt as $row)
  {
?>
    <td align="center" height="31" class="tilt" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><?php echo mar_kol($row['id_ostan'],$row['id_mar'])?></td>
