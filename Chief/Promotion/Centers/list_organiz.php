...
?>
  ...
  <table width="95%"  align="center" class="my-table"  >
    <tr align="center" class="text1">
               ...
               <td width="12%" rowspan="2" bgcolor="#999999">تاریخ ثبت / ویرایش</td>
    ...
    <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
             ...
             <tr align="center" class="text1">
               <td height="61" bgcolor="#999999">تشکل کشاورزی موضوعی - محصولی</td>
               <td height="61" bgcolor="#999999">شرکت های سهامی زراعی</td>
               <td height="61" bgcolor="#999999">تعاونی تولید روستایی</td>
...
$id_mar = $row['id_mar'] ;
?>
<td width="10%" height="58" class="tilt" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $row['ta_3'];?></span></td>
<td width="8%" height="58" class="tilt" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller"><?php echo $row['ta_2'];?></span></td>
    ...
    <td  <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmall"><span class="normalTextSmaller"><?php echo $row['date_s'];?></span></td>
    <td  <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?> class="normalTextSmall"><?php echo mar_name($row['id_mar']) ;?><br />
