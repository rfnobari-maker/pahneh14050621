...
header("Content-Disposition: attachment;Filename=public_list.xls");
?>
<?php 
include('../../../lock_ce.php');
include('../../../event.php') ;
...
?>
    ...
    <tr align="center" class="text_r">
      <td width="2%" bgcolor="#999999">تاریخ ثبت /ویرایش</td>
      <td width="2%" bgcolor="#999999">آدرس مرکز</td>
    <td width="2%" bgcolor="#999999">غالب دامی3</td>
    <td width="2%" bgcolor="#999999">غالب دامی 2</td>
    <td width="2%" bgcolor="#999999">غالب دامی 1</td>
    <td width="2%" bgcolor="#999999">غالب باغی 3</td>
    <td width="3%" bgcolor="#999999">غالب باغی 2</td>
    <td width="3%" bgcolor="#999999">غالب باغی1</td>
    <td width="2%" bgcolor="#999999">غالب زراعی3</td>
    <td width="2%" bgcolor="#999999">غالب زراعی2</td>
    <td width="2%" height="42" bgcolor="#999999">غالب زراعی1</td>
    <td width="3%" bgcolor="#999999">فعالیت غالب</td>
    <td width="4%" bgcolor="#999999">فاصله نزدیکترین آبادی<br /></td>
    <td width="4%" bgcolor="#999999">فاصله دورترین آبادی<br /></td>
    <td width="3%" bgcolor="#999999">فاکس</td>
    <td width="3%" bgcolor="#999999">تلفن</td>
    <td width="3%" bgcolor="#999999">کد پستی</td>
    <td width="3%" bgcolor="#999999">عرض جغرافیایی</td>
    <td width="3%" bgcolor="#999999">طول جغرافیایی</td>
    <td width="9%" bgcolor="#999999">سال تاسیس</td>
    <td width="6%" bgcolor="#999999">سطح مرکز</td>
...
?>
  <tr>
 <td class="normalTextSmaller" style="text-align: center" <?php if($r%2 == 0) echo 'bgcolor=#FFFFCC' ?>><span class="normalTextSmaller" style="text-align: center"><?php echo $row['date_s'];?></span></td>
