...
$id = $_POST['id'];
$query = "SELECT id,lng,lat,m_zamin,m_cod_m,m_ab,md_ab,h_ab,no_sab,no_ab,es,m_vaz_sok,id_mar,check_cod from Garden where bah_cod_m = '$bah_cod_m' and sh_gat = '$sh_gat' and z_sal = '$z_sal' and id = '$id' "; 
...
if ($no_mal <> 7)
{
$query = "SELECT bah_cod_m,no_bah,co_name,name,jens,last_name,fname,tel_m from bah where  bah_cod_m = :bah_cod_m and no_bah = :num_bah"; 
$stmt = $dbh->prepare($query);
...
if ($num_bah=='1') $m_fname = $row['fname'] ;
if ($num_bah=='2') $m_fname = $row['co_name'] ;
$m_tel_m = $row['tel_m'] ;
}
else 
{
...
<body>
  ...
  <tr>
    ...
    <td width="4"><p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="840" >
    <form action="liste_Garden.php#1" method="post" id="form1" name="form1">
      <table width="99%" height="564" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        ...
        <tr>
          ...
          <td width="24%"><div align="right"><?php echo ostan_name($id_ostan1) ; ?></div></td>
  ...
  <?php if($nah_kesh<>'3'){?> 
            ...
            <tr>
              <td width="12%" bgcolor="#FFFFCC">قطعی</td>
              <td width="12%" bgcolor="#FFFFCC">پیش بینی</td>
              <td width="6%" bgcolor="#FFFFCC">غیربارور</td>
...
$n = 1 ;
$num2_t_mah = $t_mah ;
$query = "SELECT cod_qroup,cod_mah,s_kesht_b,s_kesht_gb,tree_b,tree_gb,mah_tol,mah_tolp,mah_bem,check_cod from Garden_prod where bah_cod_m = :bah_cod_m and sh_gat=:sh_gat and z_sal = :z_sal and check_cod = :check_cod "; 
$stmt = $dbh->prepare($query);
$stmt->execute(array(':bah_cod_m'=>$bah_cod_m,':sh_gat'=>$sh_gat,':z_sal'=>$z_sal,':check_cod'=>$check_cod));
...
?>
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:100px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  echo $mah_tol ; ?>" maxlength="10" readonly="readonly"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
