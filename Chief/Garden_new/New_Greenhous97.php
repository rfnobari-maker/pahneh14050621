...
{
	var result = confirm(" از آماده سازی اطلاعات گلخانه های انتخاب شده برای سال 1397 مطمئن هستید ؟");
	if(result){
		return true;
	}else{
		return false;
...
<body>
 ...
 $bah_cod_m=$_POST['bah_cod_m'];
  ?>
<p align="center" >&nbsp;</p>
<p align="center" dir="rtl" ><span class="style8">آماده سازی اطلاعات  پایه گلخانه سال 1397</span><br />
...
$stmt->execute(array(':bah_cod_m'=>$bah_cod_m,':sal'=>'1396',':mor_cod_m'=>$login_session));
$found = $stmt -> rowCount();
if ($found>0) {
?>
    <span class="style21"><a name="result" id="result"></a></span>  </p>
 <form name="bulk_action_form" action="Greenhous_send_data97.php" method="post" onSubmit="return delete_confirm();"/>
...
?>
        ...
        <input type="submit" name="Go_send_data" id="send_data" style="height:45px ; width:350px" value="مایل به ایجاد اطلاعات فوق در سال 1397 هستم" />
      </form>
<?php
 }
 else 
