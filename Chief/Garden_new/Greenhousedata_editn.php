...
$query = "UPDATE Greenhous SET
 m_zamin=?,m_zamin_gol=?,no_mal=?,
lng_d=?,lng_m=?,lng_s=?,lng_ds=?,lat_d=?,lat_m=?,lat_s=?,lat_ds=?,
m_cod_m=?,m_vaz_sok=?,address=?,no_saz=?,no_gol=?,pt_date=?,pt_no=?,num_bah=?,add_abadi=? 
,add_city=?,pb_date=?,pb_no=?,unit_name=?,sys_kesh=?,no_sokh=?,sys_hot=?,sys_cool=?
,no_moj=?,sal_tas=?,sar_kol=?,gaz=?,z_gaz=?,barg=?,f_barg=?,a_barg=?,m_ab=?,num_ab=?,
sard=?,z_sard=?,m_sard=?,sort=?,z_sort=?,
baz_chr=?,nft=?,ab_sh=? WHERE bah_cod_m=? and id=? " ;
$q = $dbh->prepare($query);
          $q->execute(array(
      $m_zamin,$m_zamin_gol,$no_mal,
   	  $lng_d,$lng_m,$lng_s,$lng_ds,$lat_d,$lat_m,$lat_s,$lat_ds
	  ...
	  $no_moj,$sal_tas,$sar_kol,$gaz,$z_gaz,$barg,$f_barg,$a_barg,$m_ab,$num_ab,
	  $sard,$z_sard,$m_sard,$sort,$z_sort,
	  $baz_chr,$nft,$ab_sh,$bah_cod_m,$id ));
...
$q->execute(array(':date_s'=>$date_s,':mor_cod_m'=>$mor_cod_m,':m_cod_m'=>$m_cod_m,':m_addres'=>$m_addres,':m_jens'=>$m_jens,':m_name'=>$m_name,':m_last_name'=>$m_last_name,':m_fname'=>$m_fname,':m_tel_m'=>$m_tel_m));
 ...
 // ثبت در بانک پیگیری
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'ویرایش اطلاعات گلخانه - '.$bah_cod_m,$id_ostan) ; 
unset($date_s,$mor_cod_m,$num_bah,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$m_zamin,$m_zamin_gol,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesht,$no_saz,$no_gol,$pt_no,$pt_date,$pb_no,$pb_date,$m_ab,$unit_name,$sys_kesh,$no_sokh,$sys_hot,$sys_cool);
?>
<script>
alert ('ویرایش اطلاعات واحد گلخانه با موفقیت انجام شد ') ;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" >
  <tr>
    ...
    <td width="840" >
           ...
           <p class="style8">ویرایش اطلاعات  گلخانه <br />
        ...
        <tr>
         ...
         <?php if($no_kesht =='1') {?>
          ...
          <td><div align="right">
            ...
            <input name="m_zamin" type="text" class="input_text required" id="m_zamin" style="width:100px; height:30px ; " tabindex="9" dir="rtl" lang="fa" value="<?php echo $m_zamin ; ?>" maxlength="70"  align="baseline" xml:lang="fa" /></td>
          ...
          <td height="5" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="50" colspan="4"><div align="right"><span style="text-align: right">
                <textarea name="m_addres" cols="80" rows="4" class="required input_text" id="m_addres" tabindex="17"><?php echo $address ;?></textarea>
              </span></div></td>
 ...
 if($no_moj !='4' and $no_moj !='1' and $no_moj !='5' ) {?>
                  <td ><div align="right">
                    <input name="pt_date" type="text"  class="pdate required input_text" id="pcal2"  style="width:100px; height:30px ; " tabindex="22" dir="rtl" lang="fa" value="<?php echo $pt_date ; ?>" maxlength="10" xml:lang="fa"/>
                    <br />
                  </div></td>
                  <td><div id="otherFieldDiv11" align="right">:تاریخ پروانه تاسیس</div></td>
                  <td>&nbsp;</td>
                  <td bgcolor="#FFFFFF"><div  align="right">
                    <input name="pt_no" type="text" class="required  input_text" id="pt_no" style="width:75px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $pt_no ; ?>" maxlength="20" xml:lang="fa"/>
                    <br />
                  </div></td>
                ...
                <tr>
                  <td height="34"><div  align="right">
                    <input name="pb_date" type="text"  class="pdate required input_text" id="pcal1"  style="width:100px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php echo $pb_date ; ?>" maxlength="10" xml:lang="fa"/>
                    <br />
                  </div></td>
                  <td><div id="otherFieldDiv12" align="right">:تاریخ پروانه بهره برداری</div></td>
                  <td>&nbsp;</td>
                  <td bgcolor="#FFFFFF"><div  align="right">
                    <input name="pb_no" type="text" class="required  input_text" id="pb_no" style="width:75px; height:30px ; " tabindex="23" dir="rtl" lang="fa" value="<?php echo $pb_no ; ?>" maxlength="20" xml:lang="fa"/>
                    <br />
                  </div></td>
                ...
                <tr>
                  <td height="53"><div align="right"> <span class="style8">میلیارد ریال </span>
                    <input name="sar_kol" type="text" class="required number input_text" id="sar_kol" style="width:75px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $sar_kol ; ?>" maxlength="35" xml:lang="fa"/>
                    <br />
                  </div></td>
                  <td><div align="right">:سرمایه گذاری کل</div></td>
                  <td>&nbsp;</td>
                  <td bgcolor="#FFFFFF"><div align="right">
                    <input name="sal_tas" type="text" class="required number input_text" id="sal_tas" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php echo $sal_tas ; ?>"min='1200' max='1404' minlength="4" maxlength="4" xml:lang="fa"/>
                    <br />
                  </div></td>
            ...
            <tr>
              <td width="31%" height="53"><div align="right">
                <select name="no_gol" class="input_text required " id="no_gol"  style="height:40px ; width:150px ; direction:rtl" tabindex="28">
                  <option value="">انتخاب کنید</option>
              ...
              <td width="1%">&nbsp;</td>
              <td width="28%" bgcolor="#FFFFFF"><div align="right">
                <select name="no_saz" class="input_text required " id="no_saz"  style="height:40px ; width:150px ; direction:rtl" tabindex="27">
                  <option value="">انتخاب کنید</option>
            ...
            <tr>
              <td height="47"><div align="right">
                <select name="no_sokh" class="input_text required " id="no_sokh"  style="height:40px ; width:120px ; direction:rtl" tabindex="30">
                  <option value="">انتخاب کنید</option>
              ...
              <td>&nbsp;</td>
              <td><div align="right">
                <select name="sys_kesh" class="input_text  required" id="sys_kesh"  style="height:40px ; width:120px ; direction:rtl" tabindex="29">
                  <option value="">انتخاب کنید</option>
            ...
            <tr>
              <td height="47"><div align="right">
                <select name="sys_cool" class="input_text  required" id="sys_kol"  style="height:40px ; width:120px ; direction:rtl" tabindex="32">
                  <option value="">انتخاب کنید</option>
              ...
              <td>&nbsp;</td>
              <td><div align="right">
                <select name="sys_hot" class="input_text  required" id="sys_hot"  style="height:40px ; width:120px ; direction:rtl" tabindex="31">
                  <option value="">انتخاب کنید</option>
              ...
              <td height="47" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" colspan="3" class="style2"><div align="right" id="otherFieldDiv2"> مترمکعب / ساعت
                    <select name="z_gaz" class="input_text " id="gaz4"  style="height:40px ; width:75px ; direction:rtl" tabindex="34">
                  ...
                  <td width="16%" height="40" class="style2"><div align="right">
                    <select name="gaz" class="input_text required " id="seeAnotherField"  style="height:40px ; width:100px ; direction:rtl" tabindex="33">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  <td width="19%" height="46" class="style2"><div align="right" id="otherFieldDiv6" > آمپر
                    <select name="a_barg" class="input_text" id="a_barg"  style="height:40px ; width:72px ; direction:rtl" tabindex="37">
                  ...
                  <td width="20%" height="46" class="style2"><div align="right" id="otherFieldDiv4">
                    <select name="f_barg" class="input_text required " id="f_barg"  style="height:40px ; width:75px ; direction:rtl" tabindex="36">
                  ...
                  <td height="46" class="style2"><div align="right">
                    <select name="barg" class="input_text required " id="seeAnotherField2"  style="height:40px ; width:100px ; direction:rtl" tabindex="35">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  ...
                  <td><div align="right"> <span class="style2">لیتر / ثانیه</span>
                    <input name="num_ab" type="text" class="required number input_text" id="num_ab" style="width:75px; height:30px ; " tabindex="39" dir="rtl" lang="fa" value="<?php echo $num_ab ; ?>" maxlength="6" xml:lang="fa"/>
                    <br />
                  </div></td>
                  <td><div style="margin-right:15px" align="right"> :دبی آب</div></td>
                  <td><div align="right">
                    <select name="m_ab" class="input_text required " id="m_ab"  style="height:40px ; width:120px ; direction:rtl" tabindex="38">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  <td height="46" colspan="3" class="style2"><div align="right" id="otherFieldDiv8"> تن
                    <input name="z_sard" type="text" class="required number input_text" id="z_sard" style="width:75px; height:30px ; " tabindex="41" dir="rtl" lang="fa"  value="<?php echo $z_sard?>" maxlength="35" xml:lang="fa"/>
                    <br />
                  </div></td>
                  ...
                  <td width="16%" height="46" class="style2"><div align="right">
                    <select name="sard" class="input_text required " id="seeAnotherField3"  style="height:40px ; width:100px ; direction:rtl" tabindex="40">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  ...
                  <td height="42" class="style2"><div align="right">
                    <select name="m_sard" class="input_text required " id="sard"  style="height:40px ; width:100px ; direction:rtl" tabindex="42">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  <td height="42" colspan="3" class="style2"><div align="right" id="otherFieldDiv10"> تن
                    <input name="z_sort" type="text" class="required number input_text" id="z_sort" style="width:75px; height:30px ; " tabindex="44" dir="rtl" lang="fa" value="<?php echo $z_sort?>" maxlength="35" xml:lang="fa"/>
                    <br />
                  </div></td>
                  ...
                  <td width="16%" height="42" class="style2"><div align="right">
                    <select name="sort" class="input_text required " id="seeAnotherField4"  style="height:40px ; width:100px ; direction:rtl" tabindex="43">
                      <option value="">انتخاب کنید</option>
                ...
                <tr>
                  <td height="53" class="style2"><div align="right">
                    <select name="ab_sh" class="input_text required " id="barg2"  style="height:40px ; width:100px ; direction:rtl" tabindex="47">
                      <option value="">انتخاب کنید</option>
                  <option value="2" <?php if ($sort=='2') { echo 'selected="selected"' ; } ?>>ندارد</option>
                  <option value="1" <?php if ($sort=='1') { echo 'selected="selected"' ; } ?>>دارد</option>
                    </select>
                  ...
                  <td height="53" class="style2"><div align="right">
                    <select name="nft" class="input_text required " id="barg"  style="height:40px ; width:100px ; direction:rtl" tabindex="46">
                      <option value="">انتخاب کنید</option>
                  ...
                  <td height="53" class="style2"><div align="right">
                    <select name="baz_chr" class="input_text required " id="seeAnotherField2"  style="height:40px ; width:100px ; direction:rtl" tabindex="45">
                      <option value="">انتخاب کنید</option>
     ...
     <input type="submit" name="action" value="تصحیح" style="width:150px ; height:45px" tabindex="48" id="btn1" onClick="setTimeout(disableFunction, 1);"/>
     <input type="button" name="btn1" value="انصراف" onClick="close_window()" style="width:150px ; height:45px" tabindex="49" />
        </p>
      </div>
</form> 
<script>
