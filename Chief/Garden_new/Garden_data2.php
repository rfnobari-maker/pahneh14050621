...
<input name="lng" type="text" class="required number input_text" id="lng" style="width:150px; height:30px ; " tabindex="1" dir="rtl" lang="fa" value="<?php echo $lng ; ?>" maxlength="11" xml:lang="fa"/>
        ...
        <tr>
          <td height="49" colspan="4"><div align="right"><span class="style2">مترمربع</span>
...
?>
  ...
  <?php if($nah_kesh<>'3'){?> 
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_kesht_gb<?php echo $num2_t_mah ;?>" type="text" class="mashat required digits input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  $s_kesht_gb.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
    <input name="s_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="mashat required digits input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  $s_kesht_b.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
                <?php }?> 
...
?>
  ...
  <?php if($nah_kesh<>'3'){?> 
        <tr>
          <td height="31" colspan="4"><div align="right"><span class="style2">مترمربع</span>
 ...
 &nbsp;<a href="JavaScript: new_captcha();"><img src="refresh.png" alt="" width="30" height="26" border="0" align="bottom"></a><br />
 <span class="style8">
      <input name="security_code" type="text"  class="required input_text" id="security_code" placeholder="کد امنیتی " style=" width:120px ; height:25px ; border: 1px solid #295C89; border-radius: 10px ; margin-top:10px"  tabindex="3" autocomplete="off"  onfocus="[php light=”true”]
using System.Globalization;
InputLanguage.CurrentInputLanguage = InputLanguage.FromCulture(new CultureInfo("fa-IR"));
[/php]"/>
      :      کد امنیتی<br />
      </span><span class="style2">غیرحساس به حروف بزرگ و کوچک</span><span class="style8"><br />
      <br />
      </span>
 <input type="submit" name="action" value="ثبت اطلاعات" style="width:150px ; height:45px" tabindex="31" id="btn1" onClick="setTimeout(disableFunction, 1);"/>
        </p>
