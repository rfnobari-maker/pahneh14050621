...
?>
<table width="792" border="1" align="center" cellpadding="10" cellspacing="0" dir="rtl" id="user_table">
<tr>
  ...
  <th width="171" bgcolor="#FFFF99">عملیات</th>
</tr>
<?php
 foreach($stmt as $row)
{
...
<tr id="new_row">
 ...
 <td><input type="button" value="اضافه کردن سالن جدید" class="add" id="add" onclick="insert_row(<?php echo $unit_id.','.$y_prod ?>);"></td>
</tr>
</table>
</div>
<script>
