  ...
  <?php }?>
        ...
        <tr>
          <td height="40" colspan="4"><div align="right">
            <div align="right">
              <span class="style8">امکان ثبت اطلاعات باغی 1397 مقدور نمی باشد</span>
...
?>
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="mah_tol required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  $mah_tol.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="mah_tolp required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  $mah_tolp.$num2_t_mah ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
                </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
              ...
              <?php if($nah_kesh<>'3'){?> 
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_kesht_gb<?php echo $num2_t_mah ;?>" type="text" class="s_kesht_gb mashat required number input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  $s_kesht_gb.$num2_t_mah ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
    <input name="s_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="s_kesht_b mashat required number input_text" id="s_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  $s_kesht_b.$num2_t_mah ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
                <?php }?> 
              <td bgcolor="#FFFFFF"><span style="margin:10px"><div align="right">
                <select  name="mah_name<?php echo $num2_t_mah ;?>" class="target required input_text mar<?php echo $mah_name.$num2_t_mah ;?>" style="width:150px ; height:40px" tabindex="23" dir="rtl" id="cod_mah<?php echo $num2_t_mah ;?>">
                  <option value="" selected="selected">انتخاب نام محصول</option>
                </select>
              </div></td>
              <td bgcolor="#FFFFFF"><div align="right"><span style="margin:10px">
                <select  name="mah_qroup<?php echo $num2_t_mah ;?>" class="required style2 country<?php echo $num2_t_mah ;?>" id="mah_qroup<?php echo $num2_t_mah ;?>" style="width:130px ; height:40px" tabindex="22" dir="rtl"  >
...
?>
    ...
    <script>
        $('.mah_tolp').change(function () {
            ...
            if (parseFloat(treeb) <= 0 ) {
                alert("تعداد درخت بارور کوچکتر از 1");
                // پاک کردن مقدار تولید
