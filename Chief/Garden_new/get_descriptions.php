...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // دریافت توضیحات مرتبط با Garden_id و mor_cod_m
        $stmt = $dbh->prepare("SELECT id, description, date_s, mor_cod_m FROM `$Garden_not_table` WHERE Garden_id = :Garden_id ORDER BY id DESC");
