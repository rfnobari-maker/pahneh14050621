...
$t_mah = $_POST['t_mah'] ;
$query = "UPDATE Garden SET es=?,no_mal=?,lng=?,lat=?,
...
$q = $dbh->prepare($query);
          $q->execute(array($es,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesh,$m_ab,$md_ab,$h_ab,$no_sab,$no_ab,$z_sal,$num_bah,$add_abadi,$add_city,$m_zamin,$num_bah,$nah_kesh,$t_mah,$bah_cod_m,$id));
// بانک اطلاعات کشت 
...
$query = "INSERT INTO Garden_prod (Garden_id,date_s,mor_cod_m,bah_cod_m,num_bah,sh_gat,id_ostan,id_city,id_mar,add_abadi,add_city,no_kesh,z_sal,cod_qroup,cod_mah,s_kesht_b,s_kesht_gb,tree_b,tree_gb,mah_tol,mah_tolp,mah_bem,nah_kesh,check_cod) VALUES(:Garden_id,:date_s,:mor_cod_m,:bah_cod_m,:num_bah,:sh_gat,:id_ostan,:id_city,:id_mar,:add_abadi,:add_city,:no_kesh,:z_sal,:cod_qroup,:cod_mah,:s_kesht_b,:s_kesht_gb,:tree_b,:tree_gb,:mah_tol,:mah_tolp,:mah_bem,:nah_kesh,:check_cod)";
$q = $dbh->prepare($query);
$q->execute(array(':Garden_id'=>$Garden_id,':date_s'=>$date_s,':mor_cod_m'=>$mor_cod_m,':bah_cod_m'=>$bah_cod_m,':num_bah'=>$num_bah,':sh_gat'=>$sh_gat,':id_ostan'=>$id_ostan,':id_city'=>$id_city,':id_mar'=>$id_mar,':add_abadi'=>$add_abadi,':add_city'=>$add_city,':no_kesh'=>$no_kesh,':z_sal'=>$z_sal,':cod_qroup'=>$cod_qroup,':cod_mah'=>$cod_mah,':s_kesht_b'=>$s_kesht_b,':s_kesht_gb'=>$s_kesht_gb,':tree_b'=>$tree_b,':tree_gb'=>$tree_gb,':mah_tol'=>$mah_tol,':mah_tolp'=>$mah_tolp,':mah_bem'=>$mah_bem,':nah_kesh'=>$nah_kesh,':check_cod'=>$check_cod));
...
$q->execute(array(':date_s'=>$date_s,':mor_cod_m'=>$mor_cod_m,':m_cod_m'=>$m_cod_m,':m_jens'=>$m_jens,':m_name'=>$m_name,':m_last_name'=>$m_last_name,':m_fname'=>$m_fname,':m_tel_m'=>$m_tel_m));
 ...
 // ثبت در بانک پیگیری
sabt_event($login_session,getUserIP_1(),$date_edit,$time,$add_abadi,'تکمیل اطلاعات باغی قطعی-'.$bah_cod_m,$id_ostan) ; 
unset($error,$date_s,$mor_cod_m,$sh_gat,$id_ostan,$id_city,$id_mar,$add_abadi,$add_city,$no_kesh,$z_sal,$mah_mas,$cod_qroup,$cod_mah,$s_kesht_b,$s_kesht_gb,$tree_b,$tree_gb,$mah_tol,$mah_tolp,$mah_bem,$m_zamin,$no_mal,$lng,$lat,$m_cod_m,$m_vaz_sok,$no_kesh,$m_ab,$md_ab,$h_ab,$no_sab,$no_ab,$es,$z_sal,$m_jens,$m_name,$m_last_name,$m_fname,$m_tel_m);
...
<body>
    ...
    <form action="" method="post" id="form1" name="form1">
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
        <tr>
          <td height="32" colspan="5" bgcolor="#CCCCCC"  align="right" ><div style="margin-right:40px" align="right"><strong>موقعیت بهره برداری</strong></div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="36"><div align="right">نوع مالکیت:<?php echo $v_no_mal; ?></div></td>
          <td height="36" colspan="2"><div align="right">نوع کاشت :<?php echo $v_no_kesh; ?></div></td>
          <td height="36"><div align="right"> <?php echo $v_nah_kesh; ; ?></div></td>
          <td height="36"><div style="margin-right:30px" align="right" > : نحوه کشت </div></td>
        </tr>
  <?php if($nah_kesh<>'3'){?> 
        <tr>
  ...
  <?php }?>
        ...
        <tr>
          <td height="122" colspan="5"><table width="100%"  border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td width="9%" rowspan="2" bgcolor="#FFFFCC">محصول بیمه شده ؟</td>
              <td colspan="2" bgcolor="#FFFFCC">میزان تولید<br />                <span class="style8">تن</span></td>
              <td  colspan="2" bgcolor="#FFFFCC">تعداد درخت<br /></td>
  <?php if($nah_kesh<>'3'){?> 
...
?>
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="mah_tol<?php echo $num2_t_mah ;?> required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:100px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php  echo $mah_tol ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                 <input name="mah_tolp<?php echo $num2_t_mah ;?>" type="text" class="mah_tolp<?php echo $num2_t_mah ;?> required number input_text" id="mah_tolp<?php echo $num2_t_mah ;?>" style="width:70px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo  $mah_tolp ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="tree_gb<?php echo $num2_t_mah ;?>" type="text" class="tree_gb required digits input_text" id="tree_gb<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $tree_gb ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="tree_b<?php echo $num2_t_mah ;?>" type="text" class="tree_b<?php echo $num2_t_mah ?> required digits input_text" id="tree_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $tree_b ; ?>" maxlength="10"  align="baseline" xml:lang="fa" />
              </div></td>
                <?php if($nah_kesh<>'3'){?> 
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_kesht_gb<?php echo $num2_t_mah ;?>" type="text" class="s_kesht_gb mashat required number input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  echo $s_kesht_gb ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
<input name="s_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="s_kesht_b<?php echo $num2_t_mah ?> mashat required number input_text" id="s_kesht_b<?php echo $num2_t_mah ;?>" style="width:75px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php   echo $s_kesht_b ; ?>" maxlength="11"  align="baseline" xml:lang="fa" />
              </div></td>
                        <?php }?> 
...
<button type="button" style="width:150px ; height:45px"
        onclick="window.open('', '_self', ''); window.close();" >انصراف</button>
<script>
...
?>
    ...
    <script>
        $('.tree_b<?php echo $no ?>').change(function () {
			...
			|| mcod == '299006'  || mcod == '299101' || mcod == '299003' ) &  treeb > 0 ) {
    ...
    <script>
        $('.tree_gb').change(function () {
            ...
            if ((mcod == '203003' || mcod == '206024' || mcod == '205002'
			|| mcod == '299006'  || mcod == '299101' || mcod == '299003' ) &  treegb > 0 ) {
