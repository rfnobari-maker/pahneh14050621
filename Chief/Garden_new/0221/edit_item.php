...
// ========== اضافه کن ==========
// بررسی: اگر همه مقادیر سطح کشت و تعداد درخت صفر هستند، ویرایش ممنوع باشد
...
$Garden_prod_table = 'Garden_prod';    
    ...
    // ======== دریافت مستقیم Garden_id از دیتابیس (مطمئن‌ترین روش) ========
    ...
    // ======== اعتبارسنجی تراز مساحت با استفاده از $real_garden_id ========
    ...
    // جمع کل سطح کشت فعلی (به جز محصول جاری)
