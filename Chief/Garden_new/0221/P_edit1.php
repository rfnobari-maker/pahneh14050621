    ...
    $(document).on('change', '.cod_q', function() {
        ...
        if (group_cod) {
            $.ajax({
                ...
                success: function(html) { row.find('.cod_m').html(html); },
...
$('#save1').click(function() {
    ...
    // اضافه کردن آرایه‌ها با ایندکس‌های صریح برای PHP 5.3
   for (var i = 0; i < newRows.length; i++) {
    postData['f_cod_qroup[]'] = newRows[i].cod_qroup;
    postData['f_cod_mah[]'] = newRows[i].cod_mah;
    postData['f_s_kesht_b[]'] = newRows[i].s_kesht_b;
    postData['f_s_kesht_gb[]'] = newRows[i].s_kesht_gb;
    postData['f_tree_b[]'] = newRows[i].tree_b;
    postData['f_tree_gb[]'] = newRows[i].tree_gb;
    postData['f_mah_tolp[]'] = newRows[i].mah_tolp;
    postData['f_mah_tol[]'] = newRows[i].mah_tol;
    postData['f_mah_bem[]'] = newRows[i].mah_bem;
    postData['f_mah_kh[]'] = newRows[i].mah_kh;
}
