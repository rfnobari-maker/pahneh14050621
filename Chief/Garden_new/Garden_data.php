...
// ====== تغییر اصلی: ثبت اطلاعات بر اساس nah_kesh ======
if ($nah_kesh == '3') {
    // درختان پراکنده - فقط اطلاعات پایه قطعه ثبت شود
    $query = "INSERT INTO Garden (date_s, mor_cod_m, bah_cod_m, num_bah, sh_gat, id_ostan, id_city, id_mar, add_abadi, add_city, nah_kesh, z_sal, check_cod) 
              VALUES (:date_s, :mor_cod_m, :bah_cod_m, :num_bah, :sh_gat, :id_ostan, :id_city, :id_mar, :add_abadi, :add_city, :nah_kesh, :z_sal, :check_cod)";
    $q = $dbh->prepare($query);
    $q->execute(array(
        ':date_s' => $date_s,
        ':mor_cod_m' => $mor_cod_m,
    ...
    // نحوه کشت ساده یا مخلوط - همه فیلدها ثبت شود
    $query = "INSERT INTO Garden (date_s, mor_cod_m, bah_cod_m, num_bah, sh_gat, id_ostan, id_city, id_mar, add_abadi, add_city, m_zamin, no_mal, lng, lat, m_cod_m, m_vaz_sok, no_kesh, nah_kesh, m_ab, md_ab, h_ab, no_sab, no_ab, es, z_sal, check_cod)                        
              VALUES (:date_s, :mor_cod_m, :bah_cod_m, :num_bah, :sh_gat, :id_ostan, :id_city, :id_mar, :add_abadi, :add_city, :m_zamin, :no_mal, :lng, :lat, :m_cod_m, :m_vaz_sok, :no_kesh, :nah_kesh, :m_ab, :md_ab, :h_ab, :no_sab, :no_ab, :es, :z_sal, :check_cod)";
    $q = $dbh->prepare($query);
    $q->execute(array(
        ':date_s' => $date_s,
        ':mor_cod_m' => $mor_cod_m,
...
// ====== پایان تغییر اصلی ======
    ...
    $check++ ;
//
// اطلاعات مالک (در هر دو حالت ثبت می‌شود)
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
        <td>
            <?php include('top.php'); ?>
            <div class="style8">ثبت قطعه باغی جدید</div>
                    ...
                    <td width="840" >
                        <form action="" method="post" id="form1" name="form1">
                            <table width="99%" height="612" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
                                ...
                                <?php if ($nah_kesh != '3') { // درختان پراکنده نیست، نمایش اطلاعات مالکیت و زمین ?>
                                ...
                                <!-- بخش اطلاعات مالک فقط برای حالت غیر پراکنده -->
                                <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td  height="42" colspan="5" bgcolor="#CCCCCC">
                                                    <?php 
                                                    if($no_mal<>7) 
                                                        echo '<p align="center" style="color:#0066CC" > اطلاعات بهره بردار '.$v_co_name.' بعنوان مالک ثبت خواهد شد </p>'; 
                                                    else 
                                                        echo '<div style="margin-right:40px" align="right"><strong>اطلاعات مالک</strong></div>'; 
                                                    ?>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <?php } // پایان if no_kesh == 1 ?>
                                
                                <?php } // پایان if nah_kesh != 3 ?>
                                
                                <!-- سال برای همه حالات نمایش داده می‌شود -->
                              <tr>
                                    <td height="58">&nbsp;</td>
                                    <td height="58">&nbsp;</td>
                                    <td height="58">&nbsp;</td>
