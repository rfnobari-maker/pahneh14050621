    ...
    <table width="100%" border='0' align="center" cellpadding='0' cellspacing='0'>
      ...
      <tr bgcolor='#f1f1f1' >
        <td height="45" align="right" bgcolor="#F1F1F1" class="input_text" >
              <select  name="id_ostan"  class="style2" id="id_ostan" style="width:170px ; height:40px" dir="rtl"  onchange="this.form.submit()">
...
?>
  <img src="../files/horizontal-line-700x223.png" width="700" height="19"  alt=""/><span class="style21"><a name="1" id="1"></a></span></p><form  action="promo_action_xls.php" method="post">
        ...
        <button><img src="../files/xls.png" title="دانلود فایل اکسل"  width="50" height="55"  alt=""/></button>
      </form></p>
