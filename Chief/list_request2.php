...
<td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="11%"><span class="normalTextSmaller"><?php echo $row['date_s'];?></span></td>
 <td width="12%" class="normalTextSmaller" <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $last_name_mo2.' '.$name_mo2 ;  ?></td>
 ...
 <td <? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> width="14%" class="normalTextSmaller"><?php echo $last_name_mo1.' '.$name_mo1 ;?></td>
