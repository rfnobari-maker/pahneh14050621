...
<?php include('../login/config.php'); ?>
           <table width="70%" height="70" border="1" bordercolor="#0099CC" align="center" cellpadding="0" cellspacing="0" >
             <tr align="center" class="text1">
               <td align="center"bgcolor="#999999">کد مرکز </td>
               <td align="center"bgcolor="#999999">نام مرکز</td>
...
$r = 1 ;
 ...
 $id_city = $row['id_city'] ;
?>
               <td style="mso-number-format:'\@';" align="center"width="14%" height="34"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['id_mar'];?></td>
               <td align="center"width="15%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['mar'];?></td>
               <td style="mso-number-format:'\@';" align="center"<?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['id_city'];?></td>
               <td align="center"<?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  ><?php echo $row['city'];?></td>
               <td style="mso-number-format:'\@';" align="center"<?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo $row['id_ostan'];?></td>
