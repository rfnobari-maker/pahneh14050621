...
header("Content-Disposition: attachment;Filename=آبادی.doc");
include('../lock_ce.php');
include('counter.php');
...
if ($add_deh == 0) { $v_add_deh = 'add_deh=add_deh' ;} else { $v_add_deh = "add_deh='$add_deh'" ;}
 // برای نمایش 
$query = "SELECT add_abadi,abadi,deh,mar,bakh,city,ostan FROM  list_abadi where  $v_id_ostan and  $v_id_city and $v_id_mar   ORDER BY  add_abadi ASC  "; 
