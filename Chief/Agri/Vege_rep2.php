...
?>
                 ...
                 <td height="60" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                   <select  name="mah_name" class="required input_text " id="mah_name" style="width:150px ; height:40px" tabindex="22" dir="rtl" onchange="this.form.submit()" >
...
?>
            ...
            <table width="90%" align="center" class="my-table" >
              <tr class="text1">
                ...
                <td width="6%" rowspan="2" bgcolor="#006699">نام محصول</td>
...
if ($row['b_time']=='4')  $v_b_time='پاییزه';
  ?>
          <td width="7%" height="58" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>  <form  action="../send_pm1.php#1" method="post" onsubmit="popup_V2(this)">
...
function generate_hidden_inputs() {
    global $id_ostan1, $id_city, $id_mar, $add_abadi, $add_city,
           $ra_kesh, $mor_cod_m, $bah_cod_m, $z_sal, $b_time, $mah_name,
...
<div dir="rtl" class="pagination-container" style="margin: 20px auto; text-align: center; padding: 15px;">
    <ul class="pagination" style="list-style: none; padding: 0; margin: 0; display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
        <?php if($id > 1): ?>
            <li style="display: inline-block;">
                <form action="Vege_rep2.php?id=<?= $id-1 ?>#1" method="post" style="display: inline;">
        ...
        <?php if($start_page > 1): ?>
            <li style="display: inline-block;">
                <form action="Vege_rep2.php?id=1#1" method="post" style="display: inline;">
                    <?php generate_hidden_inputs(); ?>
        ...
        <?php for($i = $start_page; $i <= $end_page; $i++): ?>
            <li style="display: inline-block;">
                ...
                <?php else: ?>
                    <form action="Vege_rep2.php?id=<?= $i ?>#1" method="post" style="display: inline;">
                        <?php generate_hidden_inputs(); ?>
        ...
        <?php if($end_page < $total): ?>
            ...
            <?php endif; ?>
            <li style="display: inline-block;">
                <form action="Vege_rep2.php?id=<?= $total ?>#1" method="post" style="display: inline;">
                    <?php generate_hidden_inputs(); ?>
    ...
    <div class="page-jump" style="margin-top: 15px;">
        <form action="Vege_rep2.php" method="post" style="display: inline-flex; align-items: center; gap: 10px;">
            <?php generate_hidden_inputs(); ?>
...
document.querySelector('.page-jump form').addEventListener('submit', function(e) {
    ...
    this.action = `Vege_rep2.php?id=${pageNum}#1`;
});
</script>
    </td>
  </tr>
