...
<body>
 ...
 if ($add_abadi  == '0') { $f_add_abadi = 1   ;}else{$f_add_abadi = "Vege_prod.add_abadi = '$add_abadi'" ;}
 if ($add_city  == '0')  { $f_add_city  = 1   ;}else{$f_add_city  = "Vege_prod.add_city = '$add_city'" ;}
 if ($ra_kesh == '')     { $v_ra_kesh    = 1   ;}else{$v_ra_kesh   = "Vege_prod.ra_kesh = '$ra_kesh'" ;}
 if ($mor_cod_m == '')   { $v_mor_cod_m = 1   ;}else{$v_mor_cod_m = "Vege_prod.mor_cod_m = '$mor_cod_m'" ;}
 if ($bah_cod_m == '')   { $v_bah_cod_m = 1   ;}else{$v_bah_cod_m = "Vege_prod.bah_cod_m = '$bah_cod_m'" ;}
 ...
 if ($zka1 == '')        { $v_zka1  = 1       ;}else{$v_zka1      = "Vege_prod.zer_kesht >= '$zka1'" ;}
 if ($zka2 == '')        { $v_zka2  = 1       ;}else{$v_zka2      = "Vege_prod.zer_kesht <= '$zka2'" ;}
 if ($sba1 == '')        { $v_sba1  = 1       ;}else{$v_sba1      = "Vege_prod.s_bar >= '$sba1'" ;}
 if ($sba2 == '')        { $v_sba2  = 1       ;}else{$v_sba2      = "Vege_prod.s_bar <= '$sba2'" ;}
 if ($mtol1 == '')       { $v_mtol1  = 1      ;}else{$v_mtol1     = "Vege_prod.mah_tol >= $mtol1" ;}
 if ($mtol2 == '')       { $v_mtol2  = 1      ;}else{$v_mtol2     = "Vege_prod.mah_tol <= $mtol2" ;}
 if ($mtolp1 == '')      { $v_mtolp1  = 1     ;}else{$v_mtolp1    = "Vege_prod.mah_tolp >= $mtolp1" ;}
 if ($mtolp2 == '')      { $v_mtolp2  = 1     ;}else{$v_mtolp2    = "Vege_prod.mah_tolp <= $mtolp2" ;}
 ...
 include_once('../../login/config.php');
  $query = "SELECT Vege_prod.*, Vege.lng, Vege.lat 
          FROM Vege_prod 
          INNER JOIN Vege ON Vege_prod.Vege_id = Vege.id 
          WHERE $v_id_ostan AND $v_id_city AND $v_id_mar AND $f_add_abadi AND 
