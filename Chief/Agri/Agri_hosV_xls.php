...
<body>
 ...
 $query = "SELECT id_ostan, id_city , cod_mah ,
sum(zer_kesht) as zer_keshtkol
FROM Vege_prod
where z_sal= '1399-1400' Group by id_ostan , id_city , cod_mah   "  ;
...
round($row['zer_keshta'],3) ;
 $zer_keshta = '' ;
 $zer_keshtb = '' ;
 $zer_keshtkol = round($row['zer_keshtkol'],3) ; 
 $v_no_kesh= 'آبی' ; 
