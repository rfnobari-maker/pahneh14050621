...
?>
               ...
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['ayesh'],1)*1 ; ?></td>
...
?>
             <tr>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?> width="5%" height="59" ><?php echo round((kol_sum_mah_tol('1',$id_ostan,$z_sal) + kol_sum_mah_tol('2',$id_ostan,$z_sal))*1,1) ?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="5%" ><?php echo round(kol_sum_mah_tol('2',$id_ostan,$z_sal)*1,1)?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC'?>  width="5%" ><?php echo round(kol_sum_mah_tol('1',$id_ostan,$z_sal)*1,1)?></td>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round((kol_sum_s_ayesh('1',$id_ostan,$z_sal) + kol_sum_s_ayesh('2',$id_ostan,$z_sal)),1) ?></td>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_s_ayesh('2',$id_ostan,$z_sal),1)?></td>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_s_ayesh('1',$id_ostan,$z_sal),1)?></td>
               <td width="6%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round((kol_sum_s_bar_a('1',$id_ostan,$z_sal) + kol_sum_s_bar_a('2',$id_ostan,$z_sal)),1) ?><br />
                 <?php echo round((kol_sum_s_bar_b('1',$id_ostan,$z_sal) + kol_sum_s_bar_b('2',$id_ostan,$z_sal)),1) ?></td>
               <td width="6%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_s_bar_a('2',$id_ostan,$z_sal),1)?><br />
                 <?php echo round(kol_sum_s_bar_b('2',$id_ostan,$z_sal),1)?></td>
               <td width="7%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_s_bar_a('1',$id_ostan,$z_sal),1)?><br />
                 <?php echo round(kol_sum_s_bar_b('1',$id_ostan,$z_sal),1)?></td>
               <td width="6%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round((kol_sum_zer_kesht_a('1',$id_ostan,$z_sal) + kol_sum_zer_kesht_a('2',$id_ostan,$z_sal)),1) ?><br />
                 <?php echo round((kol_sum_zer_kesht_b('1',$id_ostan,$z_sal) + kol_sum_zer_kesht_b('2',$id_ostan,$z_sal)),1) ?></td>
               <td width="6%"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_zer_kesht_a('2',$id_ostan,$z_sal),1)?><br />
                 <?php echo round(kol_sum_zer_kesht_b('2',$id_ostan,$z_sal),1)?></td>
               <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(kol_sum_zer_kesht_a('1',$id_ostan,$z_sal),1)?><br />
                 <?php echo round(kol_sum_zer_kesht_b('1',$id_ostan,$z_sal),1)?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> ><?php echo kol_Agri_count($id_ostan,$z_sal)?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  ><?php echo kol_no_Agri_gat('2',$id_ostan,$z_sal)?></td>
               <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  ><?php echo kol_no_Agri_gat('1',$id_ostan,$z_sal)?></td>
