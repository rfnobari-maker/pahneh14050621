...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style8">گزارش تولید به تفکیک مرکز جهاد کشاورزی</span><br />
      </p>
...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56">
                 <form  action="Vege_rep31_xls.php" method="post">
                ...
                <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
                 ...
                 <td width="56"><form  action="Vege_rep31_doc.php" method="post">
                   <input type="hidden" name="id_ostan"  value="<?php echo  $id_ostan1 ;?>" />
                   <input type="hidden" name="ra_kesh"   value="<?php echo  $ra_kesh ;?>" />
                   <input type="hidden" name="z_sal"     value="<?php echo $z_sal ;?>" />
                   <input type="hidden" name="b_time" value="<?php echo $b_time;?>" />
          ...
          <td width="20%" bgcolor="#006699">مجموع  سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td width="17%" bgcolor="#006699">نام مرکز</td>
          <td width="17%" bgcolor="#006699">نام شهرستان</td>
...
foreach($stmt as $row){ 
  ?>
          ...
          <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mar_name($row['id_mar'])?></td>
          <td   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><div align="right"><?php echo city_name1($row['id_city'],$id_ostan1)?></div></td>
	...
	?>
        <tr>
          ...
          <td bgcolor="#006699" class="text1">مجموع  سطح زیر کشت<br />
            <span class="style3">هکتار</span></td>
          <td colspan="3" bgcolor="#006699" class="text1"  >کل استان </td>
          </tr>
<?php 
foreach($stmt as $row){ 
?>
