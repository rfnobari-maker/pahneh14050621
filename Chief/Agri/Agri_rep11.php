...
FROM $Agri_table
where $Agri_table.id_ostan = '$id_ostan1'  and $Agri_table.date_s < '1404/12/01'
GROUP BY id_city
 "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
...
FROM 
    $Agri_table
WHERE 
    id_ostan = '$id_ostan1' and $Agri_table.date_s < '1404/12/01'  ";
$stmt = $dbh->prepare($query);
$stmt->execute();
...
FROM 
    $Agri_prod_table 
WHERE 
    id_ostan = '$id_ostan1' and $Agri_prod_table.date_s < '1404/12/01'
GROUP BY 
    id_city; "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
