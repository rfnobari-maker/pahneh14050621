...
if ($num2_t_mah < $row_count)
{
echo 'کم'.$xx =  $row_count - $num2_t_mah  ;
include_once('../../login/config.php');
...
?>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_tol<?php echo $num2_t_mah ;?>" type="text" class="required number input_text" id="mah_tol<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php  echo $mah_tol ; ?>" maxlength="4"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_b<?php echo $num2_t_mah ;?>" type="text" class="s_bar_b required digits input_text" id="s_bar_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="27" dir="rtl" lang="fa" value="<?php echo $s_bar_b ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="s_bar_a<?php echo $num2_t_mah ;?>" type="text" class="s_bar_a required digits input_text" id="s_bar_a<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="26" dir="rtl" lang="fa" value="<?php echo $s_bar_a ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="zer_kesht_b<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_b required digits input_text" id="z_kesht_b<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="25" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_b ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
              <td bgcolor="#FFFFFF"><div align="center">
    <input name="zer_kesht_a<?php echo $num2_t_mah ;?>" type="text" class="z_kesht_a required digits input_text" id="z_kesht_a<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="24" dir="rtl" lang="fa" value="<?php  echo $zer_kesht_a ; ?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
...
?>
   ...
   <?php if ($row['group_cod']==$group_cod) echo 'selected=selected'?>> <? echo $row['group_name'] ;?></option>
              ...
              <td bgcolor="#FFFFFF"><div align="center">
                <input name="mah_mas<?php echo $num2_t_mah ;?>" type="text" class="mashat required digits input_text" id="mashat<?php echo $num2_t_mah ;?>" style="width:50px; height:30px ; " tabindex="21" dir="rtl" lang="fa" value="<?php echo $mah_mas ;?>" maxlength="6"  align="baseline" xml:lang="fa" />
              </div></td>
