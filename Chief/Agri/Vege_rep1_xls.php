...
if ($t_row>0) { ;
?>
               <P align="center"> لیست قطعات صیفی 1</P>
<table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
        <tr class="text1">
          <td align="center" width="11%" bgcolor="#CCCCCC"> کد ملی کارشناس<br /></td>
          <td align="center" width="9%" bgcolor="#CCCCCC">نظر تکمیلی</td>
          <td align="center" width="10%" bgcolor="#CCCCCC">نظر اولیه</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">عرض جغرافیایی</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">طول جغرافیایی</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">مساحت زمین /<span class="style2">هکتار</span></td>
          <td align="center" width="6%" bgcolor="#CCCCCC">منبع آب </td>
          <td align="center" width="5%" bgcolor="#CCCCCC">نوع طرح</td>
          <td align="center" width="6%" bgcolor="#CCCCCC">شماره قطعه</td>
          <td align="center" width="5%" bgcolor="#CCCCCC">سال زراعی</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">کد ملی </td>
          <td align="center" width="8%" bgcolor="#CCCCCC">نام و نام خانوادگی</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">شهر/آبادی</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">مرکز</td>
