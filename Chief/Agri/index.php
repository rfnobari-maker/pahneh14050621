...
<tr>
  ...
  <?php include('../top.php'); ?>
   ...
   <?php  if(strstr($perm,'d1')) { ?>
          ...
          <?php if($login_session=='2800397896' or $login_session=='1380066174') {?>

           <div class="box" align="center">
             <p><a href="Agri_s_ab.php"><img src="../../files/add_new.png" alt="ثبت برنامه الگوی کشت" width="86" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="Agri_s_ab.php" class="btn">ثبت برنامه الگوی کشت </a><br />
             </p>
           </div>
