...
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td width="56"><form  action="Vege_rep11_xls.php" method="post">
        ...
        <input type="hidden" name="z_sal" value="<?php echo $z_sal ;?>" />
                 ...
                 <td width="56"><form  action="Agri_rep15_doc.php" method="post">
                   ...
                   <input type="hidden" name="mor_cod_m2" value="<?php echo  $mor_cod_m ;?>" />
                   <input type="hidden" name="bah_cod_m2" value="<?php echo  $bah_cod_m ;?>" />
                   <input type="hidden" name="z_sal2" value="<?php echo $z_sal ;?>" />
