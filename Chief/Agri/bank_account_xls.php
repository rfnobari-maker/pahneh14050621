...
header("Content-Disposition: attachment;Filename=bank_account.xls");
include('../../lock_ce.php');
include('../../event.php');
...
//  $query = "SELECT DISTINCT bah_cod_m,num_bah from Agri_prod where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah ORDER BY bah_cod_m ASC "; 

  $query = "SELECT * from Agri_prod where $v_id_ostan  and $v_id_city and  $v_id_mar and $f_add_abadi and $f_add_city and $f_no_kesh  and $v_mor_cod_m and $v_bah_cod_m and  $v_z_sal and  $v_cod_mah group by bah_cod_m,num_bah ORDER BY bah_cod_m ASC "; 
...
<table width="85%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
        <tr class="style8">
          <td align="center" width="9%" bgcolor="#CCCCCC">نام مروج </td>
          <td align="center" width="9%" bgcolor="#CCCCCC">کد ملی مروج</td>
          <td align="center" width="9%" bgcolor="#CCCCCC">شماره حساب بانک کشاورزی</td>
          <td align="center" width="9%" bgcolor="#CCCCCC">میزان محصول قطعی <br />تن</td>
          <td align="center" width="12%" bgcolor="#CCCCCC"> میزان محصول پیش بینی  <br />
          تن</td>
          <td align="center" width="12%" bgcolor="#CCCCCC">سطح برداشت <br />
          هکتار</td>
          <td align="center" width="13%" bgcolor="#CCCCCC">سطح زیر کشت<br />
هکتار</td>
          <td align="center" width="11%" bgcolor="#CCCCCC"> تعداد            قطعه<br /></td>
          <td align="center" width="11%" bgcolor="#CCCCCC">شماره همراه</td>
          <td align="center" width="11%" bgcolor="#CCCCCC"><span class="style8"> کد ملی بهره بردار</span></td>
          <td align="center" width="13%" bgcolor="#CCCCCC">نام و نام خانوادگی بهره بردار</td>
          <td width="12%" align="center" bgcolor="#CCCCCC" class="text_r">نام مرکز</td>
          <td width="12%" align="center" bgcolor="#CCCCCC" class="text_r">شهرستان </td>
          <td width="10%" align="center" bgcolor="#CCCCCC" class="text_r">استان</td>
...
foreach($stmt as $row){ 
  ?>
          ...
          <td align="center" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo bank_account($row['bah_cod_m'],$row['num_bah'])?></td>
 ...
 ?></td>
	...
	?>
        ...
        <p align="center" class="style8"> ------------ پایان گزارش --------------- </p>
   <?php }  
