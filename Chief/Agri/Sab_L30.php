    ...
    <td height="100" colspan="3" valign="middle" >
      ...
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 350px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
          <table width="100%" height="359" border='0' align="center" cellpadding='0' cellspacing='0'>
            <tr bgcolor='#f1f1f1' >
...
<tr bgcolor='#f1f1f1' >
  <td height="53" align="right" bgcolor="#FFFFFF" class="input_text" >
    <select name="add_abadi" class="input_text" id="abadi" style="width:170px ; height:40px" dir="rtl" >
...
if (!empty($id_mar) && !empty($add_abadi)) {
  ...
  <td  align='center' bgcolor="#FFFFFF" class="style1">: آبادی </td>
</tr>
            <tr bgcolor='#f1f1f1' >
<tr bgcolor='#f1f1f1' >
  <td height="53" align="right" bgcolor="#FFFFFF" class="input_text" >
    <select name="add_city" class="input_text" id="shahr" style="width:170px ; height:40px" dir="rtl" >
...
if (!empty($id_mar) && !empty($add_city)) {
  ...
  <td  align='center' bgcolor="#FFFFFF" class="style1">: شهر </td>
</tr>
            <tr bgcolor='#f1f1f1' >
