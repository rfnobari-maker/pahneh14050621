...
<div class="container">
    ...
    if (1==1) {
        ...
        if ($dbh) {
            ...
            if ($stmt && $stmt->rowCount() > 0) {
                ...
                // آرایه‌ها برای داده‌های هر ستون
                $data_s_sal = array();     
                $data_s_payez = array();   
                ...
                // **متغیرها برای محاسبه مجموع کل هر آیتم**
                $sum_s_sal = 0;
                $sum_s_payez = 0;
                $sum_s_t_ostan = 0;
                $sum_s_est = 0;
                ...
                // تعریف Datasets - **مجموع‌ها را در Label قرار می‌دهیم**
                $datasets = array();
                ...
                $datasets[] = array(
                 ...
                 // 3. برش استانی
                 $datasets[] = array(
                    'label' => 'برش استانی (جمع: ' . number_format($sum_s_t_ostan) . ')',
                    'data' => $data_s_t_ostan,
    ...
    // پارامتر total حذف شد چون دیگر در عنوان کلی استفاده نمی‌شود
        ...
        const chartInstance = new Chart(ctx, {
            ...
            options: {
                ...
                onClick: (e) => {
                    ...
                    if (points.length) {
                        ...
                        if (ostanId) {
                            ...
                            form.method = 'POST';
                            form.action = 'sokht_L2_chart.php'; 
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        // **تغییر: حذف نمایش مجموع کل در اینجا**
                        text: `${chartTitle}`, 
    ...
    // فراخوانی تابع بدون پارامتر مجموع کل
    const myChart = createChart('fuelChart', '', datasets, 'لیتر');
