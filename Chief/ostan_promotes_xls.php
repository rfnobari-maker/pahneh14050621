...
$stmt->execute();
?>
<p align="center" class="style1">لیست مروجین  استان <?php echo $ostan_sh?></p>
           <table width="85%" height="90" border="0" align="center" cellpadding="0" cellspacing="0" >
...
$r = 1 ;
 foreach($stmt as $row){
?>
  <td align="center" width="9%" height="42"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo mor_bah_count($row['cod_m'])?></td>
    <td align="center" width="9%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
     <?php echo mor_abadi_count($row['cod_m'])?>
   </td>
    <td align="center" width="8%" class="normalTextSmaller"  <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>>
