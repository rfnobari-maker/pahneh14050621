...
header("Content-Disposition: attachment;Filename=تولید_به_تفکیک_استان.xls");
include('../../lock_ce.php');
include('../../event.php');
...
<body>
<div align="center" class="style1">آمار تولید زنبورستان به تفکیک استان بر اساس سرشماری <?php echo $sal?></div>
...
sum(t_nan) t_nan ,
sum(t_zah) t_zah 
FROM bee WHERE sal = '$sal' group by id_ostan
...
?>
        <table width="98%" height="172" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
          <tr align="center" class="text1">
            ...
            <td width="6%" rowspan="2" bgcolor="#999999">تولید ژل رویال /Kg</td>
            <td width="6%" rowspan="2" bgcolor="#999999">تعداد کلنی تولید کننده ژل رویال</td>
            <td width="6%" rowspan="2" bgcolor="#999999">میانگین تولید کندوی مدرن Kg</td>
            <td width="6%" rowspan="2" bgcolor="#999999">تولید کندوی مدرن /تن</td>
            <td width="7%" rowspan="2" bgcolor="#999999">میانگین تولید کندوی سنتی Kg</td>
            <td width="7%" rowspan="2" bgcolor="#999999">تولید کندوی سنتی /تن</td>
            <td width="6%" rowspan="2" bgcolor="#999999">تعداد کندومی مدرن</td>
            <td width="5%" rowspan="2" bgcolor="#999999">تعداد کندوی سنتی</td>
            <td rowspan="2" bgcolor="#999999">میزان مصرف سالانه شکر /تن</td>
            <td colspan="6" bgcolor="#999999">تعداد ملکه خریداری شده </td>
            <td colspan="3" bgcolor="#999999">تعداد ملکه تولیدی</td>
            <td width="7%" rowspan="2" bgcolor="#999999">تعداد زنبورداری عضو تعاونی</td>
            <td width="7%" rowspan="2" bgcolor="#999999">تعداد زنبورداری به عنوان شغل اصلی</td>
            <td width="7%" rowspan="2" bgcolor="#999999">تعداد زنبوردار تحت پوشش بیمه</td>
            <td width="7%" rowspan="2" bgcolor="#999999">تعداد افراد شاغل/نفر</td>
            <td width="6%" rowspan="2" bgcolor="#999999">تعداد زنبورستان بیمه شده </td>
            <td width="8%" rowspan="2" bgcolor="#999999">تعداد زنبورستان</td>
            <td width="12%" rowspan="2" bgcolor="#999999">استان<br /></td>
            <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
          </tr>
          <tr align="center" class="text1">
            <td bgcolor="#999999">جمع </td>
            <td bgcolor="#999999">سایر</td>
            <td bgcolor="#999999">ایتالیایی</td>
            <td bgcolor="#999999">قفقازی</td>
            <td bgcolor="#999999">کارنیکا</td>
            <td bgcolor="#999999">ایرانی</td>
            <td bgcolor="#999999">جمع </td>
            <td bgcolor="#999999">عرضه شده</td>
            <td bgcolor="#999999">خود مصرفی</td>
          </tr>
               <?php
$r = 1 ;
  foreach($stmt as $row){
 ...
 ?>
 <tr align="center">
 <td align="center" width="4%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['t_nan'],1) ; ?></td>
 <td align="center" width="4%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(($row['t_zah']/1000),3) ; ?></td>
 <td align="center" width="4%" height="32"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['t_bar'],0) ; ?></td>
 ...
 ?></td>
            ...
            <td align="center" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>> <div align="right" style="margin-right:2px"> <?php echo ostan_name($row['id_ostan']);?></div></td>
...
?>
  <tr>
    <td align="center"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round($row['t_nan'],1) ; ?></td>
