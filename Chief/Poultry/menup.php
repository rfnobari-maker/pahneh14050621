...
<?php } if(strstr($perm,'d')) {?>
 ...
 <?php } if(strstr($perm,'d7')) { ?>
   <li class='has-sub'><a href='#'><span>زنبورعسل</span></a>
          <ul>
               <li><a href='list_bee.php'><span>لیست زنبورستان ها</span></a></li>
               <li><a href='list_unknown_bee.php'><span>لیست زنبورستان ناشناس</span></a></li>
