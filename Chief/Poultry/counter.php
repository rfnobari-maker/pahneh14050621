...
include('../../login/config.php');
 function mar_bee_count($id_mar,$sal)
{
global $dbh; 
...
<?php function mor_bee_count($mor_cod_m,$sal)
{
global $dbh; 
$query = "SELECT id FROM  bee WHERE mor_cod_m = '$mor_cod_m' and  sal = '$sal' " ;
$stmt = $dbh->prepare($query);
$stmt->execute();
