        ...
        <button><img src="../../files/xls.png" title="دانلود نتایج با فرمت فایل اکسل"  width="44" height="45"  alt=""/></button>
           ...
           <table align="center" class="my-table"  >
             <tr align="center" class="text1">
               <td height="42" colspan="5" bgcolor="#999999">تلفات ناشی از بیماری</td>
...
?>
             <tr>
               ...
               <td  class="style1" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tal_b_lav'];?></td>
...
?>
    <tr>
      <td height="52" colspan="5" align="center" bgcolor="#999999" class="text1">تلفات ناشی از بیماری</td>
