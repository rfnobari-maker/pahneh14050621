...
Kg</td>
               ...
               <td colspan="2" rowspan="2" bgcolor="#669999"><br />      استان</td>
    <td width="3%" rowspan="2" bgcolor="#669999">ردیف</td>
    </tr>
             <tr align="center" class="text1">
               <td bgcolor="#669999">نان عسل</td>
               <td bgcolor="#669999">زهر</td>
               <td height="53" bgcolor="#669999">بره موم</td>
               ...
               <td width="5%" bgcolor="#669999">زنبوردار</td>
...
$r = 1 ;
 ...
 if(ostan_status($row['id_ostan'])=='2') $conf_status='../../files/icon1Inactive.png'; ?>
             <tr>
               <td width="2%"  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo round(($row['t_nan']),1) ; ?></td>
