...
header("Content-Disposition: attachment;Filename=آمار_تلفات_به_تفکیک_استان.xls");
include('../../lock_ce.php');
...
<body>
        <p align="center" >آمار تلفات به تفکیک استان</p>
...
?>
        <table width="98%" height="211" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
          <tr align="center" class="text1">
               <td height="28" colspan="5" bgcolor="#999999">تلفات ناشی از بیماری</td>
    ...
    <td width="5%" rowspan="2" bgcolor="#999999">ردیف</td>
             ...
             <tr align="center" class="text1">
               ...
               <td width="6%" bgcolor="#999999">لارو میری</td>
...
?>
             <tr>
               ...
               <td  class="style1" style="text-align: center" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['tal_b_lav'];?></td>
...
?>
    <tr>
      <td height="30" colspan="5" align="center" bgcolor="#999999" class="text1">تلفات ناشی از بیماری</td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#999999" class="text1">لارو میری</td>
