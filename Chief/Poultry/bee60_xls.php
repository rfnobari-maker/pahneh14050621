...
<body>
<div align="center" class="style1">آمار  نهایی تولید زنبورستان به تفکیک استان بر اساس سرشماری <?php echo $sal?></div>
...
?>
        <table width="98%" height="172" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" >
          <tr align="center" class="text1">
            ...
            <td width="4%" rowspan="2" bgcolor="#999999">تعداد زنبوردار تحت پوشش بیمه سایر ها</td>
            <td width="4%" rowspan="2" bgcolor="#999999">تعداد زنبوردار تحت پوشش بیمه زنبورداری</td>
            ...
            <td width="9%" rowspan="2" bgcolor="#999999">استان<br /></td>
          ...
          <tr align="center" class="text1">
            ...
            <td width="4%" bgcolor="#999999">ایرانی</td>
            <td width="2%" bgcolor="#999999">جمع </td>
...
$m_kmo = $row['t_mo'] / $row['k_mo'] ; 
 ...
 ?></td>
                ...
                <td align="center" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['t_zanB2'] ; ?></td>
                <td align="center" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['t_zanB1'] ; ?></td>
            ...
            <td align="center" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><div align="right" style="margin-right:2px"> <?php echo $row2['ostan'];?></div></td>
