      ...
      <tr bgcolor='#f1f1f1' >
        ...
        <td height="49" align="right" bgcolor="#DDDDDD" class="input_text" ><div align="right">
          <select name="sal" class="input_text  required" id="sal" style="height:40px ; width:170px ; direction:rtl">
            <option value="">سال مورد نظر را انتخاب کنید</option>
            <option value="1397" <?php if (isset($sal) && $sal=='1397') echo 'selected=selected'?>>1397</option>
            <option value="1396" <?php if (isset($sal) && $sal=='1396') echo 'selected=selected'?>>1396</option>
            <option value="1395" <?php if (isset($sal) && $sal=='1395') echo 'selected=selected'?>>1395</option>
            <option value="1394" <?php if (isset($sal) && $sal=='1394') echo 'selected=selected'?>>1394</option>
          </select>
        </div></td>
...
if(isset($_GET['id']))
{
 ...
 $query =  "SELECT * FROM   bee where  id > 368036 and (id_ostan != '03' or 
 id_ostan != '10' or
 id_ostan != '18' or
 id_ostan != '09' or
 id_ostan != '06' or
 ...
 id_ostan != '07' or
 id_ostan != '22' or
   )   ORDER BY id_ostan ASC LIMIT $start, $limit ";
 $query1 = "SELECT id FROM  bee where  id > 368036 and (id_ostan != '03' or 
 id_ostan != '10' or
 id_ostan != '18' or
 id_ostan != '09' or
 id_ostan != '06' or
