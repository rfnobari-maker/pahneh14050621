...
$query = "SELECT bee.*,bah.m_tah,bah.date_t,bah.tel_m,bah.m_tah,bah.name,bah.last_name,ostanname.ostan,cityname.city,COUNT( * ) as t_dup
FROM  bee 
...
?>
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          <td align="center" bgcolor="#FFCC99">تعداد تکرار</td>
          ...
          <td align="center" width="2%" bgcolor="#FFCC99">سال</td>
  ...
  ?>
        <tr>
          <td width="2%" bgcolor="#FFFFCC"><span class="normalTextSmall"><?php echo $row['t_dup'] ?></span></td>
          ...
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $row['sal'] ?></td>
