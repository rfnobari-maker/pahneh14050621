...
header("Content-Disposition: attachment;Filename=ostan_cod.doc");
include("../lock_ce.php");
...
$r = 1 ;
 ...
 $id_city = $row['id_city'] ;
?>
               <td align="center"width="14%" height="34"   <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['id_mar'];?></td>
