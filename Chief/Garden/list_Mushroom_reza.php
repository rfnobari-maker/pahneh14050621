...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
   ...
   <form  id="reg-form" method="post" action="#1">
             <p> <span class="style19">لیست واحدهای پرورش قارچ</span></p>
             <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               <table width="100%" height="484" border='0' align="center" cellpadding='0' cellspacing='0'>
                 <tr bgcolor='#f1f1f1' >
...
if ($row['no_mush']=='3')  $v_no_mush='سایر قارچ های پرورشی خاص';
  ?>
          <td width="5%"<?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><form  action="del_list_Mushroom.php" method="post" onsubmit="target_po2(this)">
            <form  action="del_list_Mushroom.php" method="post"  onsubmit="target_po3(this)">
              <input type="hidden" name="id"  value="<?php echo $row['id'] ;?>" />
              <input type="hidden" name="bah_cod_m" value="<?php echo $row['bah_cod_m']  ;?>" />
              <button onclick="return confirm('از حذف اطلاعات این واحد و عملکرد سنوات گذشته آن مطمئن هستید ؟ ')"><img src="../../files/del.png" title="حذف اطلاعات واحد " width="20" height="20"  alt=""/></button>
            </form></td>
