...
// ============================================================
// آرایه مقادیر فعلی برای مقایسه در جاوااسکریپت
// ============================================================
$current_values = array(
    's_nobar_abi' => floatval($request['current_s_nobar_abi']),
    's_nobar_dem' => floatval($request['current_s_nobar_dem']),
    's_bar_abi' => floatval($request['current_s_bar_abi']),
    's_bar_dem' => floatval($request['current_s_bar_dem']),
    'a_abi' => floatval($request['current_a_abi']),
    'a_dem' => floatval($request['current_a_dem'])
);

// ============================================================
// آرایه مقادیر admin برای نمایش در فیلدها
// ============================================================
$admin_values = array(
    's_nobar_abi' => $request['admin_s_nobar_abi'],
    's_nobar_dem' => $request['admin_s_nobar_dem'],
    's_bar_abi' => $request['admin_s_bar_abi'],
    's_bar_dem' => $request['admin_s_bar_dem'],
    'a_abi' => $request['admin_a_abi'],
    'a_dem' => $request['admin_a_dem']
);
?>
                    ...
                    <div class="admin-detail-box">
                        ...
                        <form id="admin-form" method="post" action="Garden_ab_request_admin_update.php">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_s_nobar_abi" class="admin-input" id="admin_s_nobar_abi"
                                                   value="<?php echo ($request['admin_s_nobar_abi'] !== null && $request['admin_s_nobar_abi'] != 0) ? number_format($request['admin_s_nobar_abi'], 1) : ''; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_s_nobar_dem" class="admin-input" id="admin_s_nobar_dem"
                                                   value="<?php echo ($request['admin_s_nobar_dem'] !== null && $request['admin_s_nobar_dem'] != 0) ? number_format($request['admin_s_nobar_dem'], 1) : ''; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_s_bar_abi" class="admin-input" id="admin_s_bar_abi"
                                                   value="<?php echo ($request['admin_s_bar_abi'] !== null && $request['admin_s_bar_abi'] != 0) ? number_format($request['admin_s_bar_abi'], 1) : ''; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_s_bar_dem" class="admin-input" id="admin_s_bar_dem"
                                                   value="<?php echo ($request['admin_s_bar_dem'] !== null && $request['admin_s_bar_dem'] != 0) ? number_format($request['admin_s_bar_dem'], 1) : ''; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_a_abi" class="admin-input" id="admin_a_abi"
                                                   value="<?php echo ($request['admin_a_abi'] !== null && $request['admin_a_abi'] != 0) ? number_format($request['admin_a_abi'], 2) : ''; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="admin_a_dem" class="admin-input" id="admin_a_dem"
                                                   value="<?php echo ($request['admin_a_dem'] !== null && $request['admin_a_dem'] != 0) ? number_format($request['admin_a_dem'], 2) : ''; ?>"
                            ...
                            <div class="btn-actions">
                                ...
                                <?php endif; ?>
                                <a href="Garden_ab_request_admin.php" class="btn-back">🔙 بازگشت به لیست مدیریت</a>
                            </div>
                        </form>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.valid) {
                    ...
                    setTimeout(function() {
                        window.location.href = 'Garden_ab_request_admin_detail.php?id=<?php echo $request['id']; ?>';
                    }, 1500);
                } else {
                    $('#form-message')
                        .html('❌ ' + response.message)
