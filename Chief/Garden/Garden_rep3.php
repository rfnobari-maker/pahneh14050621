...
<form  id="reg-form" method="post" action="#1">
  ...
  <div style="width: 450px; padding: 5px; border: 3px solid navy; margin: auto; text-align: left; border-radius:15px" >
    <table width="100%" height="200" border='0' align="center" cellpadding='0' cellspacing='0'>
      <tr bgcolor='#f1f1f1' >
        <td height="48" colspan='2' align='center' bgcolor="#FFFFFF"><span class="style11"><span class="style1">نمودار های اراضی باغی استان </span><span class="style8"><a name="1" id="1"></a></span></span></td>
      </tr>
      <tr bgcolor='#f1f1f1' >
...
?></td>
      ...
      <tr bgcolor='#f1f1f1' >
        ...
        <td width="112"  align='center' bgcolor="#FFFFFF" class="style11"><span class="input_text"><font size="2" class="style8">: سال </font></span><span style="color: #06C; font-family: Tahoma; font-weight: normal; text-align: right; text-decoration: none;"><font size="2" style="text-decoration: none; font-family: Tahoma; color: #990000;">عملکرد</font></span></td>
      </tr>
      <tr >
...
?>
           ...
           <table width="80%" height="413" border="0" align="center">
             <tr>
               <td width="50%" height="131"><table width="400" border="1" align="center" cellpadding="0" cellspacing="0"  bordercolor="#0066CC" class="Tableheader">
                 <tr>
                   <td width="100%" height="58"><p class="style8" style="text-align: center">نمودار سطح زیر کشت اراضی باغی استان </p>
                     <div class="main" align="center">
                       <div class="main" align="center">
                         <table id='myTable6' align="center">
                           ...
                           <tbody>
                             <tr>
                               <td><?php echo round(kol_sum_s_kesht_b($id_ostan,$z_sal),1) ?></td>
                               <td><?php echo round(kol_sum_s_kesht_gb($id_ostan,$z_sal),1) ?></td>
                               </tr>
                             </tbody>
                           <tr>
                             <td></tbody></td>
               ...
               <td width="50%">
                 <table width="400" border="1" align="center" cellpadding="0" cellspacing="0"  bordercolor="#0066CC" class="Tableheader">
                   <tr>
                     <td width="100%" height="58"><p class="style8" style="text-align: center">نمودار تعداد قطعات باغی استان </p>
                       <div class="main" align="center">
                         <div class="main" align="center">
                           <table id='myTable5' align="center">
                             ...
                             <tbody>
                               <tr>
                                 <td><?php echo kol_no_Garden_gat('1',$id_ostan,$z_sal) ?></td>
                                 <td><?php echo kol_no_Garden_gat('2',$id_ostan,$z_sal) ?></td>
                                 </tr>
                              </tbody>
                             <tr>
                               <td></tbody></td>
             ...
             <tr>
               <td height="127"><table width="400" border="1" align="center" cellpadding="0" cellspacing="0"  bordercolor="#0066CC" class="Tableheader">
                 <tr>
                   <td width="100%" height="58"><p class="style8" style="text-align: center">نمودار سطح زیر کشت باغات آبی استان<br />
                     به تفکیک منبع آب </p>
                     <div class="main" align="center">
                       <div class="main" align="center">
                         <table id='myTable8' align="center">
                           ...
                           <thead>
                             <tr>
                               <th></th>
                               <?php $query = "SELECT  DISTINCT m_ab FROM Garden where id_ostan='$id_ostan' and z_sal = '$z_sal' and no_kesh = '1' order by m_ab "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
 foreach($stmt as $row){
	 $m_ab = $row['m_ab'] ; 
...
$stmt->execute();
 foreach($stmt as $row){
	 $m_ab = $row['m_ab'] ; 
?>
                               <td><?php echo  sum_m_zamin_m_ab($id_ostan,$z_sal,$m_ab) ;?></td>
                               <?php }?>
                               </tr>
                             </tbody>
                           <tr>
               ...
               <td><table width="400" border="1" align="center" cellpadding="0" cellspacing="0"  bordercolor="#0066CC" class="Tableheader">
                 <tr>
                   <td width="100%" height="58" valign="middle"><p class="style8" style="text-align: center">نمودار تعداد درختان بارور و غیر بارور باغات استان </p>
                     <div class="main" align="center">
                       <div class="main" align="center">
                         <table id='myTable7' align="center">
                           ...
                           <tbody>
                             <tr>
                               <td><?php echo kol_sum_tree_b($id_ostan,$z_sal) ?></td>
                               <td><?php echo kol_sum_tree_gb($id_ostan,$z_sal) ?></td>
                               </tr>
                             </tbody>
                           <tr>
                             <td></tbody></td>
                       ...
                       <div class="main" align="center">
                         <table id='myTable9' align="center">
                           ...
                           <thead>
                             <tr>
                               <th></th>
                               <?php $query = "SELECT  DISTINCT no_ab FROM Garden where id_ostan='$id_ostan' and z_sal = '$z_sal' and no_kesh = '1' order by no_ab "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
 foreach($stmt as $row){
	 $no_ab = $row['no_ab'] ; 
...
$stmt->execute();
 foreach($stmt as $row){
	 $no_ab = $row['no_ab'] ; 
?>
                               <td><?php echo  sum_m_zamin_no_ab($id_ostan,$z_sal,$no_ab) ;?></td>
                               <?php }?>
                               </tr>
                             </tbody>
                           <tr>
           ...
           <p>&nbsp;</p>
           <?php }?>
           <p>&nbsp;</p><p><a href="Garden.php" title="برگشت به صفحه قبل"><img src="../../files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p></td>
  </tr>
  <tr>
