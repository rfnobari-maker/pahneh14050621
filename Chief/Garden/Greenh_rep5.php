...
if (isset($_POST['skb1'])) $skb1 = $_POST['skb1'];
if (isset($_POST['skb2'])) $skb2 = $_POST['skb2'];
if (isset($_POST['date_1_kesh'])) $date_1_kesh = $_POST['date_1_kesh'];
if (isset($_POST['date_2_kesh'])) $date_2_kesh = $_POST['date_2_kesh'];
if (isset($_POST['date_1_bar'])) $date_1_bar = $_POST['date_1_bar'];
if (isset($_POST['date_2_bar'])) $date_2_bar = $_POST['date_2_bar'];
if (isset($_POST['mtol1'])) $mtol1 = $_POST['mtol1'];
if (isset($_POST['mtol2'])) $mtol2 = $_POST['mtol2'];

// کد گروه و کد محصول
if (isset($_POST['group_cod'])) $group_cod = $_POST['group_cod'];
if (isset($_POST['mah_cod'])) $mah_cod = $_POST['mah_cod'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td  colspan="3" valign="middle" >
      <span class="style8">گزارش جمعبندی کشوری محصولات گلخانه</span><br />
      </p>
      <form  id="reg-form" method="post" action="#1">
        <div style="width: 700px; padding: 5px; border: 2px solid #09C  ; margin: auto; text-align: left; ; border-radius: 15px" >
               ...
               <tr bgcolor='#f1f1f1' >
                 <td width="204" height="41" align="right" bgcolor="#FFFFFF" class="input_text" ><div align="right">
                 ...
                 <td width="134" height="41" align="right" bgcolor="#FFFFFF" class="style1" ><font size="2" class="normalTextSmall">: نوع کشت</font></td>
                 ...
                 <td width="166"  align='center' bgcolor="#FFFFFF" class="style1"><span class="normalTextSmall">: سال </span></td>
               </tr>
               <tr >
...
if(isset($_GET['id']))
{
    ...
    $query = " SELECT sum(s_kesh) as s_kesh , sum(m_tol) as m_tol , mah_cod , group_cod , no_kesht 
FROM Greenprod_annual
where $f_no_kesht and 
 ...
 and $v_mtol1 and $v_mtol2 group by no_kesht,group_cod,mah_cod  LIMIT $start, $limit "; 
 $query1 = "SELECT id
FROM Greenprod_annual
where $f_no_kesht and 
 $v_y_prod and $v_group_cod  and $v_mah_cod and $v_date_1_kesh and $v_date_2_kesh and $v_date_1_bar and $v_date_2_bar and $v_skb1 and $v_skb2 
 and $v_mtol1 and $v_mtol2  group by no_kesht,group_cod,mah_cod  "; 
$stmt = $dbh->prepare($query);
$stmt->execute();
$t_row = $stmt -> rowCount() ; 
if ($t_row>0) { ;
?>
             ...
             <table width="122" height="56" border="0" align="center">
               <tr>
                 <td><form  action="Greenh_rep5_xls.php" method="post">
...
{
	?>
    <form  action="Greenh_rep5.php?id=<?php echo $id-1 ?>#1" method="post">
...
echo "<ul class='page'>";
		for($i=1;$i<=$total;$i++)
		{
			...
			?>
      <li class='current'><form  action="Greenh_rep5.php?id=<?php echo $i?>#1" method="post">
        <input type="hidden" name="action" value="1" />
        <input type="hidden" name="bah_cod_m" value="<?php echo $bah_cod_m ;?>" />
        <input type="hidden" name="no_kesht"   value="<?php echo  $no_kesht ;?>" />
        <input type="hidden" name="y_prod"     value="<?php echo $y_prod ;?>" />
