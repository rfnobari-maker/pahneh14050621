...
<tr>
  ...
  <?php include('top.php'); ?>
           ...
           <div class="box" align="center">
             <p><a href="Greenh_rep1.php"><img src="../../files/add_new.png" alt="گزارش ویژه زراعت" width="70" height="79" border="0" class="tricky_image" /></a></p>
           ...
           <div class="box" align="center">
             <p><a href="Greenh_daily_report.php"><img src="../../files/ostan_cod.png" alt="گزارش ویژه زراعت" width="86" height="86" border="0" class="tricky_image" /></a></p>
             <p><a href="Greenh_daily_report.php" class="btn">گزارش  خلاصه روزانه</a></p>
           </div>

           <div class="box" align="center">
             <p><a href="Greenh_rep170.php"><img src="../../files/filter_data.png" alt="گزارش ویژه زراعت" width="100" height="100" border="0" class="tricky_image" /></a></p>
             <p><a href="Greenh_rep170.php" class="btn">گزارش ویژه محصولات </a></p>
           </div>
           <div class="box" align="center">
             <p><a href="Greenh_rep4.php"><img src="../../files/map.png" alt="گزارش ویژه زراعت" width="100" height="100" border="0" class="tricky_image" /></a></p>
             <p><a href="Greenh_rep4.php" class="btn"> گزارش جمعبندی  محصولات </a></p>
           </div>
           <div class="box" align="center">
             <p><a href="Greenh_rep4.php"><img src="../../files/Ind.png" alt="گزارش ویژه زراعت" width="100" height="100" border="0" class="tricky_image" /></a></p>
             <p><a href="Greenh_rep5.php" class="btn"> گزارش جمعبندی  کشوری </a></p>
           </div>
