...
?>
            <table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#00CCFF">
              <tr class="text1">
                <td bordercolor="#FFFFFF">همراه کارشناس</td>
                <td bordercolor="#FFFFFF"> کد ملی کارشناس</td>
                <td bordercolor="#FFFFFF">نام کارشناس</td>
...
if ($bah_vaz=='3') $v_bah_vaz='تایید نشده' ;	 
 ...
 $t_r = $r ; 
  ?>
        <tr>
          <td bordercolor="#FFFFFF" class="normalTextSmall" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo user_tel($row['mor_cod_m']) ?></td>
