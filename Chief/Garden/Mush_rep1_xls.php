...
<table width="99%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#66CCFF">
              <tr class="text1">
                <td align="center" width="4%" bgcolor="#CCCCCC">همراه  کارشناس</td>
                <td align="center" width="4%" bgcolor="#CCCCCC">کد ملی کارشناس</td>
                <td align="center" width="4%" bgcolor="#CCCCCC">نام کارشناس</td>
                <td align="center" width="4%" bgcolor="#CCCCCC">عملکرد تولید / کیلوگرم بر مترمربع</td>
          <td align="center" width="3%" bgcolor="#CCCCCC"><p>کل تولید / تن</p></td>
          <td align="center" width="5%" bgcolor="#CCCCCC">سطح زیر کشت/ مترمربع</td>
          <td align="center" width="4%" bgcolor="#CCCCCC"><p>تعداد دوره پرورشی</p></td>
          <td align="center" width="5%" bgcolor="#CCCCCC">نحوه تامین کمپوست</td>
          <td align="center" width="5%" bgcolor="#CCCCCC"><p>کمپوست مصرفی /تن در سال</p></td>
          <td align="center" width="3%" bgcolor="#CCCCCC">نوع قارچ</td>
          <td align="center" width="4%" bgcolor="#CCCCCC">مسئول فنی</td>
          <td align="center" width="5%" bgcolor="#CCCCCC"><p>تعداد شاغل/ نفر
          </p></td>
          <td align="center" width="6%" bgcolor="#CCCCCC">شماره همره</td>
          <td align="center" width="6%" bgcolor="#CCCCCC"><span class="text1"> کد ملی</span></td>
          <td align="center" width="10%" bgcolor="#CCCCCC">نام و نام خانوادگی</td>
          <td align="center" width="6%" bgcolor="#CCCCCC">آبادی/شهر</td>
          <td align="center" width="6%" bgcolor="#CCCCCC">مرکز</td>
          <td align="center" width="8%" bgcolor="#CCCCCC">شهرستان</td>
