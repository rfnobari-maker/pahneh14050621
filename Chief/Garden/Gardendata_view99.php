...
<body>
  ...
  <tr>
    ...
    <td width="4"><p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="840" >
    <form action="liste_Garden.php" method="post" id="form1" name="form1">
...
?>
            <tr>
              <td height="36" bgcolor="#FFFFFF"><div align="center">
                <select name="mah_bem<?php echo $num2_t_mah ;?>" disabled="disabled" class="required input_text  required" id="mah_bem<?php echo $num2_t_mah ;?>"  style="height:40px ; width:100px ; direction:rtl" tabindex="29">
                  <option value="">انتخاب کنید</option>
