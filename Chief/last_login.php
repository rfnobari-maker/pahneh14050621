...
<table width="100%" height="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
 ...
 {
?>
      <td align="center" height="68" class="normalTextSmaller"<? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['time'];?></td>
      <td align="center" class="normalTextSmaller"<? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $row['date'];?></td>
      <td align="center" class="normalTextSmaller"<? if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo $r;?></td>
    </tr>
    <?php
	$r++ ; 
}
