...
?>
      ...
      <table width="98%" height="90" border="1" align="center" cellpadding="1" cellspacing="1" >
        <tr align="center" class="text1">
          <td height="57" bgcolor="#FFFFCC" class="style8">بیمه</td>
          <td bgcolor="#FFFFCC" class="style8">تولید قطعی</td>
          <td bgcolor="#FFFFCC" class="style8">سطح زیر کشت /هکتار</td>
          <td bgcolor="#FFFFCC" class="style8">نام محصول</td>
          <td width="5%" bgcolor="#FFFFFF" class="style8"> کد ملی<br />
          </td>
          <td width="8%" bgcolor="#FFFFFF" class="style8">نام خانوادگی</td>
          <td width="5%" bgcolor="#FFFFFF" class="style8"> نام </td>
          <td width="6%" bgcolor="#FFFFCC" class="style8">نوع بهره بردار</td>
          <td width="9%" bgcolor="#FFFFCC" class="style8">آدرس آماری</td>
          <td width="10%" bgcolor="#FFFFCC" class="style8">شهر / آبادی </td>
          <td width="13%" bgcolor="#FFFFCC" class="style8">شهرستان </td>
          <td width="7%" bgcolor="#FFFFFF" class="style8">تاریخ ثبت / ویرایش</td>
...
?>
          <td  width="7%" height="30" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo sum_mush($row['bah_cod_m'],$row['num_bah'],$row['id_ostan']) ;?></td>
          <td  width="8%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo sum_Greenhous($row['bah_cod_m'],$row['num_bah'],$row['id_ostan']) ;?></td>
          <td  width="8%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo sum_Garden($row['bah_cod_m'],$row['num_bah'],$row['id_ostan']) ;?></td>
          <td  width="8%" align="center" bgcolor="#FFFFCC" class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo sum_Agri($row['bah_cod_m'],$row['num_bah'],$row['id_ostan']) ;?></td>
