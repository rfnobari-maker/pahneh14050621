...
<div style=" 
    height: 40px; 
    background: linear-gradient(to bottom, #005c38, #0ea070, #005c38); 
    padding: 5px; 
    display: flex; 
...
">
    ...
    <div class="logout-item" style="width: 8%; text-align: left; margin-left: 20px;">
        <a href="<?php echo $root; ?>login/logout" title="خروج از سامانه" style="color: #FF9; text-decoration: none;">خروج</a>
    </div>
