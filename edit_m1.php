...
<head>
    ...
    <title>سامانه شبکه پهنه بندی اراضی کشاورزی</title>
...
$query1 = "SELECT * from users WHERE username='".$user_check."'";
 ...
 ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" >
                <tr>
                      <td width="282" height="235" align="center" bgcolor="#FFFFCC"><p align="justify" class="style2"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >- ارسال عکس پرسنلی به سامانه </p>
                      ...
                      <td width="257" align="center" bgcolor="#FFFFCC"><p class="up_row">
                        <?php if($row1['pic']<>""){?>
                        <img style="border:1px solid #021a40;" src="<?php echo 'files/users/'.$row1['pic'];?>"  width="87" height="107"/>                      
                        <p class="up_row">
                        ...
                        <input type="submit" value="ارسال فايل" name="action4"  <?php if($row1['pic']<>"") { echo ' disabled="disabled"';}?>/>
   ...
   <tr>
     ...
     <td><div align="right">: کد ملی/ نام کاربری</div></td>
     <td>&nbsp;</td>
     <td><div align="right">
   ...
   <tr>
     <td height="38"><div align="right">
       <input name="last_name" type="text" class="required" style="width:200px; height:30px ; " tabindex="29" dir="rtl" lang="fa" value="<?php echo $last_name ; ?>" maxlength="50" xml:lang="fa" />
       </div></td>
     <td><div align="right">:نام خانوادگی</div></td>
     <td rowspan="8">&nbsp;</td>
     <td><div align="right">
       <input name="name" type="text" class="required" style="width:150px; height:30px ; " tabindex="28" dir="rtl" lang="fa" value="<?php echo $my_name ; ?>" maxlength="50" xml:lang="fa" />
       </div></td>
     <td><div style="margin-right:15px" align="right">: نام</div></td>
   </tr>
   <tr>
     <td height="38"><div align="right">
       <input name="sh_sh" type="text" class="required digits" id="sh_sh" style="width:150px; height:30px ; " tabindex="31" dir="rtl" lang="fa" value="<?php echo $sh_sh ; ?>" maxlength="20" xml:lang="fa"/>
     </div></td>
     <td><div align="right">:شماره شناسنامه</div></td>
     <td><div align="right">
       <select name="jens" class="required" id="jens" style="height:40px ; width:100px ; direction:rtl" tabindex="35">
   ...
   <tr>
     <td height="42"><div align="right">
       <input name="m_sodor" type="text" class="required" id="m_sodor" style="width:150px; height:30px ; " tabindex="33" dir="rtl" lang="fa" value="<?php echo $m_sodor ; ?>" maxlength="35" xml:lang="fa"/>
     </div></td>
     <td><div align="right">:محل صدور</div></td>
    <td height="42" dir="rtl"><div align="right">
       <input name="date_t" type="text" class="pdate required" id="pcal1" style="width:150px; height:30px ; " tabindex="32" dir="rtl" lang="fa" value="<?php echo $date_t ; ?>" maxlength="10" xml:lang="fa" />
     </div></td>
     <td><div style="margin-right:15px" align="right" > : تاریخ تولد</div></td>
   </tr>
   <tr>
     <td height="38"><div align="right">
       <select name="m_tah" class="required" id="m_tah" style="height:40px ; width:150px ; direction:rtl" tabindex="35"> <option value="">انتخاب کنید</option>
     ...
     <td><div align="right">
       <input name="fname" type="text" class="required" id="fname" style="width:150px; height:30px ; " tabindex="34" dir="rtl" lang="fa" value="<?php echo $fname ; ?>" maxlength="35" xml:lang="fa" />
     </div></td>
     <td><div style="margin-right:15px" align="right" >: نام پدر</div></td>
   </tr>
   <tr>
     <td height="42"><div align="right">
       <input name="univer" type="text" class="required" id="univer" style="width:200px; height:30px ; " tabindex="34" dir="rtl" lang="fa" value="<?php echo $univer ; ?>" maxlength="35" xml:lang="fa" />
     </div></td>
     <td><div align="right">:نام دانشگاه</div></td>
     <td><div align="right">
       <input name="r_tah" type="text" class="required" id="r_tah" style="width:200px; height:30px ; " tabindex="34" dir="rtl" lang="fa" value="<?php echo $r_tah ; ?>" maxlength="35" xml:lang="fa" />
     </div></td>
     <td><div style="margin-right:15px" align="right" >:رشته تحصیلی</div></td>
     </tr>
   <tr>
     <td height="42"><div align="right">
       <input name="avre" type="text" class="required" id="avre" style="width:75px; height:30px ; " tabindex="33" dir="rtl" lang="fa" value="<?php echo $avre ; ?>" maxlength="5" xml:lang="fa"/>
     </div></td>
     <td><div align="right">:معدل </div></td>
    <td height="42" dir="rtl"><div align="right">
       <input name="m_date" type="text" class="pdate required" id="pcal2" style="width:150px; height:30px ; " tabindex="32" dir="rtl" lang="fa" value="<?php echo $m_date ; ?>" maxlength="10" xml:lang="fa" />
     </div></td>
     <td><div style="margin-right:15px" align="right" >:تاریخ اخذ مدرک</div></td>
     </tr>
   <tr>
     <td height="42"><div align="right">
       <input name="cod_p" type="text" class="required" id="cod_p" style="width:150px; height:30px ; " tabindex="33" dir="rtl" lang="fa" value="<?php echo $cod_p ; ?>" maxlength="35" xml:lang="fa"/>
     </div></td>
     <td><div align="right">:کد پرسنلی</div></td>
     <td height="38"><div align="right">
       <select name="v_tahol" class="required" id="v_tahol" style="height:40px ; width:150px ; direction:rtl" tabindex="35">
         <option value="">انتخاب کنید</option>
   ...
   <tr>
     <td height="38"><div align="right"><span class="style2"><img src="files/sms.png" width="25" height="25" /></span>
       <input name="tel_m" type="text" class="required digits" id="tel_m" style="width:150px; height:30px ; " tabindex="37" dir="rtl" lang="fa" value="<?php echo $tel_m ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
     <td><div align="right">:شماره همراه</div></td>
     <td><div align="right">
       <input name="tel_s" type="text" class="required digits" id="tel_s" style="width:150px; height:30px ; " tabindex="36" dir="rtl" lang="fa" value="<?php echo $tel_s ; ?>" maxlength="11" xml:lang="fa"/>
     </div></td>
     <td><div style="margin-right:15px" align="right" >:شماره تلفن ثابت</div></td>
   </tr>
   <tr>
     <td height="38" colspan="4"><div align="right">
       <input name="addres" type="text" class="required" id="addres" style="width:700px; height:30px ; " tabindex="38" dir="rtl" lang="fa" value="<?php echo $addres ; ?>" maxlength="300" xml:lang="fa" />
     </div></td>
...
$text= " با سلام اطلاعات شما در سامانه ثبت درخواست مجوزهای کشاورزی سازمان نظام مهندسی استان تصحیح شد کد رهگیری ".$cod_p." اطلاعات بیشتر در سایت سامانه  به آدرس www.ea-aozsh.ir" ; 
//$text = $cod_p.':کد پیگیری شما ';
//sms($tel_m,$text) ;
// ثبت در بانک پیگیری
date_default_timezone_set('Asia/Tehran') ;
$date_edit = jdate("Y/m/d");
//include('event.php');
//sabt_event($no_bah,$cod_p,'ویرایش اطلاعات درخواست ',$date_edit,$euser) ; 
