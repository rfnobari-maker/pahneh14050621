...
//
$query = "SELECT S_access,date_pas,username,Last_name,ostan,id_ostan,city,id_city,markaz,name,id_mar,pic,jens,perm from users  WHERE username='".$user_check."' and  S_access  IN ('4','98') ";
...
$no_karbar = 'مدیریت جهاد کشاورزی شهرستان' ; 
$dbh = null;
