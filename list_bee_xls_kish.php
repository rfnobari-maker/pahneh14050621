...
include ('../../login/config.php');
 ...
 if ($jens == '')           { $v_jens       = 1 ;} else{ $v_jens      = "bah.jens= '$jens'" ;}
$query = "SELECT bee.*,bah.m_tah,bah.date_t,bah.tel_m,bah.m_tah,bah.name,bah.last_name,ostanname.ostan,cityname.city,bah.jens,bah.no_bah 
FROM  bee 
...
where  $v_id_ostan  and  $v_m_ostan and  $v_m_city and  $v_id_city and $v_id_mar and $v_sal and
 $f_add_abadi and $f_add_city and $f_no_zan and $v_mor_cod_m and $v_bah_cod_m  and $v_jens  ORDER BY bah_cod_m ASC"  ;
...
?>
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor='#CCCCCC' dir="rtl">
        <tr class="text1">
          ...
          <td align="center" width="2%" bgcolor="#FFCC99">تولید زهرg </td>
          <td align="center" width="2%" bgcolor="#FFCC99">تولید ژله رویال g</td>
          ...
          <td align="center" width="2%" bgcolor="#FFCC99">کل عسل تولیدی Kg</td>
          <td align="center" width="2%" bgcolor="#FFCC99">تولید عسل مدرن Kg</td>
          <td align="center" width="2%" bgcolor="#FFCC99">تولید عسل سنتی
          Kg</td>
          <td align="center" width="2%" bgcolor="#FFCC99">جمع</td>
          <td align="center" width="2%" height="31" bgcolor="#FFCC99">تعداد کندوی مدرن</td>
          <td align="center" width="2%" bgcolor="#FFCC99">تعدادکندوی سنتی</td>
          ...
          <td align="center" width="3%" bgcolor="#FFCC99">شماره پروانه زنبورداری</td>
          <td align="center" width="2%" bgcolor="#FFCC99">تعداد ملکه خریداری شده از بخش دولتی</td>
          <td align="center" width="4%" bgcolor="#FFCC99">تعداد ملکه خریداری شده از بخش خصوص</td>
          <td align="center" width="3%" bgcolor="#FFCC99">تعداد ملکه خود مصرفی</td>
          ...
          <td align="center" width="2%" bgcolor="#FFCC99">جنسیت</td>
          <td align="center" width="2%" bgcolor="#FFCC99">نوع بهره بردار</td>
  ...
  ?>
        <tr>
          ...
          <td height="35" class="normalTextSmaller"><p><?php echo user_name($row['mor_cod_m'])?></p></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall" ><?php echo $row['t_zah'] ?></td>
          ...
          <td class="normalTextSmall"><?php echo $row['tm_kdo'] ?></td>
          <td class="normalTextSmall"><?php echo $row['tm_kkh'] ?></td>
          <td class="normalTextSmall"><?php echo $row['tm_kh'] ?></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $row['no_mo'] ?></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo city_name1($row['m_city'],$row['m_ostan']) ?></td>
          ...
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $v_jens ; ?></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $v_no_bah ; ?></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $age ; ?></td>
          <td bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $row['date_t'] ?></td>
          <td height="35" bgcolor="#FFFFCC" class="normalTextSmall"><?php echo $row['bah_cod_m'] ?></td>
