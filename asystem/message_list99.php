...
?>
      ...
      <p>        <span class="style8">لیست پیام ها </span>
      </p>
...
<form name="bulk_action_form" action="message_del2.php" method="post" onSubmit="return delete_confirm();"/>
    ...
    <td height="33" bgcolor="#0099CC">&nbsp;</td>
    <td height="33" bgcolor="#0099CC">&nbsp;</td>
  ...
  <tr align="center" class="text1">
    ...
    <td width="10%" bgcolor="#0099CC">تاریخ</td>
    <td width="9%" bgcolor="#0099CC">&nbsp;</td>
    </tr>
  <tr>
<?php
$r = $start+1 ;
...
<td  class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>><?php echo user_name($row['s_user']);?><br />
  ...
  <?php echo user_tel($row['s_user']);?>  <br />
    ...
    <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  class="normalTextSmall"><span class="normalTextSmaller"><?php echo $row['s_date']?></span></td>
    <?php 
$pic =   $row['pic'] ;
if ($pic == '') $pic = 'no_pic.png'

 ?>
   <td class="normalTextSmaller" <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?> >&nbsp;</td>
