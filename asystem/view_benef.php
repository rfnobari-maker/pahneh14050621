 ...
 <table width="95%" height="301" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
   ...
   <tr>
     ...
     <td bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
           <input name="fa_6" type="radio"  disabled="disabled"   class="required green" id="fa_1_10" tabindex="20" <?php if($fa_6=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio"  disabled="disabled" name="fa_6"   class="required red"  <?php if($fa_6=="2") echo "checked='checked'"?> value="2" id="fa_1_11" />
           </label>
         <br />
         </p>
     </div></td>
     ...
     <td width="132" bgcolor="#FFFFFF"><div align="right">
       <p>
  <label> بلی
           <input name="fa_1" type="radio"  disabled="disabled"   class="required green" id="fa_1_0" tabindex="16" <?php if($fa_1=="1") echo "checked='checked'"?>  value="1" />
           </label>
   ...
   <tr>
     ...
     <td bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
           <input name="fa_7" type="radio"  disabled="disabled"   class="required green" id="fa_1_24" tabindex="21"   <?php if($fa_7=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio"  disabled="disabled" name="fa_7"   class="required red"  <?php if($fa_7=="2") echo "checked='checked'"?> value="2" id="fa_1_25" />
           </label>
         <br />
         </p>
     </div></td>
   ...
   <tr>
     ...
     <td bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
           <input name="fa_4" type="radio"  disabled="disabled"   class="required green" id="fa_1_6" tabindex="18"  <?php if($fa_4=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio"  disabled="disabled" name="fa_4"   class="required red" <?php if($fa_4=="2") echo "checked='checked'"?>  value="2" id="fa_1_7" />
           </label>
         <br />
         </p>
     </div></td>
   ...
   <tr>
     ...
     <td><div align="right">
       <p>
         <label> بلی
           <input name="fa_5" type="radio"  disabled="disabled"   class="required green" id="fa_1_8" tabindex="19"   <?php if($fa_5=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio"  disabled="disabled" name="fa_5"   class="required red"  <?php if($fa_5=="2") echo "checked='checked'"?> value="2" id="fa_1_9" />
           </label>
         <br />
         </p>
     </div></td>
