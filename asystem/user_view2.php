...
<p align="center" >مدیریت کاربران </p>
 ...
 <p align="center" style="color:#900 ; font-family:Tahoma; font-size:12px" ><?php echo $_POST['mess'] ; ?></p>
   ...
   <table width="776" border='0' align="center" cellpadding='0' cellspacing='0' dir="rtl">
     <tr bgcolor='#f1f1f1' >
       <td width="246" height="77" align="right" bgcolor="#F1F1F1" class="input_text" ><div id="int3" align="right"> استان: </div></td>
       <td width="142"><span class="input_text">
         <form method="post" name="form1" id="form5"  action="">
...
?>
       ...
       <td width="246" align="right" bgcolor="#F1F1F1" class="input_text" ><div id="int2" align="right"> شهرستان: </div></td>
       <td width="142"><form method="post" name="form1" id="form4"  action="#1">
