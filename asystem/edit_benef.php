...
<body>
 ...
 <?php  if ($no_bah=='1') { ?>
  <td height="38" colspan="5" align="right" bgcolor="#CCCCCC"><div style="margin-right:40px" align="right"><strong>مشخصات بهره بردار حقیقی</strong></div></td>
   ...
   <tr>
     ...
     <td width="194"><div align="right">
       <input name="name" type="text" class="required" id="name" style="width:150px; height:30px ; " tabindex="2" dir="rtl" lang="fa" value="<?php echo $bah_name ; ?>" maxlength="50" xml:lang="fa" />
     </div></td>
  ...
  <?php if($s_bah==2) {?>
   <tr>
     ...
     <td height="45" bgcolor="#FFFFCC"><div align="right">
       <input name="city_s" type="text"  placeholder="شهر" class="required" id="city_s" style="width:150px; height:30px ; " tabindex="14" dir="rtl" lang="fa" value="<?php echo $tel_s ; ?>" maxlength="50" xml:lang="fa"/>
     </div></td>
     <td height="45" bgcolor="#FFFFCC"><div align="right">
 ...
 <table width="95%" height="301" border="0" align="center" cellpadding="0" cellspacing="0" style="border:3px solid #069;">
   <tr>
   ...
   <tr>
     <td width="133" height="48" bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
     ...
     <td width="153" bgcolor="#FFFFFF"><div  style="margin-right:30px" align="right">:کرم ابریشم</div></td>
     <td bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
           <input name="fa_6" type="radio"   class="required green" id="fa_1_10" tabindex="20" <?php if($fa_6=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio" name="fa_6"   class="required red"  <?php if($fa_6=="2") echo "checked='checked'"?> value="2" id="fa_1_11" />
           </label>
         <br />
         </p>
     </div></td>
     <td bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:دام سبک سنتی</div></td>
   ...
   <tr>
     ...
     <td bgcolor="#FFFFCC"><div style="margin-right:30px" align="right">:پرورش ماهی</div></td>
     <td bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
           <input name="fa_7" type="radio"   class="required green" id="fa_1_24" tabindex="21"   <?php if($fa_7=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio" name="fa_7"   class="required red"  <?php if($fa_7=="2") echo "checked='checked'"?> value="2" id="fa_1_25" />
           </label>
         <br />
         </p>
     </div></td>
     <td bgcolor="#FFFFCC"><div style="margin-right:30px" align="right">:دام سبک صنعتی</div></td>
     <td bgcolor="#FFFFCC"><div align="right">
       <div align="right">
         <p>
           <label> بلی
   ...
   <tr>
     <td height="51" bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
     ...
     <td bgcolor="#FFFFFF"><div style="margin-right:30px" align="right">:صنایع کشاورزی</div></td>
     <td width="138" bgcolor="#FFFFFF"><div align="right">
       <p>
         <label> بلی
   ...
   <tr>
     ...
     <td bgcolor="#FFFFCC"><div align="right">
       <p>
         <label> بلی
           <input name="fa_4" type="radio"   class="required green" id="fa_1_6" tabindex="18"  <?php if($fa_4=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio" name="fa_4"   class="required red" <?php if($fa_4=="2") echo "checked='checked'"?>  value="2" id="fa_1_7" />
           </label>
         <br />
         </p>
     </div></td>
     <td bgcolor="#FFFFCC"><div style="margin-right:30px" align="right">:دام سنگین سنتی</div></td>
   </tr>
   <tr>
     <td>&nbsp;</td>
     <td height="59">&nbsp;</td>
     ...
     <td><div align="right">
       <p>
         <label> بلی
           <input name="fa_5" type="radio"   class="required green" id="fa_1_8" tabindex="19"   <?php if($fa_5=="1") echo "checked='checked'"?>  value="1" />
           </label>
         <br />
         <label> خیر</label>
         <label>
           <input type="radio" name="fa_5"   class="required red"  <?php if($fa_5=="2") echo "checked='checked'"?> value="2" id="fa_1_9" />
           </label>
         <br />
         </p>
     </div></td>
     <td><div style="margin-right:30px" align="right">:دام سنگین صنعتی</div></td>
     </tr>
 </table>
 <p>&nbsp;</p>
 <div align="center">
...
include('../login/config.php');
$query = "UPDATE bah  SET mor_cod_m=?,no_bah=?,bah_cod_m=?,jens=?,name=?,last_name=?,date_t=?,sh_sh=?	 ,m_sod=?,fname=?,m_tah=?,er_mtah=?,tel_s=?,tel_m=?,ostan_s=?,shahr_s=?,city_s=?,rosta_s=?,co_name=?,no_co=?,sh_meli=?,co_sabt=?,fa_1=?,fa_2=?,fa_3=?,fa_4=?,fa_5=?,fa_6=?,fa_7=?,fa_8=?,fa_9=?,fa_10=?,fa_11=?,fa_12=?,fa_13=?,add_abadi=?,add_city=?	
    WHERE bah_cod_m=?";
$q = $dbh->prepare($query);
$q->execute(array($mor_cod_m,$no_bah,$bah_cod_m,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,$fname,$m_tah,$er_mtah,$tel_s,$tel_m,$ostan_s,$shahr_s,$city_s,$rosta_s,$co_name,$no_co,$sh_meli,$co_sabt,$fa_1,$fa_2,$fa_3,$fa_4,$fa_5,$fa_6,$fa_7,$fa_8,$fa_9,$fa_10,$fa_11,$fa_12,$fa_13,$add_abadi,$add_city,$bah_cod_m));
// ارسال اس ام اس 
...
//sms($tel_m,$text) ;
 // ثبت در بانک پیگیری
sabt_event($login_session,$_SERVER['REMOTE_ADDR'],$date_edit,$time,$add_abadi,'تصحیح اطلاعات بهره بردار - '.$bah_cod_m) ; 
 // once saved, redirect back to the view page 
 //header("Location: user_view.php");
unset($error,$date_s,$mor_cod_m,$bah_cod_m,$no_bat,$jens,$name,$last_name,$date_t,$sh_sh,$m_sod,$fname,$m_tah,$er_mtah,$tel_s,$tel_m,$ostan_s,$shahr_s,$city_s,$rosta_s,$co_name,$no_co,$sh_meli,$co_sabt,$fa_1,$fa_2,$fa_3,$fa_4,$fa_5,$fa_6,$fa_7,$fa_8,$fa_9,$fa_10,$fa_11,$fa_12,$fa_13,$add_abadi,$add_city);
