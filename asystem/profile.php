 ...
 ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" >
                <tr>
                      <td width="358" height="235" align="center" bgcolor="#FFFFFF"><p align="justify" class="normalTextSmall"  style="direction:rtl; color:#900 ; margin-right:20px ; margin-left:20px" >تصویر کاربر </p>
                      ...
                      <td width="351" align="center" bgcolor="#FFFFFF"><p class="up_row">
                        <?php if($row['pic']<>""){
							 		?>
