...
<p align="center" ><span class="style1">تغییر مرکز و مروج آبادی </span></p>
 ...
 <div align="center" style="margin-top:60px"><a href="index.php">برگشت</a></div>
...
echo $query = "SELECT public_abadi4.add_abadi from public_abadi4 
inner join list_abadi ON public_abadi4.add_abadi = list_abadi.add_abadi 
where  public_abadi4.id_abadi = :id_abadi "; 
