...
if(isset($_GET['id']))
{
  ...
  $query = "SELECT bah.id,bah.date_s,bah.add_abadi,bah.add_city,bah.no_bah,bah.name,bah.last_name
  ...
  setTimeout(function() {
    ...
    $("#message").hide();
      ...
      <td height="57" bgcolor="#999999"><p>مشاهده</p>
        <p>اطلاعات</p></td>
      <td width="6%" bgcolor="#999999">کارشناس مروج</td>
...
?>
      ...
      <td <?php if($r%2 == 0)  echo 'bgcolor=#FFFFCC' ?>  width="5%" class="normalTextSmaller"><?php echo $row['date_s'];?></td>
