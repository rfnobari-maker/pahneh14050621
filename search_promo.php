  ...
  <tr>
    ...
    <td width="840" >
       <?php include('top.php'); ?>
           ...
           <p class="style8">&nbsp;</p>
           <p class="style8">جستجوی کاربران سامانه</p>
...
$cod_m =  substr($_POST['typeahead'],$b+1,$c) ;
 $query = "SELECT username,tel_m,cod_m,Last_name,name,pic FROM  users WHERE  cod_m = $cod_m "  ;
$stmt = $dbh->prepare($query);
$stmt->execute();
?>
  <table width="93%" height="119" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr align="center" class="style8">
    <td height="58" bgcolor="#CCCCCC">ارسال پیام</td>
...
<?php
 foreach($stmt as $row){
?>
<td   width="4%" height="58" class="normalTextSmaller">
  <form  action="send_pm.php#1" method="post">
...
if ($pic == '') $pic = 'no_pic.png'
 ...
 ?>
    <td><span class="normalTextSmaller"><img src="../files/users/<? echo $pic ?>" width="40" height="49"  alt=""/></span></td>
    </tr>
<?php
}
}
?>
           ...
           <p>
           <p>            
           <p><a href="indexbenef.php" title="برگشت به صفحه قبل"><img src="files/goback.jpg" width="118" height="47"  alt=""/> </a></p>    </p>
           <p>&nbsp;</p>
